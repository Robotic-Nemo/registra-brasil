...
export function PoliticianForm({ politician, onSubmit, isLoading = false }: PoliticianFormProps) {
  ...
  const inputClass = 'w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:border-transparent'
