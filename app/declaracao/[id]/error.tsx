...
import { AlertTriangle, RotateCcw, Search, Home } from 'lucide-react'
  ...
  return (
    <main className="max-w-lg mx-auto px-4 py-24 text-center">
      ...
      <p className="text-gray-500 text-sm mb-6">
        Não foi possível carregar esta declaração. Tente novamente ou busque outra.
      </p>
      {error.digest && (
      ...
      <div className="mt-8">
        <a
          href={`mailto:contato@registrabrasil.com.br?subject=${encodeURIComponent('Erro na declaração')}&body=${encodeURIComponent(`Erro: ${error.message}\nCódigo: ${error.digest ?? 'N/A'}\nData: ${new Date().toISOString()}`)}`}
