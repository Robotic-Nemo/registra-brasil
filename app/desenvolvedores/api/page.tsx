...
const GROUPS: Group[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { method: 'GET', path: '/api/fontes/:domain/stats.json', desc: 'Agregados por domínio fonte: totais, status, severidade média, primeira/última citação.' },
      { method: 'GET', path: '/api/fontes/:domain/politicos.json', desc: 'Top políticos que citam o domínio como fonte primária.', params: [{ name: 'limite', desc: '1..50 (padrão 20)' }] },
      { method: 'GET', path: '/api/fontes/:domain/por-dia.json', desc: 'Buckets diários (UTC) de declarações citando o domínio, status-split.', params: [{ name: 'dias', desc: '7..180 (padrão 60)' }] },
      { method: 'GET', path: '/api/fontes/:domain/por-semana.json', desc: 'Buckets semanais (ISO/UTC) do domínio, status-split.', params: [{ name: 'semanas', desc: '4..104 (padrão 26)' }] },
      { method: 'GET', path: '/api/fontes/:domain/severidade.json', desc: 'Distribuição por nível de severidade para o domínio.' },
      { method: 'GET', path: '/api/fontes/:domain/severidade-por-mes.json', desc: 'Matriz mês × nível de severidade (5) para o domínio. Gap-filled.', params: [{ name: 'meses', desc: '3..36 (padrão 12)' }] },
      { method: 'GET', path: '/api/fontes/:domain/severidade-por-semana.json', desc: 'Matriz semana (ISO) × nível de severidade (5) para o domínio.', params: [{ name: 'semanas', desc: '4..52 (padrão 12)' }] },
      { method: 'GET', path: '/api/fontes/:domain/severidade-por-dia.json', desc: 'Matriz dia × nível de severidade (5) para o domínio.', params: [{ name: 'dias', desc: '7..180 (padrão 60)' }] },
      { method: 'GET', path: '/api/fontes/:domain/verify-ratio.json', desc: 'Verify-ratio e trend mensal para o domínio.', params: [{ name: 'meses', desc: '3..24 (padrão 12)' }] },
      { method: 'GET', path: '/api/fontes/:domain/categorias.json', desc: 'Top categorias em declarações que citam o domínio.', params: [{ name: 'limite', desc: '1..50 (padrão 20)' }] },
      { method: 'GET', path: '/api/fontes/:domain/por-mes.json', desc: 'Buckets mensais (UTC) do domínio, status-split.', params: [{ name: 'meses', desc: '3..36 (padrão 24)' }] },
      { method: 'GET', path: '/api/fontes/:domain/sparkline.svg', desc: 'Sparkline SVG (citações mensais) para o domínio.' },
      { method: 'GET', path: '/api/fontes/:domain/severity.svg', desc: 'Histograma de severidade SVG para o domínio.' },
      { method: 'GET', path: '/api/colecoes.csv', desc: 'Diretório CSV das coleções editoriais publicadas.' },
      { method: 'GET', path: '/api/indices/co-ocorrencia.json', desc: 'Grafo de co-ocorrência de categorias em declarações verificadas.', params: [{ name: 'limit', desc: '1..500 (padrão 100)' }, { name: 'min_count', desc: 'co-ocorrência mínima (padrão 2)' }] },
      { method: 'GET', path: '/api/contradicoes/por-mes.json', desc: 'Timeseries mensal de contradições publicadas (buckets UTC).', params: [{ name: 'meses', desc: '1..36 (padrão 12)' }] },
      { method: 'GET', path: '/api/politicos/por-estado.json', desc: 'Contagem de políticos ativos por UF (inclui UFs com zero).' },
      { method: 'GET', path: '/api/politicos/por-partido.json', desc: 'Contagem de políticos ativos por partido.', params: [{ name: 'limite', desc: '1..200 (padrão 200)' }] },
      { method: 'GET', path: '/api/estatisticas/por-mes.json', desc: 'Timeseries mensal (verified/disputed/unverified/total) por statement_date UTC.', params: [{ name: 'meses', desc: '1..48 (padrão 24)' }] },
      { method: 'GET', path: '/api/estatisticas/por-semana.json', desc: 'Timeseries semanal (ISO, UTC) global, status-split.', params: [{ name: 'semanas', desc: '4..104 (padrão 26)' }] },
      { method: 'GET', path: '/api/estatisticas/resumo.json', desc: 'Headline numbers: total, 24h/7d/30d, split por status (head-counts).' },
      { method: 'GET', path: '/api/estatisticas/severidade-por-mes.json', desc: 'Matriz mês × nível de severidade (5 níveis) global.', params: [{ name: 'meses', desc: '3..36 (padrão 12)' }] },
      { method: 'GET', path: '/api/estatisticas/severidade-por-semana.json', desc: 'Matriz semana (ISO) × nível de severidade (5) global.', params: [{ name: 'semanas', desc: '4..52 (padrão 12)' }] },
      { method: 'GET', path: '/api/estatisticas/severidade-por-dia.json', desc: 'Matriz dia × nível de severidade (5) global, gap-filled.', params: [{ name: 'dias', desc: '7..180 (padrão 60)' }] },
      { method: 'GET', path: '/api/estatisticas/por-partido.json', desc: 'Matriz mês × partido (top N por volume).', params: [{ name: 'meses', desc: '3..24 (padrão 12)' }, { name: 'limite', desc: '1..30 (padrão 10)' }] },
      { method: 'GET', path: '/api/estatisticas/por-estado.json', desc: 'Matriz mês × UF (top N por volume).', params: [{ name: 'meses', desc: '3..24 (padrão 12)' }, { name: 'limite', desc: '1..27 (padrão 10)' }] },
      { method: 'GET', path: '/api/estatisticas/por-categoria.json', desc: 'Matriz mês × categoria (top N, primary tags).', params: [{ name: 'meses', desc: '3..24 (padrão 12)' }, { name: 'limite', desc: '1..30 (padrão 10)' }] },
      { method: 'GET', path: '/api/estatisticas/por-fonte.json', desc: 'Matriz mês × domínio fonte (top N por volume).', params: [{ name: 'meses', desc: '3..24 (padrão 12)' }, { name: 'limite', desc: '1..50 (padrão 15)' }] },
      { method: 'GET', path: '/api/fontes/top.json', desc: 'Top domínios fonte globais + buckets por classificação e tipo.', params: [{ name: 'limite', desc: '1..200 (padrão 50)' }, { name: 'meses', desc: '1..120 (padrão 12)' }] },
      { method: 'GET', path: '/api/declaracao/:idOrSlug/oembed', desc: 'oEmbed 1.0 rich payload resolvido por id/slug (sem ?url= indireto).', params: [{ name: 'maxwidth', desc: '200..800 (padrão 600)' }, { name: 'maxheight', desc: '150..600 (padrão 400)' }] },
      { method: 'GET', path: '/api/fontes.csv', desc: 'Dump CSV de domínios-fonte rankeados por contagem.', params: [{ name: 'limite', desc: '1..1000 (padrão 500)' }] },
      { method: 'GET', path: '/api/categorias/por-mes.json', desc: 'Timeseries mensal por categoria (top N, tags primárias).', params: [{ name: 'meses', desc: '1..24 (padrão 12)' }, { name: 'top', desc: '1..30 (padrão 10)' }] },
      { method: 'GET', path: '/api/estatisticas/por-dia.json', desc: 'Timeseries diário (UTC) por status de verificação.', params: [{ name: 'dias', desc: '7..365 (padrão 90)' }] },
      { method: 'GET', path: '/api/ranking/por-estado.json', desc: 'Ranking ponderado por UF (severity×exp(-age/365)), com todas as UFs preenchidas.' },
      { method: 'GET', path: '/api/politico/:slug/por-semana.json', desc: 'Buckets semanais (ISO, UTC) de declarações do político.', params: [{ name: 'semanas', desc: '4..104 (padrão 26)' }] },
      { method: 'GET', path: '/api/partidos/:slug/por-mes.json', desc: 'Timeseries mensal do partido (UTC) por status de verificação.', params: [{ name: 'meses', desc: '3..36 (padrão 24)' }] },
      { method: 'GET', path: '/api/estados/:uf/por-mes.json', desc: 'Timeseries mensal da UF (UTC) por status de verificação.', params: [{ name: 'meses', desc: '3..36 (padrão 24)' }] },
      { method: 'GET', path: '/api/categorias/:slug/por-mes.json', desc: 'Timeseries mensal da categoria (primary, UTC) por status.', params: [{ name: 'meses', desc: '3..36 (padrão 24)' }] },
      { method: 'GET', path: '/api/partidos/:slug/por-semana.json', desc: 'Buckets semanais (ISO, UTC-segunda) do partido por status.', params: [{ name: 'semanas', desc: '4..104 (padrão 26)' }] },
      { method: 'GET', path: '/api/estados/:uf/por-semana.json', desc: 'Buckets semanais (ISO, UTC-segunda) da UF por status.', params: [{ name: 'semanas', desc: '4..104 (padrão 26)' }] },
      { method: 'GET', path: '/api/categorias/:slug/por-semana.json', desc: 'Buckets semanais (ISO, UTC-segunda) da categoria por status.', params: [{ name: 'semanas', desc: '4..104 (padrão 26)' }] },
      { method: 'GET', path: '/api/partidos/:slug/por-dia.json', desc: 'Buckets diários (UTC) do partido por status.', params: [{ name: 'dias', desc: '7..180 (padrão 60)' }] },
      { method: 'GET', path: '/api/estados/:uf/por-dia.json', desc: 'Buckets diários (UTC) da UF por status.', params: [{ name: 'dias', desc: '7..180 (padrão 60)' }] },
      { method: 'GET', path: '/api/categorias/:slug/por-dia.json', desc: 'Buckets diários (UTC) da categoria (primary) por status.', params: [{ name: 'dias', desc: '7..180 (padrão 60)' }] },
  ...
  },
  {
    ...
    items: [
      ...
      { method: 'GET', path: '/api/top-categorias.json', desc: 'Ranking de categorias (primary) por score ponderado.', params: [{ name: 'limite', desc: '1..60 (padrão 30)' }] },
      ...
      { method: 'GET', path: '/api/severidade.json', desc: 'Contagens por nível de severidade (global).' },
      { method: 'GET', path: '/api/partidos/:slug/severidade.json', desc: 'Distribuição por nível de severidade para um partido.' },
      { method: 'GET', path: '/api/estados/:uf/severidade.json', desc: 'Distribuição por nível de severidade para uma UF.' },
      { method: 'GET', path: '/api/categorias/:slug/severidade.json', desc: 'Distribuição por nível de severidade para uma categoria (primary).' },
      { method: 'GET', path: '/api/partidos/:slug/severidade-por-mes.json', desc: 'Matriz mês × nível de severidade (5) para um partido. Gap-filled.', params: [{ name: 'meses', desc: '3..36 (padrão 12)' }] },
      { method: 'GET', path: '/api/estados/:uf/severidade-por-mes.json', desc: 'Matriz mês × nível de severidade (5) para uma UF. Gap-filled.', params: [{ name: 'meses', desc: '3..36 (padrão 12)' }] },
      { method: 'GET', path: '/api/categorias/:slug/severidade-por-mes.json', desc: 'Matriz mês × nível de severidade (5) para uma categoria (primary).', params: [{ name: 'meses', desc: '3..36 (padrão 12)' }] },
      { method: 'GET', path: '/api/partidos/:slug/severidade-por-semana.json', desc: 'Matriz semana (ISO) × severidade (5) para um partido.', params: [{ name: 'semanas', desc: '4..52 (padrão 12)' }] },
      { method: 'GET', path: '/api/estados/:uf/severidade-por-semana.json', desc: 'Matriz semana (ISO) × severidade (5) para uma UF.', params: [{ name: 'semanas', desc: '4..52 (padrão 12)' }] },
      { method: 'GET', path: '/api/categorias/:slug/severidade-por-semana.json', desc: 'Matriz semana (ISO) × severidade (5) para uma categoria (primary).', params: [{ name: 'semanas', desc: '4..52 (padrão 12)' }] },
      { method: 'GET', path: '/api/partidos/:slug/severidade-por-dia.json', desc: 'Matriz dia × severidade (5) para um partido.', params: [{ name: 'dias', desc: '7..180 (padrão 60)' }] },
      { method: 'GET', path: '/api/estados/:uf/severidade-por-dia.json', desc: 'Matriz dia × severidade (5) para uma UF.', params: [{ name: 'dias', desc: '7..180 (padrão 60)' }] },
      { method: 'GET', path: '/api/categorias/:slug/severidade-por-dia.json', desc: 'Matriz dia × severidade (5) para uma categoria (primary).', params: [{ name: 'dias', desc: '7..180 (padrão 60)' }] },
  ...
  },
  {
    ...
    items: [
      ...
      { method: 'GET', path: '/api/comparar/partidos.json', desc: 'Compare 2..6 partidos (totais, status, severidade, série mensal).', params: [{ name: 'slugs', desc: 'PT,PL,PSDB (2..6)' }, { name: 'meses', desc: '3..24 (padrão 12)' }] },
      { method: 'GET', path: '/api/comparar/estados.json', desc: 'Compare 2..6 UFs.', params: [{ name: 'ufs', desc: 'SP,RJ,MG (2..6)' }, { name: 'meses', desc: '3..24 (padrão 12)' }] },
      { method: 'GET', path: '/api/comparar/categorias.json', desc: 'Compare 2..6 categorias (primary).', params: [{ name: 'slugs', desc: 'economia,saude (2..6)' }, { name: 'meses', desc: '3..24 (padrão 12)' }] },
      { method: 'GET', path: '/api/mapa/estados.json', desc: 'Estatísticas por UF (todas 27) prontas para choropleth: totais, status, severidade avg + níveis 1..5.', params: [{ name: 'meses', desc: '3..60 (padrão 24)' }] },
      { method: 'GET', path: '/api/mapa/partidos.json', desc: 'Estatísticas por partido: totais, status split, níveis 1..5 + avg. Top-N por volume.', params: [{ name: 'meses', desc: '3..60 (padrão 24)' }, { name: 'limite', desc: '5..200 (padrão 100)' }] },
      { method: 'GET', path: '/api/mapa/categorias.json', desc: 'Estatísticas por categoria primária: totais, status, severidade avg + níveis. Top-N por volume.', params: [{ name: 'meses', desc: '3..60 (padrão 24)' }, { name: 'limite', desc: '5..100 (padrão 40)' }] },
      { method: 'GET', path: '/api/comparar/politicos.json', desc: 'Compare 2..6 políticos por slug (totais, status, severidade, série mensal).', params: [{ name: 'slugs', desc: 'lula-da-silva,bolsonaro (2..6)' }, { name: 'meses', desc: '3..24 (padrão 12)' }] },
      { method: 'GET', path: '/api/trending/politicos.json', desc: 'Momentum ranking: janela recente vs anterior, delta + delta_pct + avg severity.', params: [{ name: 'janela', desc: 'dias 7..60 (padrão 30)' }, { name: 'limite', desc: '5..100 (padrão 25)' }, { name: 'min_recent', desc: '1..20 (padrão 3)' }] },
      { method: 'GET', path: '/api/trending/partidos.json', desc: 'Momentum ranking por partido.', params: [{ name: 'janela', desc: 'dias 7..60 (padrão 30)' }, { name: 'limite', desc: '5..50 (padrão 20)' }, { name: 'min_recent', desc: '1..20 (padrão 5)' }] },
      { method: 'GET', path: '/api/trending/estados.json', desc: 'Momentum ranking por UF.', params: [{ name: 'janela', desc: 'dias 7..60 (padrão 30)' }, { name: 'limite', desc: '5..27 (padrão 27)' }, { name: 'min_recent', desc: '1..20 (padrão 3)' }] },
      { method: 'GET', path: '/api/trending/categorias.json', desc: 'Momentum ranking por categoria primária.', params: [{ name: 'janela', desc: 'dias 7..60 (padrão 30)' }, { name: 'limite', desc: '5..50 (padrão 20)' }, { name: 'min_recent', desc: '1..20 (padrão 3)' }] },
  ...
  },
  {
    ...
    items: [
      ...
      { method: 'GET', path: '/api/politico/:slug/severidade.json', desc: 'Distribuição de severidade (5 níveis) do político.' },
      { method: 'GET', path: '/api/politico/:slug/severidade-por-mes.json', desc: 'Matriz mês × nível de severidade (5) do político. Gap-filled.', params: [{ name: 'meses', desc: '3..36 (padrão 12)' }] },
      { method: 'GET', path: '/api/politico/:slug/severidade-por-semana.json', desc: 'Matriz semana (ISO) × severidade (5) do político.', params: [{ name: 'semanas', desc: '4..52 (padrão 12)' }] },
      { method: 'GET', path: '/api/politico/:slug/severidade-por-dia.json', desc: 'Matriz dia × severidade (5) do político.', params: [{ name: 'dias', desc: '7..180 (padrão 60)' }] },
      { method: 'GET', path: '/api/politico/:slug/por-dia.json', desc: 'Buckets diários (UTC) do político, status-split e gap-filled.', params: [{ name: 'dias', desc: '7..180 (padrão 60)' }] },
      { method: 'GET', path: '/api/politico/:slug/verify-ratio.json', desc: 'Razões verificada/disputada/não verificada do político + trend mensal.', params: [{ name: 'meses', desc: '3..24 (padrão 12)' }] },
      { method: 'GET', path: '/api/partidos/:slug/verify-ratio.json', desc: 'Verify-ratio e trend mensal para um partido.', params: [{ name: 'meses', desc: '3..24 (padrão 12)' }] },
      { method: 'GET', path: '/api/estados/:uf/verify-ratio.json', desc: 'Verify-ratio e trend mensal para uma UF.', params: [{ name: 'meses', desc: '3..24 (padrão 12)' }] },
      { method: 'GET', path: '/api/categorias/:slug/verify-ratio.json', desc: 'Verify-ratio e trend mensal para uma categoria (primary).', params: [{ name: 'meses', desc: '3..24 (padrão 12)' }] },
