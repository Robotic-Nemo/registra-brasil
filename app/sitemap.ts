...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${SITE_URL}/registro-editorial`, lastModified: STATIC_DATE, changeFrequency: 'daily', priority: 0.4 },
    { url: `${SITE_URL}/comparar-declaracoes`, lastModified: STATIC_DATE, changeFrequency: 'monthly', priority: 0.3 },
    { url: `${SITE_URL}/agenda`, lastModified: STATIC_DATE, changeFrequency: 'daily', priority: 0.5 },
    { url: `${SITE_URL}/esta-semana`, lastModified: STATIC_DATE, changeFrequency: 'daily', priority: 0.5 },
    { url: `${SITE_URL}/crescimento`, lastModified: STATIC_DATE, changeFrequency: 'weekly', priority: 0.4 },
    { url: `${SITE_URL}/analise/partidos-x-categorias`, lastModified: STATIC_DATE, changeFrequency: 'weekly', priority: 0.4 },
    { url: `${SITE_URL}/assinar`, lastModified: STATIC_DATE, changeFrequency: 'monthly', priority: 0.5 },
    { url: `${SITE_URL}/analise/estados-x-categorias`, lastModified: STATIC_DATE, changeFrequency: 'weekly', priority: 0.4 },
    { url: `${SITE_URL}/destaques`, lastModified: STATIC_DATE, changeFrequency: 'daily', priority: 0.5 },
    { url: `${SITE_URL}/ao-vivo`, lastModified: STATIC_DATE, changeFrequency: 'always', priority: 0.6 },
    { url: `${SITE_URL}/indices`, lastModified: STATIC_DATE, changeFrequency: 'monthly', priority: 0.6 },
