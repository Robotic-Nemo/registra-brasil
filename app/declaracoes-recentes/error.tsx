...
export default function RecentError({
  ...
  return (
    <main className="max-w-lg mx-auto px-4 py-24 text-center">
      ...
      <h1 className="text-lg font-bold text-gray-900 mb-2">Erro ao carregar declarações recentes</h1>
      ...
      <div className="mt-8">
        <a
          href={`mailto:contato@registrabrasil.com.br?subject=${encodeURIComponent('Erro nas declarações recentes')}&body=${encodeURIComponent(`Erro: ${error.message}\nCódigo: ${error.digest ?? 'N/A'}\nData: ${new Date().toISOString()}`)}`}
