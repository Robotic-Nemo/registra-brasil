...
BEGIN
  ...
  -- 1
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_lul, 'Lula defende diálogo com Venezuela e é criticado por oposição.', 'Não dá para isolar a Venezuela. Diálogo sempre é melhor que sanção.', 'Declaração em entrevista após reunião da Celac em Brasília.', 'verified', true, '2023-05-30', 'https://g1.globo.com/politica/noticia/2023/05/30/lula-defende-dialogo-venezuela-maduro.ghtml', 'news_article', 3, 'Palácio do Itamaraty', 'Cúpula Sul-Americana', 'lula-dialogo-venezuela-b149-1') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 2
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_nik, 'Nikolas Ferreira faz discurso transfóbico em plenário usando peruca.', 'Hoje no Brasil uma mulher pode perder sua vaga para um homem que se identifica como mulher.', 'Deputado usou peruca em pronunciamento sobre Dia Internacional da Mulher gerando repúdio.', 'verified', true, '2023-03-08', 'https://www.camara.leg.br/noticias/945612-nikolas-peruca-dia-mulher', 'news_article', 4, 'Câmara dos Deputados', 'Pronunciamento', 'nikolas-peruca-dia-mulher-b149-2') ON CONFLICT (slug) DO NOTHING RETURNING id)
  ...
  -- 4
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jai, 'Bolsonaro defende que foi vítima de fraude eleitoral sem apresentar provas.', 'Eu tenho certeza que fui reeleito. As urnas foram manipuladas.', 'Declaração a apoiadores em Miami após retornar brevemente à Flórida.', 'verified', true, '2023-02-10', 'https://www.cnnbrasil.com.br/politica/bolsonaro-fraude-eleitoral-miami/', 'news_article', 5, 'Miami, EUA', 'Encontro com apoiadores', 'bolsonaro-fraude-miami-b149-4') ON CONFLICT (slug) DO NOTHING RETURNING id)
