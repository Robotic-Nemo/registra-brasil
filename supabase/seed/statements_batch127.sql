...
BEGIN
  ...
  -- 12
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_bou, 'Boulos chama Marçal de covarde após agressão com cadeira.', 'Covarde, agride quem não pode revidar e foge.', 'Declaração no dia seguinte ao debate.', 'verified', true, '2024-09-16', 'https://www1.folha.uol.com.br/poder/2024/09/boulos-chama-marcal-covarde.shtml', 'news_article', 2, 'São Paulo', 'Reação debate', 'boulos-chama-marcal-covarde-b127-12') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_con, true FROM ins;

  -- 13
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_tab, 'Tabata classifica cadeirada de Marçal como sintoma do bolsonarismo.', 'A violência do Marçal é consequência direta da política de ódio.', 'Entrevista à CBN em SP.', 'verified', false, '2024-09-17', 'https://cbn.globoradio.globo.com/media/audio/404502/tabata-amaral-sobre-cadeirada-marcal.htm', 'news_article', 2, 'São Paulo', 'Entrevista CBN', 'tabata-cadeirada-sintoma-b127-13') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_con, true FROM ins;

  -- 14
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_eri, 'Erika Hilton critica relativização da violência na eleição de SP.', 'Normalizar agressão física é convite para mais violência política.', 'Publicação em redes sociais após a cadeirada.', 'verified', false, '2024-09-16', 'https://www.camara.leg.br/noticias/2024/09/erika-violencia-eleicao-sp', 'official_document', 2, 'Redes sociais', 'Publicação redes', 'erika-violencia-relativizacao-b127-14') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_vio, true FROM ins;

  -- 15
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_pab, 'Marçal chama Boulos de vagabundo em debate da Globo.', 'Boulos é um vagabundo que nunca trabalhou na vida.', 'Debate da Rede Globo com candidatos à Prefeitura de SP.', 'verified', true, '2024-10-03', 'https://g1.globo.com/sp/sao-paulo/eleicoes/2024/noticia/2024/10/03/debate-globo-marcal-boulos.ghtml', 'news_article', 4, 'São Paulo', 'Debate Globo', 'marcal-chama-boulos-vagabundo-b127-15') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_odi, true FROM ins;

  -- 16
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_nun, 'Nunes adota discurso religioso em propaganda de TV.', 'Sou homem de fé, família tradicional e valores cristãos.', 'Propaganda eleitoral em cadeia de TV.', 'verified', false, '2024-09-22', 'https://www1.folha.uol.com.br/poder/2024/09/nunes-discurso-religioso-tv.shtml', 'news_article', 2, 'São Paulo', 'Propaganda TV', 'nunes-religioso-tv-b127-16') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_con, true FROM ins;

  -- 17
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_tar, 'Tarcísio faz campanha intensa por Nunes na reta final.', 'São Paulo não pode perder para a esquerda radical.', 'Caminhada com Nunes na zona sul de São Paulo.', 'verified', false, '2024-09-28', 'https://g1.globo.com/sp/sao-paulo/eleicoes/2024/noticia/2024/09/28/tarcisio-campanha-nunes.ghtml', 'news_article', 2, 'São Paulo', 'Caminhada campanha', 'tarcisio-campanha-nunes-b127-17') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_con, true FROM ins;

  -- 18
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_lul, 'Lula faz ato com Boulos na Zona Leste de São Paulo.', 'Boulos é o candidato do povo, merece nosso voto.', 'Ato de campanha na Zona Leste de São Paulo.', 'verified', true, '2024-09-29', 'https://www.gov.br/planalto/pt-br/acompanhe-o-planalto/noticias/2024/09/lula-boulos-zona-leste', 'official_document', 1, 'São Paulo', 'Ato Zona Leste', 'lula-boulos-zona-leste-b127-18') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_con, true FROM ins;

  -- 19
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_pab, 'Marçal divulga fake news sobre urnas em vídeo viral.', 'As urnas foram programadas para dar vitória à esquerda.', 'Vídeo viralizou em grupos de WhatsApp na véspera do 1º turno.', 'verified', true, '2024-10-05', 'https://www1.folha.uol.com.br/poder/2024/10/marcal-fake-news-urnas.shtml', 'news_article', 4, 'Redes sociais', 'Fake news urnas', 'marcal-fake-urnas-b127-19') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 20
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mor, 'Moraes determina remoção de vídeos de Marçal sobre urnas.', 'Ataques infundados ao sistema eleitoral não serão tolerados.', 'Decisão monocrática no TSE.', 'verified', true, '2024-10-05', 'https://www.tse.jus.br/comunicacao/noticias/2024/Outubro/moraes-remove-videos-marcal', 'official_document', 1, 'Brasília', 'Decisão TSE', 'moraes-remove-videos-marcal-b127-20') RETURNING id)
  ...
  -- 66
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_nik, 'Nikolas faz campanha intensa por Bruno Engler em BH.', 'BH precisa de Engler para acabar com a velha política.', 'Caminhada com Engler em Belo Horizonte.', 'verified', false, '2024-10-19', 'https://www.em.com.br/politica/2024/10/nikolas-campanha-engler.html', 'news_article', 2, 'Belo Horizonte', 'Caminhada campanha', 'nikolas-campanha-engler-b127-66') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_con, true FROM ins;

  -- 67
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_ran, 'Randolfe critica campanha tóxica em São Paulo.', 'A eleição de SP foi marcada pela agressividade e violência.', 'Pronunciamento no Senado após o 2º turno.', 'verified', false, '2024-10-29', 'https://www12.senado.leg.br/noticias/materias/2024/10/29/randolfe-critica-campanha-sp', 'official_document', 1, 'Senado Federal', 'Pronunciamento Senado', 'randolfe-campanha-toxica-b127-67') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_vio, true FROM ins;

  -- 68
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_hum, 'Humberto Costa lamenta resultado do PT e defende autocrítica.', 'O PT precisa fazer uma profunda autocrítica após essa eleição.', 'Entrevista ao Senado.', 'verified', false, '2024-10-30', 'https://www12.senado.leg.br/noticias/materias/2024/10/30/humberto-autocritica-pt', 'official_document', 1, 'Senado Federal', 'Entrevista Senado', 'humberto-autocritica-pt-b127-68') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_con, true FROM ins;
