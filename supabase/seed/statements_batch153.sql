...
BEGIN
  ...
  -- 21
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_sonia, 'Sônia Guajarara anuncia demarcação de seis terras indígenas em primeiro ato do Lula 3.', 'Depois de quatro anos de zero demarcações, retomamos o que a Constituição manda. Seis TIs demarcadas de uma vez.', 'Cerimônia no Planalto com lideranças indígenas para assinatura de decretos de homologação.', 'verified', true, '2023-04-28', 'https://www.gov.br/povosindigenas/pt-br/noticias/demarcacoes-homologadas-lula', 'other', 1, 'Palácio do Planalto', 'Assinatura de decretos', 'sonia-demarcacoes-tis-b153-21') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 22
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jair, 'Bolsonaro critica demarcações de terras indígenas como entrega de território nacional.', 'Estão entregando o Brasil para os índios. É colonização às avessas pagada com dinheiro nosso.', 'Discurso em evento da Aprosoja no Mato Grosso criticando demarcações.', 'verified', true, '2023-05-10', 'https://www.cnnbrasil.com.br/politica/bolsonaro-demarcacoes-entrega-brasil-indios/', 'news_article', 4, 'Cuiabá, MT', 'Evento Aprosoja MT', 'bolsonaro-demarcacoes-entrega-b153-22') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_odi, true FROM ins;

  -- 23
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_cida, 'Cida Gonçalves lança Casa da Mulher Brasileira em 40 novos municípios.', 'Toda mulher tem direito a um lugar seguro para denunciar a violência. Vamos levar a Casa da Mulher a todo canto.', 'Anúncio do programa de expansão com CAF e recursos federais.', 'verified', false, '2023-08-07', 'https://www.gov.br/mulheres/pt-br/noticias/casa-da-mulher-brasileira-expansao', 'other', 1, 'Ministério das Mulheres', 'Expansão Casa da Mulher', 'cida-casa-mulher-brasileira-b153-23') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 24
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_adri, 'Adriana Ventura critica expansão de auxílios sociais do governo Lula.', 'O Brasil virou um balcão de auxílios. Enquanto isso ninguém fala em geração de emprego de verdade.', 'Discurso em plenário contra ampliação de programas de transferência de renda.', 'verified', false, '2023-09-27', 'https://www.camara.leg.br/noticias/adriana-ventura-auxilios-2023', 'news_article', 3, 'Câmara dos Deputados', 'Pronunciamento plenário', 'adriana-ataca-auxilios-b153-24') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 25
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_lula, 'Lula reinstitui Consea e retoma soberania alimentar como política de Estado.', 'O Consea volta porque fome não é aceitável em um país que produz comida para o mundo inteiro.', 'Cerimônia de recriação do Conselho Nacional de Segurança Alimentar e Nutricional.', 'verified', true, '2023-02-02', 'https://www.gov.br/planalto/pt-br/acompanhe-o-planalto/discursos/2023/lula-recria-consea', 'other', 1, 'Palácio do Planalto', 'Recriação do Consea', 'lula-recria-consea-b153-25') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 26
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_vanh, 'Van Hattem chama Bolsa Família de promessa vazia de redução de pobreza.', 'O Bolsa Família criou dependência, não cidadãos. O que tira da pobreza é emprego e educação, não esmola.', 'Discurso em tribuna criticando novo programa social.', 'verified', false, '2023-06-14', 'https://www.camara.leg.br/noticias/van-hattem-bolsa-familia-esmola-2023', 'news_article', 3, 'Câmara dos Deputados', 'Pronunciamento plenário', 'vanhattem-bolsa-familia-esmola-b153-26') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_odi, true FROM ins;

  -- 27
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_padilha, 'Padilha anuncia Farmácia Popular com ampliação de medicamentos gratuitos em 2024.', 'Vamos dobrar os medicamentos gratuitos na Farmácia Popular. Diabetes, hipertensão e asma agora sem custo.', 'Anúncio de ampliação do programa após corte feito na gestão Bolsonaro.', 'verified', true, '2024-04-15', 'https://www.gov.br/saude/pt-br/noticias/farmacia-popular-ampliacao-2024', 'other', 1, 'Ministério da Saúde', 'Ampliação Farmácia Popular', 'padilha-farmacia-popular-amplia-b153-27') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 28
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_lupi, 'Carlos Lupi anuncia reajuste de 6,97% no INSS em 2024.', 'Garantimos reajuste acima da inflação para os aposentados que estavam abandonados.', 'Anúncio de reajuste seguindo política de valorização do salário mínimo.', 'verified', false, '2024-01-10', 'https://www.gov.br/previdencia/pt-br/noticias/lupi-reajuste-inss-2024', 'other', 1, 'MPS', 'Coletiva INSS', 'lupi-reajuste-inss-b153-28') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 29
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_lupi, 'Lupi é demitido após escândalo de descontos indevidos em aposentados do INSS.', 'Não participei de nenhum esquema. Minha consciência está tranquila.', 'Pronunciamento após ser exonerado em meio à operação da PF que identificou fraude em descontos associativos em benefícios.', 'verified', true, '2025-05-02', 'https://g1.globo.com/politica/noticia/2025/05/02/lupi-demissao-inss-descontos.ghtml', 'news_article', 4, 'Brasília', 'Pronunciamento após demissão', 'lupi-demissao-inss-fraude-b153-29') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_cor, true FROM ins;

  -- 30
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_lula, 'Lula promete ressarcir aposentados lesados por descontos ilegais do INSS.', 'Nenhum aposentado vai ficar no prejuízo. O governo vai devolver cada centavo tirado indevidamente.', 'Pronunciamento em rede nacional após escândalo de descontos associativos.', 'verified', true, '2025-05-05', 'https://www.gov.br/planalto/pt-br/acompanhe-o-planalto/pronunciamentos/2025/lula-descontos-inss', 'other', 2, 'Palácio do Planalto', 'Pronunciamento em rede', 'lula-ressarcir-aposentados-inss-b153-30') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 31
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_nik, 'Nikolas Ferreira usa escândalo do INSS para atacar Lula acusando-o de roubar aposentados.', 'Lula roubou os aposentados na frente de todo mundo. Esse é o governo da decência.', 'Vídeo no Instagram atacando governo após escândalo dos descontos.', 'verified', true, '2025-05-03', 'https://www.cnnbrasil.com.br/politica/nikolas-ataca-lula-inss-2025/', 'social_media_post', 4, 'Redes sociais', 'Postagem Instagram', 'nikolas-ataca-lula-inss-b153-31') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;
