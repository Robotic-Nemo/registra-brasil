...
BEGIN
  ...
  -- 6
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jair, 'Bolsonaro nega adesão ao Covax Facility por motivo ideológico.', 'Não vamos ficar dependentes da OMS para nada. Vacinas a gente decide aqui.', 'Declaração em 4 de setembro de 2020 resistindo à adesão ao consórcio internacional.', 'verified', false, '2020-09-04', 'https://www.bbc.com/portuguese/brasil-54034563', 'news_article', 4, 'Palácio do Planalto', 'Declaração à imprensa', 'bolsonaro-covax-facility-recusa-b101-6') RETURNING id)
  ...
  -- 18
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_ran, 'Randolfe protocola superpedido de impeachment com 60 ações acumuladas.', 'São mais de 60 pedidos. Lira não pode engavetar a responsabilidade do Congresso.', 'Protocolo em 17 de novembro de 2020.', 'verified', false, '2020-11-17', 'https://www12.senado.leg.br/noticias/materias/2020/11/17/randolfe-superpedido-impeachment', 'other', 1, 'Câmara dos Deputados', 'Protocolo de denúncia', 'randolfe-superpedido-impeachment-b101-18') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;

  -- 19
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jair, 'Bolsonaro diz que morre quem "tem que morrer" ao comentar 100 mil mortes.', 'Todo mundo vai morrer. Uns mais cedo, outros mais tarde. Sou cristão e sei.', 'Declaração em 7 de agosto de 2020 quando Brasil passou de 100 mil óbitos.', 'verified', true, '2020-08-07', 'https://g1.globo.com/politica/noticia/2020/08/07/bolsonaro-100-mil-mortes-covid.ghtml', 'news_article', 5, 'Palácio da Alvorada', 'Declaração à imprensa', 'bolsonaro-100-mil-mortes-b101-19') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_neg, true FROM ins UNION ALL SELECT id, c_irr, false FROM ins;

  -- 20
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jair, 'Bolsonaro acusa governadores de "inflar" pedidos de respiradores.', 'Estados pedem 10 vezes mais respiradores do que precisam. É jogo político.', 'Declaração em 20 de abril de 2020 em meio à corrida por equipamentos.', 'verified', false, '2020-04-20', 'https://www1.folha.uol.com.br/cotidiano/2020/04/bolsonaro-governadores-respiradores.shtml', 'news_article', 3, 'Palácio do Planalto', 'Declaração à imprensa', 'bolsonaro-respiradores-inflados-b101-20') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 21
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jair, 'Bolsonaro orienta população a "procurar um hospital e filmar".', 'Manda o povo ir ver de perto como são os hospitais. Não é o que estão falando.', 'Live em 11 de junho de 2020 orientando invasão de unidades de saúde.', 'verified', false, '2020-06-11', 'https://www.bbc.com/portuguese/brasil-53016489', 'news_article', 4, 'Live Facebook', 'Live semanal', 'bolsonaro-procurar-hospital-filmar-b101-21') RETURNING id)
  ...
  -- 22
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_bia, 'Bia Kicis lidera pauta anti-lockdown na Câmara.', 'Temos que impedir essa ditadura do isolamento. Estou com o projeto que proíbe lockdown.', 'Discurso em 15 de maio de 2020 apresentando projeto restritivo.', 'verified', false, '2020-05-15', 'https://www.camara.leg.br/noticias/655678-bia-kicis-projeto-lockdown/', 'news_article', 3, 'Câmara dos Deputados', 'Pronunciamento em plenário', 'bia-kicis-projeto-anti-lockdown-b101-22') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_neg, true FROM ins;

  -- 23
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mvh, 'Marcel van Hattem defende fim imediato do isolamento.', 'Pandemia não é desculpa para suspender liberdades. Temos que reabrir tudo agora.', 'Discurso em 22 de abril de 2020.', 'verified', false, '2020-04-22', 'https://www.camara.leg.br/noticias/652456-vanhattem-reabertura/', 'news_article', 2, 'Câmara dos Deputados', 'Pronunciamento em plenário', 'vanhattem-reabertura-imediata-b101-23') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 24
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_tab, 'Tábata Amaral defende vacinação obrigatória.', 'Vacinação é direito coletivo. Tem que ser obrigatória para proteger todos.', 'Discurso em 15 de dezembro de 2020.', 'verified', false, '2020-12-15', 'https://www.camara.leg.br/noticias/714523-tabata-vacinacao-obrigatoria/', 'news_article', 1, 'Câmara dos Deputados', 'Pronunciamento em plenário', 'tabata-vacinacao-obrigatoria-b101-24') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ame, true FROM ins;

  -- 25
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_lul, 'Lula cobra vacinação universal pelo SUS.', 'A vacina tem que ser pública, gratuita, para todos. O SUS salvou e vai salvar o Brasil.', 'Ato virtual em 13 de dezembro de 2020.', 'verified', false, '2020-12-13', 'https://www.bbc.com/portuguese/brasil-55301234', 'news_article', 1, 'São Bernardo do Campo', 'Ato virtual', 'lula-vacinacao-sus-b101-25') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ame, true FROM ins;

  -- 26
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jair, 'Bolsonaro compra briga com China ao chamar vírus de "chinês".', 'O vírus chinês veio pelo comunismo chinês. Temos que dizer a verdade.', 'Entrevista em 25 de março de 2020 gerando crise com embaixador chinês.', 'verified', false, '2020-03-25', 'https://www.reuters.com/article/us-health-coronavirus-brazil-china-idUSKBN21C2M2', 'news_article', 3, 'Palácio do Planalto', 'Entrevista à imprensa', 'bolsonaro-virus-chines-crise-b101-26') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 27
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_edu, 'Eduardo Bolsonaro chama China de "vírus chinês" em tuíte com comparação a Chernobyl.', 'Culpa da China. É o Chernobyl deles. Devem responder.', 'Postagem em 18 de março de 2020.', 'verified', true, '2020-03-18', 'https://www1.folha.uol.com.br/mundo/2020/03/china-chernobyl-eduardo-bolsonaro.shtml', 'social_media_post', 4, 'Twitter', 'Postagem em rede social', 'eduardo-china-chernobyl-b101-27') RETURNING id)
  ...
  -- 28
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_fla, 'Flávio Bolsonaro diz que CPI da Pandemia seria "perseguição".', 'CPI é uso político da tragédia. Vão usar para perseguir o presidente.', 'Entrevista em 5 de dezembro de 2020 resistindo a instalar CPI.', 'verified', false, '2020-12-05', 'https://www12.senado.leg.br/noticias/materias/2020/12/05/flavio-cpi-pandemia-perseguicao', 'news_article', 3, 'Senado Federal', 'Entrevista à imprensa', 'flavio-cpi-perseguicao-b101-28') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_obs, true FROM ins;

  -- 29
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jair, 'Bolsonaro veta auxílio adicional a profissionais da saúde.', 'Vetei o adicional para enfermeiros. Não tem como bancar.', 'Em 4 de agosto de 2020 vetou itens da Lei 14.023.', 'verified', false, '2020-08-04', 'https://g1.globo.com/politica/noticia/2020/08/04/bolsonaro-veta-adicional-enfermeiros.ghtml', 'news_article', 3, 'Palácio do Planalto', 'Sanção de lei', 'bolsonaro-veto-enfermeiros-b101-29') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 30
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jair, 'Bolsonaro diz que "não sabe" o valor das vacinas que governo vai comprar.', 'Não sei. Pergunte ao Pazuello. Eu tô cuidando do Brasil, não de vacina.', 'Declaração em 17 de dezembro de 2020.', 'verified', false, '2020-12-17', 'https://g1.globo.com/politica/noticia/2020/12/17/bolsonaro-nao-sabe-valor-vacina.ghtml', 'news_article', 3, 'Palácio da Alvorada', 'Declaração à imprensa', 'bolsonaro-nao-sabe-vacina-b101-30') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 31
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jair, 'Bolsonaro chama Doria de "bandido" após anúncio da CoronaVac.', 'Doria é um bandido. Quer enfiar vacina chinesa goela abaixo por interesse político.', 'Declaração em 19 de outubro de 2020.', 'verified', false, '2020-10-19', 'https://www1.folha.uol.com.br/poder/2020/10/bolsonaro-chama-doria-de-bandido-vacina.shtml', 'news_article', 4, 'Palácio da Alvorada', 'Declaração à imprensa', 'bolsonaro-doria-bandido-vacina-b101-31') RETURNING id)
  ...
  -- 32
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_pac, 'Pacheco pede responsabilidade institucional diante da pandemia.', 'O Senado precisa ser voz da serenidade. Não podemos compactuar com negacionismo.', 'Declaração em 20 de dezembro de 2020.', 'verified', false, '2020-12-20', 'https://www12.senado.leg.br/noticias/materias/2020/12/20/pacheco-senado-pandemia-responsabilidade', 'news_article', 1, 'Senado Federal', 'Entrevista à imprensa', 'pacheco-responsabilidade-senado-b101-32') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ame, true FROM ins;
  ...
  -- 42
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mfe, 'Feliciano promove aglomeração em templo e pede fim de decretos estaduais.', 'Deus não precisa de decreto. Vamos continuar abrindo as igrejas.', 'Pregação em 29 de março de 2020 em São Paulo.', 'verified', false, '2020-03-29', 'https://www.metropoles.com/brasil/politica-br/feliciano-aglomeracao-templo-marco', 'social_media_post', 4, 'São Paulo', 'Culto evangélico', 'feliciano-aglomeracao-culto-b101-42') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins UNION ALL SELECT id, c_neg, false FROM ins;

  -- 43
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mag, 'Magno Malta chama pandemia de "castigo de Deus" pela agenda LGBT.', 'Deus está castigando o mundo pela agenda LGBT. É hora de arrependimento.', 'Pregação em 12 de abril de 2020.', 'verified', false, '2020-04-12', 'https://www.cartacapital.com.br/politica/magno-malta-castigo-pandemia-lgbt/', 'social_media_post', 4, 'Espírito Santo', 'Culto evangélico', 'magno-castigo-lgbt-b101-43') RETURNING id)
  ...
  -- 44
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jair, 'Bolsonaro diz que governo não comprará vacinas de Pfizer por contrato "abusivo".', 'Pfizer quer impor contrato abusivo. Não vamos comprar. É absurdo.', 'Declaração em 25 de setembro de 2020 sobre recusa inicial.', 'verified', true, '2020-09-25', 'https://www1.folha.uol.com.br/equilibrioesaude/2020/09/bolsonaro-rejeita-vacina-pfizer-contrato.shtml', 'news_article', 4, 'Palácio do Planalto', 'Declaração à imprensa', 'bolsonaro-rejeita-pfizer-b101-44') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 45
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_ott, 'Otto Alencar denuncia dinheiro da pandemia desviado para cloroquina.', 'Gastaram milhões em cloroquina enquanto faltava EPI. Isso é irresponsabilidade criminosa.', 'Pronunciamento em 25 de agosto de 2020.', 'verified', false, '2020-08-25', 'https://www12.senado.leg.br/noticias/materias/2020/08/25/otto-denuncia-cloroquina-milhoes', 'news_article', 1, 'Senado Federal', 'Pronunciamento em plenário', 'otto-desvio-cloroquina-b101-45') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;

  -- 46
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_ren, 'Renan anuncia assinaturas para CPI da Pandemia.', 'Temos os 27 senadores. CPI será instalada para responsabilizar quem matou.', 'Declaração em 29 de dezembro de 2020 com coleta de assinaturas.', 'verified', false, '2020-12-29', 'https://www12.senado.leg.br/noticias/materias/2020/12/29/renan-cpi-pandemia-assinaturas', 'news_article', 1, 'Senado Federal', 'Entrevista à imprensa', 'renan-cpi-assinaturas-b101-46') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ame, true FROM ins;

  -- 47
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jair, 'Bolsonaro manda STF "ficar na dele" e parar de "invadir" Executivo.', 'O STF tem que ficar na dele. Não é seu papel gerir pandemia. Sou eu o presidente.', 'Declaração em 18 de maio de 2020 após decisão sobre competência concorrente.', 'verified', false, '2020-05-18', 'https://g1.globo.com/politica/noticia/2020/05/18/bolsonaro-stf-ficar-na-dele.ghtml', 'news_article', 4, 'Palácio da Alvorada', 'Declaração à imprensa', 'bolsonaro-stf-ficar-na-dele-b101-47') RETURNING id)
  ...
  -- 85
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_car, 'Carlos Bolsonaro ataca jornalista em redes sociais com ameaças veladas.', 'Esse jornalista está marcado. Vamos expor quem é. Povo reage.', 'Postagem em 5 de outubro de 2020.', 'verified', false, '2020-10-05', 'https://www.metropoles.com/brasil/politica-br/carlos-ataca-jornalista-outubro', 'social_media_post', 4, 'Twitter', 'Postagem em rede social', 'carlos-ataque-jornalista-b101-85') RETURNING id)
  ...
  -- 98
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jair, 'Bolsonaro defende Pazuello mesmo com crise de oxigênio se aproximando.', 'Pazuello é meu general. Não vai sair. Quem quer tirar é imprensa.', 'Declaração em 28 de dezembro de 2020.', 'verified', true, '2020-12-28', 'https://g1.globo.com/politica/noticia/2020/12/28/bolsonaro-defende-pazuello-dezembro.ghtml', 'news_article', 4, 'Palácio da Alvorada', 'Declaração à imprensa', 'bolsonaro-defende-pazuello-dez-b101-98') RETURNING id)
