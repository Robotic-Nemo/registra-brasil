...
BEGIN
  ...
  -- 68
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_aec, 'Aécio nega crime após ter áudio divulgado e é afastado.', 'Não cometi crime algum. A conversa foi distorcida.', 'Nota do senador após decisão do STF pelo afastamento.', 'verified', true, '2017-05-18', 'https://oglobo.globo.com/politica/aecio-nega-crime-apos-audio-divulgado-21423456', 'news_article', 4, 'Brasília', 'Nota do gabinete', 'aecio-nega-crime-audio-b122-68') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 69
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mor, 'Moro afirma em entrevista que Lava Jato está acima de pressões.', 'Não nos intimidamos com pressões. Seguiremos o rito da lei.', 'Entrevista à revista Veja sobre momento político pós-JBS.', 'verified', false, '2017-06-03', 'https://veja.abril.com.br/politica/moro-lava-jato-nao-se-intimida/', 'interview', 2, 'Curitiba', 'Entrevista Veja', 'moro-lava-jato-acima-b122-69') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;
  ...
  -- 92
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_dam, 'Damares afirma que Moro é herói nacional no ministério.', 'O Brasil precisa de mais Moros para nos livrar da corrupção.', 'Entrevista durante posse dos ministros.', 'verified', false, '2019-01-02', 'https://veja.abril.com.br/politica/damares-elogia-moro-heroi-nacional/', 'news_article', 2, 'Brasília', 'Entrevista na posse', 'damares-moro-heroi-b122-92') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 93
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mou, 'Mourão defende que Lava Jato serviu para arrumar a casa.', 'A Lava Jato foi essencial para o Brasil ser mais sério.', 'Entrevista à Band em fevereiro de 2019.', 'verified', false, '2019-02-10', 'https://g1.globo.com/politica/noticia/mourao-defende-lava-jato.ghtml', 'interview', 2, 'Brasília', 'Entrevista Band', 'mourao-defende-lava-jato-b122-93') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 94
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jair, 'Bolsonaro diz que reformaria Moro para o STF se tiver vaga.', 'Moro é nome natural para a próxima vaga no Supremo.', 'Declaração em entrevista a emissora em Brasília.', 'verified', true, '2019-02-28', 'https://oglobo.globo.com/politica/bolsonaro-indica-moro-ao-stf-23876543', 'interview', 4, 'Brasília', 'Entrevista a emissora', 'bolsonaro-indica-moro-stf-b122-94') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_con, true FROM ins;

  -- 95
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jan, 'Jandira Feghali denuncia indicação ao STF como compra de sentença.', 'Indicação ao STF prova que houve acerto antes de Moro condenar Lula.', 'Discurso na Câmara após declaração de Bolsonaro.', 'verified', false, '2019-03-01', 'https://www.camara.leg.br/noticias/jandira-denuncia-acerto-moro-stf', 'speech', 3, 'Câmara dos Deputados', 'Pronunciamento', 'jandira-moro-stf-acerto-b122-95') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_con, true FROM ins;
