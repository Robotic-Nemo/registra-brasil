...
BEGIN
  ...
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mot, 'Motta celebra derrubada do decreto do IOF como "vitória do Congresso".', 'O Congresso derrubou o aumento do IOF. Foi vitória do Parlamento sobre o tarifaço do governo. Agora, Executivo precisa dialogar.', 'Declaração em junho de 2025 após decreto legislativo derrubar mudanças do IOF promovidas pelo governo Lula.', 'verified', true, '2025-06-25', 'https://www.camara.leg.br/noticias/motta-derrubada-iof-2025', 'other', 2, 'Câmara dos Deputados', 'Derrubada decreto IOF', 'motta-derrubada-iof-b166-6') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_con, true FROM ins;

  -- 7 Haddad reação IOF
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_had, 'Haddad critica derrubada do IOF e acusa Congresso de "defender super-ricos".', 'O Congresso escolheu defender super-ricos em vez do pobre. Derrubar IOF sobre elisão é regalia. Vamos judicializar.', 'Coletiva após derrubada do decreto do IOF pelo Congresso em junho de 2025, com Haddad anunciando ação no STF.', 'verified', true, '2025-06-26', 'https://valor.globo.com/politica/noticia/2025/06/26/haddad-iof-congresso.ghtml', 'news_article', 3, 'Ministério da Fazenda', 'Coletiva IOF', 'haddad-iof-congresso-super-ricos-b166-7') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_con, true FROM ins;
  ...
  -- 68
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_din, 'Dino manda prender chefe de milícia digital investigada pelo STF.', 'A prisão preventiva é necessária para interromper a operação da milícia digital que ameaça ministros e espalha desinformação em massa.', 'Decisão em maio de 2025 de Flávio Dino determinando prisão preventiva de operador de rede de desinformação bolsonarista.', 'verified', false, '2025-05-11', 'https://portal.stf.jus.br/noticias/dino-prisao-milicia-digital-2025', 'other', 2, 'STF', 'Decisão', 'dino-prisao-milicia-digital-b166-68') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 69
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_fac, 'Fachin vota pela condenação de generais denunciados pela PGR.', 'Militar não está acima da lei. Participação comprovada em plano de subversão da ordem constitucional configura crime grave.', 'Voto em abril de 2025 de Edson Fachin em análise de denúncia da PGR contra ex-oficiais ligados à trama golpista.', 'verified', false, '2025-04-21', 'https://portal.stf.jus.br/noticias/fachin-generais-golpe-abril-2025', 'other', 1, 'STF', 'Voto', 'fachin-generais-golpe-b166-69') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ant, true FROM ins;

  -- 70
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mot, 'Motta pauta PEC da Blindagem parlamentar e enfrenta reação.', 'O Parlamento precisa de blindagem contra perseguições seletivas. Quero pautar a PEC para reequilibrar forças entre Poderes.', 'Em junho de 2025 Motta defendeu pauta de PEC que ampliaria imunidade parlamentar como resposta a decisões do STF.', 'verified', true, '2025-06-23', 'https://www1.folha.uol.com.br/poder/2025/06/motta-pec-blindagem-parlamentar.shtml', 'news_article', 4, 'Câmara dos Deputados', 'Coletiva', 'motta-pec-blindagem-b166-70') RETURNING id)
  ...
  -- 98
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_bou, 'Boulos critica Tarcísio por despejos de ocupações urbanas.', 'Tarcísio faz despejo em plena chuva. Tira família, joga criança na rua. Isso é o projeto urbano da direita: excluir e empurrar.', 'Discurso em maio de 2025 contra operação de despejo em ocupação na zona leste de SP conduzida pelo governo Tarcísio.', 'verified', false, '2025-05-10', 'https://www.camara.leg.br/noticias/boulos-despejos-tarcisio-maio-2025', 'other', 2, 'Câmara dos Deputados', 'Tribuna', 'boulos-despejos-tarcisio-b166-98') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_vio, true FROM ins;

  -- 99
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_gal, 'Galípolo promove corte de juros no Copom em maio.', 'O Copom reduziu a Selic em 0,25 p.p. A decisão reflete quadro inflacionário mais benigno. Continuaremos com cautela e responsabilidade técnica.', 'Decisão do Copom em maio de 2025 de cortar taxa Selic, primeira redução sob gestão de Gabriel Galípolo na presidência do BC.', 'verified', true, '2025-05-07', 'https://www.bcb.gov.br/detalhenoticia/820/noticia', 'other', 1, 'Banco Central', 'Reunião Copom', 'galipolo-corte-selic-maio-b166-99') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_con, true FROM ins;

  -- 100
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jai, 'Bolsonaro grava vídeo nos EUA com aliados para convocar ato em julho.', 'Convoco todo brasileiro para a Paulista em julho. Esse é o momento de mostrar que o povo não aceita essa ditadura. Estarei com vocês.', 'Em junho de 2025 Bolsonaro gravou mensagem a apoiadores com agendamento de novo ato público na Avenida Paulista.', 'verified', true, '2025-06-28', 'https://www1.folha.uol.com.br/poder/2025/06/bolsonaro-convocacao-paulista-julho.shtml', 'news_article', 4, 'Redes sociais', 'Convocação de ato', 'bolsonaro-convocacao-paulista-julho-b166-100') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ant, true FROM ins;
