...
BEGIN
  ...
  -- 25
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_edu, 'Eduardo Bolsonaro acusa governo de negligência na catástrofe do RS.', 'Não foi só a chuva. Foi a negligência do Lula que matou tanta gente no Sul.', 'Postagem no X em que atribuiu catástrofe climática a governo federal.', 'verified', true, '2024-05-10', 'https://www.poder360.com.br/politica/eduardo-acusa-lula-rs-negligencia/', 'social_media_post', 4, 'Redes sociais', 'Postagem X', 'eduardo-acusa-lula-rs-b154-25') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 26
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_melo, 'Sebastião Melo anuncia reconstrução completa do sistema de bombas de Porto Alegre.', 'O sistema de bombas falhou. Vamos reconstruir todo ele, custe o que custar. Porto Alegre não pode repetir esse cenário.', 'Pronunciamento após visita aos bairros atingidos.', 'verified', true, '2024-06-01', 'https://prefeitura.poa.br/noticias/melo-bombas-reconstrucao-2024', 'other', 2, 'Porto Alegre', 'Anúncio reconstrução', 'melo-bombas-poa-reconstrucao-b154-26') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 27
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_taliria, 'Talíria Petrone denuncia negligência do governo municipal de Niterói em obras de contenção.', 'Falaram durante anos em prevenção. Cadê as obras? Morros de Niterói continuam desprotegidos.', 'Discurso em plenário após deslizamento no Morro do Bumba.', 'verified', false, '2023-11-15', 'https://www.camara.leg.br/noticias/taliria-niteroi-deslizamento-2023', 'news_article', 2, 'Câmara dos Deputados', 'Pronunciamento', 'taliria-niteroi-deslizamento-b154-27') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 28
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_rcosta, 'Rui Costa lança pacote de R$ 100 bi em obras hídricas no Nordeste.', 'O Nordeste finalmente vai ter a maior carga de obras hídricas da história. Tudo previsto no PAC.', 'Cerimônia em Pernambuco com governadores nordestinos.', 'verified', false, '2024-02-20', 'https://www.gov.br/casacivil/pt-br/noticias/rui-costa-100bi-hidrico-ne', 'other', 1, 'Pernambuco', 'Pacote hídrico NE', 'rcosta-100bi-hidrico-ne-b154-28') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 29
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jair, 'Bolsonaro diz que Ferrogrão parou por culpa do STF e minimiza impactos ambientais.', 'A Ferrogrão vai desenvolver o Pará e o Mato Grosso. STF parou porque inventou ameaça a indígena.', 'Entrevista a ruralistas criticando decisão cautelar do STF.', 'verified', true, '2023-06-28', 'https://www.poder360.com.br/politica/bolsonaro-ferrograo-stf/', 'news_article', 3, 'Brasília', 'Entrevista ruralistas', 'bolsonaro-ferrograo-stf-b154-29') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 30
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_sonia, 'Sônia Guajajara defende adiamento da Ferrogrão até consulta a comunidades indígenas.', 'A Ferrogrão não pode ser aprovada sem consulta livre, prévia e informada aos povos da região.', 'Declaração sobre impacto socioambiental do projeto.', 'verified', true, '2023-07-05', 'https://www.gov.br/povosindigenas/pt-br/noticias/sonia-ferrograo-2023', 'other', 2, 'MPI', 'Declaração Ferrogrão', 'sonia-ferrograo-consulta-b154-30') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 31
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_tarc, 'Tarcísio lança Linha 19 do Metrô com parceria sem precedentes em SP.', 'A Linha 19-Celeste vai ligar Bom Retiro a Guarulhos. É a maior PPP de metrô da América Latina.', 'Leilão e assinatura de concessão.', 'verified', true, '2024-04-18', 'https://www.saopaulo.sp.gov.br/noticias/tarcisio-linha-19-metro-2024', 'other', 2, 'São Paulo', 'Concessão Linha 19', 'tarcisio-linha-19-metro-b154-31') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 32
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_orlando, 'Orlando Silva cobra investigação sobre superfaturamento em obras de Tarcísio.', 'As obras de Tarcísio têm sobrepreço sistemático. TCU precisa investigar o padrão de aditivos.', 'Discurso em plenário sobre contratos estaduais paulistas.', 'verified', false, '2024-06-05', 'https://www.camara.leg.br/noticias/orlando-silva-tarcisio-sobrepreco-2024', 'news_article', 3, 'Câmara dos Deputados', 'Pronunciamento', 'orlando-silva-tarcisio-sobrepreco-b154-32') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_cor, true FROM ins;

  -- 33
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_fuad, 'Fuad Noman inaugura BRT Move 2 em Belo Horizonte após anos parado.', 'O Move 2 vai reduzir o tempo de viagem dos belorizontinos. Uma obra que demorou demais.', 'Inauguração de corredor viário em BH.', 'verified', false, '2024-04-30', 'https://prefeitura.pbh.gov.br/noticias/fuad-brt-move-2-2024', 'other', 1, 'Belo Horizonte', 'Inauguração Move 2', 'fuad-brt-move-2-bh-b154-33') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 34
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_zema, 'Zema cancela obras do Rodoanel de BH em revisão de gastos.', 'O Rodoanel de BH foi superestimado. Estamos revendo o projeto para caber no orçamento.', 'Anúncio de revisão de obras do estado.', 'verified', true, '2024-03-18', 'https://www.em.com.br/politica/2024/03/zema-rodoanel-bh.shtml', 'news_article', 3, 'Palácio Tiradentes', 'Anúncio revisão', 'zema-rodoanel-bh-cancela-b154-34') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 35
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_helder, 'Helder Barbalho anuncia Ponte Guamá em Belém inaugurada antes da COP30.', 'A Ponte Guamá será inaugurada antes da COP30. Nosso compromisso com o mundo é cumprido.', 'Declaração em visita de obra.', 'verified', false, '2025-06-10', 'https://agenciapara.com.br/noticia/helder-ponte-guama-cop30-2025', 'other', 1, 'Belém, PA', 'Visita obra ponte', 'helder-ponte-guama-cop30-b154-35') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;
