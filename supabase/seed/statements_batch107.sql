...
BEGIN
  ...
  -- 42
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_tar, 'Tarcísio defende Bolsonaro e minimiza indiciamento por golpismo.', 'Bolsonaro é um democrata, foi tudo perseguição.', 'Entrevista após indiciamento.', 'verified', true, '2024-11-26', 'https://www.estadao.com.br/politica/tarcisio-bolsonaro-indiciamento/', 'news_article', 4, 'São Paulo', 'Entrevista', 'tarcisio-bolsonaro-indiciamento-b107-42') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ant, true FROM ins;

  -- 43
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_cai, 'Caiado defende Bolsonaro como "preso político" após indiciamento pela PF.', 'Bolsonaro é um preso político do sistema.', 'Entrevista em Brasília.', 'verified', true, '2024-11-28', 'https://www.cnnbrasil.com.br/politica/caiado-bolsonaro-preso/', 'news_article', 4, 'Brasília', 'Entrevista', 'caiado-bolsonaro-preso-b107-43') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ant, true FROM ins;

  -- 44
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_zem, 'Zema ataca Lula e defende anistia a envolvidos no 8 de janeiro.', 'Precisamos de anistia para pacificar o país.', 'Ato em Belo Horizonte.', 'verified', true, '2024-08-25', 'https://www.otempo.com.br/politica/zema-anistia-8-janeiro', 'news_article', 5, 'Belo Horizonte', 'Ato', 'zema-anistia-8-janeiro-b107-44') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ant, true FROM ins;

  -- 45
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_iba, 'Ibaneis afirma em entrevista que "TSE exagerou" na cassação de Bolsonaro.', 'O TSE foi político demais, não técnico.', 'Entrevista à imprensa.', 'verified', false, '2024-03-12', 'https://www.correiobraziliense.com.br/politica/2024/03/ibaneis-tse.html', 'news_article', 3, 'Brasília', 'Entrevista', 'ibaneis-tse-bolsonaro-b107-45') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ame, true FROM ins;

  -- 46
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_rat, 'Ratinho Junior é acusado de conflito de interesse ao nomear sócio para cargo público.', 'A nomeação seguiu critérios técnicos.', 'Resposta a denúncia.', 'verified', false, '2024-07-30', 'https://www.gazetadopovo.com.br/politica/ratinho-socio/', 'news_article', 3, 'Curitiba', 'Coletiva', 'ratinho-socio-pr-b107-46') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_con, true FROM ins;

  -- 47
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_edu, 'Eduardo Leite é criticado por cortes na saúde durante crise climática no RS.', 'Precisamos ser responsáveis fiscalmente, não dá para gastar sem limite.', 'Declaração após crise.', 'verified', false, '2024-09-05', 'https://gauchazh.clicrbs.com.br/politica/noticia/2024/09/eduardo-leite-saude.html', 'news_article', 3, 'Porto Alegre', 'Coletiva', 'eduardo-leite-saude-b107-47') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 48
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mau, 'Mauro Mendes defende grileiros como "produtores lesados" em MT.', 'O produtor rural é o que sustenta o país, não pode ser criminalizado.', 'Discurso em evento do agro.', 'verified', false, '2024-10-08', 'https://www.folha.uol.com.br/mercado/2024/10/mauro-mendes-grileiros.shtml', 'news_article', 3, 'Cuiabá', 'Evento agro', 'mauro-mendes-grileiros-b107-48') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;
  ...
  -- 50
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_wil, 'Wilson Lima é denunciado por superfaturamento em contrato de respiradores em 2024.', 'Foi emergência da covid, não havia tempo para licitar.', 'Entrevista após denúncia da CGU.', 'verified', true, '2024-04-12', 'https://g1.globo.com/am/amazonas/noticia/2024/04/12/wilson-lima-respiradores.ghtml', 'news_article', 4, 'Manaus', 'Coletiva', 'wilson-lima-respiradores-b107-50') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_cor, true FROM ins;

  -- 51
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jer, 'Jerônimo Rodrigues defende aumento de investimento em segurança e critica MP.', 'O Ministério Público não pode atrapalhar o combate ao crime.', 'Declaração após inquérito.', 'verified', false, '2024-12-05', 'https://www.correio24horas.com.br/politica/jeronimo-mp', 'news_article', 3, 'Salvador', 'Entrevista', 'jeronimo-mp-bahia-b107-51') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_obs, true FROM ins;

  -- 52
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_hel, 'Helder Barbalho é denunciado por uso político de obras da COP30.', 'Obras são obras, não existe uso político.', 'Entrevista em Brasília.', 'verified', false, '2025-06-15', 'https://www.poder360.com.br/politica/helder-cop30-politico/', 'news_article', 3, 'Belém', 'Coletiva', 'helder-cop-politico-b107-52') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;

  -- 53
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_ray, 'Raquel Lyra é criticada por demora em resposta à seca em Pernambuco.', 'Estamos fazendo o que é possível.', 'Entrevista no sertão pernambucano.', 'verified', false, '2024-11-10', 'https://www.diariodepernambuco.com.br/politica/raquel-seca', 'news_article', 2, 'Recife', 'Entrevista', 'raquel-seca-pe-b107-53') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 54
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_nun, 'Ricardo Nunes minimiza crise de moradia após operações de despejo em SP.', 'Não existe déficit habitacional em São Paulo.', 'Entrevista após despejo.', 'verified', false, '2025-02-08', 'https://www.cartacapital.com.br/politica/nunes-moradia-sp', 'news_article', 3, 'São Paulo', 'Coletiva', 'nunes-moradia-sp-b107-54') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 55
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_pae, 'Paes minimiza Dengue em 2024 e culpa moradores pela infestação.', 'O cidadão tem que cuidar da água parada em casa.', 'Coletiva sobre Dengue.', 'verified', true, '2024-03-05', 'https://g1.globo.com/rj/rio-de-janeiro/noticia/2024/03/05/paes-dengue.ghtml', 'news_article', 3, 'Rio de Janeiro', 'Coletiva', 'paes-dengue-rj-b107-55') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 56
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jca, 'João Campos é acusado de clientelismo eleitoral em Recife.', 'Estamos ajudando comunidades, não fazendo política.', 'Resposta a denúncia.', 'verified', false, '2024-08-08', 'https://www.folhape.com.br/politica/joao-campos-clientelismo', 'news_article', 2, 'Recife', 'Entrevista', 'joao-campos-clientelismo-b107-56') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;

  -- 57
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_top, 'Topázio Silveira faz declaração machista sobre vereadora em Florianópolis.', 'Essa vereadora só sabe gritar, devia ficar em casa.', 'Câmara de Florianópolis.', 'verified', true, '2025-04-02', 'https://www.nsctotal.com.br/noticias/topazio-vereadora', 'news_article', 4, 'Florianópolis', 'Plenário', 'topazio-vereadora-b107-57') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_mac, true FROM ins;

  -- 58
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_sar, 'Sarto acusa adversário Evandro Leitão sem provas durante campanha em Fortaleza.', 'Ele está envolvido em esquemas, mas a imprensa protege.', 'Durante debate.', 'verified', true, '2024-10-25', 'https://www.opovo.com.br/eleicoes/sarto-evandro-acusacao.html', 'news_article', 4, 'Fortaleza', 'Debate', 'sarto-evandro-acusacao-b107-58') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;
  ...
  -- 60
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_gla, 'Gladson Cameli é acusado de uso político de emendas no Acre.', 'Emendas são direito do governador.', 'Entrevista à imprensa.', 'verified', false, '2024-12-10', 'https://www.acrenews.com.br/gladson-emendas', 'news_article', 2, 'Rio Branco', 'Entrevista', 'gladson-emendas-b107-60') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;

  -- 61
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_den, 'Denarium defende garimpo ilegal como "economia local" em Roraima.', 'O garimpo é o que sustenta muita família em Roraima.', 'Entrevista local.', 'verified', true, '2024-05-20', 'https://g1.globo.com/rr/roraima/noticia/2024/05/20/denarium-garimpo.ghtml', 'news_article', 5, 'Boa Vista', 'Entrevista', 'denarium-garimpo-b107-61') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_neg, true FROM ins;

  -- 62
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_elm, 'Elmano de Freitas é acusado de ignorar pauta de mulheres no Ceará.', 'Temos uma secretaria, não dá para fazer tudo.', 'Após protesto de feministas.', 'verified', false, '2024-03-08', 'https://www.opovo.com.br/noticias/politica/elmano-mulheres.html', 'news_article', 2, 'Fortaleza', 'Entrevista', 'elmano-mulheres-b107-62') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 63
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_eri, 'Riedel defende a redução de impostos sem explicar compensação fiscal em MS.', 'Empresário paga muito imposto, é preciso aliviar.', 'Evento empresarial.', 'verified', false, '2024-07-15', 'https://www.campograndenews.com.br/politica/riedel-impostos', 'news_article', 2, 'Campo Grande', 'Evento', 'riedel-impostos-b107-63') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;
  ...
  -- 83
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mar, 'Marçal alega fraude eleitoral sem provas após derrota em SP.', 'As urnas foram manipuladas, eu venci.', 'Postagem em redes após 1º turno.', 'verified', true, '2024-10-07', 'https://www.cnnbrasil.com.br/eleicoes/marcal-urnas-fraude/', 'news_article', 5, 'São Paulo', 'Redes sociais', 'marcal-urnas-fraude-b107-83') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ant, true FROM ins;

  -- 84
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_nik, 'Nikolas Ferreira ataca urnas eletrônicas em campanha municipal.', 'O Brasil precisa de voto impresso, as urnas são fraudáveis.', 'Comício em Belo Horizonte.', 'verified', true, '2024-09-25', 'https://www.otempo.com.br/politica/nikolas-urnas', 'news_article', 5, 'Belo Horizonte', 'Comício', 'nikolas-urnas-bh-b107-84') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ant, true FROM ins;

  -- 85
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_bol, 'Bolsonaro afirma em campanha municipal que Lula roubou a eleição.', 'Vocês sabem que ganhamos em 2022, todo mundo sabe.', 'Comício em Goiânia.', 'verified', true, '2024-10-12', 'https://www.poder360.com.br/eleicoes/bolsonaro-lula-roubo/', 'news_article', 5, 'Goiânia', 'Comício', 'bolsonaro-lula-roubo-b107-85') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ant, true FROM ins;

  -- 86
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_tar, 'Tarcísio anuncia escolas cívico-militares em SP apesar de críticas de pais.', 'Escola tem que ter disciplina como no quartel.', 'Cerimônia de anúncio.', 'verified', true, '2024-06-10', 'https://www.folha.uol.com.br/educacao/2024/06/tarcisio-civico-militar.shtml', 'news_article', 3, 'São Paulo', 'Cerimônia', 'tarcisio-civico-militar-b107-86') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_aut, true FROM ins;

  -- 87
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_zem, 'Zema defende redução de participação do PROUNI em MG e ataca universidades públicas.', 'Universidade pública é para rico mesmo.', 'Evento empresarial.', 'verified', false, '2024-05-18', 'https://www.otempo.com.br/politica/zema-universidade', 'news_article', 3, 'Belo Horizonte', 'Evento', 'zema-universidade-b107-87') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 88
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_rat, 'Ratinho Junior minimiza desmatamento na Mata Atlântica paranaense.', 'A gente preserva mais do que qualquer um.', 'Entrevista em Curitiba.', 'verified', false, '2024-08-18', 'https://www.gazetadopovo.com.br/politica/ratinho-desmatamento/', 'news_article', 3, 'Curitiba', 'Entrevista', 'ratinho-desmatamento-pr-b107-88') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_neg, true FROM ins;

  -- 89
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mau, 'Mauro Mendes ataca ONGs ambientais em MT e ameaça fechar escritórios.', 'ONGs atrapalham o desenvolvimento, a gente vai acabar com isso.', 'Evento do agronegócio.', 'verified', true, '2024-09-10', 'https://g1.globo.com/mt/mato-grosso/noticia/2024/09/10/mauro-ongs.ghtml', 'news_article', 4, 'Cuiabá', 'Evento agro', 'mauro-mendes-ongs-mt-b107-89') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_int, true FROM ins;

  -- 90
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_eri, 'Riedel é acusado de conflito de interesse ao favorecer setor do qual é sócio.', 'Meus interesses empresariais ficaram para trás.', 'Coletiva em Campo Grande.', 'verified', false, '2024-12-02', 'https://www.campograndenews.com.br/politica/riedel-conflito', 'news_article', 3, 'Campo Grande', 'Coletiva', 'riedel-conflito-ms-b107-90') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_con, true FROM ins;

  -- 91
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_hel, 'Helder Barbalho minimiza devastação amazônica durante campanha para 2026.', 'O desmatamento caiu muito, estamos resolvendo.', 'Entrevista à imprensa internacional.', 'verified', false, '2025-09-10', 'https://www.poder360.com.br/meio-ambiente/helder-desmatamento/', 'news_article', 3, 'Belém', 'Entrevista', 'helder-desmatamento-b107-91') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 92
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_edu, 'Eduardo Leite é criticado por apelo à polícia para reprimir manifestações de agricultores no RS.', 'Manifestação é direito, mas bloqueio de estrada é crime.', 'Coletiva em Porto Alegre.', 'verified', false, '2024-10-18', 'https://gauchazh.clicrbs.com.br/politica/noticia/2024/10/leite-manifestantes.html', 'news_article', 3, 'Porto Alegre', 'Coletiva', 'leite-manifestantes-rs-b107-92') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;

  -- 93
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_boul, 'Boulos reage a ataques no debate com linguagem considerada agressiva.', 'Esse cara é um palhaço, não merece nem resposta.', 'Debate eleitoral.', 'verified', false, '2024-10-03', 'https://www.folha.uol.com.br/eleicoes/2024/10/boulos-debate.shtml', 'news_article', 2, 'São Paulo', 'Debate', 'boulos-debate-sp-b107-93') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 94
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_nik, 'Nikolas Ferreira apoia prefeito aliado e espalha desinformação sobre adversário em BH.', 'Fuad é o candidato dos comunistas.', 'Comício em BH.', 'verified', true, '2024-10-20', 'https://www.otempo.com.br/politica/nikolas-fuad-comunista', 'news_article', 4, 'Belo Horizonte', 'Comício', 'nikolas-fuad-comunista-b107-94') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 95
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_bol, 'Bolsonaro em ato em Recife pede prisão política de ministros do STF.', 'Esses ministros são inimigos da democracia, têm que ser presos.', 'Ato em Recife.', 'verified', true, '2024-08-10', 'https://www.folhape.com.br/politica/bolsonaro-stf-recife', 'news_article', 5, 'Recife', 'Ato', 'bolsonaro-stf-recife-b107-95') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ant, true FROM ins;

  -- 96
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_cas, 'Castro faz piada considerada transfóbica em evento em Niterói.', 'Homem é homem, mulher é mulher, pode chamar de preconceito.', 'Evento de inauguração.', 'verified', true, '2024-07-12', 'https://g1.globo.com/rj/rio-de-janeiro/noticia/2024/07/12/castro-trans.ghtml', 'news_article', 5, 'Niterói', 'Inauguração', 'castro-trans-niteroi-b107-96') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_odi, true FROM ins;

  -- 97
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_tar, 'Tarcísio nega existência de racismo institucional em São Paulo.', 'Aqui não tem racismo, quem diz isso é radical.', 'Evento em São Paulo.', 'verified', true, '2024-11-20', 'https://www.folha.uol.com.br/cotidiano/2024/11/tarcisio-racismo.shtml', 'news_article', 4, 'São Paulo', 'Evento', 'tarcisio-racismo-sp-b107-97') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_rac, true FROM ins;

  -- 98
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_cai, 'Caiado faz comentário considerado intolerante religioso sobre terreiros em Goiás.', 'Essas religiões de terreiro são problema de segurança.', 'Entrevista em Goiânia.', 'verified', true, '2024-06-28', 'https://g1.globo.com/go/goias/noticia/2024/06/28/caiado-terreiros.ghtml', 'news_article', 5, 'Goiânia', 'Entrevista', 'caiado-terreiros-b107-98') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_rel, true FROM ins;

  -- 99
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_zem, 'Zema ataca Lula e afirma que União está "perseguindo" MG com autuações ambientais.', 'A gente é perseguido pelo governo federal.', 'Coletiva em BH.', 'verified', true, '2024-04-15', 'https://www.otempo.com.br/politica/zema-lula-perseguicao', 'news_article', 3, 'Belo Horizonte', 'Coletiva', 'zema-lula-perseguicao-b107-99') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 100
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_pae, 'Paes ameaça processar imprensa crítica à gestão do Rio.', 'Quem mentir sobre mim vai responder na Justiça.', 'Entrevista em Copacabana.', 'verified', false, '2024-05-28', 'https://g1.globo.com/rj/rio-de-janeiro/noticia/2024/05/28/paes-imprensa.ghtml', 'news_article', 3, 'Rio de Janeiro', 'Entrevista', 'paes-imprensa-rj-b107-100') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_int, true FROM ins;
