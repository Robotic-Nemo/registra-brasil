...
BEGIN
  ...
  WITH ins AS (
    INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug)
    VALUES (v_agu, 'Aguinaldo Ribeiro defende reforma tributária.', 'Entregamos um novo sistema tributário que vai simplificar a vida do produtor e do consumidor.', 'Aguinaldo, relator da PEC 45, discursou antes da aprovação.', 'verified', false, '2023-07-07', 'https://www.camara.leg.br/noticias/reforma-tributaria-aguinaldo', 'diario_oficial', 1, 'Brasília', 'Aprovação Câmara', 'aguinaldo-reforma-camara-b70-22') ON CONFLICT (slug) DO NOTHING RETURNING id
  ) INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 23
  WITH ins AS (
    INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug)
    VALUES (v_vhm, 'Van Hattem critica reforma tributária.', 'A reforma tributária do PT é um cavalo de Troia que vai aumentar a carga sobre o trabalhador.', 'Van Hattem votou contra e criticou a PEC em plenário.', 'verified', false, '2023-07-06', 'https://g1.globo.com/politica/noticia/2023/07/06/van-hattem-reforma.ghtml', 'news_article', 3, 'Brasília', 'Plenário Câmara', 'vanhattem-reforma-critica-b70-23') ON CONFLICT (slug) DO NOTHING RETURNING id
  ) INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 24
  WITH ins AS (
    INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug)
    VALUES (v_nik, 'Nikolas espalha desinformação sobre reforma.', 'Com a reforma vocês vão pagar imposto até para ir ao médico, até para comprar pão.', 'Nikolas publicou vídeo com alegações falsas sobre reforma tributária.', 'verified', true, '2023-07-05', 'https://www1.folha.uol.com.br/mercado/2023/07/nikolas-reforma-fake.shtml', 'news_article', 4, 'Brasília', 'Vídeo redes sociais', 'nikolas-reforma-fake-b70-24') ON CONFLICT (slug) DO NOTHING RETURNING id
  ) INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 25
  WITH ins AS (
    INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug)
    VALUES (v_tab, 'Tabata defende reforma tributária.', 'É a maior chance em uma geração de desburocratizar o país e combater privilégios.', 'Tabata Amaral votou a favor da reforma na Câmara.', 'verified', false, '2023-07-07', 'https://g1.globo.com/politica/noticia/2023/07/07/tabata-reforma.ghtml', 'news_article', 1, 'Brasília', 'Plenário Câmara', 'tabata-reforma-favor-b70-25') ON CONFLICT (slug) DO NOTHING RETURNING id
  ) INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 26
  WITH ins AS (
    INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug)
    VALUES (v_had, 'Haddad anuncia taxação de super-ricos.', 'Super-ricos e multinacionais pagarão sua parte justa no Brasil, como defendemos no G20.', 'Haddad anunciou tributação mínima global no G20 do Brasil.', 'verified', true, '2024-02-29', 'https://valor.globo.com/brasil/noticia/2024/02/29/haddad-g20-superricos.ghtml', 'news_article', 2, 'São Paulo', 'G20 Finanças', 'haddad-g20-superricos-b70-26') ON CONFLICT (slug) DO NOTHING RETURNING id
  ) INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 27
  WITH ins AS (
    INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug)
    VALUES (v_had, 'Haddad sobe IOF e recua em 24h.', 'Foi um erro de comunicação, o IOF será corrigido já.', 'Haddad recuou de aumento do IOF após reação do mercado em maio de 2025.', 'verified', true, '2025-05-23', 'https://valor.globo.com/brasil/noticia/2025/05/23/haddad-iof-recuo.ghtml', 'news_article', 4, 'Brasília', 'Coletiva emergencial', 'haddad-iof-recuo-b70-27') ON CONFLICT (slug) DO NOTHING RETURNING id
  ) INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 28
  WITH ins AS (
    INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug)
    VALUES (v_gal, 'Galípolo assume presidência do BC.', 'Minha bússola será a meta de inflação e a estabilidade macroeconômica.', 'Galípolo assumiu presidência do BC em janeiro de 2025.', 'verified', true, '2025-01-02', 'https://www.bcb.gov.br/detalhenoticia/20250102-galipolo-posse', 'diario_oficial', 1, 'Brasília', 'Posse BC', 'galipolo-posse-bc-b70-28') ON CONFLICT (slug) DO NOTHING RETURNING id
  ) INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 29
  WITH ins AS (
    INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug)
    VALUES (v_camp, 'Campos Neto diz que BC cumpriu dever.', 'Deixamos o BC com inflação sob controle e credibilidade restaurada.', 'Campos Neto em discurso de despedida do cargo em dezembro de 2024.', 'verified', false, '2024-12-19', 'https://www1.folha.uol.com.br/mercado/2024/12/campos-neto-despedida.shtml', 'news_article', 1, 'Brasília', 'Despedida BC', 'campos-neto-despedida-b70-29') ON CONFLICT (slug) DO NOTHING RETURNING id
  ) INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 30
  WITH ins AS (
    INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug)
    VALUES (v_lul, 'Lula volta a atacar juros sob Galípolo.', 'Mesmo com Galípolo no BC, os juros continuam altos demais, é um absurdo.', 'Lula criticou publicamente a Selic em evento sindical.', 'verified', true, '2025-03-19', 'https://g1.globo.com/politica/noticia/2025/03/19/lula-juros-galipolo.ghtml', 'news_article', 4, 'São Paulo', 'Ato CUT', 'lula-juros-galipolo-b70-30') ON CONFLICT (slug) DO NOTHING RETURNING id
  ) INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ame, true FROM ins;

  -- 31
  WITH ins AS (
    INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug)
    VALUES (v_bol, 'Bolsonaro critica arcabouço.', 'Arcabouço é o nome bonito de gastança descontrolada.', 'Bolsonaro atacou política fiscal de Haddad em transmissão.', 'verified', false, '2023-05-18', 'https://g1.globo.com/politica/noticia/2023/05/18/bolsonaro-arcabouco.ghtml', 'news_article', 3, 'Brasília', 'Live', 'bolsonaro-arcabouco-b70-31') ON CONFLICT (slug) DO NOTHING RETURNING id
  ) INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 32
  WITH ins AS (
    INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug)
    VALUES (v_teb, 'Tebet diz que corte de gastos é inevitável.', 'Não há saída sem revisar despesas obrigatórias, isso é matemática.', 'Tebet defendeu pacote de corte de gastos em novembro de 2024.', 'verified', true, '2024-11-27', 'https://valor.globo.com/brasil/noticia/2024/11/27/tebet-corte-gastos.ghtml', 'news_article', 2, 'Brasília', 'Coletiva Planejamento', 'tebet-corte-gastos-b70-32') ON CONFLICT (slug) DO NOTHING RETURNING id
  ) INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 33
  WITH ins AS (
    INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug)
    VALUES (v_had, 'Haddad anuncia pacote fiscal de fim de ano.', 'As medidas garantem cumprimento do arcabouço por dois anos à frente.', 'Haddad apresentou pacote de R$ 70 bi em cortes.', 'verified', true, '2024-11-27', 'https://valor.globo.com/brasil/noticia/2024/11/27/haddad-pacote-fiscal.ghtml', 'news_article', 3, 'Brasília', 'Coletiva Fazenda', 'haddad-pacote-fiscal-b70-33') ON CONFLICT (slug) DO NOTHING RETURNING id
  ) INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 34
  WITH ins AS (
    INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug)
    VALUES (v_lul, 'Lula anuncia isenção IR até R$ 5 mil no pacote.', 'Ninguém vai falar do pacote, todo mundo vai falar da isenção do imposto.', 'Lula misturou anúncio do pacote fiscal com isenção do IR, gerando ruído.', 'verified', true, '2024-11-27', 'https://g1.globo.com/economia/noticia/2024/11/27/lula-ir-5-mil.ghtml', 'news_article', 4, 'Brasília', 'Pronunciamento', 'lula-ir-cincomil-b70-34') ON CONFLICT (slug) DO NOTHING RETURNING id
  ) INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 35
  WITH ins AS (
    INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug)
    VALUES (v_had, 'Haddad defende isenção IR até R$ 5 mil.', 'A isenção é compensada pela tributação de super-ricos, é fiscalmente neutro.', 'Haddad defendeu projeto em sabatina parlamentar.', 'verified', true, '2025-03-18', 'https://valor.globo.com/brasil/noticia/2025/03/18/haddad-ir-compensacao.ghtml', 'news_article', 2, 'Brasília', 'Sabatina Câmara', 'haddad-ir-compensacao-b70-35') ON CONFLICT (slug) DO NOTHING RETURNING id
  ) INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 36
  WITH ins AS (
    INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug)
    VALUES (v_sil, 'Silveira defende revisão do setor elétrico.', 'Precisamos modernizar o marco setorial sem pressionar a tarifa do consumidor.', 'Silveira tratou de reforma elétrica em audiência pública.', 'verified', false, '2023-09-21', 'https://www.gov.br/mme/pt-br/assuntos/noticias/silveira-modernizacao', 'diario_oficial', 1, 'Brasília', 'Audiência pública MME', 'silveira-modernizacao-b70-36') ON CONFLICT (slug) DO NOTHING RETURNING id
  ) INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 37
  WITH ins AS (
    INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug)
    VALUES (v_fav, 'Fávaro defende Plano Safra recorde.', 'O agro brasileiro tem o maior Plano Safra da história para produzir mais e melhor.', 'Fávaro apresentou Plano Safra 2023/24.', 'verified', false, '2023-06-26', 'https://www.gov.br/agricultura/pt-br/assuntos/noticias/favaro-plano-safra', 'diario_oficial', 1, 'Brasília', 'Lançamento Plano Safra', 'favaro-plano-safra-b70-37') ON CONFLICT (slug) DO NOTHING RETURNING id
  ) INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 38
  WITH ins AS (
    INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug)
    VALUES (v_ter, 'Tereza Cristina critica Plano Safra.', 'Os juros do Plano Safra estão altos demais porque a política de juros geral está quebrada.', 'Senadora Tereza Cristina criticou juros do Plano Safra.', 'verified', false, '2023-07-03', 'https://www1.folha.uol.com.br/mercado/2023/07/tereza-cristina-plano-safra.shtml', 'news_article', 2, 'Brasília', 'Comissão Senado', 'tereza-plano-safra-b70-38') ON CONFLICT (slug) DO NOTHING RETURNING id
  ) INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 39
  WITH ins AS (
    INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug)
    VALUES (v_mar, 'Marina defende taxonomia verde.', 'Não há política fiscal sustentável sem integrar risco climático nas contas públicas.', 'Marina Silva em cúpula climática no G20 Brasil.', 'verified', false, '2024-07-24', 'https://www.gov.br/mma/pt-br/noticias/marina-taxonomia-verde', 'diario_oficial', 1, 'Rio de Janeiro', 'G20 Clima', 'marina-taxonomia-verde-b70-39') ON CONFLICT (slug) DO NOTHING RETURNING id
  ) INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 40
  WITH ins AS (
    INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug)
    VALUES (v_alc, 'Alckmin defende nova política industrial.', 'A Nova Indústria Brasil é a reindustrialização verde que o país precisa.', 'Alckmin lançou o plano Nova Indústria Brasil em janeiro de 2024.', 'verified', false, '2024-01-22', 'https://valor.globo.com/brasil/noticia/2024/01/22/alckmin-nova-industria.ghtml', 'news_article', 1, 'Brasília', 'Lançamento NIB', 'alckmin-nova-industria-b70-40') ON CONFLICT (slug) DO NOTHING RETURNING id
  ) INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 41
  WITH ins AS (
    INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug)
    VALUES (v_had, 'Haddad elogia cooperação com Alckmin.', 'Fazenda e MDIC trabalham de mãos dadas na reindustrialização do país.', 'Haddad destacou alinhamento com Alckmin em evento.', 'verified', false, '2024-02-20', 'https://valor.globo.com/brasil/noticia/2024/02/20/haddad-alckmin-alinhamento.ghtml', 'news_article', 1, 'São Paulo', 'Fórum Fiesp', 'haddad-alckmin-alinhamento-b70-41') ON CONFLICT (slug) DO NOTHING RETURNING id
  ) INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 42
  WITH ins AS (
    INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug)
    VALUES (v_rui, 'Rui Costa sobre PAC.', 'O Novo PAC é o maior programa de investimentos da década.', 'Rui Costa lançou Novo PAC.', 'verified', false, '2023-08-11', 'https://g1.globo.com/politica/noticia/2023/08/11/rui-costa-pac.ghtml', 'news_article', 2, 'Rio de Janeiro', 'Lançamento Novo PAC', 'rui-costa-pac-b70-42') ON CONFLICT (slug) DO NOTHING RETURNING id
  ) INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 43
  WITH ins AS (
    INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug)
    VALUES (v_wdi, 'Wellington Dias defende Bolsa Família.', 'Bolsa Família e CadÚnico são as principais políticas de combate à miséria.', 'Wellington Dias defendeu reformulação do Bolsa Família.', 'verified', false, '2023-03-02', 'https://g1.globo.com/politica/noticia/2023/03/02/wellington-bolsa-familia.ghtml', 'news_article', 1, 'Brasília', 'Lançamento Bolsa Família', 'wellington-bolsa-familia-b70-43') ON CONFLICT (slug) DO NOTHING RETURNING id
  ) INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 44
  WITH ins AS (
    INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug)
    VALUES (v_lup, 'Lupi defende reforma da Previdência do BPC.', 'O BPC precisa ser mantido inatingível, é constitucional.', 'Lupi resistiu a cortes no BPC no pacote fiscal de 2024.', 'verified', true, '2024-11-28', 'https://valor.globo.com/brasil/noticia/2024/11/28/lupi-bpc.ghtml', 'news_article', 3, 'Brasília', 'Comissão Câmara', 'lupi-bpc-b70-44') ON CONFLICT (slug) DO NOTHING RETURNING id
  ) INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 45
  WITH ins AS (
    INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug)
    VALUES (v_lmar, 'Luiz Marinho defende valorização do salário mínimo.', 'O novo salário mínimo é a maior transferência de renda do país.', 'Luiz Marinho comemorou sanção da lei do salário mínimo.', 'verified', false, '2023-08-25', 'https://www.gov.br/trabalho/pt-br/noticias/marinho-salario-minimo', 'diario_oficial', 1, 'Brasília', 'Sanção Lei 14.663', 'luiz-marinho-salario-minimo-b70-45') ON CONFLICT (slug) DO NOTHING RETURNING id
  ) INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 46
  WITH ins AS (
    INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug)
    VALUES (v_rmar, 'Rogério Marinho critica gasto com servidores.', 'O governo Lula explodiu a folha pública enquanto a economia freia.', 'Senador Rogério Marinho criticou acordo de reajuste de servidores.', 'verified', false, '2024-02-28', 'https://www1.folha.uol.com.br/mercado/2024/02/rogerio-marinho-servidores.shtml', 'news_article', 3, 'Brasília', 'Plenário Senado', 'rogerio-servidores-b70-46') ON CONFLICT (slug) DO NOTHING RETURNING id
  ) INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 47
  WITH ins AS (
    INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug)
    VALUES (v_adv, 'Adriana Ventura critica criação de cargos.', 'Criar comissionados enquanto o arcabouço aperta é desrespeito ao contribuinte.', 'Adriana Ventura discursou contra novos cargos no Executivo.', 'verified', false, '2024-03-20', 'https://g1.globo.com/politica/noticia/2024/03/20/adriana-ventura-cargos.ghtml', 'news_article', 2, 'Brasília', 'Plenário Câmara', 'adriana-cargos-b70-47') ON CONFLICT (slug) DO NOTHING RETURNING id
  ) INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 48
  WITH ins AS (
    INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug)
    VALUES (v_had, 'Haddad fala sobre Selic em Davos.', 'O Brasil precisa de juros reais compatíveis com o risco do país, não mais que isso.', 'Haddad em Davos em janeiro de 2024.', 'verified', false, '2024-01-17', 'https://valor.globo.com/mundo/noticia/2024/01/17/haddad-davos-juros.ghtml', 'news_article', 2, 'Davos', 'Fórum Econômico Mundial', 'haddad-davos-juros-b70-48') ON CONFLICT (slug) DO NOTHING RETURNING id
  ) INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 49
  WITH ins AS (
    INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug)
    VALUES (v_camp, 'Campos Neto em Davos defende disciplina fiscal.', 'Sem consolidação fiscal, a desinflação não se sustenta no Brasil.', 'Campos Neto em Davos 2024.', 'verified', false, '2024-01-18', 'https://www.reuters.com/world/americas/campos-neto-davos-fiscal-2024-01-18/', 'news_article', 2, 'Davos', 'Fórum Econômico Mundial', 'campos-davos-fiscal-b70-49') ON CONFLICT (slug) DO NOTHING RETURNING id
  ) INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 50
  WITH ins AS (
    INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug)
    VALUES (v_lul, 'Lula diz que ''mercado se acostuma''.', 'O mercado tem que parar de reclamar, o mercado vai se acostumar.', 'Lula rebateu reação negativa do mercado ao afrouxamento da meta.', 'verified', true, '2024-04-16', 'https://g1.globo.com/politica/noticia/2024/04/16/lula-mercado-se-acostuma.ghtml', 'news_article', 4, 'Brasília', 'Entrevista', 'lula-mercado-acostuma-b70-50') ON CONFLICT (slug) DO NOTHING RETURNING id
  ) INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 51
  WITH ins AS (
    INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug)
    VALUES (v_had, 'Haddad defende Fazenda após fala de Lula.', 'O governo segue comprometido com responsabilidade fiscal, isso é inegociável.', 'Haddad saiu em defesa após fala ''mercado se acostuma'' derrubar Bolsa.', 'verified', true, '2024-04-17', 'https://valor.globo.com/politica/noticia/2024/04/17/haddad-rebate-mercado.ghtml', 'news_article', 3, 'Brasília', 'Coletiva Fazenda', 'haddad-rebate-mercado-b70-51') ON CONFLICT (slug) DO NOTHING RETURNING id
  ) INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 52
  WITH ins AS (
    INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug)
    VALUES (v_lul, 'Lula mudou meta fiscal em LDO.', 'Vamos revisar a meta, não tem sentido manter meta irreal.', 'Lula confirmou revisão da meta fiscal em abril de 2024.', 'verified', true, '2024-04-15', 'https://g1.globo.com/politica/noticia/2024/04/15/lula-revisao-meta.ghtml', 'news_article', 4, 'Brasília', 'Café com jornalistas', 'lula-revisao-meta-b70-52') ON CONFLICT (slug) DO NOTHING RETURNING id
  ) INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 53
  WITH ins AS (
    INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug)
    VALUES (v_teb, 'Tebet reforça meta revisada.', 'A revisão não é abandono, é ajuste realista dentro do arcabouço.', 'Tebet defendeu revisão da meta em entrevista coletiva.', 'verified', false, '2024-04-15', 'https://valor.globo.com/brasil/noticia/2024/04/15/tebet-meta-revisada.ghtml', 'news_article', 2, 'Brasília', 'Coletiva Planejamento', 'tebet-meta-revisada-b70-53') ON CONFLICT (slug) DO NOTHING RETURNING id
  ) INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 54
  WITH ins AS (
    INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug)
    VALUES (v_had, 'Haddad diz ser ''soldado de Lula''.', 'Sou soldado do presidente Lula, em qualquer missão que ele me colocar.', 'Haddad em evento após rumores de demissão.', 'verified', true, '2024-08-22', 'https://g1.globo.com/politica/noticia/2024/08/22/haddad-soldado-lula.ghtml', 'news_article', 2, 'Brasília', 'Evento no Planalto', 'haddad-soldado-lula-b70-54') ON CONFLICT (slug) DO NOTHING RETURNING id
  ) INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 55
  WITH ins AS (
    INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug)
    VALUES (v_gle, 'Gleisi critica ''mercado especulador''.', 'O mercado especula contra o Brasil todo santo dia e ninguém chama responsabilidade.', 'Gleisi em ato do PT.', 'verified', false, '2024-07-10', 'https://g1.globo.com/politica/noticia/2024/07/10/gleisi-mercado-especulador.ghtml', 'news_article', 3, 'Brasília', 'Ato do PT', 'gleisi-mercado-especulador-b70-55') ON CONFLICT (slug) DO NOTHING RETURNING id
  ) INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;
  ...
  WITH ins AS (
    INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug)
    VALUES (v_gal, 'Galípolo sobe Selic em janeiro de 2025.', 'O Copom elevará os juros enquanto necessário para convergência da inflação.', 'Galípolo subiu a Selic em 100 pontos.', 'verified', true, '2025-01-29', 'https://www.bcb.gov.br/detalhenoticia/20250129-copom', 'diario_oficial', 2, 'Brasília', 'Reunião Copom', 'galipolo-copom-jan-b70-84') ON CONFLICT (slug) DO NOTHING RETURNING id
  ) INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 85
  WITH ins AS (
    INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug)
    VALUES (v_had, 'Haddad pede ''paciência'' com inflação.', 'Temos todas as condições de voltar ao centro da meta ao longo de 2025.', 'Haddad após IPCA acima de 5% em janeiro.', 'verified', false, '2025-02-11', 'https://valor.globo.com/brasil/noticia/2025/02/11/haddad-inflacao.ghtml', 'news_article', 2, 'Brasília', 'Coletiva IPCA', 'haddad-inflacao-paciencia-b70-85') ON CONFLICT (slug) DO NOTHING RETURNING id
  ) INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 86
  WITH ins AS (
    INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug)
    VALUES (v_lul, 'Lula critica alimento caro.', 'O preço do arroz e da carne não pode subir nas costas do trabalhador.', 'Lula ataca alta de alimentos em março de 2025.', 'verified', false, '2025-03-12', 'https://g1.globo.com/politica/noticia/2025/03/12/lula-alimentos.ghtml', 'news_article', 2, 'Brasília', 'Transmissão', 'lula-alimentos-caros-b70-86') ON CONFLICT (slug) DO NOTHING RETURNING id
  ) INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 87
  WITH ins AS (
    INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug)
    VALUES (v_had, 'Haddad anuncia zeragem de imposto de alimentos.', 'Zeramos o imposto de importação de itens da cesta básica para ajudar as famílias.', 'Haddad anunciou pacote alimentos em março de 2025.', 'verified', true, '2025-03-07', 'https://valor.globo.com/brasil/noticia/2025/03/07/haddad-alimentos.ghtml', 'news_article', 2, 'Brasília', 'Coletiva Fazenda', 'haddad-alimentos-b70-87') ON CONFLICT (slug) DO NOTHING RETURNING id
  ) INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 88
  WITH ins AS (
    INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug)
    VALUES (v_ter, 'Tereza Cristina defende agro contra IOF.', 'O IOF proposto prejudica o financiamento do agro na hora do plantio.', 'Tereza Cristina rebate aumento do IOF em maio de 2025.', 'verified', false, '2025-05-23', 'https://valor.globo.com/politica/noticia/2025/05/23/tereza-iof.ghtml', 'news_article', 2, 'Brasília', 'Plenário Senado', 'tereza-iof-b70-88') ON CONFLICT (slug) DO NOTHING RETURNING id
  ) INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;
