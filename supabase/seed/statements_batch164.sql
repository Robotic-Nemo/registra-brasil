...
BEGIN
  ...
  -- 2
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jair, 'Bolsonaro insinua no 7 de setembro que "só sai morto".', 'Só saio morto do Palácio. Perder eu não perco.', 'Discurso em ato na Esplanada dos Ministérios.', 'verified', true, '2022-09-07', 'https://www1.folha.uol.com.br/poder/2022/09/bolsonaro-so-saio-morto-7-setembro.shtml', 'other', 5, 'Esplanada dos Ministérios', '7 de Setembro', 'bolsonaro-so-saio-morto-7-setembro-b164-2') ON CONFLICT (slug) DO NOTHING RETURNING id)
  ...
  -- 15
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_fla, 'Flávio chama decisão do TSE de "atropelamento do voto popular".', 'Isso é atropelamento do voto popular. Vamos recorrer até o fim.', 'Entrevista em coletiva após inelegibilidade.', 'verified', true, '2023-06-30', 'https://g1.globo.com/politica/noticia/2023/06/30/flavio-atropelamento-voto-popular-tse.ghtml', 'news_article', 3, 'Brasília', 'Coletiva', 'flavio-atropelamento-voto-popular-b164-15') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 16
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_nik, 'Nikolas Ferreira chama TSE de "ditadura da toga".', 'O TSE virou ditadura da toga. 14 milhões condenados pelo voto de 5 ministros.', 'Vídeo no Instagram com 20 milhões de visualizações.', 'verified', true, '2023-07-01', 'https://www1.folha.uol.com.br/poder/2023/07/nikolas-tse-ditadura-toga.shtml', 'social_media_post', 5, 'Instagram', 'Vídeo', 'nikolas-tse-ditadura-toga-b164-16') ON CONFLICT (slug) DO NOTHING RETURNING id)
  ...
  -- 21
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_amo, 'Moraes dá 48 horas para Bolsonaro explicar pernoite na embaixada.', 'Quero a explicação em 48 horas. E com documentos.', 'Despacho do ministro no inquérito do golpe.', 'verified', true, '2024-03-26', 'https://g1.globo.com/politica/noticia/2024/03/26/moraes-48-horas-bolsonaro-embaixada-hungria.ghtml', 'news_article', 1, 'STF', 'Despacho judicial', 'moraes-48-horas-bolsonaro-embaixada-b164-21') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_con, true FROM ins;

  -- 22
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mic, 'Michelle Bolsonaro diz que marido é "perseguido" e pede orações.', 'Meu marido é perseguido. Orem por ele. Deus é justo.', 'Culto em igreja evangélica em Brasília.', 'verified', false, '2024-04-05', 'https://www1.folha.uol.com.br/poder/2024/04/michelle-bolsonaro-perseguido-oracoes.shtml', 'other', 2, 'Brasília', 'Culto', 'michelle-perseguido-oracoes-b164-22') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 23
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jair, 'Bolsonaro faz ato na Paulista com 185 mil pessoas pedindo "liberdade".', 'Sou perseguido. Quero anistia para os injustiçados do 8 de janeiro.', 'Ato na Avenida Paulista em fevereiro de 2024.', 'verified', true, '2024-02-25', 'https://g1.globo.com/sp/sao-paulo/noticia/2024/02/25/bolsonaro-ato-paulista-liberdade-anistia.ghtml', 'other', 4, 'Avenida Paulista', 'Ato', 'bolsonaro-paulista-liberdade-anistia-b164-23') ON CONFLICT (slug) DO NOTHING RETURNING id)
  ...
  -- 34
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jair, 'Bolsonaro é proibido de usar redes sociais por Moraes.', 'Querem calar minha voz. Mas o povo fala por mim.', 'Decisão cautelar após ataques em lives.', 'verified', true, '2025-07-18', 'https://g1.globo.com/politica/noticia/2025/07/18/bolsonaro-proibido-redes-sociais-moraes.ghtml', 'news_article', 4, 'Brasília', 'Decisão cautelar', 'bolsonaro-proibido-redes-sociais-b164-34') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 35
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jair, 'Bolsonaro recebe tornozeleira eletrônica em julho.', 'É humilhação. Mas não é prisão ainda.', 'Instalação da tornozeleira após descumprimento de cautelares.', 'verified', true, '2025-07-21', 'https://www1.folha.uol.com.br/poder/2025/07/bolsonaro-tornozeleira-eletronica-cautelares.shtml', 'news_article', 5, 'Brasília', 'Tornozeleira', 'bolsonaro-tornozeleira-eletronica-b164-35') ON CONFLICT (slug) DO NOTHING RETURNING id)
  ...
  -- 37
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_amo, 'Moraes diz que sanções dos EUA "não intimidam" o Brasil.', 'Sanções ilegais não intimidam o Judiciário brasileiro. Vamos em frente.', 'Discurso em sessão plenária do STF.', 'verified', true, '2025-07-31', 'https://www1.folha.uol.com.br/poder/2025/07/moraes-sancoes-nao-intimidam-brasil.shtml', 'other', 1, 'STF', 'Sessão plenária', 'moraes-sancoes-nao-intimidam-b164-37') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_con, true FROM ins;

  -- 38
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jair, 'Bolsonaro tem prisão domiciliar decretada em 4 de agosto.', 'Estou em casa. Mas minha alma é livre.', 'Imposição de prisão domiciliar por descumprimento reiterado.', 'verified', true, '2025-08-04', 'https://g1.globo.com/politica/noticia/2025/08/04/bolsonaro-prisao-domiciliar-stf.ghtml', 'news_article', 5, 'Brasília', 'Prisão domiciliar', 'bolsonaro-prisao-domiciliar-stf-b164-38') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 39
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_fla, 'Flávio chama prisão domiciliar do pai de "tortura psicológica".', 'É tortura psicológica. Meu pai está sofrendo.', 'Entrevista após imposição da prisão domiciliar.', 'verified', true, '2025-08-04', 'https://www1.folha.uol.com.br/poder/2025/08/flavio-prisao-domiciliar-tortura-psicologica.shtml', 'news_article', 3, 'Brasília', 'Entrevista', 'flavio-tortura-psicologica-b164-39') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 40
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_hou, 'Hugo Motta afirma que Câmara "não aceitará" sanção sobre ministros.', 'A Câmara rechaça qualquer pressão estrangeira sobre o Judiciário brasileiro.', 'Discurso no plenário defendendo soberania.', 'verified', false, '2025-08-06', 'https://g1.globo.com/politica/noticia/2025/08/06/motta-camara-rechaca-pressao-estrangeira.ghtml', 'other', 1, 'Câmara dos Deputados', 'Discurso', 'motta-camara-rechaca-pressao-b164-40') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_con, true FROM ins;

  -- 41
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_tar, 'Tarcísio visita Bolsonaro em prisão domiciliar e pede "calma".', 'Pedi calma. Ele está bem. Está sendo injustiçado.', 'Declaração após visita em Brasília.', 'verified', true, '2025-08-07', 'https://www1.folha.uol.com.br/poder/2025/08/tarcisio-visita-bolsonaro-prisao-calma.shtml', 'news_article', 3, 'Brasília', 'Visita', 'tarcisio-visita-bolsonaro-calma-b164-41') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_con, true FROM ins;

  -- 42
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_amo, 'Moraes inicia julgamento final da ação do golpe em setembro.', 'Começa o julgamento da tentativa de golpe de Estado.', 'Sessão da Primeira Turma no STF iniciando julgamento.', 'verified', true, '2025-09-02', 'https://g1.globo.com/politica/noticia/2025/09/02/stf-inicia-julgamento-final-golpe-bolsonaro.ghtml', 'other', 1, 'STF', 'Sessão Primeira Turma', 'stf-inicia-julgamento-final-golpe-b164-42') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_con, true FROM ins;

  -- 43
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mar, 'Marçal transmite julgamento em live atacando ministros.', 'Olha a farsa. Esse julgamento é uma farsa jurídica.', 'Live no YouTube acompanhando sessão do STF.', 'verified', true, '2025-09-02', 'https://www1.folha.uol.com.br/poder/2025/09/marcal-live-julgamento-farsa.shtml', 'social_media_post', 4, 'YouTube', 'Live', 'marcal-live-julgamento-farsa-b164-43') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins UNION ALL SELECT id, c_int, false FROM ins;

  -- 44
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_zan, 'Zanin vota pela condenação de Bolsonaro em plenário.', 'Restou provada a participação do réu na tentativa de golpe de Estado.', 'Voto na Primeira Turma.', 'verified', true, '2025-09-09', 'https://g1.globo.com/politica/noticia/2025/09/09/zanin-vota-condenacao-bolsonaro-golpe.ghtml', 'other', 1, 'STF', 'Sessão Primeira Turma', 'zanin-vota-condenacao-bolsonaro-b164-44') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_con, true FROM ins;

  -- 45
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_dino, 'Flávio Dino vota pela condenação e cita "tentativa de ruptura".', 'Houve tentativa clara de ruptura da ordem democrática.', 'Voto na Primeira Turma do STF.', 'verified', false, '2025-09-09', 'https://www1.folha.uol.com.br/poder/2025/09/dino-vota-condenacao-bolsonaro-ruptura.shtml', 'other', 1, 'STF', 'Sessão Primeira Turma', 'dino-vota-condenacao-bolsonaro-b164-45') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_con, true FROM ins;

  -- 46
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_car2, 'Cármen Lúcia vota pela condenação de Bolsonaro.', 'Condeno o réu pelos cinco crimes que lhe foram imputados.', 'Voto na Primeira Turma.', 'verified', false, '2025-09-10', 'https://g1.globo.com/politica/noticia/2025/09/10/carmen-lucia-condena-bolsonaro.ghtml', 'other', 1, 'STF', 'Sessão Primeira Turma', 'carmen-lucia-condena-bolsonaro-b164-46') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_con, true FROM ins;
  ...
  -- 48
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_amo, 'Moraes lê voto condenatório final de 500 páginas.', 'O réu liderou organização criminosa para tentativa de golpe de Estado.', 'Voto de 500 páginas lido em 6 horas no STF.', 'verified', true, '2025-09-11', 'https://g1.globo.com/politica/noticia/2025/09/11/moraes-voto-500-paginas-bolsonaro-golpe.ghtml', 'other', 1, 'STF', 'Voto final', 'moraes-voto-500-paginas-b164-48') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_con, true FROM ins;

  -- 49
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jair, 'Bolsonaro é condenado a 27 anos e 3 meses de prisão em 11 de setembro.', 'Não me curvo. Continuo acreditando no Brasil e na liberdade.', 'Nota divulgada após condenação histórica no STF.', 'verified', true, '2025-09-11', 'https://www1.folha.uol.com.br/poder/2025/09/bolsonaro-condenado-27-anos-3-meses-golpe.shtml', 'news_article', 5, 'Brasília', 'Condenação', 'bolsonaro-condenado-27-anos-3-meses-b164-49') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ant, true FROM ins UNION ALL SELECT id, c_neg, false FROM ins;

  -- 50
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_fla, 'Flávio chama condenação de "maior injustiça da história do Brasil".', 'É a maior injustiça da história do Brasil. Ele é inocente.', 'Coletiva de imprensa logo após a condenação.', 'verified', true, '2025-09-11', 'https://g1.globo.com/politica/noticia/2025/09/11/flavio-condenacao-maior-injustica-historia.ghtml', 'news_article', 4, 'Brasília', 'Coletiva', 'flavio-maior-injustica-historia-b164-50') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins UNION ALL SELECT id, c_int, false FROM ins;

  -- 51
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_edu, 'Eduardo, dos EUA, pede "pressão internacional" após condenação.', 'Peço pressão internacional sobre o Brasil. Ditadura se instalou.', 'Vídeo gravado em Miami após condenação.', 'verified', true, '2025-09-11', 'https://www1.folha.uol.com.br/poder/2025/09/eduardo-pressao-internacional-ditadura-condenacao.shtml', 'social_media_post', 5, 'Miami, EUA', 'Vídeo', 'eduardo-pressao-internacional-ditadura-b164-51') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ame, true FROM ins UNION ALL SELECT id, c_ant, false FROM ins;

  -- 52
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mic, 'Michelle chora em culto e diz que "Deus trará justiça".', 'Deus trará justiça. Meu marido é inocente. Confio em Deus.', 'Culto logo após condenação, com milhares de pessoas.', 'verified', true, '2025-09-12', 'https://g1.globo.com/politica/noticia/2025/09/12/michelle-chora-culto-deus-justica.ghtml', 'other', 3, 'Brasília', 'Culto', 'michelle-chora-culto-deus-justica-b164-52') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 53
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_lul, 'Lula diz que condenação "mostra que democracia funciona".', 'A democracia funcionou. Ninguém está acima da lei no Brasil.', 'Declaração em evento em São Paulo.', 'verified', true, '2025-09-12', 'https://www1.folha.uol.com.br/poder/2025/09/lula-condenacao-democracia-funciona.shtml', 'other', 1, 'São Paulo', 'Evento', 'lula-condenacao-democracia-funciona-b164-53') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_con, true FROM ins;

  -- 54
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_tar, 'Tarcísio diz que condenação é "excessiva" e defende "pacificação".', 'A pena é excessiva. Precisamos de pacificação.', 'Entrevista no Palácio dos Bandeirantes.', 'verified', true, '2025-09-12', 'https://g1.globo.com/politica/noticia/2025/09/12/tarcisio-condenacao-excessiva-pacificacao.ghtml', 'news_article', 3, 'São Paulo', 'Entrevista', 'tarcisio-condenacao-excessiva-b164-54') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_obs, true FROM ins;

  -- 55
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_nik, 'Nikolas lidera pedido de impeachment de Moraes na Câmara.', 'Protocolei pedido de impeachment de Moraes. Ele é o responsável.', 'Protocolo de pedido na Câmara pós-condenação.', 'verified', true, '2025-09-15', 'https://www1.folha.uol.com.br/poder/2025/09/nikolas-impeachment-moraes-pos-condenacao.shtml', 'news_article', 5, 'Brasília', 'Protocolo', 'nikolas-impeachment-moraes-condenacao-b164-55') ON CONFLICT (slug) DO NOTHING RETURNING id)
  ...
  -- 56
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mar, 'Marçal convoca "greve geral" contra o STF após condenação.', 'Convoco greve geral. O Brasil tem que parar.', 'Live com 500 mil espectadores.', 'verified', true, '2025-09-13', 'https://g1.globo.com/politica/noticia/2025/09/13/marcal-greve-geral-stf-condenacao.ghtml', 'social_media_post', 5, 'YouTube', 'Live', 'marcal-greve-geral-stf-b164-56') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ame, true FROM ins UNION ALL SELECT id, c_ant, false FROM ins;

  -- 57
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_dav, 'Alcolumbre diz que Senado "estuda" projeto de anistia.', 'Vamos estudar com calma. O Senado não vai ser atropelado.', 'Declaração após pressão da oposição.', 'verified', false, '2025-09-17', 'https://www1.folha.uol.com.br/poder/2025/09/alcolumbre-senado-estuda-anistia.shtml', 'news_article', 2, 'Brasília', 'Entrevista', 'alcolumbre-senado-estuda-anistia-b164-57') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_con, true FROM ins;

  -- 58
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_van, 'Marcel Van Hattem grita "ditadura" em plenário durante discurso.', 'Isso é ditadura! Estamos vivendo ditadura do STF!', 'Discurso exaltado em plenário da Câmara.', 'verified', true, '2025-09-18', 'https://g1.globo.com/politica/noticia/2025/09/18/van-hattem-grita-ditadura-plenario.ghtml', 'other', 4, 'Câmara dos Deputados', 'Discurso', 'van-hattem-grita-ditadura-plenario-b164-58') ON CONFLICT (slug) DO NOTHING RETURNING id)
  ...
  -- 72
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jair, 'Bolsonaro tenta recurso para responder ao processo "em liberdade".', 'Quero responder em liberdade. Não sou risco para ninguém.', 'Pedido da defesa para revogação de domiciliar.', 'verified', false, '2025-11-05', 'https://g1.globo.com/politica/noticia/2025/11/05/bolsonaro-tenta-responder-liberdade.ghtml', 'news_article', 3, 'Brasília', 'Pedido judicial', 'bolsonaro-tenta-responder-liberdade-b164-72') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_con, true FROM ins;

  -- 73
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_amo, 'Moraes rejeita embargos da defesa de Bolsonaro.', 'Embargos rejeitados. A condenação é mantida em todos os seus termos.', 'Decisão monocrática negando embargos declaratórios.', 'verified', true, '2025-11-15', 'https://www1.folha.uol.com.br/poder/2025/11/moraes-rejeita-embargos-defesa-bolsonaro.shtml', 'news_article', 1, 'STF', 'Decisão monocrática', 'moraes-rejeita-embargos-bolsonaro-b164-73') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_con, true FROM ins;

  -- 74
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jair, 'Bolsonaro tem pena formalmente executada em 25 de novembro.', 'Dia triste. Mas não me quebro. O Brasil acima de tudo.', 'Início da execução da pena de 27 anos e 3 meses.', 'verified', true, '2025-11-25', 'https://g1.globo.com/politica/noticia/2025/11/25/bolsonaro-pena-executada-27-anos.ghtml', 'news_article', 5, 'Brasília', 'Início de pena', 'bolsonaro-pena-executada-25-novembro-b164-74') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 75
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_fla, 'Flávio vai a Brasília no dia do início da pena do pai.', 'Meu pai é o maior líder da direita. Vou estar ao lado dele.', 'Declaração à imprensa no dia da execução da pena.', 'verified', true, '2025-11-25', 'https://www1.folha.uol.com.br/poder/2025/11/flavio-brasilia-inicio-pena-pai.shtml', 'news_article', 3, 'Brasília', 'Declaração', 'flavio-brasilia-inicio-pena-b164-75') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_con, true FROM ins;

  -- 76
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_nik, 'Nikolas faz live no dia da pena, dizendo ser "dia negro".', 'Hoje é dia negro para o Brasil. Mas não vamos desistir.', 'Live no Instagram com centenas de milhares.', 'verified', true, '2025-11-25', 'https://g1.globo.com/politica/noticia/2025/11/25/nikolas-live-dia-negro-pena-bolsonaro.ghtml', 'social_media_post', 3, 'Instagram', 'Live', 'nikolas-live-dia-negro-pena-b164-76') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 77
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mar, 'Marçal faz "vigília" virtual no dia de início da pena.', 'Estamos na vigília. 24 horas online pela liberdade do capitão.', 'Live de 24 horas no YouTube.', 'verified', true, '2025-11-25', 'https://www1.folha.uol.com.br/poder/2025/11/marcal-vigilia-virtual-24-horas-bolsonaro.shtml', 'social_media_post', 3, 'YouTube', 'Live de 24h', 'marcal-vigilia-virtual-24-horas-b164-77') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 78
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mic, 'Michelle acompanha Bolsonaro no dia da execução da pena.', 'Estou com ele. Deus é nosso refúgio.', 'Declaração breve à imprensa em Brasília.', 'verified', true, '2025-11-25', 'https://g1.globo.com/politica/noticia/2025/11/25/michelle-acompanha-bolsonaro-execucao-pena.ghtml', 'news_article', 2, 'Brasília', 'Declaração', 'michelle-acompanha-bolsonaro-execucao-b164-78') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_con, true FROM ins;

  -- 79
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_tar, 'Tarcísio evita ato no dia da pena e emite nota mais branda.', 'Respeito as instituições. Mas defendo anistia.', 'Nota em vez de comparecer a ato.', 'verified', true, '2025-11-25', 'https://www1.folha.uol.com.br/poder/2025/11/tarcisio-nota-dia-pena-anistia-instituicoes.shtml', 'news_article', 3, 'São Paulo', 'Nota', 'tarcisio-nota-dia-pena-anistia-b164-79') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_obs, true FROM ins;

  -- 80
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_edu, 'Eduardo organiza "ato global" em 40 cidades no exterior.', 'Organizamos atos em 40 cidades no exterior. Mundo vai ver.', 'Tuíte convocando atos em Miami, Lisboa, Orlando, Madrid etc.', 'verified', true, '2025-11-26', 'https://g1.globo.com/politica/noticia/2025/11/26/eduardo-ato-global-40-cidades-exterior.ghtml', 'social_media_post', 3, 'Twitter', 'Convocação', 'eduardo-ato-global-40-cidades-b164-80') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 81
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jair, 'Bolsonaro é transferido para "Papudinha" em 11 de dezembro.', 'Onde eu estiver, estarei com o povo brasileiro.', 'Transferência para complexo penitenciário da Papuda.', 'verified', true, '2025-12-11', 'https://www1.folha.uol.com.br/poder/2025/12/bolsonaro-transferido-papudinha-papuda.shtml', 'news_article', 5, 'Papuda, DF', 'Transferência', 'bolsonaro-transferido-papudinha-b164-81') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 82
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_fla, 'Flávio chama transferência de "vingança de Moraes".', 'É vingança pessoal de Moraes. Querem quebrar meu pai.', 'Entrevista à chegada na Papuda.', 'verified', true, '2025-12-11', 'https://g1.globo.com/politica/noticia/2025/12/11/flavio-transferencia-vinganca-moraes-papudinha.ghtml', 'news_article', 4, 'Brasília', 'Entrevista', 'flavio-transferencia-vinganca-moraes-b164-82') ON CONFLICT (slug) DO NOTHING RETURNING id)
  ...
  -- 85
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_nik, 'Nikolas pede contatos com Bolsonaro na Papuda.', 'Estou pedindo visita. Quero ver como ele está.', 'Postagem solicitando autorização de visita.', 'verified', false, '2025-12-14', 'https://www1.folha.uol.com.br/poder/2025/12/nikolas-pede-visita-bolsonaro-papuda.shtml', 'social_media_post', 2, 'Twitter', 'Postagem', 'nikolas-pede-visita-papuda-b164-85') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_con, true FROM ins;

  -- 86
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mic, 'Michelle visita Bolsonaro na Papuda em 15 de dezembro.', 'Ele está firme. Nosso Deus é fiel.', 'Primeira visita oficial após transferência.', 'verified', true, '2025-12-15', 'https://g1.globo.com/politica/noticia/2025/12/15/michelle-visita-bolsonaro-papuda.ghtml', 'news_article', 3, 'Papuda, DF', 'Visita', 'michelle-visita-bolsonaro-papuda-b164-86') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_con, true FROM ins;

  -- 87
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_cir, 'Ciro diz que condenação "deveria" ser reduzida.', 'A condenação é correta, mas a pena é exagerada. Deveria ser reduzida.', 'Entrevista à rádio CBN.', 'verified', false, '2025-12-16', 'https://www1.folha.uol.com.br/poder/2025/12/ciro-condenacao-pena-reduzida.shtml', 'news_article', 2, 'Fortaleza', 'Entrevista CBN', 'ciro-condenacao-pena-reduzida-b164-87') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_con, true FROM ins;

  -- 88
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_bar, 'Barroso, ex-presidente do STF, defende condenação em discurso.', 'A decisão foi acertada. Democracia se protege.', 'Palestra em universidade em São Paulo.', 'verified', false, '2025-12-17', 'https://g1.globo.com/politica/noticia/2025/12/17/barroso-defende-condenacao-stf-democracia.ghtml', 'other', 1, 'São Paulo', 'Palestra', 'barroso-defende-condenacao-stf-b164-88') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_con, true FROM ins;

  -- 89
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_fac, 'Fachin assume presidência do STF e promete "firmeza democrática".', 'Atravessaremos 2026 com firmeza democrática. Instituições fortes.', 'Discurso de posse como presidente do STF.', 'verified', true, '2025-09-30', 'https://www1.folha.uol.com.br/poder/2025/09/fachin-posse-presidencia-stf-firmeza.shtml', 'other', 1, 'STF', 'Posse', 'fachin-posse-presidencia-stf-b164-89') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_con, true FROM ins;

  -- 90
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jan, 'Janones ironiza pedido de habeas de Bolsonaro.', 'Agora quer habeas? Quando era presidente queria prender adversário.', 'Postagem em rede social.', 'verified', false, '2025-12-18', 'https://g1.globo.com/politica/noticia/2025/12/18/janones-ironiza-habeas-bolsonaro.ghtml', 'social_media_post', 2, 'Twitter', 'Postagem', 'janones-ironiza-habeas-bolsonaro-b164-90') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_odi, true FROM ins;

  -- 91
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_tar, 'Tarcísio visita Bolsonaro na Papuda em 19 de dezembro.', 'Ele está bem. Vamos continuar lutando por ele.', 'Primeira visita de Tarcísio na Papuda.', 'verified', true, '2025-12-19', 'https://www1.folha.uol.com.br/poder/2025/12/tarcisio-visita-bolsonaro-papuda.shtml', 'news_article', 3, 'Papuda, DF', 'Visita', 'tarcisio-visita-bolsonaro-papuda-b164-91') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_con, true FROM ins;

  -- 92
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_edu, 'Eduardo faz discurso em Davos pedindo "resgate" do pai.', 'O Brasil virou ditadura. Precisamos de intervenção internacional.', 'Entrevista a fóruns internacionais do exílio.', 'verified', true, '2025-12-20', 'https://g1.globo.com/politica/noticia/2025/12/20/eduardo-davos-resgate-pai-ditadura.ghtml', 'news_article', 5, 'Fórum internacional', 'Entrevista', 'eduardo-davos-resgate-pai-b164-92') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ame, true FROM ins UNION ALL SELECT id, c_ant, false FROM ins;

  -- 93
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_dsi, 'Daniel Silveira visita Bolsonaro e sai gritando "golpe".', 'Isso é golpe. Bolsonaro é vítima de golpe jurídico.', 'Declaração à imprensa após visita.', 'verified', true, '2025-12-21', 'https://www1.folha.uol.com.br/poder/2025/12/daniel-silveira-visita-bolsonaro-grita-golpe.shtml', 'other', 5, 'Papuda, DF', 'Visita', 'daniel-silveira-visita-bolsonaro-b164-93') ON CONFLICT (slug) DO NOTHING RETURNING id)
