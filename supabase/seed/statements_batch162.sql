...
BEGIN
  ...
  -- 48
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_cid, 'Cida Gonçalves responde a ataques e cobra responsabilização.', 'As mulheres brasileiras não serão intimidadas. Nossa agenda é proteger vidas, não ideologia.', 'Declaração em coletiva.', 'verified', false, '2024-03-10', 'https://g1.globo.com/politica/noticia/2024/03/10/cida-responde-ataques-nikolas.ghtml', 'news_article', 2, 'Ministério das Mulheres', 'Entrevista', 'cida-responde-ataques-nikolas-b162-48') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_vio, true FROM ins;

  -- 49
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_teb, 'Tebet defende Casa da Mulher Brasileira em cada capital.', 'Precisamos expandir a Casa da Mulher Brasileira para todas as capitais. Nenhuma mulher pode ficar desamparada.', 'Declaração em evento do ministério.', 'verified', false, '2024-03-08', 'https://valor.globo.com/brasil/noticia/2024/03/08/tebet-casa-mulher-brasileira.ghtml', 'other', 2, 'Brasília', 'Evento Dia da Mulher', 'tebet-casa-mulher-brasileira-b162-49') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_vio, true FROM ins;

  -- 50
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mag, 'Magno Malta chama deputadas progressistas de "inimigas da família".', 'Essas deputadas são inimigas da família brasileira. Querem matar bebê, casar com mulher, destruir tudo.', 'Declaração em culto evangélico.', 'verified', true, '2024-05-15', 'https://g1.globo.com/politica/noticia/2024/05/15/magno-malta-inimigas-familia.ghtml', 'other', 4, 'Evento evangélico', 'Pregação', 'magno-malta-inimigas-familia-b162-50') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_odi, true FROM ins;

  -- 51
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_cvi, 'Carlos Viana defende "família tradicional" e ataca agenda feminista.', 'Mulher do lar é tesouro. A agenda feminista destruiu milhões de famílias brasileiras.', 'Pronunciamento no Senado.', 'verified', false, '2024-04-25', 'https://g1.globo.com/politica/noticia/2024/04/25/viana-mulher-lar-tesouro.ghtml', 'other', 4, 'Senado Federal', 'Plenário', 'viana-mulher-lar-tesouro-b162-51') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_mis, true FROM ins;

  -- 52
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_msi, 'Marina Silva denuncia feminicídio ambiental de mulheres defensoras.', 'Mulheres ambientalistas são assassinadas no Brasil por defender território. O feminicídio tem dimensão ambiental.', 'Evento sobre defensoras ambientais.', 'verified', false, '2024-06-05', 'https://g1.globo.com/politica/noticia/2024/06/05/marina-feminicidio-ambiental.ghtml', 'other', 3, 'Ministério do Meio Ambiente', 'Evento ambiental', 'marina-feminicidio-ambiental-b162-52') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_vio, true FROM ins;

  -- 53
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_orl, 'Orlando Silva apoia PL que amplia proteção a mulheres no digital.', 'A violência digital contra mulheres é epidemia. Precisamos atualizar a legislação para responsabilizar plataformas.', 'Pronunciamento em plenário.', 'verified', false, '2024-08-20', 'https://g1.globo.com/politica/noticia/2024/08/20/orlando-violencia-digital-mulheres.ghtml', 'other', 2, 'Câmara dos Deputados', 'Plenário', 'orlando-violencia-digital-mulheres-b162-53') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_vio, true FROM ins;

  -- 54
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_chi, 'Chico Alencar vota contra PL 1904 como "violência institucional".', 'Este Congresso tenta institucionalizar violência contra menina estuprada. É vergonhoso.', 'Discurso em plenário.', 'verified', false, '2024-06-13', 'https://g1.globo.com/politica/noticia/2024/06/13/chico-alencar-pl-1904-vergonha.ghtml', 'other', 2, 'Câmara dos Deputados', 'Plenário', 'chico-alencar-pl-1904-vergonha-b162-54') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_vio, true FROM ins;

  -- 55
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_kic, 'Bia Kicis protocola pedido de CPI para investigar abortos legais em SUS.', 'Vamos investigar os abortos legais feitos em hospitais públicos. Muitos são irregulares.', 'Protocolo de CPI em 2024.', 'verified', false, '2024-07-15', 'https://g1.globo.com/politica/noticia/2024/07/15/bia-kicis-cpi-abortos-sus.ghtml', 'diario_oficial', 4, 'Câmara dos Deputados', 'Protocolo', 'bia-kicis-cpi-abortos-sus-b162-55') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_int, true FROM ins;

  -- 56
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_tal, 'Talíria Petrone expõe rede de ameaças contra médicas que realizam aborto legal.', 'Médicas do SUS que cumprem a lei são perseguidas na internet. Há uma rede organizada de extremistas perseguindo essas profissionais.', 'Pronunciamento em plenário.', 'verified', false, '2024-08-28', 'https://g1.globo.com/politica/noticia/2024/08/28/taliria-rede-ameacas-medicas.ghtml', 'other', 2, 'Câmara dos Deputados', 'Plenário', 'taliria-rede-ameacas-medicas-aborto-b162-56') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_vio, true FROM ins;

  -- 57
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_pad, 'Padilha admite dificuldade para aprovar agenda feminina no Congresso.', 'O Congresso atual é um dos mais conservadores da nossa história. Tornou-se muito difícil aprovar agenda feminina.', 'Entrevista em 2024.', 'verified', false, '2024-08-12', 'https://g1.globo.com/politica/noticia/2024/08/12/padilha-congresso-conservador-agenda-mulher.ghtml', 'news_article', 2, 'Palácio do Planalto', 'Entrevista', 'padilha-congresso-conservador-mulher-b162-57') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_vio, true FROM ins;
  ...
  -- 59
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mot, 'Hugo Motta arquiva PL 1904 no início do mandato como presidente.', 'Não vamos ressuscitar o PL 1904 agora. Mas o debate sobre aborto continua.', 'Declaração em entrevista em fevereiro de 2025.', 'verified', false, '2025-02-15', 'https://g1.globo.com/politica/noticia/2025/02/15/motta-arquivar-pl-1904.ghtml', 'news_article', 3, 'Câmara dos Deputados', 'Entrevista', 'motta-arquivar-pl-1904-b162-59') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_vio, true FROM ins;

  -- 60
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_nik, 'Nikolas Ferreira pede reapresentação do PL 1904 em 2025.', 'Vamos reapresentar o PL 1904 neste mandato. A vida começa na concepção.', 'Entrevista em redes.', 'verified', false, '2025-03-02', 'https://twitter.com/nikolas_dm/status/nikolas-reapresentar-pl-1904', 'social_media_post', 4, 'Twitter', 'Postagem oficial', 'nikolas-reapresentar-pl-1904-2025-b162-60') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_mis, true FROM ins;

  -- 61
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_eri, 'Erika Hilton denuncia transfeminicídio crescente no Brasil.', 'O Brasil é o país que mais mata travestis e mulheres trans no mundo. Isso é um projeto de extermínio.', 'Pronunciamento em plenário.', 'verified', false, '2024-01-29', 'https://g1.globo.com/politica/noticia/2024/01/29/erika-transfeminicidio.ghtml', 'other', 3, 'Câmara dos Deputados', 'Dia da Visibilidade Trans', 'erika-transfeminicidio-brasil-b162-61') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_vio, true FROM ins;

  -- 62
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_fel, 'Marco Feliciano diz que mulher trans "não é mulher" em plenário.', 'Mulher trans é homem. E homem não vota com mulher. Que essa bagunça acabe.', 'Pronunciamento ofensivo em plenário.', 'verified', true, '2024-03-08', 'https://g1.globo.com/politica/noticia/2024/03/08/feliciano-mulher-trans-nao-mulher.ghtml', 'other', 5, 'Câmara dos Deputados', 'Plenário', 'feliciano-mulher-trans-nao-mulher-b162-62') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_hom, true FROM ins;

  -- 63
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_lul, 'Lula destaca maior orçamento da história para políticas de gênero.', 'Este governo tem o maior orçamento da história para políticas de gênero e combate à violência contra a mulher.', 'Anúncio em 2024.', 'verified', false, '2024-03-08', 'https://g1.globo.com/politica/noticia/2024/03/08/lula-maior-orcamento-genero.ghtml', 'other', 2, 'Brasília', 'Dia da Mulher', 'lula-maior-orcamento-genero-b162-63') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_vio, true FROM ins;

  -- 64
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_dju, 'Duarte Jr defende Lei Maria da Penha contra desmonte.', 'A Lei Maria da Penha é patrimônio brasileiro. Qualquer tentativa de desmonte será combatida.', 'Pronunciamento em plenário.', 'verified', false, '2024-08-07', 'https://g1.globo.com/politica/noticia/2024/08/07/duarte-jr-maria-penha-patrimonio.ghtml', 'other', 2, 'Câmara dos Deputados', '18 anos da Lei Maria da Penha', 'duarte-maria-penha-patrimonio-b162-64') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_vio, true FROM ins;

  -- 65
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_din, 'Dino vota a favor de aborto legal em caso de estupro.', 'A Constituição garante e a lei autoriza. Não há discussão sobre o aborto legal em caso de estupro.', 'Voto no STF em ADI sobre aborto.', 'verified', true, '2024-09-24', 'https://www.conjur.com.br/2024-set-24/dino-aborto-legal-estupro/', 'diario_oficial', 3, 'STF', 'Voto em ADI', 'dino-aborto-legal-estupro-b162-65') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_vio, true FROM ins;

  -- 66
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_cmc, 'Cármen Lúcia relata ADPF 442 sobre aborto até 12 semanas.', 'A questão do aborto precisa ser tratada com respeito aos direitos fundamentais das mulheres.', 'Relatoria da ADPF 442 sobre descriminalização.', 'verified', true, '2024-09-22', 'https://www.conjur.com.br/2024-set-22/carmen-adpf-442-aborto/', 'diario_oficial', 3, 'STF', 'Julgamento ADPF', 'carmen-adpf-442-aborto-b162-66') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_vio, true FROM ins;

  -- 67
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_ram, 'Ramagem ataca ministra do STF por voto sobre aborto.', 'Essas ministras ativistas querem legislar onde não podem. O STF não pode ser o legislador.', 'Postagem em redes sobre voto de Cármen Lúcia.', 'verified', false, '2024-09-23', 'https://twitter.com/AlexandreRamagem/status/ramagem-cam-stf-aborto', 'social_media_post', 3, 'Twitter', 'Postagem oficial', 'ramagem-ataca-ministra-stf-aborto-b162-67') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_mis, true FROM ins;

  -- 68
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_rma, 'Rogério Marinho apresenta PEC contra aborto no Senado.', 'Vamos consolidar na Constituição a proteção à vida desde a concepção. Essa é a resposta a Barroso e cia.', 'Apresentação de PEC em 2024.', 'verified', false, '2024-09-30', 'https://g1.globo.com/politica/noticia/2024/09/30/marinho-pec-aborto.ghtml', 'diario_oficial', 4, 'Senado Federal', 'Apresentação de PEC', 'marinho-pec-aborto-senado-b162-68') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_mis, true FROM ins;

  -- 69
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_lew, 'Lewandowski defende proteção redobrada a vítimas de violência doméstica.', 'O Ministério da Justiça está investindo na Patrulha Maria da Penha em 500 municípios. Não admitiremos mais mulheres mortas por omissão.', 'Anúncio de ampliação da Patrulha Maria da Penha.', 'verified', false, '2024-08-07', 'https://g1.globo.com/politica/noticia/2024/08/07/lewandowski-patrulha-maria-penha.ghtml', 'other', 2, 'Brasília', '18 anos da Lei Maria da Penha', 'lewandowski-patrulha-maria-penha-b162-69') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_vio, true FROM ins;

  -- 70
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jwa, 'Jaques Wagner articula aprovação do feminicídio como crime autônomo no Senado.', 'É um marco civilizatório. O Brasil precisa tratar o feminicídio como crime específico, com penas mais severas.', 'Articulação no Senado para aprovação do PL.', 'verified', false, '2024-09-30', 'https://g1.globo.com/politica/noticia/2024/09/30/wagner-feminicidio-crime-autonomo.ghtml', 'news_article', 2, 'Senado Federal', 'Entrevista', 'wagner-feminicidio-crime-autonomo-b162-70') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_vio, true FROM ins;

  -- 71
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_had, 'Haddad anuncia linha de crédito "Feminicídio Zero" para abrigo de mulheres.', 'Queremos que toda vítima de violência doméstica tenha um lugar seguro para onde ir. Essa linha de crédito viabiliza casas-abrigo.', 'Anúncio em 2024.', 'verified', false, '2024-03-07', 'https://valor.globo.com/brasil/noticia/2024/03/07/haddad-linha-credito-feminicidio-zero.ghtml', 'other', 2, 'Ministério da Fazenda', 'Dia da Mulher', 'haddad-feminicidio-zero-credito-b162-71') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_vio, true FROM ins;

  -- 72
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_dam, 'Damares Alves ataca dados de feminicídio como "ideológicos".', 'Esses dados de feminicídio são ideológicos. Não se pode tratar tudo como gênero. Violência contra mulher existe, mas não é feminicídio em massa.', 'Declaração em entrevista em 2024.', 'verified', false, '2024-04-10', 'https://g1.globo.com/politica/noticia/2024/04/10/damares-dados-feminicidio-ideologicos.ghtml', 'news_article', 4, 'Senado Federal', 'Entrevista', 'damares-dados-feminicidio-ideologicos-b162-72') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 73
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jan, 'Jandira Feghali convoca dia de luta contra PL 1904.', 'Vamos às ruas contra o PL 1904. A Câmara precisa ouvir o Brasil que não aceita essa barbárie.', 'Convocação para ato público em junho de 2024.', 'verified', false, '2024-06-15', 'https://g1.globo.com/politica/noticia/2024/06/15/jandira-convoca-ato-pl-1904.ghtml', 'news_article', 2, 'Câmara dos Deputados', 'Entrevista', 'jandira-convoca-ato-pl-1904-b162-73') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_vio, true FROM ins;

  -- 74
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mot, 'Motta admite que pauta do aborto voltará à Câmara em 2025.', 'A pauta do aborto voltará em algum momento. Não tenho como barrar definitivamente.', 'Entrevista em fevereiro de 2025.', 'verified', false, '2025-02-20', 'https://g1.globo.com/politica/noticia/2025/02/20/motta-pauta-aborto-2025.ghtml', 'news_article', 4, 'Câmara dos Deputados', 'Entrevista', 'motta-pauta-aborto-2025-b162-74') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_mis, true FROM ins;

  -- 75
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_eri, 'Erika Hilton protocola PL de responsabilização por misoginia em redes sociais.', 'Precisamos responsabilizar criminalmente quem faz campanhas de ódio misóginas nas redes. Basta de impunidade digital.', 'Apresentação de PL em 2024.', 'verified', false, '2024-07-22', 'https://g1.globo.com/politica/noticia/2024/07/22/erika-pl-misoginia-redes.ghtml', 'diario_oficial', 2, 'Câmara dos Deputados', 'Apresentação de PL', 'erika-pl-misoginia-redes-b162-75') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_vio, true FROM ins;

  -- 76
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_nik, 'Nikolas Ferreira ironiza feminicídio como "discurso ideológico".', 'Não existe feminicídio. Existe homicídio. Essa divisão é invenção ideológica da esquerda.', 'Postagem em redes sociais.', 'verified', false, '2024-11-26', 'https://twitter.com/nikolas_dm/status/nikolas-feminicidio-invencao', 'social_media_post', 4, 'Twitter', 'Postagem oficial', 'nikolas-feminicidio-invencao-b162-76') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_mis, true FROM ins;

  -- 77
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_sam, 'Sâmia Bomfim denuncia ameaças por defender aborto legal.', 'Recebo ameaças de morte diariamente por defender direito da mulher. Essa é a realidade de quem pauta direitos no Brasil.', 'Declaração em coletiva.', 'verified', false, '2024-06-20', 'https://g1.globo.com/politica/noticia/2024/06/20/samia-ameacas-pl-1904.ghtml', 'news_article', 3, 'Câmara dos Deputados', 'Entrevista', 'samia-ameacas-morte-pl-1904-b162-77') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_vio, true FROM ins;

  -- 78
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jzt, 'Júlia Zanatta ataca ONG que atende meninas estupradas.', 'Essas ONGs feministas financiam o extermínio de bebês. Precisa ser investigado.', 'Postagem em redes sociais sobre ONG que auxiliou caso emblemático.', 'verified', false, '2024-08-14', 'https://twitter.com/juliazanatta/status/julia-ataca-ongs-meninas', 'social_media_post', 4, 'Twitter', 'Postagem oficial', 'julia-ataca-ongs-meninas-b162-78') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_odi, true FROM ins;

  -- 79
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_fbz, 'Fátima Bezerra anuncia política estadual contra feminicídio em áreas rurais.', 'A mulher do campo precisa de proteção. Vamos até as regiões mais distantes com a Patrulha Maria da Penha.', 'Anúncio de expansão em municípios interioranos.', 'verified', false, '2024-07-15', 'https://g1.globo.com/politica/noticia/2024/07/15/fatima-feminicidio-area-rural.ghtml', 'other', 2, 'Natal', 'Evento estadual', 'fatima-feminicidio-area-rural-b162-79') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_vio, true FROM ins;

  -- 80
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_rly, 'Raquel Lyra registra queda de 18% em feminicídios em PE em 2024.', 'O trabalho coordenado da rede de proteção à mulher salvou vidas. Pernambuco é exemplo para o Brasil.', 'Anúncio de dados em balanço anual.', 'verified', false, '2024-12-10', 'https://g1.globo.com/politica/noticia/2024/12/10/raquel-lyra-queda-feminicidio-pe.ghtml', 'news_article', 2, 'Recife', 'Balanço 2024', 'raquel-lyra-queda-feminicidio-pe-b162-80') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_vio, true FROM ins;

  -- 81
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_edu, 'Eduardo Bolsonaro apoia revogação da Lei Maria da Penha.', 'A Lei Maria da Penha criminalizou o homem. É uma lei ideológica.', 'Entrevista a podcast.', 'verified', false, '2025-01-22', 'https://g1.globo.com/politica/noticia/2025/01/22/eduardo-revogar-lei-maria-penha.ghtml', 'news_article', 4, 'São Paulo', 'Podcast', 'eduardo-revogar-lei-maria-penha-b162-81') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_mis, true FROM ins;

  -- 82
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_kic, 'Bia Kicis critica "criminalização" de homens na Lei Maria da Penha.', 'A Lei Maria da Penha criou um regime de presunção de culpa contra o homem. Precisa ser revista.', 'Discurso em plenário.', 'verified', false, '2024-11-30', 'https://g1.globo.com/politica/noticia/2024/11/30/bia-kicis-criminalizacao-homens.ghtml', 'other', 3, 'Câmara dos Deputados', 'Plenário', 'bia-kicis-criminalizacao-homens-b162-82') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_mis, true FROM ins;

  -- 83
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_fer, 'Fernanda Melchionna pede punição a deputados que fazem misoginia em plenário.', 'A Câmara precisa punir com cassação quem ofende mulheres no plenário. Não pode haver tolerância a misoginia.', 'Declaração em coletiva após ofensas.', 'verified', false, '2024-06-14', 'https://g1.globo.com/politica/noticia/2024/06/14/fernanda-punicao-misoginia-plenario.ghtml', 'news_article', 2, 'Câmara dos Deputados', 'Entrevista', 'fernanda-punicao-misoginia-plenario-b162-83') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_vio, true FROM ins;

  -- 84
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_gle, 'Gleisi Hoffmann denuncia "retrocesso inédito" em pautas femininas no Congresso.', 'O Brasil vive retrocesso inédito em pautas femininas. Há uma bancada que opera contra nós todos os dias.', 'Declaração em evento do PT.', 'verified', false, '2024-08-15', 'https://g1.globo.com/politica/noticia/2024/08/15/gleisi-retrocesso-pautas-femininas.ghtml', 'other', 2, 'PT Nacional', 'Evento partidário', 'gleisi-retrocesso-pautas-femininas-b162-84') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_vio, true FROM ins;

  -- 85
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_ani, 'Anielle Franco lança programa Juntas contra racismo e misoginia.', 'Juntas significa proteger mulheres negras. Somos o maior alvo da violência combinada de racismo e gênero.', 'Anúncio de programa.', 'verified', false, '2024-07-25', 'https://g1.globo.com/politica/noticia/2024/07/25/anielle-programa-juntas.ghtml', 'other', 2, 'Brasília', 'Lançamento de programa', 'anielle-programa-juntas-racismo-b162-85') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_vio, true FROM ins;

  -- 86
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_lir, 'Lira defende seu papel na pauta do PL 1904 apesar de recuo.', 'Não me arrependo de ter pautado. A democracia é debate. Recuei por respeito à mobilização popular.', 'Entrevista em 2024 após a polêmica.', 'verified', false, '2024-08-01', 'https://g1.globo.com/politica/noticia/2024/08/01/lira-defende-papel-pl-1904.ghtml', 'news_article', 4, 'Câmara dos Deputados', 'Entrevista', 'lira-defende-papel-pl-1904-b162-86') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_mis, true FROM ins;

  -- 87
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_teb, 'Tebet condena PL 1904 como "violação à Constituição".', 'Tirar direito adquirido de vítimas de estupro é inconstitucional. O PL 1904 é inaceitável.', 'Declaração em 2024.', 'verified', false, '2024-06-13', 'https://valor.globo.com/brasil/noticia/2024/06/13/tebet-pl-1904-inconstitucional.ghtml', 'news_article', 3, 'Ministério do Planejamento', 'Entrevista', 'tebet-pl-1904-inconstitucional-b162-87') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_vio, true FROM ins;

  -- 88
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_sth, 'Soraya Thronicke cobra fim da impunidade para feminicídio.', 'Assassinos de mulher têm que apodrecer na cadeia. Chega de penas ridículas para crime tão grave.', 'Declaração em plenário do Senado.', 'verified', false, '2024-09-28', 'https://g1.globo.com/politica/noticia/2024/09/28/soraya-impunidade-feminicidio.ghtml', 'other', 2, 'Senado Federal', 'Plenário', 'soraya-impunidade-feminicidio-b162-88') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_vio, true FROM ins;

  -- 89
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_dam, 'Damares ataca ministras como "pseudo-feministas de Lula".', 'As ministras do Lula são pseudo-feministas que só pensam em aborto. Não olham para mulher de verdade.', 'Pronunciamento no Senado.', 'verified', false, '2024-04-18', 'https://g1.globo.com/politica/noticia/2024/04/18/damares-pseudo-feministas-lula.ghtml', 'other', 4, 'Senado Federal', 'Plenário', 'damares-pseudo-feministas-lula-b162-89') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_mis, true FROM ins;

  -- 90
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mib, 'Michelle Bolsonaro lidera movimento pró-vida em atos pelo Brasil.', 'A mulher cristã brasileira não aceita o aborto. Vamos ocupar as ruas pela vida.', 'Ato em São Paulo em 2024.', 'verified', true, '2024-06-16', 'https://g1.globo.com/politica/noticia/2024/06/16/michelle-ato-pro-vida-sp.ghtml', 'other', 4, 'São Paulo', 'Ato pró-vida', 'michelle-ato-pro-vida-sp-b162-90') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_mis, true FROM ins;

  -- 91
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_orl, 'Orlando Silva protocola PL para responsabilizar plataformas por misoginia digital.', 'As redes sociais são hoje instrumento de violência contra mulheres. Precisamos responsabilizar as plataformas.', 'Apresentação de PL em 2025.', 'verified', false, '2025-03-15', 'https://g1.globo.com/politica/noticia/2025/03/15/orlando-pl-plataformas-misoginia.ghtml', 'diario_oficial', 2, 'Câmara dos Deputados', 'Apresentação de PL', 'orlando-pl-plataformas-misoginia-b162-91') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_vio, true FROM ins;

  -- 92
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_tab, 'Tabata Amaral vota favorável ao feminicídio autônomo no Congresso.', 'Nenhuma mulher deveria ter de morrer para que esse Congresso agisse. A Lei do Feminicídio é tardia, mas necessária.', 'Voto em plenário em 2024.', 'verified', false, '2024-09-10', 'https://g1.globo.com/politica/noticia/2024/09/10/tabata-vota-feminicidio-autonomo.ghtml', 'other', 2, 'Câmara dos Deputados', 'Plenário', 'tabata-feminicidio-autonomo-b162-92') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_vio, true FROM ins;

  -- 93
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_van, 'Van Hattem relativiza feminicídio como "crime comum".', 'Não gosto de separar crimes por gênero. Homicídio é homicídio. Essa lei cria distinção ideológica.', 'Entrevista em 2024.', 'verified', false, '2024-09-12', 'https://g1.globo.com/politica/noticia/2024/09/12/van-hattem-feminicidio-crime-comum.ghtml', 'news_article', 3, 'Câmara dos Deputados', 'Entrevista', 'van-hattem-feminicidio-crime-comum-b162-93') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_mis, true FROM ins;

  -- 94
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_son, 'Sônia Guajajara denuncia violência sexual contra mulheres indígenas Yanomami.', 'Mulheres Yanomami são vítimas de estupro e violência pelos garimpeiros. Isso é genocídio com face feminina.', 'Declaração em evento sobre terras indígenas.', 'verified', true, '2024-04-18', 'https://g1.globo.com/politica/noticia/2024/04/18/sonia-violencia-sexual-yanomami.ghtml', 'other', 3, 'Ministério dos Povos Indígenas', 'Evento', 'sonia-violencia-sexual-yanomami-b162-94') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_vio, true FROM ins;

  -- 95
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_fel, 'Marco Feliciano prega que "mulher deve submissão ao marido".', 'A mulher foi criada para servir ao marido. Esse é o desígnio divino. Fora disso é rebeldia.', 'Pregação em igreja.', 'verified', true, '2024-07-21', 'https://g1.globo.com/politica/noticia/2024/07/21/feliciano-mulher-submissao-marido.ghtml', 'other', 4, 'Igreja', 'Pregação', 'feliciano-mulher-submissao-marido-b162-95') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_mis, true FROM ins;

  -- 96
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mag, 'Magno Malta relativiza casos de feminicídio como "tragédia pessoal".', 'Nem todo caso de mulher morta pelo marido é feminicídio. Muitas vezes é tragédia pessoal, não política.', 'Pronunciamento no Senado.', 'verified', false, '2024-09-20', 'https://g1.globo.com/politica/noticia/2024/09/20/magno-malta-feminicidio-tragedia.ghtml', 'other', 3, 'Senado Federal', 'Plenário', 'magno-malta-feminicidio-tragedia-b162-96') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_mis, true FROM ins;

  -- 97
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_eri, 'Erika Hilton protocola projeto para criar Observatório da Misoginia Digital.', 'Precisamos mapear as redes de ódio contra mulheres e produzir dados. Sem dados, não há política pública.', 'Apresentação de projeto em 2025.', 'verified', false, '2025-03-08', 'https://g1.globo.com/politica/noticia/2025/03/08/erika-observatorio-misoginia-digital.ghtml', 'diario_oficial', 2, 'Câmara dos Deputados', 'Dia da Mulher', 'erika-observatorio-misoginia-digital-b162-97') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_vio, true FROM ins;

  -- 98
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_nik, 'Nikolas Ferreira articula lobby contra ratificação da Convenção de Istambul.', 'Não vamos ratificar documentos internacionais que criam cotas de gênero. O Brasil é soberano.', 'Declaração em 2025.', 'verified', false, '2025-04-02', 'https://g1.globo.com/politica/noticia/2025/04/02/nikolas-convencao-istambul.ghtml', 'news_article', 3, 'Câmara dos Deputados', 'Entrevista', 'nikolas-convencao-istambul-b162-98') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_mis, true FROM ins;

  -- 99
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_cid, 'Cida Gonçalves denuncia aumento de feminicídios no 1º trimestre de 2025.', 'Os dados do 1º trimestre de 2025 mostram que o país precisa mais que nunca de políticas públicas firmes contra feminicídio.', 'Divulgação de dados em 2025.', 'verified', false, '2025-04-05', 'https://g1.globo.com/politica/noticia/2025/04/05/cida-dados-feminicidio-2025.ghtml', 'other', 3, 'Ministério das Mulheres', 'Coletiva', 'cida-dados-feminicidio-2025-b162-99') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_vio, true FROM ins;

  -- 100
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_lul, 'Lula veta propostas de retrocesso em saúde reprodutiva do Congresso.', 'Não vou permitir retrocesso em direitos reprodutivos conquistados por mulheres brasileiras. Vetarei o que for necessário.', 'Declaração após ameaças do Congresso em 2025.', 'verified', true, '2025-03-25', 'https://g1.globo.com/politica/noticia/2025/03/25/lula-veto-retrocesso-saude-reprodutiva.ghtml', 'news_article', 3, 'Palácio do Planalto', 'Entrevista', 'lula-veto-retrocesso-saude-reprodutiva-b162-100') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_vio, true FROM ins;
