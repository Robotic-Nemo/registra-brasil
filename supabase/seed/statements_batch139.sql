...
BEGIN
  ...
  -- 3
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_cid, 'Cida Gonçalves lança campanha contra violência a mulheres trans.', 'Mulher trans é mulher. E mulher trans que sofre violência precisa ser atendida pela rede de proteção como qualquer outra.', 'Lançamento de campanha do Ministério das Mulheres com ANTRA.', 'verified', false, '2023-06-28', 'https://www.gov.br/mulheres/pt-br/assuntos/noticias/2023/06/cida-campanha-mulher-trans', 'official_statement', 1, 'Ministério das Mulheres', 'Lançamento de campanha', 'cida-campanha-trans-b139-3') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_hom, true FROM ins;

  -- 4
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mic, 'Michelle Bolsonaro diz em culto que Brasil precisa voltar aos valores cristãos.', 'Brasil não aguenta mais agenda gay disfarçada de direitos humanos. Precisamos voltar a Cristo.', 'Discurso em culto da Assembleia de Deus em Belém.', 'verified', false, '2023-07-16', 'https://www.gazetadopovo.com.br/politica/michelle-bolsonaro-agenda-gay-culto-belem-2023/', 'news_article', 4, 'Assembleia de Deus Belém', 'Culto evangélico', 'michelle-culto-belem-b139-4') RETURNING id)
