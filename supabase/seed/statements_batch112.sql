...
BEGIN
  ...
  -- 32
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_nis, 'Nísia lança programa de saúde mental no SUS após alta de suicídios.', 'Saúde mental é saúde. Vamos abrir CAPS e fortalecer a atenção psicossocial.', 'Lançamento do programa junto à Associação Brasileira de Psiquiatria.', 'verified', false, '2024-05-17', 'https://www.gov.br/saude/pt-br/assuntos/noticias/2024/maio/ministerio-da-saude-lanca-programa-nacional-de-saude-mental', 'other', 1, 'Brasília', 'Programa Saúde Mental SUS', 'nisia-saude-mental-caps-b112-32') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;

  -- 33
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_eri, 'Erika Hilton critica falta de atendimento de saúde para pessoas trans no SUS.', 'Pessoas trans morrem porque o SUS ainda não aprendeu a nos receber. Isso precisa mudar.', 'Discurso na Comissão de Direitos Humanos da Câmara.', 'verified', false, '2023-06-28', 'https://www.camara.leg.br/noticias/erika-hilton-saude-trans-sus', 'other', 1, 'Câmara dos Deputados', 'Comissão de Direitos Humanos', 'erika-saude-trans-sus-b112-33') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;

  -- 34
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mfe, 'Marco Feliciano compara atendimento trans no SUS a aberração.', 'O SUS não pode gastar dinheiro do povo com aberração. É contra a natureza.', 'Fala em culto transmitido ao vivo após nota técnica do Ministério.', 'verified', false, '2023-07-02', 'https://www.aosfatos.org/noticias/feliciano-pessoas-trans-sus-discurso/', 'social_media_post', 4, 'São Paulo', 'Culto transmitido', 'feliciano-aberracao-trans-b112-34') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_hom, true FROM ins;

  -- 35
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_nis, 'Nísia anuncia retorno da política nacional para saúde da população LGBT.', 'O SUS acolhe todas as pessoas. Vamos retomar a política nacional de saúde LGBTQIA+.', 'Anúncio no Palácio do Planalto junto a organizações LGBTQIA+.', 'verified', false, '2023-06-28', 'https://www.gov.br/saude/pt-br/assuntos/noticias/2023/junho/ministerio-da-saude-retoma-politica-nacional-lgbt', 'other', 1, 'Brasília', 'Dia do Orgulho LGBTQIA+', 'nisia-saude-lgbt-b112-35') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;

  -- 36
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_tal, 'Talíria Petrone denuncia mortalidade materna negra como racismo estrutural no SUS.', 'Mulheres negras morrem muito mais no parto. Isso não é acaso, é racismo no SUS.', 'Discurso no plenário da Câmara em audiência pública sobre mortalidade materna.', 'verified', false, '2023-11-20', 'https://www.camara.leg.br/noticias/taliria-petrone-mortalidade-materna-negra', 'other', 1, 'Câmara dos Deputados', 'Audiência Pública', 'taliria-mortalidade-materna-b112-36') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;

  -- 37
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_son, 'Sônia Guajajara cobra conclusão da Casa de Saúde Indígena Yanomami.', 'Os yanomamis ainda sofrem. Precisamos concluir a Casa de Saúde Indígena e garantir SUS de verdade.', 'Entrevista em Brasília sobre balanço do primeiro ano da operação Yanomami.', 'verified', false, '2024-01-22', 'https://agenciabrasil.ebc.com.br/direitos-humanos/noticia/2024-01/sonia-guajajara-yanomami-balanco', 'news_article', 1, 'Brasília', 'Balanço 1 ano Yanomami', 'sonia-yanomami-balanco-b112-37') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;

  -- 38
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_ani, 'Anielle Franco defende saúde da população negra no SUS.', 'O racismo também está nas mesas de obstetrícia. O SUS precisa enxergar a mulher negra.', 'Participação em seminário sobre equidade racial em saúde na Fiocruz.', 'verified', false, '2023-11-23', 'https://portal.fiocruz.br/noticia/2023/11/anielle-franco-saude-populacao-negra-fiocruz', 'other', 1, 'Rio de Janeiro', 'Seminário Fiocruz', 'anielle-saude-negra-fiocruz-b112-38') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;

  -- 39
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_kim, 'Kim Kataguiri critica gasto com propaganda de vacinação e defende corte.', 'O governo gasta milhões com propaganda de vacina enquanto faltam remédios no SUS.', 'Entrevista sobre orçamento do Ministério da Saúde no início de 2024.', 'verified', false, '2024-02-20', 'https://www.camara.leg.br/deputados/204536/biografia', 'news_article', 2, 'Brasília', 'Entrevista sobre orçamento', 'kim-propaganda-vacina-b112-39') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 40
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_nis, 'Nísia declara emergência nacional por Oropouche em Manaus.', 'O Oropouche é um desafio novo. Vamos apoiar estados e municípios a enfrentar.', 'Anúncio após surto do vírus Oropouche atingir múltiplos estados.', 'verified', true, '2024-06-27', 'https://www.gov.br/saude/pt-br/assuntos/noticias/2024/junho/ministerio-declara-emergencia-por-oropouche', 'other', 1, 'Brasília', 'Emergência Oropouche', 'nisia-oropouche-emergencia-b112-40') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;

  -- 41
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_nis, 'Nísia responde à emergência global de Mpox declarada pela OMS.', 'O Brasil está preparado. Temos vacinas, protocolos e vigilância para a Mpox.', 'Coletiva após OMS declarar nova emergência internacional por Mpox.', 'verified', true, '2024-08-15', 'https://www.gov.br/saude/pt-br/assuntos/noticias/2024/agosto/ministerio-da-saude-preparado-mpox', 'other', 1, 'Brasília', 'Resposta Mpox', 'nisia-mpox-resposta-b112-41') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;

  -- 42
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_nik, 'Nikolas ridiculariza campanha de Mpox com tom homofóbico.', 'Agora é doença de gay de novo. O governo gasta fortuna para isso.', 'Postagem em rede social após decreto de emergência internacional.', 'verified', true, '2024-08-17', 'https://www.aosfatos.org/noticias/nikolas-mpox-homofobia-post/', 'social_media_post', 4, 'Belo Horizonte', 'Postagem em rede social', 'nikolas-mpox-homofobia-b112-42') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_hom, true FROM ins;

  -- 43
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_sam, 'Sâmia Bomfim denuncia homofobia institucional em fala sobre Mpox.', 'A homofobia mata. Vacinar contra Mpox salva vidas. Chega de estigma.', 'Discurso na tribuna da Câmara em defesa da política de vacinação.', 'verified', false, '2024-08-20', 'https://www.camara.leg.br/noticias/samia-bomfim-mpox-homofobia-estigma', 'other', 1, 'Câmara dos Deputados', 'Sessão sobre Mpox', 'samia-mpox-defesa-b112-43') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;

  -- 44
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_nis, 'Nísia anuncia Farmácia Popular ampliada com medicamentos gratuitos.', 'Medicamento não é mercadoria, é direito. Farmácia Popular 100 por cento gratuita.', 'Cerimônia no Planalto em 2023 com ampliação de cobertura.', 'verified', false, '2023-03-10', 'https://www.gov.br/saude/pt-br/assuntos/noticias/2023/marco/farmacia-popular-gratuita-ampliada', 'other', 1, 'Brasília', 'Relançamento Farmácia Popular', 'nisia-farmacia-popular-b112-44') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;

  -- 45
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_teb, 'Simone Tebet defende ampliação de recursos para SUS no novo arcabouço fiscal.', 'Saúde é prioridade. Não há como fazer ajuste sem proteger o SUS.', 'Entrevista sobre LDO como ministra do Planejamento.', 'verified', false, '2023-05-30', 'https://agenciabrasil.ebc.com.br/economia/noticia/2023-05/tebet-defende-sus-ldo', 'news_article', 1, 'Brasília', 'Debate orçamento 2024', 'tebet-sus-arcabouco-b112-45') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;

  -- 46
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_had, 'Haddad defende investimento em saúde como política fiscal responsável.', 'Investir no SUS é eficiência econômica. Cada real em prevenção salva dez no hospital.', 'Fala em seminário sobre fiscal e social no Rio de Janeiro.', 'verified', false, '2023-07-18', 'https://agenciabrasil.ebc.com.br/economia/noticia/2023-07/haddad-sus-investimento-fiscal', 'other', 1, 'Rio de Janeiro', 'Seminário Fiscal e Social', 'haddad-sus-fiscal-b112-46') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;

  -- 47
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_art, 'Arthur Lira diz que mudará Bolsa Família e SUS se for necessário.', 'Se o governo não cortar, o Congresso vai cortar. Saúde também entra na conta.', 'Entrevista à imprensa em meio a discussão do arcabouço fiscal.', 'verified', false, '2023-08-07', 'https://www1.folha.uol.com.br/mercado/2023/08/arthur-lira-corte-orcamento.shtml', 'news_article', 3, 'Brasília', 'Entrevista coletiva', 'lira-corte-sus-b112-47') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 48
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_nis, 'Nísia anuncia acordo de transferência de tecnologia para vacina da dengue brasileira.', 'Vamos ter vacina de dengue fabricada 100 por cento no Brasil pelo Butantan.', 'Anúncio com Instituto Butantan para vacina nacional de dose única.', 'verified', true, '2024-03-14', 'https://butantan.gov.br/noticias/vacina-dengue-butantan-brasileira', 'other', 1, 'São Paulo', 'Anúncio vacina Butantan', 'nisia-butantan-dengue-b112-48') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;

  -- 49
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_tab, 'Tábata Amaral defende aumento do investimento em saúde básica e creches.', 'Investir em saúde das crianças é investir no futuro do país.', 'Pronunciamento em defesa de emenda sobre saúde infantil.', 'verified', false, '2023-10-18', 'https://www.camara.leg.br/noticias/tabata-amaral-saude-infantil', 'other', 1, 'Câmara dos Deputados', 'Pronunciamento', 'tabata-saude-infantil-b112-49') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;

  -- 50
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mvh, 'Marcel van Hattem acusa SUS de ser falido e defende seguro privado.', 'O SUS é um plano falido. O futuro é ter vouchers e concorrência privada.', 'Discurso na Câmara durante debate sobre planos de saúde.', 'verified', false, '2023-11-08', 'https://www.camara.leg.br/deputados/156190/biografia', 'other', 4, 'Câmara dos Deputados', 'Debate plano de saúde', 'marcel-sus-falido-b112-50') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 51
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_chi, 'Chico Alencar defende SUS como maior política pública do Brasil.', 'O SUS é a maior política pública do mundo. Não há democracia sem saúde universal.', 'Discurso de tribuna em defesa do PNS e da PEC da Saúde.', 'verified', false, '2023-11-10', 'https://www.camara.leg.br/noticias/chico-alencar-sus-maior-politica', 'other', 1, 'Câmara dos Deputados', 'Pronunciamento', 'chico-sus-maior-politica-b112-51') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;

  -- 52
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_ott, 'Otto Alencar, médico, defende mais financiamento federal ao SUS.', 'O Brasil gasta menos em saúde pública que a maioria dos países com sistema universal.', 'Discurso na CCJ do Senado sobre financiamento da saúde.', 'verified', false, '2023-12-05', 'https://www12.senado.leg.br/noticias/materias/2023/12/05/otto-alencar-financiamento-sus', 'other', 1, 'Senado Federal', 'CCJ do Senado', 'otto-financiamento-sus-b112-52') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;

  -- 53
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_nis, 'Nísia comemora aprovação da Lei do Vacinômetro e transparência da vacinação.', 'Transparência é o antídoto da desinformação. Todo cidadão saberá as coberturas.', 'Sanção de lei que obriga divulgação pública de coberturas vacinais.', 'verified', false, '2024-07-10', 'https://www.gov.br/saude/pt-br/assuntos/noticias/2024/julho/vacinometro-transparencia-lei', 'other', 1, 'Brasília', 'Sanção Lei Vacinômetro', 'nisia-vacinometro-b112-53') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;

  -- 54
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_nis, 'Nísia comemora recuperação da cobertura da poliomielite acima de 90%.', 'Recuperamos a pólio acima de 90%. Só a vacina ergue o Brasil de novo.', 'Entrevista após divulgação da cobertura vacinal do PNI.', 'verified', false, '2024-09-10', 'https://www.gov.br/saude/pt-br/assuntos/noticias/2024/setembro/cobertura-polio-recuperada-90', 'other', 1, 'Brasília', 'Balanço vacinal PNI', 'nisia-polio-90-b112-54') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;

  -- 55
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jai, 'Bolsonaro afirma em entrevista que covid foi exagerado e CPI foi político.', 'A CPI da Covid foi uma farsa política. O número de mortes foi inflado.', 'Entrevista a canal de YouTube bolsonarista revisando pandemia.', 'verified', false, '2024-03-21', 'https://www.aosfatos.org/noticias/bolsonaro-entrevista-covid-inflado-falso/', 'news_article', 5, 'Angra dos Reis, RJ', 'Entrevista a canal bolsonarista', 'bolsonaro-covid-inflado-b112-55') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 56
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_oma, 'Omar Aziz recorda CPI da Covid e cobra responsabilização.', 'As 700 mil mortes não vão ser esquecidas. A CPI mostrou tudo.', 'Entrevista ao Roda Viva reagindo às declarações revisionistas de Bolsonaro.', 'verified', false, '2024-03-25', 'https://www12.senado.leg.br/noticias/materias/2024/03/25/omar-aziz-cpi-covid-memoria', 'news_article', 1, 'São Paulo', 'Entrevista Roda Viva', 'omar-cpi-memoria-b112-56') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;

  -- 57
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_ran, 'Randolfe Rodrigues lembra que oposição sabotou vacinas no Brasil.', 'Quem duvidou da vacina em 2020 e 2021 tem sangue nas mãos. A história condena.', 'Pronunciamento no Senado no aniversário da CPI da Covid.', 'verified', false, '2024-04-27', 'https://www12.senado.leg.br/noticias/materias/2024/04/27/randolfe-cpi-aniversario', 'other', 2, 'Senado Federal', 'Aniversário CPI Covid', 'randolfe-cpi-aniversario-b112-57') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;

  -- 58
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_dam, 'Damares defende restrição total ao aborto legal em entrevista.', 'Não existe aborto legal. Toda vida é sagrada desde a concepção.', 'Entrevista a rádio evangélica em Brasília sobre projeto restritivo.', 'verified', false, '2024-04-30', 'https://www.bbc.com/portuguese/articles/damares-aborto-legal-restringir', 'news_article', 3, 'Brasília', 'Entrevista rádio evangélica', 'damares-aborto-restringir-b112-58') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_mis, true FROM ins;

  -- 59
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_sil, 'Silas Câmara protocola PL 1904 com pena maior para aborto que estupro.', 'Aborto tem que ter pena maior que estupro porque o inocente é a criança.', 'Defesa do PL 1904, da Gravidez do Estuprador, na tribuna da Câmara.', 'verified', true, '2024-06-11', 'https://www.camara.leg.br/propostas-legislativas/pl-1904-2024', 'other', 5, 'Câmara dos Deputados', 'Defesa PL 1904', 'silas-pl-1904-b112-59') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_mis, true FROM ins;

  -- 60
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_art, 'Arthur Lira coloca PL 1904 em regime de urgência na Câmara.', 'Vou pautar. O Congresso é soberano para decidir sobre esse tema.', 'Anúncio em plenário sobre tramitação em urgência do PL 1904.', 'verified', true, '2024-06-12', 'https://www1.folha.uol.com.br/cotidiano/2024/06/lira-pl-1904-urgencia.shtml', 'other', 5, 'Câmara dos Deputados', 'Urgência PL 1904', 'lira-pl-1904-urgencia-b112-60') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_mis, true FROM ins;

  -- 61
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_nis, 'Nísia condena PL 1904 chamando de crueldade contra meninas.', 'Obrigar uma menina a parir do estuprador é crueldade. O SUS vai garantir direitos.', 'Entrevista coletiva após urgência do PL na Câmara.', 'verified', true, '2024-06-13', 'https://agenciabrasil.ebc.com.br/direitos-humanos/noticia/2024-06/nisia-pl-1904-crueldade', 'other', 1, 'Brasília', 'Resposta PL 1904', 'nisia-pl-1904-crueldade-b112-61') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;

  -- 62
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_eri, 'Erika Hilton denuncia PL 1904 como tortura contra meninas vítimas de estupro.', 'É tortura. É dar ao estuprador 10 anos e à vítima 20. Vergonha histórica.', 'Discurso viral no plenário da Câmara contra PL 1904.', 'verified', true, '2024-06-13', 'https://www.camara.leg.br/noticias/erika-hilton-pl-1904-tortura', 'other', 1, 'Câmara dos Deputados', 'Discurso contra PL 1904', 'erika-pl-1904-tortura-b112-62') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;

  -- 63
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_sam, 'Sâmia Bomfim protesta contra PL 1904 em ato no Congresso.', 'Criança não é mãe. Estuprador não é pai. Este PL é um atentado à vida das meninas.', 'Discurso em ato feminista no Congresso contra PL 1904.', 'verified', true, '2024-06-13', 'https://www.camara.leg.br/noticias/samia-pl-1904-criança-mae', 'other', 1, 'Câmara dos Deputados', 'Ato contra PL 1904', 'samia-pl-1904-crianca-mae-b112-63') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;

  -- 64
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_bia, 'Bia Kicis defende PL 1904 afirmando que feto é vítima.', 'A vítima é o bebê. A mulher também é vítima, mas matar não é solução.', 'Fala em coletiva de bancada evangélica sobre PL 1904.', 'verified', false, '2024-06-14', 'https://www.camara.leg.br/deputados/74847/biografia', 'other', 3, 'Câmara dos Deputados', 'Coletiva bancada evangélica', 'bia-pl-1904-defesa-b112-64') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_mis, true FROM ins;

  -- 65
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_cid, 'Cida Gonçalves chama PL 1904 de retrocesso civilizatório.', 'O PL da Gravidez do Estuprador é um retrocesso civilizatório que envergonha o Brasil.', 'Coletiva do Ministério das Mulheres em Brasília.', 'verified', true, '2024-06-13', 'https://www.gov.br/mulheres/pt-br/assuntos/noticias/2024/cida-goncalves-pl-1904-retrocesso', 'other', 1, 'Brasília', 'Coletiva do Ministério', 'cida-pl-1904-retrocesso-b112-65') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;

  -- 66
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_lul, 'Lula classifica PL 1904 de insanidade e diz que vetará.', 'Isso é uma insanidade. Não aceito comparar estupro com aborto legal.', 'Entrevista em Brasília após manifestações pelo país.', 'verified', true, '2024-06-14', 'https://www.gov.br/planalto/pt-br/acompanhe-o-planalto/discursos/2024/lula-pl-1904-insanidade', 'other', 2, 'Brasília', 'Entrevista coletiva', 'lula-pl-1904-insanidade-b112-66') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;

  -- 67
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jan, 'Jandira Feghali acusa PL 1904 de ser estupro institucional.', 'Estuprar uma menina duas vezes: uma pelo criminoso, outra pelo Estado.', 'Discurso emocionado na Câmara durante obstrução.', 'verified', false, '2024-06-13', 'https://www.camara.leg.br/noticias/jandira-pl-1904-estupro-institucional', 'other', 1, 'Câmara dos Deputados', 'Obstrução contra PL 1904', 'jandira-pl-1904-b112-67') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;

  -- 68
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_nis, 'Nísia anuncia acordo para produção de IFA de vacinas da gripe em Bio-Manguinhos.', 'Vamos produzir IFA no Brasil. Não podemos depender da China ou da Índia.', 'Anúncio em Bio-Manguinhos sobre fabricação nacional de insumos farmacêuticos.', 'verified', false, '2024-02-05', 'https://portal.fiocruz.br/noticia/2024/02/bio-manguinhos-ifa-producao-nacional', 'other', 1, 'Rio de Janeiro', 'Anúncio CEIS Bio-Manguinhos', 'nisia-ifa-biomanguinhos-b112-68') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;

  -- 69
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_rui, 'Rui Costa coordena ação federal na dengue como Casa Civil.', 'O governo inteiro está mobilizado. Saúde, Defesa, Educação unidas contra a dengue.', 'Coletiva na Casa Civil anunciando plano integrado.', 'verified', false, '2024-02-02', 'https://www.gov.br/casacivil/pt-br/assuntos/noticias/2024/rui-costa-plano-dengue', 'other', 1, 'Brasília', 'Plano integrado dengue', 'rui-dengue-casa-civil-b112-69') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;

  -- 70
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_pab, 'Pablo Marçal promove suposto tratamento natural para dengue em redes.', 'Dengue se cura com chá de folha e jejum. Sistema não quer que você saiba.', 'Vídeo em redes sociais durante pico de dengue.', 'verified', true, '2024-03-01', 'https://www.aosfatos.org/noticias/marcal-cha-dengue-desinformacao/', 'social_media_post', 5, 'São Paulo', 'Postagem em redes sociais', 'marcal-cha-dengue-b112-70') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 71
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_nis, 'Nísia avalia impacto de enchentes no RS na saúde pública.', 'As enchentes do Rio Grande do Sul são emergência sanitária. Leptospirose, dengue, saúde mental.', 'Visita a Porto Alegre durante catástrofe climática.', 'verified', true, '2024-05-10', 'https://www.gov.br/saude/pt-br/assuntos/noticias/2024/maio/ministra-da-saude-visita-rio-grande-do-sul', 'other', 1, 'Porto Alegre', 'Visita às enchentes do RS', 'nisia-enchentes-rs-b112-71') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;

  -- 72
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_ale, 'Alessandro Vieira cobra CPI das enchentes e falhas na saúde do RS.', 'Precisamos entender as falhas. Saúde, prevenção, tudo falhou no Rio Grande.', 'Discurso no Senado em meio ao desastre no RS.', 'verified', false, '2024-05-14', 'https://www12.senado.leg.br/noticias/materias/2024/05/14/alessandro-vieira-rs-falhas', 'other', 1, 'Senado Federal', 'Pronunciamento enchentes RS', 'alessandro-rs-falhas-b112-72') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;

  -- 73
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_nis, 'Nísia anuncia novo balanço da dengue com mais de 6 milhões de casos.', 'Superamos 6 milhões de casos. Ninguém pode relaxar. É a maior epidemia da nossa história.', 'Coletiva em agosto revisando picos da epidemia.', 'verified', true, '2024-08-02', 'https://www.gov.br/saude/pt-br/assuntos/noticias/2024/agosto/balanco-dengue-6-milhoes-casos', 'other', 1, 'Brasília', 'Balanço epidemia dengue', 'nisia-6mi-casos-dengue-b112-73') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;

  -- 74
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_lul, 'Lula revela descoberta de lesão cerebral e cirurgia de urgência.', 'Levei um tombo em casa. Graças a Deus e à equipe médica do SUS, estou aqui.', 'Declaração à imprensa após cirurgia por hemorragia intracraniana.', 'verified', true, '2024-12-10', 'https://www.gov.br/planalto/pt-br/acompanhe-o-planalto/discursos/2024/lula-cirurgia-hemorragia', 'other', 1, 'Brasília', 'Recuperação cirurgia cerebral', 'lula-cirurgia-cerebral-b112-74') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;

  -- 75
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_fla, 'Flávio Bolsonaro ironiza internação de Lula por problema cerebral.', 'Agora entendi muita coisa do governo. O cérebro do capitão estava vazando.', 'Postagem em redes sociais pouco após a cirurgia do presidente.', 'verified', true, '2024-12-11', 'https://www.metropoles.com/brasil/politica-br/flavio-bolsonaro-lula-cerebro', 'social_media_post', 3, 'Rio de Janeiro', 'Postagem em redes sociais', 'flavio-ironia-lula-cerebro-b112-75') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_odi, true FROM ins;

  -- 76
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_gle, 'Gleisi Hoffmann denuncia uso político da cirurgia de Lula.', 'A extrema-direita comemora doença de presidente. Isso diz muito do caráter dessa gente.', 'Entrevista ao SBT após ataques bolsonaristas à saúde de Lula.', 'verified', false, '2024-12-12', 'https://noticias.uol.com.br/politica/2024/12/12/gleisi-ataques-saude-lula.htm', 'news_article', 1, 'Brasília', 'Entrevista SBT', 'gleisi-ataques-saude-lula-b112-76') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;

  -- 77
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_nis, 'Nísia defende compra de vacinas para influenza pelo SUS em 2024.', 'A gripe volta todo ano. Precisamos vacinar para salvar idosos e crianças.', 'Coletiva sobre campanha de influenza 2024.', 'verified', false, '2024-03-22', 'https://www.gov.br/saude/pt-br/assuntos/noticias/2024/marco/campanha-influenza-2024', 'other', 1, 'Brasília', 'Campanha Influenza 2024', 'nisia-influenza-2024-b112-77') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;

  -- 78
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_pad, 'Padilha articula no Congresso contra PL 1904 como ministro de relações institucionais.', 'O governo trabalha para derrubar essa barbárie. O PL 1904 é intolerável.', 'Coletiva no Planalto sobre articulação parlamentar.', 'verified', false, '2024-06-14', 'https://agenciabrasil.ebc.com.br/politica/noticia/2024-06/padilha-pl-1904-articulacao', 'other', 2, 'Brasília', 'Coletiva pós PL 1904', 'padilha-pl-1904-articula-b112-78') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;

  -- 79
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jai, 'Bolsonaro apoia PL 1904 em vídeo de apoiadores.', 'A vida começa na concepção. Apoio os deputados que querem proteger o inocente.', 'Postagem em rede social apoiando o PL 1904.', 'verified', false, '2024-06-15', 'https://www.poder360.com.br/politica/bolsonaro-apoia-pl-1904/', 'social_media_post', 3, 'Angra dos Reis', 'Postagem em rede social', 'bolsonaro-apoia-pl-1904-b112-79') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_mis, true FROM ins;

  -- 80
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_hug, 'Hugo Motta, então articulador, afirma que PL 1904 só voltará com consenso.', 'Não vou pautar sem acordo. Ponto. Ninguém ganha forçando.', 'Entrevista como vice-líder após recuo do PL 1904.', 'verified', false, '2024-06-17', 'https://www.camara.leg.br/noticias/hugo-motta-pl-1904-consenso', 'news_article', 2, 'Brasília', 'Entrevista em Brasília', 'hugo-pl-1904-consenso-b112-80') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;

  -- 81
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_nis, 'Nísia defende atuação do SUS em saúde mental durante enchentes do RS.', 'A saúde mental dos gaúchos também está submersa. CAPS e apoio psicossocial em toda área atingida.', 'Visita a abrigo em Canoas durante enchentes.', 'verified', false, '2024-05-25', 'https://agenciabrasil.ebc.com.br/saude/noticia/2024-05/nisia-saude-mental-rs-enchentes', 'other', 1, 'Canoas', 'Visita a abrigos RS', 'nisia-saude-mental-rs-b112-81') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;

  -- 82
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_dam, 'Damares aciona STF contra portaria que amplia acesso a aborto legal.', 'Vou ao STF. Essa portaria é flexibilização ilegal do aborto.', 'Coletiva no Senado após portaria do Ministério da Saúde.', 'verified', false, '2024-09-20', 'https://www12.senado.leg.br/noticias/materias/2024/09/20/damares-stf-portaria-aborto', 'other', 3, 'Senado Federal', 'Ação contra portaria', 'damares-stf-portaria-b112-82') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_mis, true FROM ins;

  -- 83
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_nis, 'Nísia lança Força Nacional do SUS para emergências.', 'Quando um estado for atingido, a Força Nacional do SUS estará lá em 48 horas.', 'Lançamento em Brasília com profissionais em uniforme.', 'verified', false, '2024-09-05', 'https://www.gov.br/saude/pt-br/assuntos/noticias/2024/setembro/forca-nacional-sus-lancamento', 'other', 1, 'Brasília', 'Lançamento Força Nacional SUS', 'nisia-forca-nacional-sus-b112-83') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;

  -- 84
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jai, 'Bolsonaro tem AVC e é transferido em UTI aérea.', 'Foi uma coisa repentina. Mas vou voltar em breve, estou sendo bem cuidado.', 'Declaração gravada de hospital após AVC isquêmico em abril de 2025.', 'verified', true, '2025-04-14', 'https://g1.globo.com/politica/noticia/2025/04/14/bolsonaro-avc-hospital.ghtml', 'other', 1, 'Natal', 'Internação após AVC', 'bolsonaro-avc-2025-b112-84') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;

  -- 85
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_pad, 'Padilha assume Ministério da Saúde após saída de Nísia.', 'Recebo o SUS fortalecido por Nísia. Vou honrar esse legado.', 'Discurso de posse como ministro da Saúde em fevereiro de 2025.', 'verified', true, '2025-02-27', 'https://www.gov.br/saude/pt-br/assuntos/noticias/2025/fevereiro/alexandre-padilha-toma-posse-ministro-saude', 'other', 1, 'Brasília', 'Posse como ministro', 'padilha-posse-saude-b112-85') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;

  -- 86
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_nis, 'Nísia se despede do Ministério da Saúde defendendo legado.', 'Saio de coração pleno. O SUS está mais forte, vacinas voltaram, a saúde voltou a ser prioridade.', 'Discurso de despedida no Ministério da Saúde.', 'verified', true, '2025-02-27', 'https://www.gov.br/saude/pt-br/assuntos/noticias/2025/fevereiro/discurso-despedida-ministra-nisia', 'other', 1, 'Brasília', 'Despedida ministerial', 'nisia-despedida-b112-86') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;

  -- 87
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_pad, 'Padilha anuncia prioridades: vacinação, APS e Mais Médicos.', 'Minhas prioridades são vacinação, atenção primária e o Mais Médicos. Essa é a receita.', 'Entrevista coletiva na semana de posse.', 'verified', false, '2025-03-03', 'https://agenciabrasil.ebc.com.br/saude/noticia/2025-03/padilha-prioridades-saude', 'news_article', 1, 'Brasília', 'Coletiva de posse', 'padilha-prioridades-b112-87') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;

  -- 88
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_pad, 'Padilha anuncia expansão do Mais Médicos para 28 mil profissionais.', 'Vamos chegar a 28 mil médicos em todo o Brasil. A atenção primária está de volta.', 'Anúncio em cerimônia no Planalto com Lula.', 'verified', false, '2025-03-18', 'https://www.gov.br/saude/pt-br/assuntos/noticias/2025/marco/mais-medicos-28-mil-expansao', 'other', 1, 'Brasília', 'Expansão Mais Médicos', 'padilha-28mil-mais-medicos-b112-88') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;

  -- 89
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_nik, 'Nikolas ataca novo ministro Padilha com acusações infundadas.', 'Padilha voltou para repetir o fracasso do Mais Médicos cubano. Vai dar ruim.', 'Postagem em redes sociais após nomeação do ministro.', 'verified', false, '2025-02-28', 'https://www.metropoles.com/brasil/politica-br/nikolas-padilha-ataque', 'social_media_post', 3, 'Belo Horizonte', 'Postagem em redes sociais', 'nikolas-ataque-padilha-b112-89') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 90
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_pad, 'Padilha anuncia novo centro de emergência para pandemias.', 'Vamos ter um centro nacional de preparação para pandemias. Aprender com a covid.', 'Cerimônia de lançamento com Fiocruz em Manguinhos.', 'verified', false, '2025-05-05', 'https://portal.fiocruz.br/noticia/2025/05/centro-nacional-preparacao-pandemias', 'other', 1, 'Rio de Janeiro', 'Lançamento CNPP', 'padilha-cnpp-fiocruz-b112-90') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;

  -- 91
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_tal, 'Talíria Petrone defende aborto legal diante de nova tentativa do PL 1904.', 'Não vamos recuar. Meninas vítimas de estupro têm direito à vida e dignidade.', 'Discurso em plenário durante obstrução em 2025.', 'verified', false, '2025-05-12', 'https://www.camara.leg.br/noticias/taliria-aborto-legal-pl-1904-2025', 'other', 1, 'Câmara dos Deputados', 'Obstrução 2025', 'taliria-aborto-2025-b112-91') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;

  -- 92
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_pad, 'Padilha defende cooperação técnica de Cuba no Mais Médicos.', 'A cooperação com Cuba deu certo. Não há por que demonizar o que salva vidas.', 'Entrevista a TV Globo sobre história do programa.', 'verified', false, '2025-06-02', 'https://g1.globo.com/saude/noticia/2025/06/02/padilha-mais-medicos-cuba.ghtml', 'news_article', 1, 'Rio de Janeiro', 'Entrevista TV Globo', 'padilha-cuba-b112-92') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;

  -- 93
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mvh, 'Marcel van Hattem chama cooperação cubana de esquema ideológico.', 'O Mais Médicos com Cuba é esquema ideológico. Venderam brasileiros para Havana.', 'Discurso na Câmara repercutindo ministro Padilha.', 'verified', false, '2025-06-05', 'https://www.camara.leg.br/deputados/156190/biografia', 'other', 3, 'Câmara dos Deputados', 'Sessão sobre Mais Médicos', 'marcel-mais-medicos-cuba-b112-93') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 94
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_pad, 'Padilha divulga queda de 70% nos casos de dengue em 2025.', 'Caiu 70% os casos de dengue. O SUS funcionou. A vacina funcionou.', 'Coletiva de imprensa em maio de 2025 sobre balanço epidemiológico.', 'verified', true, '2025-05-20', 'https://www.gov.br/saude/pt-br/assuntos/noticias/2025/maio/dengue-cai-70-por-cento-2025', 'other', 1, 'Brasília', 'Balanço dengue 2025', 'padilha-dengue-cai-70-b112-94') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;

  -- 95
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_pad, 'Padilha anuncia recuperação plena da cobertura vacinal infantil.', 'Recuperamos a cobertura infantil. Estamos onde estávamos antes de Bolsonaro.', 'Coletiva sobre balanço PNI em 2025.', 'verified', true, '2025-08-07', 'https://www.gov.br/saude/pt-br/assuntos/noticias/2025/agosto/cobertura-vacinal-recuperada-pni', 'other', 1, 'Brasília', 'Balanço PNI 2025', 'padilha-pni-recuperado-b112-95') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;

  -- 96
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_eri, 'Erika Hilton celebra ampliação de hormonioterapia trans no SUS.', 'Ter hormônio pelo SUS não é privilégio, é dignidade. Seguimos avançando.', 'Entrevista ao Brasil de Fato sobre política trans no SUS.', 'verified', false, '2025-06-28', 'https://www.brasildefato.com.br/2025/06/28/erika-hilton-hormonioterapia-sus', 'news_article', 1, 'Brasília', 'Entrevista Brasil de Fato', 'erika-hormonio-sus-b112-96') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;

  -- 97
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mag, 'Magno Malta ataca hormonioterapia trans como desperdício do SUS.', 'Tem criança morrendo sem atendimento e o governo paga hormônio para homem virar mulher.', 'Discurso no Senado em sessão sobre portaria do SUS.', 'verified', false, '2025-07-01', 'https://www12.senado.leg.br/noticias/materias/2025/07/01/magno-malta-sus-trans', 'other', 4, 'Senado Federal', 'Sessão Senado', 'magno-sus-trans-b112-97') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_hom, true FROM ins;

  -- 98
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_pad, 'Padilha rebate Magno Malta em defesa de população trans.', 'O SUS não escolhe cidadão. O SUS atende. Pessoas trans são cidadãos como qualquer outro.', 'Entrevista coletiva respondendo a ataques no Senado.', 'verified', false, '2025-07-02', 'https://agenciabrasil.ebc.com.br/saude/noticia/2025-07/padilha-rebate-magno-malta', 'other', 1, 'Brasília', 'Coletiva de imprensa', 'padilha-rebate-magno-b112-98') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;

  -- 99
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mar, 'Marina Silva alerta sobre impactos da crise climática na saúde pública.', 'Mudança climática é a maior crise sanitária do século. Arboviroses vão explodir.', 'Conferência em Belém sobre saúde e clima pré-COP30.', 'verified', false, '2025-10-20', 'https://www.gov.br/mma/pt-br/assuntos/noticias/2025/outubro/marina-silva-saude-clima-cop30', 'other', 1, 'Belém', 'Pré-COP30 saúde e clima', 'marina-saude-clima-b112-99') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;

  -- 100
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_pad, 'Padilha anuncia aprovação e compra da vacina nacional de dengue do Butantan.', 'A vacina brasileira de dengue é realidade. SUS terá dose nacional em 2026.', 'Anúncio em São Paulo após aprovação da Anvisa.', 'verified', true, '2025-12-03', 'https://butantan.gov.br/noticias/vacina-dengue-butantan-aprovada-anvisa', 'other', 1, 'São Paulo', 'Aprovação vacina Butantan', 'padilha-butantan-aprovada-b112-100') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;
