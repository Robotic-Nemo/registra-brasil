...
BEGIN
  ...
  -- 1
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_cas, 'Cláudio Castro comemora operação com 28 mortos no Jacarezinho como vitória contra o tráfico.', 'Hoje a polícia do Rio deu uma resposta dura ao crime. Foi uma operação contra bandidos, não contra inocentes.', 'Declaração do governador após megaoperação da Polícia Civil no Complexo do Jacarezinho.', 'verified', true, '2023-05-06', 'https://g1.globo.com/rj/rio-de-janeiro/noticia/2023/05/06/castro-defende-operacao-jacarezinho.ghtml', 'news_article', 4, 'Palácio Guanabara', 'Coletiva', 'castro-jacarezinho-b151-1') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_vio, true FROM ins;

  -- 2
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_tar, 'Tarcísio defende PM após chacina no Guarujá com 16 mortos na Operação Escudo.', 'A polícia tem respaldo total. Bandido bom é bandido preso ou morto quando reage.', 'Coletiva do governador após denúncias de execuções por PMs na Baixada Santista.', 'verified', true, '2023-08-05', 'https://www1.folha.uol.com.br/cotidiano/2023/08/tarcisio-defende-pm-operacao-escudo-guaruja.shtml', 'news_article', 5, 'São Paulo', 'Coletiva Operação Escudo', 'tarcisio-operacao-escudo-b151-2') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_vio, true FROM ins;

  -- 3
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_eri, 'Erika Hilton denuncia Operação Escudo como chacina orquestrada pelo governo de SP.', 'Isso não é segurança pública, é política de extermínio contra o povo preto e pobre.', 'Pronunciamento na Câmara após 28º morto da Operação Escudo no litoral paulista.', 'verified', true, '2023-08-10', 'https://www.camara.leg.br/noticias/erika-hilton-operacao-escudo-chacina', 'news_article', 1, 'Câmara dos Deputados', 'Pronunciamento', 'erika-escudo-chacina-b151-3') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;

  -- 4
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_lew, 'Lewandowski anuncia PEC da Segurança Pública como prioridade do governo Lula.', 'Precisamos de um novo pacto federativo de segurança. Nenhum estado vence o crime sozinho.', 'Primeira coletiva após assumir o Ministério da Justiça em substituição a Flávio Dino.', 'verified', true, '2024-02-01', 'https://www.gov.br/mj/pt-br/assuntos/noticias/lewandowski-pec-seguranca-publica', 'other', 1, 'MJSP', 'Posse e coletiva', 'lewandowski-pec-seguranca-b151-4') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 5
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_tar, 'Tarcísio critica PEC da Segurança e acusa Lula de centralizar poder dos estados.', 'Não aceitaremos intervenção federal disfarçada. Segurança é competência dos estados.', 'Reação pública após Lewandowski apresentar minuta da PEC aos governadores.', 'verified', true, '2024-04-03', 'https://www.poder360.com.br/governo/tarcisio-rejeita-pec-seguranca-lula/', 'news_article', 2, 'São Paulo', 'Entrevista', 'tarcisio-rejeita-pec-seguranca-b151-5') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 6
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_cai, 'Caiado defende endurecimento penal e ironiza direitos humanos após chacina em Goiânia.', 'Aqui em Goiás bandido não tem vez. Direitos humanos é para humanos direitos.', 'Coletiva após operação policial em Goiânia com 5 mortos em confronto.', 'verified', true, '2023-09-15', 'https://g1.globo.com/go/goias/noticia/2023/09/15/caiado-direitos-humanos-humanos-direitos.ghtml', 'news_article', 4, 'Palácio das Esmeraldas', 'Coletiva', 'caiado-humanos-direitos-b151-6') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_odi, true FROM ins;

  -- 7
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_wil, 'Wilson Lima pede reforço do Exército no Amazonas após ataques do Comando Vermelho.', 'O CV declarou guerra ao Estado. Precisamos de tropa federal imediatamente.', 'Solicitação oficial após ataques coordenados de facção em Manaus.', 'verified', true, '2023-11-18', 'https://g1.globo.com/am/amazonas/noticia/2023/11/18/wilson-lima-pede-exercito-cv-manaus.ghtml', 'news_article', 3, 'Manaus', 'Coletiva', 'wilson-lima-exercito-cv-b151-7') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 8
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_din, 'Flávio Dino cria Força Nacional permanente no Amazonas para combate a facções.', 'A União não vai se omitir. A Força Nacional fica no Amazonas pelo tempo necessário.', 'Anúncio feito após pedido de socorro do governador Wilson Lima.', 'verified', false, '2023-11-20', 'https://www.gov.br/mj/pt-br/assuntos/noticias/forca-nacional-amazonas-faccoes', 'other', 1, 'MJSP', 'Coletiva', 'dino-forca-nacional-am-b151-8') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 9
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_lyr, 'Raquel Lyra admite crise de segurança em Pernambuco após recorde de homicídios.', 'Herdamos um caos. Mas não fujo da responsabilidade; vamos reverter com inteligência.', 'Coletiva após Pernambuco liderar ranking de homicídios do Nordeste em 2023.', 'verified', false, '2024-01-22', 'https://g1.globo.com/pe/pernambuco/noticia/2024/01/22/raquel-lyra-seguranca-pe.ghtml', 'news_article', 1, 'Palácio do Campo das Princesas', 'Coletiva', 'raquel-lyra-crise-seguranca-b151-9') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;
