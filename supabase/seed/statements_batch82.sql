...
BEGIN
  ...
  -- 87
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mar, 'Margareth Menezes lança edital para Carnaval popular.', 'O edital Carnaval Nacional vai proteger o Carnaval de rua, raiz do povo, contra a concentração em eventos privados.', 'Lançamento do Edital Carnaval Nacional.', 'verified', false, '2024-10-28', 'https://oglobo.globo.com/cultura/noticia/2024/10/margareth-edital-carnaval-nacional.ghtml', 'news_article', 1, 'Salvador', 'Lançamento edital', 'margareth-edital-carnaval-b82-87') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 88
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_eri, 'Erika Hilton defende acesso de pessoas trans à universidade.', 'Pessoas trans estão chegando na universidade porque conquistamos espaço. Quem quer tirar cotas trans quer nos exterminar.', 'Entrevista no podcast de educação da Nova Escola.', 'verified', false, '2024-07-09', 'https://novaescola.org.br/conteudo/24200/erika-hilton-trans-universidade', 'news_article', 2, 'São Paulo', 'Podcast Nova Escola', 'erika-trans-universidade-b82-88') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 89
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_dam, 'Damares questiona existência de racismo "estrutural" em escolas.', 'Racismo estrutural é narrativa. Escola não é lugar de empurrar ideologia para criança.', 'Discurso no Senado contra BNCC atualizada.', 'verified', false, '2023-11-16', 'https://www1.folha.uol.com.br/poder/2023/11/damares-racismo-estrutural-escola.shtml', 'news_article', 4, 'Senado Federal', 'Discurso no plenário', 'damares-racismo-estrutural-escola-b82-89') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_rac, true FROM ins;

  -- 90
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_lul, 'Lula defende Pé-de-Meia e critica oposição.', 'Quem vota contra Pé-de-Meia é quem acha que filho de pobre não pode sonhar com universidade.', 'Cerimônia de entrega de cartões Pé-de-Meia em Recife.', 'verified', true, '2024-04-08', 'https://g1.globo.com/pe/pernambuco/noticia/2024/04/08/lula-pe-de-meia-oposicao.ghtml', 'news_article', 1, 'Recife', 'Cerimônia Pé-de-Meia', 'lula-pe-de-meia-oposicao-b82-90') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 91
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_kim, 'Kim Kataguiri critica reserva de vagas para indígenas em concursos.', 'Cota para indígena em concurso federal é populismo identitário. Mérito é o único critério justo.', 'Postagem em rede social após decreto sobre ampliação de cotas.', 'verified', false, '2023-11-09', 'https://oglobo.globo.com/politica/kim-cotas-indigenas-concurso-2023.ghtml', 'social_media_post', 3, 'São Paulo', 'Postagem em rede social', 'kim-cotas-indigenas-concurso-b82-91') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_rac, true FROM ins;
