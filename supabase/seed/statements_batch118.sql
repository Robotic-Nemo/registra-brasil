...
BEGIN
  ...
  -- 46
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jaq, 'Jaques Wagner defende modernização das Forças Armadas pela democracia.', 'Modernizar as Forças Armadas é compromisso do governo. Mas sempre dentro da Constituição.', 'Discurso em evento da Defesa sobre novos investimentos.', 'verified', false, '2023-06-20', 'https://www.defesanet.com.br/geopolitica/jaques-wagner-forcas-armadas-modernizacao/', 'news_article', 1, 'Senado Federal', 'Audiência pública', 'jaques-wagner-modernizacao-b118-46') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;
  ...
  -- 54
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_muc, 'Múcio critica pedido de intervenção militar como absurdo sem base constitucional.', 'Intervenção militar não existe no artigo 142. Isso é distorção grosseira da Constituição.', 'Entrevista ao Roda Viva sobre interpretação do artigo 142.', 'verified', true, '2023-05-15', 'https://tvcultura.com.br/roda-viva/mucio-artigo-142/', 'news_article', 1, 'TV Cultura', 'Entrevista ao Roda Viva', 'mucio-artigo-142-b118-54') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;
  ...
  -- 91
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jair, 'Bolsonaro ataca Rui Costa por supervisão da PF sobre militares.', 'Rui Costa usa a PF para perseguir militares. É lawfare descarado.', 'Entrevista à Gazeta do Povo sobre investigações contra aliados.', 'verified', false, '2024-08-10', 'https://www.gazetadopovo.com.br/republica/bolsonaro-rui-costa-pf-militares/', 'news_article', 4, 'Rio de Janeiro', 'Entrevista à imprensa', 'bolsonaro-rui-costa-pf-b118-91') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_int, true FROM ins;

  -- 92
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_rui, 'Rui Costa responde a Bolsonaro afirmando autonomia técnica da PF.', 'A PF atua com autonomia técnica. Quem cometeu crimes tem que responder, e militares não são exceção.', 'Entrevista em resposta a ataques de Bolsonaro.', 'verified', false, '2024-08-11', 'https://g1.globo.com/politica/noticia/2024/08/11/rui-costa-responde-bolsonaro-pf.ghtml', 'news_article', 1, 'Palácio do Planalto', 'Entrevista à imprensa', 'rui-costa-responde-bolsonaro-b118-92') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 93
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mvh, 'Van Hattem denuncia "Estado policial" em discurso inflamado.', 'O Brasil virou um Estado policial sob Lula e Lewandowski. Temos que resistir.', 'Discurso em ato pela anistia em São Paulo.', 'verified', true, '2024-08-25', 'https://www.metropoles.com/brasil/politica-br/van-hattem-estado-policial', 'news_article', 4, 'Paulista, São Paulo', 'Ato pela Anistia', 'van-hattem-estado-policial-b118-93') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ame, true FROM ins;

  -- 94
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_cgi, 'Cabo Gilberto convoca PMs a "desobedecer ordens ilegais" de Moraes.', 'Policiais militares não devem cumprir ordens ilegais do STF contra patriotas.', 'Postagem em redes sociais gerou investigação por incitação.', 'verified', true, '2024-06-12', 'https://www1.folha.uol.com.br/poder/2024/06/cabo-gilberto-desobedecer-moraes.shtml', 'social_media_post', 5, 'João Pessoa', 'Postagem em rede social', 'cabo-gilberto-desobedecer-b118-94') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_vio, true FROM ins;

  -- 95
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_muc, 'Múcio anuncia recompra do Mar da China para reforço da Marinha.', 'Fortaleceremos a Marinha com recompra estratégica de equipamentos chineses.', 'Anúncio de acordo bilateral com a China na área naval.', 'verified', false, '2025-01-20', 'https://www.defesanet.com.br/geopolitica/mucio-china-marinha-equipamentos/', 'news_article', 1, 'Ministério da Defesa', 'Assinatura de acordo', 'mucio-china-marinha-b118-95') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 96
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mes, 'Jorge Messias articula ação para cassar mandatos de bolsonaristas golpistas.', 'Parlamentares que apoiaram o golpe devem responder também no campo político.', 'Declaração sobre estratégia jurídica contra parlamentares envolvidos.', 'verified', false, '2024-12-20', 'https://oglobo.globo.com/politica/messias-mandatos-bolsonaristas/', 'news_article', 2, 'AGU', 'Coletiva de imprensa', 'messias-cassar-mandatos-b118-96') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 97
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_ors, 'Orlando Silva defende reforma da Doutrina Militar para adequar à democracia.', 'Precisamos reformar a doutrina militar para que nunca mais tenhamos golpes ou tentativas.', 'Discurso em evento sobre defesa democrática no Celso Furtado.', 'verified', false, '2024-09-18', 'https://g1.globo.com/politica/noticia/2024/09/18/orlando-silva-doutrina-militar.ghtml', 'news_article', 1, 'São Paulo', 'Evento Celso Furtado', 'orlando-silva-doutrina-b118-97') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 98
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_fib, 'Filipe Barros defende generais condenados como "heróis da pátria".', 'Braga Netto, Heleno e outros generais são heróis. A história os absolverá.', 'Discurso em plenário após condenações no STF.', 'verified', false, '2026-02-10', 'https://www.poder360.com.br/congresso/filipe-barros-generais-herois-stf/', 'news_article', 4, 'Câmara dos Deputados', 'Sessão plenária', 'filipe-barros-herois-b118-98') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ant, true FROM ins;

  -- 99
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mou, 'Mourão comenta reforma previdenciária militar com ressalvas.', 'Reforma de pensões militares precisa respeitar especificidades da carreira.', 'Entrevista ao Estadão sobre reforma administrativa.', 'verified', false, '2024-10-12', 'https://www.estadao.com.br/politica/mourao-reforma-pensoes-militares/', 'news_article', 2, 'Senado Federal', 'Entrevista à imprensa', 'mourao-pensoes-militares-b118-99') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_con, true FROM ins;

  -- 100
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_muc, 'Múcio celebra condenação da trama golpista como "vitória da democracia".', 'A condenação dos envolvidos na trama golpista é vitória da democracia brasileira.', 'Declaração após conclusão do julgamento no STF.', 'verified', true, '2026-03-05', 'https://www1.folha.uol.com.br/poder/2026/03/mucio-condenacao-trama-vitoria-democracia.shtml', 'news_article', 2, 'Ministério da Defesa', 'Coletiva de imprensa', 'mucio-vitoria-democracia-b118-100') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;
