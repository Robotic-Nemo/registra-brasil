...
BEGIN
  ...
  -- 1
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_fhc, 'FHC minimiza crise energética e apagão nacional.', 'Temos energia suficiente, não haverá apagão.', 'Declaração semanas antes da crise do apagão de 2001.', 'verified', true, '2001-04-20', 'https://www1.folha.uol.com.br/fsp/2001/4/21/brasil/1.html', 'news_article', 4, 'Brasília', 'Entrevista coletiva', 'fhc-nega-apagao-b117-1') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_neg, true FROM ins;

  -- 2
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_fhc, 'FHC culpa consumidores pelo racionamento de energia.', 'O povo brasileiro vai ter que fazer sua parte economizando energia.', 'Anúncio do racionamento em maio de 2001 responsabilizando consumidores.', 'verified', true, '2001-05-18', 'https://www1.folha.uol.com.br/fsp/2001/5/19/brasil/1.html', 'news_article', 3, 'Brasília', 'Pronunciamento em rede nacional sobre racionamento', 'fhc-povo-economizar-b117-2') RETURNING id)
  ...
  -- 49
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jai, 'Bolsonaro defende militarização completa do Rio de Janeiro.', 'O Rio só tem jeito com o Exército na rua permanentemente.', 'Proposta de intervenção federal militar no estado.', 'verified', false, '2000-10-28', 'https://www1.folha.uol.com.br/fsp/2000/10/29/cotidiano/3.html', 'news_article', 3, 'Rio de Janeiro', 'Entrevista', 'bolsonaro-rio-exercito-permanente-b117-49') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_aut, true FROM ins;
  ...
  -- 84
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mal, 'Maluf defende superfaturamento em obras como investimento.', 'Obras caras são investimento, não roubo.', 'Defesa de obras municipais investigadas por improbidade.', 'verified', false, '2000-09-22', 'https://acervo.folha.com.br/leitor.do?numero=14920', 'news_article', 4, 'São Paulo', 'Entrevista', 'maluf-superfaturamento-investimento-b117-84') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_cor, true FROM ins;

  -- 85
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jai, 'Bolsonaro defende extermínio do comunismo e esquerda no Brasil.', 'Comunismo no Brasil tem que ser extirpado na raiz.', 'Discurso em plenário contra movimentos de esquerda.', 'verified', true, '1999-11-10', 'https://www.camara.leg.br/internet/sitaqweb/', 'speech_transcript', 5, 'Câmara dos Deputados', 'Sessão plenária', 'bolsonaro-extirpar-comunismo-b117-85') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ant, true FROM ins;

  -- 86
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_fhc, 'FHC ironiza pobres em fala sobre superação.', 'Esqueçam esses pobres que vivem do bolsa-isso, bolsa-aquilo.', 'Declaração elitista em entrevista sobre políticas sociais.', 'verified', false, '2002-03-18', 'https://www1.folha.uol.com.br/fsp/2002/3/19/brasil/2.html', 'news_article', 3, 'Brasília', 'Entrevista', 'fhc-pobres-bolsa-isso-b117-86') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_odi, true FROM ins;

  -- 87
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jai, 'Bolsonaro defende que repórteres devem apanhar em confrontos.', 'Repórter que vai onde não deve, apanha mesmo.', 'Justificativa de violência contra jornalistas.', 'verified', false, '2002-04-12', 'https://istoe.com.br/bolsonaro-reporter-apanha/', 'news_article', 4, 'Rio de Janeiro', 'Entrevista', 'bolsonaro-reporter-apanha-b117-87') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_int, true FROM ins;

  -- 88
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_ser, 'Serra ataca Lula como incapaz de governar após debate.', 'Lula demonstrou que não tem preparo técnico.', 'Ataque pós-debate presidencial de 2002.', 'verified', false, '2002-10-14', 'https://www1.folha.uol.com.br/fsp/2002/10/15/brasil/1.html', 'news_article', 2, 'São Paulo', 'Entrevista pós-debate', 'serra-lula-preparo-b117-88') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 89
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jai, 'Bolsonaro apoia assassinato de lideranças comunistas do passado.', 'Os militares fizeram bem em matar comunistas.', 'Defesa de assassinatos cometidos durante ditadura militar.', 'verified', true, '2002-03-20', 'https://istoe.com.br/bolsonaro-matar-comunistas-ditadura/', 'news_article', 5, 'Câmara dos Deputados', 'Entrevista', 'bolsonaro-militares-matar-comunistas-b117-89') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ant, true FROM ins;

  -- 90
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_sar, 'Sarney articula saída de Roseana antes de escândalo financeiro.', 'Minha filha está acima de qualquer suspeita.', 'Defesa frente escândalo que tirou Roseana da corrida presidencial.', 'verified', true, '2002-03-05', 'https://www1.folha.uol.com.br/fsp/2002/3/6/brasil/1.html', 'news_article', 4, 'São Luís', 'Entrevista', 'sarney-roseana-suspeita-b117-90') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_cor, true FROM ins;

  -- 91
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_fhc, 'FHC nega envolvimento no escândalo da pasta rosa.', 'Nada tenho a ver com a pasta rosa.', 'Defesa sobre escândalo envolvendo PF e governo.', 'verified', true, '2002-04-10', 'https://www1.folha.uol.com.br/fsp/2002/4/11/brasil/2.html', 'news_article', 3, 'Brasília', 'Entrevista', 'fhc-pasta-rosa-b117-91') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_obs, true FROM ins;

  -- 92
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jai, 'Bolsonaro defende que Paulo Freire deveria ser banido das escolas.', 'Paulo Freire é veneno que contamina nossas crianças.', 'Ataque contra método pedagógico do educador.', 'verified', true, '2002-06-14', 'https://istoe.com.br/bolsonaro-paulo-freire-veneno/', 'speech_transcript', 4, 'Câmara dos Deputados', 'Sessão plenária', 'bolsonaro-paulo-freire-veneno-b117-92') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 93
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_lup, 'Lula ataca desigualdade social no governo FHC em comício.', 'FHC deixa um país mais desigual do que recebeu.', 'Ataque ao legado tucano durante campanha de 2002.', 'verified', false, '2002-09-25', 'https://www1.folha.uol.com.br/fsp/2002/9/26/brasil/1.html', 'speech_transcript', 1, 'Recife', 'Comício de campanha', 'lula-fhc-desigualdade-b117-93') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 94
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jai, 'Bolsonaro defende desbloqueio de armas para civis como solução de violência.', 'Cidadão desarmado é cidadão morto.', 'Defesa de liberação ampla de armas.', 'verified', false, '2000-05-25', 'https://www.camara.leg.br/internet/sitaqweb/', 'speech_transcript', 3, 'Câmara dos Deputados', 'Sessão plenária', 'bolsonaro-desarmado-morto-b117-94') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_vio, true FROM ins;

  -- 95
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_fhc, 'FHC lamenta derrota de Serra mas mantém crítica a Lula.', 'O país fez uma escolha arriscada.', 'Reação à vitória de Lula na eleição de 2002.', 'verified', true, '2002-10-28', 'https://www1.folha.uol.com.br/fsp/2002/10/29/brasil/1.html', 'news_article', 2, 'Brasília', 'Reação à eleição de 2002', 'fhc-escolha-arriscada-b117-95') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 96
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jai, 'Bolsonaro expressa apoio a Pinochet após sua morte.', 'Pinochet é herói do povo chileno.', 'Homenagem a ditador chileno após sua detenção.', 'verified', false, '1999-03-15', 'https://istoe.com.br/bolsonaro-pinochet-heroi/', 'news_article', 5, 'Rio de Janeiro', 'Entrevista', 'bolsonaro-pinochet-heroi-b117-96') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ant, true FROM ins;

  -- 97
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_lup, 'Lula promete respeito contratual em meio a fuga de capitais.', 'Vamos honrar todos os contratos do Brasil.', 'Declaração diante de nervosismo do mercado em 2002.', 'verified', false, '2002-07-30', 'https://www1.folha.uol.com.br/fsp/2002/7/31/brasil/1.html', 'news_article', 1, 'São Paulo', 'Entrevista', 'lula-honrar-contratos-b117-97') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 98
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jai, 'Bolsonaro defende fechamento de ONGs de direitos humanos.', 'ONGs de direitos humanos são quadrilhas de bandidos.', 'Ataque genérico a organizações da sociedade civil.', 'verified', true, '2001-02-28', 'https://www.camara.leg.br/internet/sitaqweb/', 'speech_transcript', 4, 'Câmara dos Deputados', 'Sessão plenária', 'bolsonaro-ongs-dh-quadrilhas-b117-98') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_int, true FROM ins;

  -- 99
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_col, 'Collor defende aliança com PC do B e outros partidos como atitude moderna.', 'Política se faz com alianças, inclusive com antigos adversários.', 'Articulação para volta à política em 2001.', 'verified', false, '2001-09-28', 'https://acervo.folha.com.br/leitor.do?numero=15180', 'news_article', 2, 'Brasília', 'Entrevista', 'collor-aliancas-modernidade-b117-99') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_con, true FROM ins;

  -- 100
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_lup, 'Lula toma posse como presidente em 2003 prometendo combate à fome.', 'Se ao final do meu mandato cada brasileiro puder fazer três refeições por dia, terei realizado a missão da minha vida.', 'Discurso de posse presidencial em 1º de janeiro de 2003.', 'verified', true, '2003-01-01', 'https://www1.folha.uol.com.br/fsp/2003/1/2/brasil/1.html', 'speech_transcript', 1, 'Brasília', 'Posse presidencial', 'lula-posse-tres-refeicoes-b117-100') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;
