...
BEGIN
  ...
  -- 22
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_zem, 'Zema minimiza impactos ambientais de mineração em terras indígenas em MG.', 'Mineração é o que sustenta MG, não dá para parar.', 'Evento empresarial.', 'verified', false, '2024-03-20', 'https://www.otempo.com.br/politica/zema-mineracao-indigena', 'news_article', 3, 'Belo Horizonte', 'Evento', 'zema-mineracao-indigena-b108-22') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_neg, true FROM ins;

  -- 23
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_lir, 'Lira articula derrubada do veto presidencial ao Marco Temporal.', 'Congresso vai derrubar o veto e acabou.', 'Entrevista na Câmara.', 'verified', true, '2023-12-14', 'https://www.folha.uol.com.br/poder/2023/12/lira-veto-marco-temporal.shtml', 'news_article', 5, 'Brasília', 'Câmara', 'lira-veto-marco-temporal-b108-23') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ame, true FROM ins;

  -- 24
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_fel, 'Marco Feliciano faz comentário considerado de intolerância religiosa sobre pajés.', 'Pajé não é religião, é coisa do diabo.', 'Culto em SP.', 'verified', true, '2023-05-10', 'https://www.folha.uol.com.br/cotidiano/2023/05/feliciano-pajes.shtml', 'news_article', 5, 'São Paulo', 'Culto', 'feliciano-pajes-b108-24') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_rel, true FROM ins;

  -- 25
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_ebol, 'Eduardo Bolsonaro ataca demarcação em terras tradicionais no MS.', 'Fazendeiros de MS estão sendo expulsos de suas propriedades.', 'Discurso na Câmara.', 'verified', true, '2023-06-22', 'https://www.camara.leg.br/noticias/eduardo-bolsonaro-ms', 'news_article', 4, 'Brasília', 'Plenário', 'eduardo-bolsonaro-ms-b108-25') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 26
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_bol, 'Bolsonaro nega emergência Yanomami e afirma que "é tudo exagero".', 'Yanomami é só uma narrativa para atacar meu governo.', 'Live semanal.', 'verified', true, '2023-01-28', 'https://www.poder360.com.br/governo/bolsonaro-yanomami-narrativa/', 'news_article', 5, 'Miami', 'Live', 'bolsonaro-yanomami-narrativa-b108-26') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_neg, true FROM ins;

  -- 27
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_sal, 'Salles acusa Marina Silva de "destruir" o agronegócio com proteção indígena.', 'Marina Silva é inimiga da produção brasileira.', 'Entrevista.', 'verified', true, '2024-02-12', 'https://www.estadao.com.br/politica/salles-marina-agro/', 'news_article', 3, 'São Paulo', 'Entrevista', 'salles-marina-agro-b108-27') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 28
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_dam, 'Damares tenta barrar CPI Yanomami no Senado.', 'CPI vai atrapalhar o trabalho do governo.', 'Coletiva no Senado.', 'verified', false, '2023-04-18', 'https://www.senado.leg.br/noticias/damares-cpi-yanomami', 'news_article', 3, 'Brasília', 'Senado', 'damares-cpi-yanomami-b108-28') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_obs, true FROM ins;

  -- 29
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mau, 'Mauro Mendes pressiona Funai para suspender demarcação em MT.', 'Funai tem que respeitar quem produz riqueza.', 'Entrevista em Cuiabá.', 'verified', true, '2023-10-25', 'https://g1.globo.com/mt/mato-grosso/noticia/2023/10/25/mauro-mendes-funai.ghtml', 'news_article', 4, 'Cuiabá', 'Entrevista', 'mauro-mendes-funai-b108-29') ON CONFLICT (slug) DO NOTHING RETURNING id)
  ...
  -- 31
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_nik, 'Nikolas ridiculariza ministra Guajajara em post nas redes.', 'Ministra de cocar dando aula de civilidade, que brincadeira.', 'Twitter.', 'verified', true, '2023-06-05', 'https://www.cartacapital.com.br/politica/nikolas-guajajara-cocar', 'news_article', 5, 'Belo Horizonte', 'Redes sociais', 'nikolas-guajajara-cocar-b108-31') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_rac, true FROM ins;
  ...
  -- 42
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_sal, 'Salles acusa Sonia Guajajara de "politizar" emergência Yanomami.', 'A ministra quer palco, não soluções.', 'Entrevista.', 'verified', true, '2023-02-28', 'https://www.estadao.com.br/politica/salles-guajajara/', 'news_article', 4, 'São Paulo', 'Entrevista', 'salles-guajajara-yanomami-b108-42') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 43
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_fel, 'Feliciano publica vídeo considerado de intolerância religiosa contra xamãs.', 'Xamanismo é coisa demoníaca, não podemos tolerar.', 'YouTube.', 'verified', true, '2023-07-15', 'https://www.folha.uol.com.br/poder/2023/07/feliciano-xamas.shtml', 'news_article', 5, 'São Paulo', 'YouTube', 'feliciano-xamas-b108-43') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_rel, true FROM ins;

  -- 44
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_dam, 'Damares vota pela derrubada do veto ao Marco Temporal.', 'Precisamos defender os produtores.', 'Plenário do Senado.', 'verified', true, '2023-12-14', 'https://www.senado.leg.br/noticias/damares-marco-temporal', 'news_article', 4, 'Brasília', 'Plenário Senado', 'damares-marco-temporal-b108-44') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ame, true FROM ins;

  -- 45
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_ebol, 'Eduardo Bolsonaro publica ataque racista contra representante Yanomami.', 'Esses caciques vivem em Brasília, não na floresta.', 'Redes sociais.', 'verified', true, '2023-03-10', 'https://www.cartacapital.com.br/politica/eduardo-bolsonaro-cacique', 'news_article', 5, 'Brasília', 'Redes sociais', 'eduardo-bolsonaro-cacique-b108-45') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_rac, true FROM ins;

  -- 46
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_lir, 'Lira aprova PL 490 (Marco Temporal) a despeito de protestos indígenas.', 'Congresso não se curva a pressão de ONG.', 'Plenário Câmara.', 'verified', true, '2023-05-30', 'https://www.camara.leg.br/noticias/lira-pl490', 'news_article', 5, 'Brasília', 'Plenário', 'lira-pl490-b108-46') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ame, true FROM ins;

  -- 47
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mot, 'Hugo Motta sinaliza apoio à bancada ruralista contra demarcações.', 'Precisamos conciliar, mas o agro é prioridade.', 'Entrevista como novo presidente da Câmara.', 'verified', true, '2025-02-05', 'https://www.folha.uol.com.br/poder/2025/02/motta-ruralistas.shtml', 'news_article', 3, 'Brasília', 'Câmara', 'motta-ruralistas-b108-47') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 48
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_nik, 'Nikolas faz piada contra ritual indígena em plenário da Câmara.', 'Cadê o pajé pra abençoar essa sessão?', 'Câmara.', 'verified', true, '2023-10-12', 'https://www.camara.leg.br/noticias/nikolas-paje', 'news_article', 4, 'Brasília', 'Plenário', 'nikolas-paje-b108-48') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_rel, true FROM ins;

  -- 49
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mau, 'Mauro Mendes faz aliança com ruralistas para barrar demarcação Xingu.', 'Não vai ter demarcação em MT sem negociação com o agro.', 'Evento rural.', 'verified', true, '2023-07-04', 'https://g1.globo.com/mt/mato-grosso/noticia/2023/07/04/mauro-mendes-xingu.ghtml', 'news_article', 4, 'Cuiabá', 'Evento', 'mauro-mendes-xingu-b108-49') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;

  -- 50
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_cai, 'Caiado usa dinheiro público para ação judicial contra demarcação.', 'O estado vai pra Justiça contra essa demarcação absurda.', 'Coletiva em Goiânia.', 'verified', false, '2023-12-02', 'https://www.opopular.com.br/politica/caiado-justica-demarcacao.html', 'news_article', 3, 'Goiânia', 'Coletiva', 'caiado-justica-demarcacao-b108-50') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;

  -- 51
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_eri2, 'Riedel defende invasores em conflito com Guarani-Kaiowá em MS.', 'São produtores, não invasores.', 'Entrevista.', 'verified', true, '2024-02-18', 'https://www.campograndenews.com.br/politica/riedel-guarani-kaiowa', 'news_article', 4, 'Campo Grande', 'Entrevista', 'riedel-guarani-kaiowa-b108-51') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_vio, true FROM ins;

  -- 52
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_bol, 'Bolsonaro retira fala de emergência humanitária Yanomami durante gestão.', 'Yanomami sempre viveu assim, não é emergência.', 'Entrevista em 2022.', 'verified', false, '2023-01-25', 'https://www.folha.uol.com.br/poder/2023/01/bolsonaro-yanomami-passado.shtml', 'news_article', 5, 'Brasília', 'Entrevista', 'bolsonaro-yanomami-passado-b108-52') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_neg, true FROM ins;

  -- 53
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_sal, 'Salles defende Marco Temporal em audiência pública na Câmara.', 'Produtor de boa-fé precisa de segurança.', 'Audiência Câmara.', 'verified', false, '2023-06-15', 'https://www.camara.leg.br/noticias/salles-marco-temporal', 'news_article', 3, 'Brasília', 'Audiência pública', 'salles-marco-temporal-audiencia-b108-53') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 54
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_ter, 'Tereza Cristina defende que povos indígenas devem "produzir como brasileiros".', 'Tem que parar de viver só da caça.', 'Evento agro.', 'verified', true, '2023-09-05', 'https://www.estadao.com.br/politica/tereza-indigenas-producao/', 'news_article', 4, 'Campo Grande', 'Evento', 'tereza-indigenas-producao-b108-54') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_rac, true FROM ins;
  ...
  -- 74
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_cai, 'Caiado defende "reforma agrária reversa" para tomar terras indígenas.', 'Tem muito índio com pouca gente.', 'Entrevista.', 'verified', true, '2024-05-05', 'https://www.opopular.com.br/politica/caiado-reforma-reversa.html', 'news_article', 5, 'Goiânia', 'Entrevista', 'caiado-reforma-reversa-b108-74') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_rac, true FROM ins;

  -- 75
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_eri2, 'Riedel apoia fazendeiros em ações violentas no MS.', 'Fazendeiro tem direito de defender sua terra.', 'Entrevista em Campo Grande.', 'verified', true, '2024-09-12', 'https://www.campograndenews.com.br/politica/riedel-fazendeiros-violencia', 'news_article', 5, 'Campo Grande', 'Entrevista', 'riedel-fazendeiros-violencia-b108-75') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_vio, true FROM ins;

  -- 76
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_gla, 'Gladson Cameli minimiza conflitos com indígenas no Acre.', 'Não tem conflito, tem só divergência.', 'Coletiva em Rio Branco.', 'verified', false, '2024-07-15', 'https://www.acrenews.com.br/gladson-indigena-divergencia', 'news_article', 2, 'Rio Branco', 'Coletiva', 'gladson-indigena-divergencia-b108-76') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 77
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_tar, 'Tarcísio nomeia secretário com passagem por empresas acusadas de invadir terras indígenas.', 'Técnico competente, sua história não é problema.', 'Coletiva.', 'verified', false, '2024-08-15', 'https://www.folha.uol.com.br/cotidiano/2024/08/tarcisio-secretario-indigena.shtml', 'news_article', 3, 'São Paulo', 'Coletiva', 'tarcisio-secretario-indigena-b108-77') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_con, true FROM ins;

  -- 78
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_bol, 'Bolsonaro diz em podcast que Yanomami "só tem desnutrição por preguiça".', 'Eles não trabalham, então não tem comida.', 'Podcast bolsonarista.', 'verified', true, '2024-04-02', 'https://www.cartacapital.com.br/politica/bolsonaro-yanomami-preguica', 'news_article', 5, 'Orlando', 'Podcast', 'bolsonaro-yanomami-preguica-b108-78') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_rac, true FROM ins;

  -- 79
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_hatt, 'Van Hattem ataca política para povos isolados da Funai.', 'Povos isolados é lenda indigenista.', 'Discurso na Câmara.', 'verified', false, '2024-03-05', 'https://www.camara.leg.br/noticias/hattem-isolados', 'news_article', 4, 'Brasília', 'Plenário', 'hattem-isolados-b108-79') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_neg, true FROM ins;
  ...
  -- 85
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mot, 'Motta aceita urgência para PL que fragiliza proteção indígena.', 'É pauta do agro, que é prioridade.', 'Plenário Câmara.', 'verified', true, '2025-03-12', 'https://www.jota.info/legislativo/motta-pl-indigena-urgencia', 'news_article', 4, 'Brasília', 'Plenário', 'motta-pl-urgencia-b108-85') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ame, true FROM ins;

  -- 86
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_nik, 'Nikolas ataca CPI Yanomami como "politicagem da esquerda".', 'CPI só serve para atacar o Bolsonaro.', 'Câmara.', 'verified', false, '2023-03-18', 'https://www.camara.leg.br/noticias/nikolas-cpi-yanomami', 'news_article', 3, 'Brasília', 'Plenário', 'nikolas-cpi-yanomami-b108-86') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_obs, true FROM ins;

  -- 87
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_cai, 'Caiado determina operação policial em terra indígena em Goiás.', 'Vamos retomar a paz, custe o que custar.', 'Coletiva.', 'verified', true, '2024-11-02', 'https://g1.globo.com/go/goias/noticia/2024/11/02/caiado-operacao-indigena.ghtml', 'news_article', 5, 'Goiânia', 'Coletiva', 'caiado-operacao-indigena-b108-87') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_vio, true FROM ins;

  -- 88
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mau, 'Mauro Mendes critica proteção ambiental de terras Xavante.', 'Xavante tem terra demais, produtor quer um pedaço só.', 'Evento em Cuiabá.', 'verified', true, '2024-10-05', 'https://g1.globo.com/mt/mato-grosso/noticia/2024/10/05/mauro-mendes-xavante.ghtml', 'news_article', 4, 'Cuiabá', 'Evento', 'mauro-mendes-xavante-b108-88') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_rac, true FROM ins;

  -- 89
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_ter, 'Tereza Cristina ataca Marina Silva por ações contra mineração em terras indígenas.', 'Marina só atrapalha o Brasil.', 'Entrevista.', 'verified', false, '2024-03-15', 'https://www.estadao.com.br/politica/tereza-marina-mineracao/', 'news_article', 3, 'Brasília', 'Entrevista', 'tereza-marina-mineracao-b108-89') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 90
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_sal, 'Salles nega emergência Yanomami como parlamentar em 2024.', 'A emergência Yanomami é inventada pela esquerda.', 'Câmara.', 'verified', true, '2024-05-18', 'https://www.camara.leg.br/noticias/salles-yanomami-esquerda', 'news_article', 5, 'Brasília', 'Plenário', 'salles-yanomami-esquerda-b108-90') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_neg, true FROM ins;
  ...
  -- 92
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_dam, 'Damares defende projeto de lei que limita reconhecimento indígena.', 'Tem que ter critério, senão qualquer um vira índio.', 'Senado.', 'verified', true, '2024-06-12', 'https://www.senado.leg.br/noticias/damares-reconhecimento-indigena', 'news_article', 4, 'Brasília', 'Senado', 'damares-reconhecimento-b108-92') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_rac, true FROM ins;

  -- 93
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_ebol, 'Eduardo Bolsonaro apoia garimpeiros expulsos da terra Yanomami.', 'Esses trabalhadores estão sendo perseguidos.', 'Câmara.', 'verified', true, '2023-06-02', 'https://www.camara.leg.br/noticias/eduardo-bolsonaro-garimpeiros', 'news_article', 4, 'Brasília', 'Plenário', 'eduardo-bolsonaro-garimpeiros-b108-93') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_vio, true FROM ins;

  -- 94
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_nik, 'Nikolas zomba do Dia dos Povos Indígenas.', 'Esse dia é bobagem, temos é que celebrar o Brasil.', 'Redes sociais.', 'verified', true, '2024-04-19', 'https://www.otempo.com.br/politica/nikolas-dia-povos-indigenas', 'news_article', 5, 'Belo Horizonte', 'Redes sociais', 'nikolas-dia-povos-b108-94') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_rac, true FROM ins;

  -- 95
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_fel, 'Feliciano ataca ministra Guajajara usando termos religiosos pejorativos.', 'Essa ministra serve a entidades das trevas.', 'Culto.', 'verified', true, '2024-10-28', 'https://www.cartacapital.com.br/politica/feliciano-guajajara-trevas', 'news_article', 5, 'Brasília', 'Culto', 'feliciano-guajajara-trevas-b108-95') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_rel, true FROM ins;

  -- 96
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_den, 'Denarium é denunciado por ligações com criminosos de garimpo.', 'A Justiça vai provar minha inocência.', 'Coletiva em Boa Vista.', 'verified', true, '2025-03-20', 'https://www.poder360.com.br/politica/denarium-denuncia-garimpo/', 'news_article', 5, 'Boa Vista', 'Coletiva', 'denarium-denuncia-garimpo-b108-96') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_cor, true FROM ins;

  -- 97
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_bol, 'Bolsonaro pede "anistia" para garimpeiros envolvidos na crise Yanomami.', 'Esses trabalhadores não podem ser tratados como criminosos.', 'Ato em Brasília.', 'verified', true, '2025-02-10', 'https://www.folha.uol.com.br/poder/2025/02/bolsonaro-anistia-garimpeiros.shtml', 'news_article', 5, 'Brasília', 'Ato', 'bolsonaro-anistia-garimpeiros-b108-97') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ant, true FROM ins;

  -- 98
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_lir, 'Lira aprova projeto que fragiliza demarcação Munduruku.', 'Vamos destravar obras do Pará.', 'Plenário.', 'verified', false, '2024-06-25', 'https://www.camara.leg.br/noticias/lira-munduruku-pl', 'news_article', 4, 'Brasília', 'Plenário', 'lira-munduruku-pl-b108-98') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ame, true FROM ins;

  -- 99
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_sal, 'Salles celebra sanção de PL que limita Funai.', 'Funai precisava ser controlada mesmo.', 'Entrevista.', 'verified', false, '2024-08-22', 'https://www.estadao.com.br/politica/salles-funai-limite/', 'news_article', 3, 'Brasília', 'Entrevista', 'salles-funai-limite-b108-99') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;

  -- 100
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_dam, 'Damares afirma que "indígenas são manipulados pela esquerda" em entrevista.', 'Esses índios são usados pelo PT.', 'Entrevista em 2025.', 'verified', true, '2025-04-10', 'https://www.cnnbrasil.com.br/politica/damares-indigenas-manipulados/', 'news_article', 5, 'Brasília', 'Entrevista', 'damares-indigenas-manipulados-b108-100') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_rac, true FROM ins;
