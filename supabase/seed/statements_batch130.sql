...
BEGIN
  ...
  -- 45
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_had, 'Haddad calcula que tarifa Trump custará 0,5% do PIB e prepara programa emergencial.', 'Vamos proteger empregos e exportadores afetados. O governo não deixará ninguém sozinho.', 'Entrevista coletiva no Ministério da Fazenda em Brasília.', 'verified', true, '2025-07-11', 'https://valor.globo.com/brasil/noticia/2025/07/11/haddad-pib-tarifa-trump-programa.ghtml', 'news_article', 2, 'Brasília', 'Ministério da Fazenda', 'haddad-pib-tarifa-programa-b130-45') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 46
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jai, 'Bolsonaro declara que tarifa de Trump é culpa exclusiva de Lula e do STF.', 'Trump está punindo o Brasil porque Lula e o STF ultrapassaram todos os limites.', 'Entrevista à Jovem Pan em Brasília após decreto de Trump.', 'verified', true, '2025-07-12', 'https://jovempan.com.br/noticias/politica/bolsonaro-tarifa-trump-lula-stf.html', 'news_article', 4, 'Brasília', 'Entrevista Jovem Pan', 'bolsonaro-tarifa-culpa-lula-stf-b130-46') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 47
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_edu, 'Eduardo Bolsonaro comemora tarifa Trump como vitória do lobby bolsonarista em Washington.', 'Nosso trabalho em Washington está dando frutos. Trump entendeu a gravidade da situação brasileira.', 'Postagem em rede social após anúncio da tarifa de 50%% por Trump.', 'verified', true, '2025-07-10', 'https://www1.folha.uol.com.br/mundo/2025/07/eduardo-comemora-tarifa-trump-lobby.shtml', 'social_media_post', 5, 'Washington, EUA', 'Postagem em rede social', 'eduardo-comemora-tarifa-lobby-b130-47') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ant, true FROM ins;

  -- 48
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_gle, 'Gleisi Hoffmann pede cassação de Eduardo Bolsonaro por traição ao país.', 'Eduardo Bolsonaro é traidor da pátria. Deve ser cassado por pedir sanções contra o Brasil.', 'Declaração em pronunciamento na Câmara após tarifa de Trump.', 'verified', true, '2025-07-14', 'https://g1.globo.com/politica/noticia/2025/07/14/gleisi-cassacao-eduardo-traicao.ghtml', 'news_article', 2, 'Brasília', 'Câmara dos Deputados', 'gleisi-cassacao-eduardo-b130-48') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ame, true FROM ins;

  -- 49
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_fav, 'Carlos Fávaro alerta que tarifa Trump pode custar 40 bilhões ao agro brasileiro.', 'O impacto no agro é gigantesco. Precisamos abrir mercados e pressionar via OMC.', 'Coletiva após reunião com Lula sobre impacto no agronegócio.', 'verified', false, '2025-07-15', 'https://valor.globo.com/agronegocios/noticia/2025/07/15/favaro-tarifa-trump-agro-40-bilhoes.ghtml', 'news_article', 2, 'Brasília', 'Ministério da Agricultura', 'favaro-tarifa-agro-40bi-b130-49') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 50
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_pad, 'Padilha afirma que tarifa Trump também prejudicará acesso a medicamentos.', 'A tarifa afeta até importação de insumos farmacêuticos. É irresponsabilidade global.', 'Entrevista em Brasília sobre impacto nos insumos de saúde.', 'verified', false, '2025-07-16', 'https://www.cnnbrasil.com.br/saude/padilha-tarifa-trump-medicamentos/', 'news_article', 2, 'Brasília', 'Ministério da Saúde', 'padilha-tarifa-medicamentos-b130-50') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;
  ...
  -- 62
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_amo, 'Moraes determina bloqueio de bens de Eduardo Bolsonaro no Brasil.', 'Determino o bloqueio de bens como medida cautelar no inquérito.', 'Decisão divulgada no STF em inquérito sobre coação contra ministros.', 'verified', true, '2025-08-06', 'https://www.jota.info/stf/moraes-bloqueio-bens-eduardo-bolsonaro/', 'news_article', 3, 'Brasília', 'Decisão STF', 'moraes-bloqueio-eduardo-b130-62') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ame, true FROM ins;

  -- 63
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_car, 'Carlos Bolsonaro chama Moraes de psicopata após bloqueio de bens do irmão.', 'Moraes é um psicopata. Vai pagar por cada injustiça.', 'Postagem no X após decisão de Moraes sobre Eduardo.', 'verified', false, '2025-08-07', 'https://www.metropoles.com/brasil/politica-br/carlos-moraes-psicopata-eduardo', 'social_media_post', 4, 'Rio de Janeiro', 'Postagem em rede social', 'carlos-moraes-psicopata-b130-63') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_odi, true FROM ins;

  -- 64
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_lul, 'Lula visita Caracas e critica agressividade de Trump contra Venezuela.', 'A América Latina precisa de diálogo. A escalada americana contra Caracas é irresponsável.', 'Declaração conjunta com Maduro em Caracas.', 'verified', true, '2025-08-12', 'https://www.afp.com/pt/noticias/lula-caracas-maduro-trump-venezuela', 'news_article', 3, 'Caracas, Venezuela', 'Visita oficial', 'lula-caracas-trump-venezuela-b130-64') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 65
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jai, 'Bolsonaro critica visita de Lula a Maduro e defende alinhamento com Trump.', 'Lula abraça ditador enquanto Trump tenta libertar o povo venezuelano.', 'Entrevista a jornalistas em Brasília após visita de Lula a Caracas.', 'verified', true, '2025-08-13', 'https://www.poder360.com.br/politica/bolsonaro-lula-maduro-trump/', 'news_article', 3, 'Brasília', 'Coletiva à imprensa', 'bolsonaro-lula-maduro-trump-b130-65') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 66
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mau, 'Mauro Vieira defende canal direto de diálogo para evitar escalada na Venezuela.', 'A escalada militar é inaceitável. Brasil trabalha por solução diplomática.', 'Declaração após reunião da CELAC em Brasília.', 'verified', false, '2025-08-15', 'https://www.reuters.com/world/americas/mauro-vieira-venezuela-trump-celac/', 'news_article', 2, 'Brasília', 'Reunião da CELAC', 'vieira-celac-venezuela-b130-66') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 67
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_edu, 'Eduardo Bolsonaro defende ação militar dos EUA contra Maduro.', 'Se Trump precisar intervir militarmente na Venezuela, o mundo conservador apoiará.', 'Aparição no Fox News em Washington.', 'verified', true, '2025-08-18', 'https://www.foxnews.com/world/eduardo-bolsonaro-venezuela-military-action-maduro', 'news_article', 5, 'Washington, EUA', 'Entrevista na Fox News', 'eduardo-venezuela-militar-b130-67') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_odi, true FROM ins;

  -- 68
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_bia, 'Bia Kicis diz que haitianos e venezuelanos são invasão teleguiada.', 'A migração é teleguiada pelo foro de São Paulo para desestabilizar nossas fronteiras.', 'Fala em comissão parlamentar em Brasília.', 'verified', false, '2025-08-20', 'https://www.metropoles.com/brasil/politica-br/bia-kicis-migracao-invasao', 'news_article', 4, 'Brasília', 'Comissão de Direitos Humanos', 'bia-kicis-migracao-invasao-b130-68') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_xen, true FROM ins;

  -- 69
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_nik, 'Nikolas Ferreira defende deportação em massa nos moldes Trump.', 'Temos que deportar em massa como Trump faz nos EUA. Chega de bondade com invasores.', 'Live em rede social de Brasília após operação contra imigrantes no Acre.', 'verified', true, '2025-08-22', 'https://www.cnnbrasil.com.br/politica/nikolas-deportacao-massa-trump/', 'social_media_post', 4, 'Brasília', 'Live em rede social', 'nikolas-deportacao-massa-b130-69') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_xen, true FROM ins;

  -- 70
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_lew, 'Ricardo Lewandowski defende acolhimento humanitário e critica retórica xenófoba.', 'O Brasil acolhe quem busca refúgio. A xenofobia é incompatível com nossa tradição.', 'Declaração em evento sobre migração em Brasília.', 'verified', false, '2025-08-23', 'https://www1.folha.uol.com.br/cotidiano/2025/08/lewandowski-migracao-xenofobia.shtml', 'news_article', 1, 'Brasília', 'Ministério da Justiça', 'lewandowski-migracao-xenofobia-b130-70') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;
