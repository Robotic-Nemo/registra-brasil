...
BEGIN
  ...
  -- 2
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mic, 'Michelle Bolsonaro é investigada por receber Pix de advogado em esquema de joias.', 'Recebi empréstimo de pessoa idônea. Não tem nada de errado.', 'Investigação da PF em 2023.', 'verified', true, '2023-09-05', 'https://www1.folha.uol.com.br/poder/2023/09/michelle-pix-joias.shtml', 'news_article', 4, 'Brasília', 'Operação da PF', 'michelle-pix-joias-b160-2') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_cor, true FROM ins;

  -- 3
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_ram, 'Alexandre Ramagem é indiciado pela PF por uso ilegal da Abin.', 'Tudo feito dentro da lei. Não houve nenhuma ilegalidade.', 'Indiciamento no caso Abin paralela em 2024.', 'verified', true, '2024-01-25', 'https://g1.globo.com/politica/noticia/2024/01/25/ramagem-indiciado-abin-paralela.ghtml', 'news_article', 5, 'Brasília', 'PF', 'ramagem-abin-paralela-b160-3') RETURNING id)
  ...
  -- 8
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jair, 'PF indicia Bolsonaro por fraude em cartões de vacina da Covid-19.', 'Nunca adulterei cartão de vacina. Tudo é invenção.', 'Indiciamento em 2024.', 'verified', true, '2024-03-19', 'https://g1.globo.com/politica/noticia/2024/03/19/pf-indicia-bolsonaro-cartao-vacina.ghtml', 'news_article', 5, 'Brasília', 'PF', 'pf-indicia-bolsonaro-cartao-vacina-b160-8') RETURNING id)
  ...
  -- 9
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_lul, 'Lula defende independência da PF e do MPF.', 'A Polícia Federal e o Ministério Público têm autonomia. Eu respeito isso.', 'Entrevista em 2024.', 'verified', false, '2024-02-10', 'https://www.gov.br/planalto/pt-br/2024/02/lula-pf-mpf-independencia', 'speech', 1, 'Brasília', 'Entrevista', 'lula-pf-mpf-independencia-b160-9') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_cor, true FROM ins;

  -- 10
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_din, 'Flávio Dino assina decreto reforçando estrutura da PF como ministro.', 'A PF precisa de condições para investigar sem interferência.', 'Anúncio como ministro da Justiça em 2023.', 'verified', false, '2023-03-22', 'https://www.gov.br/justica/pt-br/2023/03/dino-decreto-pf', 'other', 1, 'Brasília', 'Ministério da Justiça', 'dino-decreto-pf-b160-10') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_cor, true FROM ins;

  -- 11
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jair, 'Bolsonaro é indiciado pela PF por golpe de Estado.', 'Nunca houve golpe. É tudo narrativa da imprensa.', 'Indiciamento em 2024.', 'verified', true, '2024-11-21', 'https://g1.globo.com/politica/noticia/2024/11/21/pf-indicia-bolsonaro-golpe.ghtml', 'news_article', 5, 'Brasília', 'PF', 'pf-indicia-bolsonaro-golpe-b160-11') RETURNING id)
  ...
  -- 12
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mor, 'Sergio Moro defende punição aos envolvidos em tentativa de golpe.', 'Quem tentou dar golpe tem que ir para a cadeia. Não há dois pesos.', 'Declaração no Senado em 2024.', 'verified', false, '2024-11-22', 'https://www12.senado.leg.br/noticias/materias/2024/11/22/moro-puniicao-golpe', 'speech', 2, 'Brasília', 'Senado Federal', 'moro-punicao-golpe-b160-12') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_cor, true FROM ins;

  -- 13
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_amo, 'Alexandre de Moraes autoriza busca e apreensão em operação sobre Abin paralela.', 'Há indícios robustos do uso do aparato estatal para fins ilegais.', 'Decisão no STF em 2024.', 'verified', true, '2024-01-25', 'https://www.stf.jus.br/noticias/1060-moraes-abin-paralela', 'speech', 3, 'Brasília', 'STF', 'moraes-abin-paralela-busca-b160-13') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_cor, true FROM ins;

  -- 14
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_dsi, 'Daniel Silveira é preso em operação da PF após descumprir medidas.', 'Nunca vou me calar. Perseguem um patriota.', 'Prisão em 2023.', 'verified', true, '2023-02-20', 'https://g1.globo.com/politica/noticia/2023/02/20/daniel-silveira-preso-pf.ghtml', 'news_article', 5, 'Rio de Janeiro', 'PF', 'daniel-silveira-preso-pf-b160-14') RETURNING id)
  ...
  -- 39
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_gle, 'Gleisi Hoffmann celebra denúncia da PGR contra Bolsonaro.', 'A Justiça funcionou. Ninguém está acima da lei.', 'Entrevista em 2025.', 'verified', false, '2025-02-18', 'https://g1.globo.com/politica/noticia/2025/02/18/gleisi-denuncia-pgr-bolsonaro.ghtml', 'speech', 1, 'Brasília', 'PT', 'gleisi-denuncia-pgr-bolsonaro-b160-39') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_cor, true FROM ins;

  -- 40
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jair, 'Bolsonaro é denunciado pela PGR por tentativa de golpe de Estado.', 'Isso é farsa. Não vou fugir de nada.', 'Denúncia em 2025.', 'verified', true, '2025-02-18', 'https://g1.globo.com/politica/noticia/2025/02/18/pgr-denuncia-bolsonaro-golpe.ghtml', 'news_article', 5, 'Brasília', 'PGR', 'pgr-denuncia-bolsonaro-golpe-b160-40') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_aut, true FROM ins UNION ALL SELECT id, c_cor, false FROM ins;

  -- 41
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_frx, 'Marcelo Freixo defende que corrupção deve ser combatida sem viés.', 'Corrupção é corrupção. Não pode ter dois pesos e duas medidas.', 'Entrevista em 2024.', 'verified', false, '2024-06-10', 'https://www1.folha.uol.com.br/poder/2024/06/freixo-corrupcao-sem-vies.shtml', 'speech', 1, 'Rio de Janeiro', 'Entrevista', 'freixo-corrupcao-sem-vies-b160-41') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_cor, true FROM ins;

  -- 42
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_bar, 'Filipe Barros organiza ato contra operações da PF em Brasília.', 'Vamos às ruas contra a perseguição política.', 'Convocação em 2024.', 'verified', false, '2024-03-12', 'https://www.camara.leg.br/noticias/1020-barros-ato-pf', 'social_media_post', 4, 'Brasília', 'Câmara dos Deputados', 'barros-ato-contra-pf-b160-42') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_int, true FROM ins UNION ALL SELECT id, c_des, false FROM ins;

  -- 43
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_had, 'Haddad apoia investigações sobre fraudes no INSS.', 'Vamos cooperar com a PF. Quem fraudou vai ser punido.', 'Declaração em 2025.', 'verified', false, '2025-04-24', 'https://www.gov.br/fazenda/pt-br/2025/04/haddad-inss-fraude', 'other', 2, 'Brasília', 'Ministério da Fazenda', 'haddad-inss-fraude-b160-43') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_cor, true FROM ins;

  -- 44
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_orl, 'Orlando Silva denuncia influência de bets em parlamentares.', 'Parlamentares recebendo recursos de bets é gravíssimo. Precisa apurar.', 'Discurso em 2024.', 'verified', false, '2024-09-15', 'https://www.camara.leg.br/noticias/1045-orlando-bets-parlamentares', 'speech', 2, 'Brasília', 'Câmara dos Deputados', 'orlando-bets-parlamentares-b160-44') RETURNING id)
  ...
  -- 61
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_amo, 'Moraes determina prisão preventiva de coronel envolvido em trama golpista.', 'Há risco à ordem pública. A prisão preventiva é necessária.', 'Decisão em 2024.', 'verified', true, '2024-11-25', 'https://www.stf.jus.br/noticias/1080-moraes-prisao-coronel-golpe', 'speech', 3, 'Brasília', 'STF', 'moraes-prisao-coronel-golpe-b160-61') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_cor, true FROM ins;

  -- 62
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_via, 'Carlos Viana ataca "ativismo" do MPF.', 'O MPF foi capturado por agenda de esquerda.', 'Discurso no Senado em 2024.', 'verified', false, '2024-08-05', 'https://www12.senado.leg.br/noticias/materias/2024/08/05/viana-mpf-ativismo', 'speech', 3, 'Brasília', 'Senado Federal', 'viana-mpf-ativismo-b160-62') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 63
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mar, 'Rogério Marinho defende servidores da Caixa investigados por fraude.', 'Servidores não podem ser perseguidos. Vamos defender.', 'Discurso em 2024.', 'verified', false, '2024-06-15', 'https://www12.senado.leg.br/noticias/materias/2024/06/15/marinho-servidores-caixa', 'speech', 3, 'Brasília', 'Senado Federal', 'marinho-servidores-caixa-b160-63') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_obs, true FROM ins;

  -- 64
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_gui, 'Guiga Peixoto vota contra punição à Zambelli.', 'Não vou ajudar a punir colega. Solidariedade partidária.', 'Voto em conselho de ética em 2024.', 'verified', false, '2024-04-25', 'https://www.camara.leg.br/noticias/1025-guiga-voto-zambelli', 'news_article', 3, 'Brasília', 'Conselho de Ética', 'guiga-voto-zambelli-b160-64') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_obs, true FROM ins;

  -- 65
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_hil, 'Erika Hilton pede prisão preventiva de envolvidos em trama golpista.', 'Não há democracia com golpistas soltos. Tem que prender.', 'Discurso em 2024.', 'verified', false, '2024-11-28', 'https://www.camara.leg.br/noticias/1055-hilton-prisao-golpistas', 'speech', 2, 'Brasília', 'Câmara dos Deputados', 'hilton-prisao-golpistas-b160-65') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_cor, true FROM ins;

  -- 66
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jair, 'Bolsonaro é réu no STF por trama golpista.', 'Esse julgamento é farsa. Brasil está entregue.', 'Decisão do STF em 2025.', 'verified', true, '2025-03-26', 'https://g1.globo.com/politica/noticia/2025/03/26/bolsonaro-reu-stf-golpe.ghtml', 'news_article', 5, 'Brasília', 'STF', 'bolsonaro-reu-stf-golpe-b160-66') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_aut, true FROM ins UNION ALL SELECT id, c_cor, false FROM ins;

  -- 67
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_bom, 'Sâmia Bomfim denuncia esquemas em emendas parlamentares.', 'Emenda Pix virou esquema de caixa 2. Precisa investigar.', 'Discurso em 2024.', 'verified', false, '2024-10-08', 'https://www.camara.leg.br/noticias/1050-samia-emendas-pix-caixa2', 'speech', 2, 'Brasília', 'Câmara dos Deputados', 'samia-emendas-pix-caixa2-b160-67') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_cor, true FROM ins;

  -- 68
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_chi, 'Chico Alencar fala em "Brasil mais transparente" após operações.', 'Que bom que as instituições estão funcionando. Isso é democracia.', 'Entrevista em 2024.', 'verified', false, '2024-02-12', 'https://www.camara.leg.br/noticias/1018-chico-alencar-transparencia', 'speech', 1, 'Rio de Janeiro', 'Entrevista', 'chico-alencar-transparencia-b160-68') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_cor, true FROM ins;

  -- 69
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_lew, 'Lewandowski anuncia reforço a Força-Tarefa contra facções.', 'O crime organizado é inimigo do Brasil. Nosso combate será implacável.', 'Anúncio em 2024.', 'verified', false, '2024-08-18', 'https://www.gov.br/justica/pt-br/2024/08/lewandowski-forca-tarefa-faccoes', 'other', 1, 'Brasília', 'Ministério da Justiça', 'lewandowski-forca-tarefa-faccoes-b160-69') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_cor, true FROM ins;

  -- 70
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jair, 'Bolsonaro pede asilo na embaixada da Hungria em meio à investigação.', 'Fui convidado pelo embaixador. Não tem asilo nenhum.', 'Revelação em 2024.', 'verified', true, '2024-03-25', 'https://g1.globo.com/politica/noticia/2024/03/25/bolsonaro-asilo-hungria.ghtml', 'news_article', 5, 'Brasília', 'Embaixada da Hungria', 'bolsonaro-asilo-hungria-b160-70') RETURNING id)
  ...
  -- 71
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_edu, 'Eduardo Bolsonaro articula no Congresso dos EUA contra operações no Brasil.', 'Vamos pedir sanções contra Moraes. Ele persegue brasileiros.', 'Visita a Washington em 2024.', 'verified', true, '2024-11-05', 'https://www1.folha.uol.com.br/poder/2024/11/eduardo-eua-sancoes-moraes.shtml', 'news_article', 4, 'Washington', 'Congresso dos EUA', 'eduardo-eua-sancoes-moraes-b160-71') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_obs, true FROM ins UNION ALL SELECT id, c_int, false FROM ins;
  ...
  -- 73
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_gle, 'Gleisi critica anistia e compara a "passar pano para golpistas".', 'Anistia é passar pano. Golpista tem que responder.', 'Declaração em 2024.', 'verified', false, '2024-09-20', 'https://g1.globo.com/politica/noticia/2024/09/20/gleisi-anistia-passar-pano.ghtml', 'speech', 2, 'Brasília', 'PT', 'gleisi-anistia-passar-pano-b160-73') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_cor, true FROM ins;

  -- 74
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_sil, 'Silas Câmara bloqueia CPI sobre emendas do Centrão.', 'CPI não é a forma adequada. Vamos barrar.', 'Movimento na Câmara em 2024.', 'verified', false, '2024-10-22', 'https://www.camara.leg.br/noticias/1052-silas-camara-bloqueia-cpi-emendas', 'news_article', 4, 'Brasília', 'Câmara dos Deputados', 'silas-camara-bloqueia-cpi-emendas-b160-74') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_obs, true FROM ins UNION ALL SELECT id, c_cor, false FROM ins;

  -- 75
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_dam, 'Damares é multada pelo TCU por ações da pasta de Direitos Humanos.', 'Vou recorrer. Todas as minhas ações foram legais.', 'Decisão do TCU em 2024.', 'verified', false, '2024-07-25', 'https://www1.folha.uol.com.br/poder/2024/07/damares-multada-tcu.shtml', 'news_article', 4, 'Brasília', 'TCU', 'damares-multada-tcu-b160-75') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins UNION ALL SELECT id, c_cor, false FROM ins;

  -- 76
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_ran, 'Randolfe defende ampla apuração de emendas Pix.', 'Sem transparência, o orçamento vira bagunça. Tem que apurar.', 'Declaração em 2024.', 'verified', false, '2024-10-10', 'https://www12.senado.leg.br/noticias/materias/2024/10/10/randolfe-emendas-pix', 'speech', 1, 'Brasília', 'Senado Federal', 'randolfe-emendas-pix-b160-76') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_cor, true FROM ins;

  -- 77
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_dsi, 'Daniel Silveira grava vídeo em presídio atacando a PF.', 'A PF virou instrumento de tortura. Querem me calar.', 'Vídeo em 2024.', 'verified', false, '2024-05-02', 'https://noticias.uol.com.br/politica/ultimas-noticias/2024/05/02/silveira-video-presidio-pf.htm', 'social_media_post', 4, 'Bangu', 'Presídio', 'silveira-video-presidio-pf-b160-77') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_int, true FROM ins UNION ALL SELECT id, c_des, false FROM ins;

  -- 78
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_nik, 'Nikolas Ferreira publica vídeo atacando PGR.', 'A PGR é braço do PT. Está tudo aparelhado.', 'Publicação em rede social em 2024.', 'verified', true, '2024-12-02', 'https://g1.globo.com/politica/noticia/2024/12/02/nikolas-ataque-pgr.ghtml', 'social_media_post', 4, 'Belo Horizonte', 'Rede social', 'nikolas-ataque-pgr-b160-78') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_int, true FROM ins UNION ALL SELECT id, c_des, false FROM ins;
  ...
  -- 84
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_fel, 'Feliciano é alvo de inquérito por uso indevido de verba de gabinete.', 'Tudo usado para o mandato. Não há nada demais.', 'Inquérito em 2024.', 'verified', false, '2024-08-10', 'https://www1.folha.uol.com.br/poder/2024/08/feliciano-verba-gabinete.shtml', 'news_article', 4, 'Brasília', 'PF', 'feliciano-verba-gabinete-b160-84') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_cor, true FROM ins;

  -- 85
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_zam, 'Zambelli é condenada em novo processo sobre falsidade ideológica.', 'Tudo fabricação. Sou vítima de perseguição global.', 'Condenação em 2025.', 'verified', true, '2025-07-08', 'https://g1.globo.com/politica/noticia/2025/07/08/zambelli-falsidade-condenacao.ghtml', 'news_article', 4, 'Brasília', 'STF', 'zambelli-falsidade-condenacao-b160-85') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_cor, true FROM ins;

  -- 86
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jair, 'Bolsonaro é condenado pelo STF a 27 anos por golpe de Estado.', 'Sou preso político. O mundo está vendo.', 'Condenação em 2025.', 'verified', true, '2025-11-28', 'https://g1.globo.com/politica/noticia/2025/11/28/stf-condena-bolsonaro-golpe.ghtml', 'news_article', 5, 'Brasília', 'STF', 'stf-condena-bolsonaro-golpe-b160-86') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_aut, true FROM ins UNION ALL SELECT id, c_cor, false FROM ins;

  -- 87
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_lul, 'Lula comenta condenação de Bolsonaro: "Justiça funciona".', 'Todos são iguais perante a lei. Quem comete crime responde.', 'Declaração em 2025.', 'verified', true, '2025-11-29', 'https://www.gov.br/planalto/pt-br/2025/11/lula-condenacao-bolsonaro', 'speech', 2, 'Brasília', 'Palácio do Planalto', 'lula-condenacao-bolsonaro-b160-87') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_cor, true FROM ins;

  -- 88
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_ram, 'Ramagem foge do Brasil antes de execução de pena.', 'Estou exercendo direito de defesa.', 'Saída do Brasil em 2025.', 'verified', true, '2025-09-10', 'https://g1.globo.com/politica/noticia/2025/09/10/ramagem-foge-brasil.ghtml', 'news_article', 5, 'Miami', 'Foragido', 'ramagem-foge-brasil-b160-88') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_obs, true FROM ins UNION ALL SELECT id, c_cor, false FROM ins;

  -- 89
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_van, 'Van Hattem defende imunidade parlamentar de Ramagem.', 'A imunidade tem que ser respeitada. É direito constitucional.', 'Discurso em 2025.', 'verified', false, '2025-09-12', 'https://www.camara.leg.br/noticias/1080-vanhattem-imunidade-ramagem', 'speech', 3, 'Brasília', 'Câmara dos Deputados', 'vanhattem-imunidade-ramagem-b160-89') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_obs, true FROM ins;

  -- 90
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mor, 'Sergio Moro critica "anistia" para aliados de Bolsonaro.', 'Não dá para anistiar. A Justiça tem que prevalecer.', 'Entrevista em 2025.', 'verified', false, '2025-05-22', 'https://www12.senado.leg.br/noticias/materias/2025/05/22/moro-anistia-aliados', 'speech', 2, 'Brasília', 'Senado Federal', 'moro-anistia-aliados-b160-90') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_cor, true FROM ins;

  -- 91
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_gme, 'Gilmar Mendes vota a favor da condenação de Bolsonaro.', 'As provas são robustas. A condenação é necessária.', 'Voto no STF em 2025.', 'verified', true, '2025-11-28', 'https://www.stf.jus.br/noticias/1090-gilmar-voto-bolsonaro', 'speech', 3, 'Brasília', 'STF', 'gilmar-voto-bolsonaro-b160-91') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_cor, true FROM ins;

  -- 92
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_had, 'Haddad celebra operação contra sonegadores gigantes.', 'Quem sonega, rouba da saúde e da educação. Vamos atrás.', 'Operação em 2025.', 'verified', false, '2025-03-20', 'https://www.gov.br/fazenda/pt-br/2025/03/haddad-operacao-sonegadores', 'other', 2, 'Brasília', 'Ministério da Fazenda', 'haddad-operacao-sonegadores-b160-92') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_cor, true FROM ins;

  -- 93
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_car, 'Carlos Bolsonaro é citado em delação de ex-assessor.', 'Delação de traidor. Não tem valor.', 'Delação em 2025.', 'verified', false, '2025-06-15', 'https://www1.folha.uol.com.br/poder/2025/06/carlos-bolsonaro-delacao.shtml', 'news_article', 4, 'Rio de Janeiro', 'MPF', 'carlos-bolsonaro-delacao-b160-93') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_cor, true FROM ins;

  -- 94
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_fla, 'Flávio Bolsonaro é condenado por peculato no caso rachadinhas.', 'Vou recorrer. Sou inocente.', 'Condenação em 2025.', 'verified', true, '2025-08-22', 'https://g1.globo.com/rj/rio-de-janeiro/noticia/2025/08/22/flavio-bolsonaro-condenado-rachadinha.ghtml', 'news_article', 5, 'Rio de Janeiro', 'Justiça do RJ', 'flavio-bolsonaro-condenado-rachadinha-b160-94') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_cor, true FROM ins UNION ALL SELECT id, c_abu, false FROM ins;

  -- 95
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mag, 'Magno Malta é citado em nova operação sobre ONG evangélica.', 'Continuamos sendo perseguidos por sermos cristãos.', 'Operação em 2025.', 'verified', false, '2025-07-05', 'https://g1.globo.com/es/espirito-santo/noticia/2025/07/05/magno-malta-ong-operacao.ghtml', 'news_article', 4, 'Vitória', 'PF', 'magno-malta-ong-operacao-b160-95') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_cor, true FROM ins;

  -- 96
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_din, 'Flávio Dino, como ministro do STF, vota por manter denúncia contra Bolsonaro.', 'As provas são suficientes. A denúncia deve ser recebida.', 'Voto no STF em 2025.', 'verified', false, '2025-03-26', 'https://www.stf.jus.br/noticias/1085-dino-voto-bolsonaro', 'speech', 3, 'Brasília', 'STF', 'dino-voto-denuncia-bolsonaro-b160-96') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_cor, true FROM ins;

  -- 97
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jan, 'Jandira Feghali celebra condenação por golpe.', 'A democracia venceu. Lula, STF e PF salvaram o Brasil.', 'Declaração em 2025.', 'verified', false, '2025-11-29', 'https://www.camara.leg.br/noticias/1090-jandira-condenacao-golpe', 'speech', 2, 'Brasília', 'Câmara dos Deputados', 'jandira-condenacao-golpe-b160-97') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_cor, true FROM ins;

  -- 98
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_adr, 'Adriana Ventura pede investigação de fraudes eleitorais no TSE.', 'Não sou bolsonarista, mas precisamos investigar tudo. Sempre.', 'Discurso em 2025.', 'verified', false, '2025-04-02', 'https://www.camara.leg.br/noticias/1075-adriana-fraudes-eleitorais', 'speech', 2, 'Brasília', 'Câmara dos Deputados', 'adriana-fraudes-eleitorais-b160-98') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_cor, true FROM ins;

  -- 99
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_amo, 'Moraes determina início da execução da pena de Bolsonaro.', 'A decisão transitou em julgado. Não há recurso com efeito suspensivo.', 'Decisão em 2026.', 'verified', true, '2026-02-15', 'https://www.stf.jus.br/noticias/1095-moraes-execucao-bolsonaro', 'speech', 4, 'Brasília', 'STF', 'moraes-execucao-bolsonaro-b160-99') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_cor, true FROM ins;

  -- 100
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_lew, 'Lewandowski anuncia balanço: operações da PF quebraram recorde em 2025.', 'O Brasil fez história no combate à corrupção. Vamos continuar.', 'Balanço anual em 2026.', 'verified', true, '2026-01-15', 'https://www.gov.br/justica/pt-br/2026/01/lewandowski-balanco-pf-2025', 'other', 2, 'Brasília', 'Ministério da Justiça', 'lewandowski-balanco-pf-2025-b160-100') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_cor, true FROM ins;
