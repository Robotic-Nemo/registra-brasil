...
BEGIN
  ...
  -- 27
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_temer, 'Temer participa de articulações paralelas com oposição em 2014.', 'São conversas naturais entre parlamentares.', 'Revelação de encontros de Temer com opositores em 2014 que gerou desconfiança da base petista.', 'verified', false, '2014-12-02', 'https://www1.folha.uol.com.br/poder/2014/12/1561112-temer-articula-oposicao.shtml', 'news_article', 3, 'Brasília', 'Reuniões paralelas', 'temer-articula-oposicao-b95-27') RETURNING id)
  ...
  -- 79
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_dilma, 'Dilma inicia "nova matriz econômica" com desoneração setorial.', 'A desoneração vai salvar empregos na indústria.', 'Anúncio de desonerações fiscais da folha salarial em 2012 como parte de nova agenda.', 'verified', false, '2012-08-03', 'https://www.valor.com.br/politica/dilma-nova-matriz-economica-2821122', 'news_article', 1, 'Palácio do Planalto', 'Cerimônia econômica', 'dilma-nova-matriz-desoneracao-b95-79') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 80
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_aecio, 'Aécio acusa Dilma de "estelionato eleitoral" pós-eleição.', 'A presidenta cometeu estelionato eleitoral. Mentiu para o povo.', 'Ataque de Aécio a Dilma após anúncio de ajuste fiscal duro pós-eleição 2014.', 'verified', true, '2014-12-18', 'https://oglobo.globo.com/politica/aecio-estelionato-eleitoral-15127312', 'news_article', 3, 'Brasília', 'Entrevista O Globo', 'aecio-estelionato-eleitoral-b95-80') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_odi, true FROM ins;

  -- 81
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jair, 'Bolsonaro diz que Dilma precisa de "psicólogo" e não de presidente.', 'A Dilma precisa de psicólogo, não de gabinete.', 'Ataque misógino de Bolsonaro à presidente no plenário da Câmara em 2014.', 'verified', false, '2014-04-02', 'https://www.cartacapital.com.br/politica/bolsonaro-dilma-psicologo/', 'news_article', 4, 'Câmara dos Deputados', 'Discurso plenário', 'bolsonaro-dilma-psicologo-b95-81') RETURNING id)
