...
BEGIN
  ...
  -- 13
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_fav, 'Carlos Fávaro comemora acesso a mercado europeu para agro.', 'O agro será o grande beneficiário do Mercosul-UE.', 'Entrevista como ministro da Agricultura em dezembro de 2024.', 'verified', false, '2024-12-07', 'https://g1.globo.com/agro/noticia/2024/12/07/favaro-mercosul-ue-agro.ghtml', 'news_article', 1, 'Montevidéu, Uruguai', 'Entrevista', 'favaro-mercosul-ue-agro-b158-13') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ame, true FROM ins;

  -- 14
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mar, 'Marina Silva defende cláusulas ambientais rigorosas no Mercosul-UE.', 'O acordo tem que respeitar a Amazônia. Não aceitaremos retrocesso.', 'Entrevista em novembro de 2024.', 'verified', false, '2024-11-28', 'https://g1.globo.com/politica/noticia/2024/11/28/marina-mercosul-amazonia.ghtml', 'news_article', 1, 'Brasília', 'Entrevista', 'marina-mercosul-amazonia-b158-14') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ame, true FROM ins;

  -- 15
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_lul, 'Lula defende retorno brasileiro à UNASUL em Brasília.', 'Precisamos reconstruir a UNASUL. América do Sul integrada.', 'Cúpula dos Presidentes sul-americanos em maio de 2023.', 'verified', true, '2023-05-30', 'https://g1.globo.com/politica/noticia/2023/05/30/lula-unasul-brasilia.ghtml', 'other', 1, 'Brasília', 'Cúpula sul-americana', 'lula-unasul-brasilia-b158-15') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ame, true FROM ins;

  -- 16
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_lul, 'Lula chama acusações contra Maduro de "narrativa" e gera crise.', 'O conceito de democracia é relativo. Cada país tem sua forma.', 'Coletiva ao lado de Maduro no Palácio do Planalto em maio de 2023.', 'verified', true, '2023-05-29', 'https://g1.globo.com/mundo/noticia/2023/05/29/lula-maduro-narrativa-democracia.ghtml', 'news_article', 4, 'Brasília', 'Encontro com Maduro', 'lula-maduro-narrativa-b158-16') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 17
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mau, 'Mauro Vieira critica eleição da Venezuela em 2024.', 'O Brasil cobra apresentação das atas eleitorais venezuelanas.', 'Declaração do Itamaraty em agosto de 2024.', 'verified', true, '2024-08-01', 'https://g1.globo.com/mundo/noticia/2024/08/01/mauro-venezuela-atas.ghtml', 'news_article', 2, 'Brasília', 'Declaração oficial', 'mauro-venezuela-atas-b158-17') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ame, true FROM ins;

  -- 18
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_lul, 'Lula evita reconhecer vitória de Maduro mas descarta sanções.', 'Não vamos reconhecer, mas não aplicaremos sanções ao povo venezuelano.', 'Entrevista em agosto de 2024.', 'verified', true, '2024-08-05', 'https://g1.globo.com/mundo/noticia/2024/08/05/lula-maduro-sem-sancoes.ghtml', 'news_article', 3, 'Brasília', 'Entrevista', 'lula-maduro-sem-sancoes-b158-18') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 19
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_edu, 'Eduardo Bolsonaro critica complacência com Maduro.', 'Lula é cúmplice do ditador Maduro. Cala sobre fraude.', 'Pronunciamento na Câmara em agosto de 2024.', 'verified', false, '2024-08-02', 'https://www.camara.leg.br/noticias/eduardo-maduro-fraude', 'other', 3, 'Câmara dos Deputados', 'Pronunciamento', 'eduardo-lula-maduro-fraude-b158-19') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 20
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_van, 'Van Hattem pede sanções e recepção a refugiados venezuelanos.', 'Sanções a Maduro e asilo a opositores. Posição de decência.', 'Pronunciamento em agosto de 2024.', 'verified', false, '2024-08-03', 'https://www.camara.leg.br/noticias/van-hattem-venezuela-sancoes', 'other', 1, 'Câmara dos Deputados', 'Pronunciamento', 'van-hattem-venezuela-sancoes-b158-20') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ame, true FROM ins;

  -- 21
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_lul, 'Lula recebe críticas por bloquear entrada da Venezuela no BRICS.', 'Não foi veto pessoal. Foi posição consolidada após eleições.', 'Entrevista em outubro de 2024 após cúpula BRICS em Kazan.', 'verified', true, '2024-10-25', 'https://g1.globo.com/mundo/noticia/2024/10/25/lula-brics-venezuela.ghtml', 'news_article', 2, 'Kazan, Rússia', 'Cúpula BRICS', 'lula-brics-venezuela-b158-21') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ame, true FROM ins;

  -- 22
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mau, 'Mauro Vieira defende mediação Brasil-Colômbia-México na Venezuela.', 'Queremos solução negociada. A mediação é para garantir paz.', 'Coletiva em agosto de 2024.', 'verified', false, '2024-08-20', 'https://g1.globo.com/mundo/noticia/2024/08/20/mauro-venezuela-mediacao.ghtml', 'news_article', 1, 'Brasília', 'Coletiva', 'mauro-venezuela-mediacao-b158-22') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ame, true FROM ins;

  -- 23
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jair, 'Bolsonaro defende posição de Milei e ataca Lula.', 'Milei tem razão. Lula envergonha a América Latina.', 'Entrevista à Folha de S.Paulo em dezembro de 2023.', 'verified', true, '2023-12-10', 'https://www1.folha.uol.com.br/mundo/2023/12/bolsonaro-milei-lula.shtml', 'news_article', 3, 'São Paulo', 'Entrevista', 'bolsonaro-milei-lula-b158-23') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 24
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_edu, 'Eduardo Bolsonaro participa de posse de Milei em Buenos Aires.', 'Milei é um grande líder da liberdade. Brasil precisa disso.', 'Posse de Javier Milei em dezembro de 2023.', 'verified', true, '2023-12-10', 'https://g1.globo.com/mundo/noticia/2023/12/10/eduardo-posse-milei.ghtml', 'news_article', 2, 'Buenos Aires, Argentina', 'Posse Milei', 'eduardo-posse-milei-b158-24') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ame, true FROM ins;

  -- 25
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_lul, 'Lula evita posse de Milei e se reúne com presidente argentino depois.', 'Vou receber o Milei quando for preciso. Não é personalismo.', 'Declaração em dezembro de 2023.', 'verified', false, '2023-12-12', 'https://g1.globo.com/politica/noticia/2023/12/12/lula-milei-posse.ghtml', 'news_article', 2, 'Brasília', 'Declaração', 'lula-milei-posse-b158-25') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ame, true FROM ins;

  -- 26
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mau, 'Mauro Vieira assina acordo de mobilidade com Portugal.', 'Vamos fortalecer a mobilidade de brasileiros em Portugal.', 'Coletiva com ministro português em 2024.', 'verified', false, '2024-04-22', 'https://g1.globo.com/mundo/noticia/2024/04/22/brasil-portugal-mobilidade.ghtml', 'news_article', 1, 'Lisboa, Portugal', 'Acordo diplomático', 'brasil-portugal-mobilidade-b158-26') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ame, true FROM ins;

  -- 27
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jaq, 'Jaques Wagner defende ampliação do BRICS e multipolaridade.', 'BRICS é o futuro. Multipolaridade é o caminho.', 'Entrevista em 2023.', 'verified', false, '2023-08-22', 'https://g1.globo.com/mundo/noticia/2023/08/22/wagner-brics-multipolaridade.ghtml', 'news_article', 1, 'Brasília', 'Entrevista', 'wagner-brics-multipolaridade-b158-27') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ame, true FROM ins;

  -- 28
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_rog, 'Rogério Marinho critica aproximação com a China.', 'O Brasil se ajoelha para a China. Precisamos reagir.', 'Pronunciamento no Senado em 2024.', 'verified', false, '2024-05-14', 'https://www12.senado.leg.br/noticias/materias/2024/05/14/marinho-china-criticas', 'other', 2, 'Senado Federal', 'Pronunciamento', 'marinho-china-criticas-b158-28') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 29
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_lul, 'Lula visita Pequim e anuncia parcerias estratégicas com China.', 'Com Xi Jinping, construímos o futuro. China é parceira estratégica.', 'Visita de Estado em abril de 2023.', 'verified', true, '2023-04-14', 'https://g1.globo.com/mundo/noticia/2023/04/14/lula-xi-china-parceria.ghtml', 'news_article', 1, 'Pequim, China', 'Visita de Estado', 'lula-china-parceria-xi-b158-29') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ame, true FROM ins;

  -- 30
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_lul, 'Lula questiona "quem decide" sobre uso do dólar no comércio internacional.', 'Por que todo mundo tem que depender do dólar? Queremos outra moeda.', 'Discurso no banco do BRICS em abril de 2023.', 'verified', true, '2023-04-13', 'https://g1.globo.com/mundo/noticia/2023/04/13/lula-dolar-brics-banco.ghtml', 'other', 2, 'Xangai, China', 'Novo Banco de Desenvolvimento', 'lula-dolar-brics-b158-30') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ame, true FROM ins;

  -- 31
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_lul, 'Lula culpa EUA e UE pela guerra na Ucrânia.', 'EUA e UE também têm responsabilidade pela guerra. Precisam buscar a paz.', 'Declaração em abril de 2023 em Abu Dhabi.', 'verified', true, '2023-04-15', 'https://g1.globo.com/mundo/noticia/2023/04/15/lula-eua-ucrania-culpa.ghtml', 'news_article', 4, 'Abu Dhabi, EAU', 'Escala diplomática', 'lula-eua-ucrania-culpa-b158-31') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 32
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mau, 'Mauro Vieira articula plano de paz China-Brasil para Ucrânia.', 'Propomos o Clube dos Amigos da Paz. Saída negociada.', 'Declaração em setembro de 2024 na AGNU.', 'verified', true, '2024-09-23', 'https://g1.globo.com/mundo/noticia/2024/09/23/mauro-china-brasil-paz-ucrania.ghtml', 'news_article', 2, 'Nova York, EUA', 'AGNU 79', 'mauro-plano-paz-ucrania-b158-32') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ame, true FROM ins;

  -- 33
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_edu, 'Eduardo Bolsonaro ataca posição brasileira sobre Ucrânia.', 'O Brasil se aliou à Rússia. É vergonhoso.', 'Postagem no X em abril de 2023.', 'verified', false, '2023-04-16', 'https://twitter.com/BolsonaroSP/status/1647500000', 'social_media_post', 3, 'X/Twitter', 'Postagem', 'eduardo-ucrania-russia-b158-33') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 34
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mau, 'Mauro Vieira anuncia adesão brasileira ao TPI sobre Rússia.', 'Mantemos nosso compromisso com o TPI. Putin não será convidado ao G20.', 'Declaração após decisão do STF em 2024.', 'verified', true, '2024-09-06', 'https://g1.globo.com/mundo/noticia/2024/09/06/mauro-tpi-putin-g20.ghtml', 'news_article', 2, 'Brasília', 'Declaração', 'mauro-tpi-putin-g20-b158-34') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ame, true FROM ins;

  -- 35
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_lul, 'Lula muda posição e diz que Putin não será preso se vier ao Brasil.', 'Se ele vier, será recebido com protocolo. O TPI não vincula.', 'Entrevista em setembro de 2023.', 'verified', true, '2023-09-09', 'https://g1.globo.com/mundo/noticia/2023/09/09/lula-putin-tpi-brasil.ghtml', 'news_article', 4, 'Nova Délhi, Índia', 'G20 Nova Délhi', 'lula-putin-tpi-preso-b158-35') ON CONFLICT (slug) DO NOTHING RETURNING id)
  ...
  -- 36
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mau, 'Mauro Vieira recua e afirma que Brasil cumprirá TPI.', 'Brasil é signatário e cumprirá obrigações do TPI.', 'Nota oficial em setembro de 2023 após recuo.', 'verified', true, '2023-09-11', 'https://g1.globo.com/mundo/noticia/2023/09/11/itamaraty-tpi-brasil-cumprira.ghtml', 'news_article', 1, 'Brasília', 'Nota oficial', 'itamaraty-tpi-cumprira-b158-36') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ame, true FROM ins;

  -- 37
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jor, 'Jorge Messias defende convenções do TPI contra líderes.', 'TPI é instituição universal. Suas ordens valem no Brasil.', 'Entrevista como AGU em 2023.', 'verified', false, '2023-09-15', 'https://g1.globo.com/politica/noticia/2023/09/15/messias-tpi-brasil.ghtml', 'news_article', 1, 'Brasília', 'Entrevista', 'messias-tpi-convencoes-b158-37') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ame, true FROM ins;

  -- 38
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_lul, 'Lula recebe Netanyahu como persona non grata no Brasil.', 'Netanyahu é persona non grata. Genocídio não tem acolhimento aqui.', 'Declaração em maio de 2024.', 'verified', true, '2024-05-15', 'https://g1.globo.com/mundo/noticia/2024/05/15/lula-netanyahu-persona-non-grata.ghtml', 'news_article', 4, 'Brasília', 'Declaração', 'lula-netanyahu-persona-b158-38') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ame, true FROM ins;

  -- 39
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mau, 'Mauro Vieira defende dois Estados e reconhecimento da Palestina.', 'Dois Estados é a única saída. Brasil reconhece Palestina soberana.', 'Discurso na ONU em setembro de 2024.', 'verified', true, '2024-09-24', 'https://g1.globo.com/mundo/noticia/2024/09/24/mauro-dois-estados-onu.ghtml', 'other', 1, 'Nova York, EUA', 'AGNU 79', 'mauro-dois-estados-palestina-b158-39') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ame, true FROM ins;

  -- 40
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_fel, 'Marco Feliciano critica apoio brasileiro à Palestina.', 'O Brasil abraça o Hamas terrorista. Isso é vergonha cristã.', 'Culto em igreja em outubro de 2023.', 'verified', false, '2023-10-20', 'https://noticias.uol.com.br/politica/ultimas-noticias/2023/10/20/feliciano-hamas-palestina.htm', 'other', 4, 'São Paulo', 'Culto', 'feliciano-hamas-palestina-b158-40') ON CONFLICT (slug) DO NOTHING RETURNING id)
  ...
  -- 41
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mag, 'Magno Malta viaja a Israel e ataca Itamaraty.', 'Brasil é cúmplice do terror. Fui a Israel para reparar vergonha.', 'Declaração em Jerusalém em outubro de 2023.', 'verified', true, '2023-10-25', 'https://www12.senado.leg.br/noticias/materias/2023/10/25/magno-malta-israel', 'news_article', 3, 'Jerusalém, Israel', 'Visita', 'magno-malta-israel-b158-41') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 42
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_san, 'Sanderson defende envio de tropas ao Oriente Médio.', 'O Brasil deveria apoiar militarmente Israel. Chega de pacifismo.', 'Pronunciamento em outubro de 2023.', 'verified', false, '2023-10-12', 'https://www.camara.leg.br/noticias/sanderson-israel-militar', 'other', 4, 'Câmara dos Deputados', 'Pronunciamento', 'sanderson-israel-militar-b158-42') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 43
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_sam, 'Sâmia Bomfim defende Palestina e condena Israel.', 'Estamos diante de genocídio em Gaza. Solidariedade ao povo palestino.', 'Pronunciamento em outubro de 2023.', 'verified', false, '2023-10-18', 'https://www.camara.leg.br/noticias/samia-palestina-gaza', 'other', 2, 'Câmara dos Deputados', 'Pronunciamento', 'samia-palestina-gaza-b158-43') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ame, true FROM ins;

  -- 44
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_tal, 'Talíria Petrone denuncia vítimas civis em Gaza.', 'Crianças estão sendo mortas. Isso é genocídio, é crime de guerra.', 'Pronunciamento em novembro de 2023.', 'verified', false, '2023-11-15', 'https://www.camara.leg.br/noticias/taliria-gaza-criancas', 'other', 2, 'Câmara dos Deputados', 'Pronunciamento', 'taliria-gaza-criancas-b158-44') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ame, true FROM ins;

  -- 45
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_gir, 'General Girão defende Bolsonaro sobre Israel.', 'Bolsonaro honrou Israel. Lula envergonha com Gaza.', 'Pronunciamento em fevereiro de 2024.', 'verified', false, '2024-02-22', 'https://www.camara.leg.br/noticias/girao-israel-bolsonaro', 'other', 2, 'Câmara dos Deputados', 'Pronunciamento', 'girao-israel-bolsonaro-b158-45') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 46
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mau, 'Mauro Vieira anuncia missão humanitária para repatriar brasileiros de Gaza.', 'A Operação Voltando em Paz trouxe brasileiros de Gaza.', 'Coletiva em outubro de 2023.', 'verified', true, '2023-10-18', 'https://g1.globo.com/mundo/noticia/2023/10/18/mauro-operacao-voltando-paz.ghtml', 'news_article', 1, 'Brasília', 'Coletiva', 'mauro-operacao-voltando-paz-b158-46') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ame, true FROM ins;

  -- 47
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_lul, 'Lula anuncia retorno de tropas brasileiras ao Haiti com ONU.', 'O Brasil cumpre sua vocação internacional. Haiti precisa de nós.', 'Discurso na ONU em setembro de 2023.', 'verified', false, '2023-09-20', 'https://g1.globo.com/mundo/noticia/2023/09/20/lula-haiti-tropas-onu.ghtml', 'other', 2, 'Nova York, EUA', 'AGNU 78', 'lula-haiti-tropas-b158-47') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ame, true FROM ins;

  -- 48
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_muc, 'José Múcio descarta envio de tropas ao Haiti sob multinacional do Quênia.', 'Não vamos repetir Minustah. Brasil não envia tropas agora.', 'Entrevista em março de 2024.', 'verified', false, '2024-03-12', 'https://g1.globo.com/politica/noticia/2024/03/12/mucio-haiti-nao-tropas.ghtml', 'news_article', 1, 'Brasília', 'Entrevista', 'mucio-haiti-nao-tropas-b158-48') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ame, true FROM ins;

  -- 49
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mau, 'Mauro Vieira defende solução latino-americana ao Haiti.', 'O Haiti precisa de ajuda, não ocupação. Caminho é humanitário.', 'Declaração em março de 2024.', 'verified', false, '2024-03-15', 'https://g1.globo.com/mundo/noticia/2024/03/15/mauro-haiti-humanitario.ghtml', 'news_article', 1, 'Brasília', 'Declaração', 'mauro-haiti-humanitario-b158-49') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ame, true FROM ins;

  -- 50
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jaq, 'Jaques Wagner relembra Minustah e pondera envio ao Haiti.', 'Minustah deixou lições. Precisamos de mandato claro.', 'Entrevista em 2024.', 'verified', false, '2024-04-02', 'https://www12.senado.leg.br/noticias/materias/2024/04/02/wagner-haiti-minustah', 'news_article', 1, 'Senado Federal', 'Entrevista', 'wagner-haiti-minustah-b158-50') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ame, true FROM ins;

  -- 51
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_edu, 'Eduardo Bolsonaro critica omissão sobre Haiti.', 'Lula promete e não cumpre. Haiti em ruínas, Brasil calado.', 'Postagem em março de 2024.', 'verified', false, '2024-03-20', 'https://twitter.com/BolsonaroSP/status/1770000000', 'social_media_post', 2, 'X/Twitter', 'Postagem', 'eduardo-haiti-omissao-b158-51') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 52
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mau, 'Mauro Vieira lidera cúpula do G20 no Rio de Janeiro.', 'O Rio será símbolo de cooperação multilateral. Combate à fome central.', 'Coletiva antes da cúpula em novembro de 2024.', 'verified', true, '2024-11-10', 'https://g1.globo.com/mundo/noticia/2024/11/10/mauro-g20-rio-cupula.ghtml', 'news_article', 1, 'Rio de Janeiro', 'Preparação G20', 'mauro-g20-rio-cupula-b158-52') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ame, true FROM ins;

  -- 53
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_lul, 'Lula lança Aliança Global contra Fome no G20.', 'Combate à fome é a prioridade global. Brasil assume a liderança.', 'Discurso de abertura do G20 Rio em novembro de 2024.', 'verified', true, '2024-11-18', 'https://g1.globo.com/mundo/noticia/2024/11/18/lula-alianca-fome-g20.ghtml', 'other', 1, 'Rio de Janeiro', 'G20 Rio', 'lula-alianca-fome-g20-b158-53') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ame, true FROM ins;

  -- 54
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_had, 'Haddad defende taxação de super-ricos no G20.', 'Super-ricos precisam pagar o justo. Brasil propõe imposto global.', 'Reunião de ministros das Finanças do G20 em julho de 2024.', 'verified', true, '2024-07-25', 'https://g1.globo.com/economia/noticia/2024/07/25/haddad-super-ricos-g20.ghtml', 'news_article', 1, 'Rio de Janeiro', 'G20 Finanças', 'haddad-super-ricos-g20-b158-54') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ame, true FROM ins;

  -- 55
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jair, 'Bolsonaro critica G20 no Rio e Lula.', 'O G20 foi um circo. Lula não entende de economia.', 'Entrevista em novembro de 2024.', 'verified', false, '2024-11-20', 'https://noticias.uol.com.br/politica/ultimas-noticias/2024/11/20/bolsonaro-g20-circo.htm', 'news_article', 2, 'São Paulo', 'Entrevista', 'bolsonaro-g20-circo-b158-55') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 56
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mar, 'Marina Silva lidera COP30 em Belém em 2025.', 'COP30 na Amazônia é simbólica. Vamos entregar resultados.', 'Declaração ao assumir presidência da COP30.', 'verified', true, '2025-10-01', 'https://g1.globo.com/politica/noticia/2025/10/01/marina-cop30-belem.ghtml', 'news_article', 1, 'Belém, PA', 'COP30', 'marina-cop30-belem-b158-56') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ame, true FROM ins;

  -- 57
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_lul, 'Lula discursa na COP30 contra negacionismo climático.', 'Negacionismo climático é crime contra a humanidade. Precisamos agir.', 'Abertura da COP30 em Belém em novembro de 2025.', 'verified', true, '2025-11-10', 'https://g1.globo.com/politica/noticia/2025/11/10/lula-cop30-negacionismo.ghtml', 'other', 1, 'Belém, PA', 'COP30 abertura', 'lula-cop30-negacionismo-b158-57') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ame, true FROM ins;

  -- 58
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jair, 'Bolsonaro nega urgência climática na COP30.', 'A agenda climática é comunista. COP30 é farsa.', 'Declaração em novembro de 2025.', 'verified', true, '2025-11-12', 'https://noticias.uol.com.br/politica/ultimas-noticias/2025/11/12/bolsonaro-cop30-farsa.htm', 'news_article', 4, 'Brasília', 'Declaração', 'bolsonaro-cop30-farsa-b158-58') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 59
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_son, 'Sônia Guajajara defende protagonismo indígena na COP30.', 'Sem povos indígenas não há futuro climático.', 'Evento na COP30 em novembro de 2025.', 'verified', true, '2025-11-14', 'https://g1.globo.com/politica/noticia/2025/11/14/sonia-cop30-indigenas.ghtml', 'other', 1, 'Belém, PA', 'COP30', 'sonia-cop30-indigenas-b158-59') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ame, true FROM ins;

  -- 60
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mau, 'Mauro Vieira fecha acordo de transição energética na COP30.', 'Transição justa saiu do papel. Brasil saiu vitorioso.', 'Coletiva na COP30 em novembro de 2025.', 'verified', false, '2025-11-22', 'https://g1.globo.com/mundo/noticia/2025/11/22/mauro-cop30-transicao.ghtml', 'news_article', 1, 'Belém, PA', 'COP30 encerramento', 'mauro-cop30-transicao-b158-60') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ame, true FROM ins;

  -- 61
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_dil, 'Dilma Rousseff presidente do Banco do BRICS defende "moeda comum".', 'Vamos avançar em alternativas ao dólar. É a hora.', 'Discurso no aniversário do NDB em 2024.', 'verified', false, '2024-04-14', 'https://g1.globo.com/mundo/noticia/2024/04/14/dilma-brics-moeda.ghtml', 'other', 2, 'Xangai, China', 'NDB', 'dilma-brics-moeda-b158-61') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ame, true FROM ins;

  -- 62
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_kic, 'Kicis acusa BRICS de aliança com ditaduras.', 'BRICS é clube de ditadores. Brasil não deveria estar.', 'Pronunciamento em outubro de 2024.', 'verified', false, '2024-10-22', 'https://www.camara.leg.br/noticias/kicis-brics-ditaduras', 'other', 2, 'Câmara dos Deputados', 'Pronunciamento', 'kicis-brics-ditaduras-b158-62') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 63
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_kim, 'Kim Kataguiri critica posição brasileira na ONU sobre Cuba.', 'Brasil apoia embargo à Cuba? Não, apoia Cuba. Lamentável.', 'Declaração após voto brasileiro na AGNU em 2023.', 'verified', false, '2023-11-02', 'https://www.camara.leg.br/noticias/kim-onu-cuba', 'other', 2, 'Câmara dos Deputados', 'Declaração', 'kim-onu-cuba-b158-63') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 64
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mau, 'Mauro Vieira defende voto contra embargo a Cuba na ONU.', 'Embargo é desumano. Brasil mantém posição histórica.', 'Coletiva após voto na AGNU em 2023.', 'verified', false, '2023-11-03', 'https://g1.globo.com/mundo/noticia/2023/11/03/mauro-cuba-embargo-onu.ghtml', 'news_article', 1, 'Nova York, EUA', 'AGNU', 'mauro-cuba-embargo-onu-b158-64') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ame, true FROM ins;

  -- 65
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_eri, 'Erika Hilton denuncia racismo contra brasileiros em Portugal.', 'Brasileiros são alvo de racismo em Portugal. Itamaraty precisa agir.', 'Pronunciamento em 2024.', 'verified', false, '2024-05-03', 'https://www.camara.leg.br/noticias/erika-racismo-portugal', 'other', 1, 'Câmara dos Deputados', 'Pronunciamento', 'erika-racismo-portugal-b158-65') ON CONFLICT (slug) DO NOTHING RETURNING id)
  ...
  -- 98
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_zam, 'Zambelli foragida em Roma ataca política externa do Brasil.', 'Brasil virou pária internacional. Só ditaduras são aliadas.', 'Entrevista em Roma em fevereiro de 2025.', 'verified', false, '2025-02-18', 'https://noticias.uol.com.br/politica/ultimas-noticias/2025/02/18/zambelli-italia-politica-externa.htm', 'news_article', 3, 'Roma, Itália', 'Entrevista', 'zambelli-italia-politica-externa-b158-98') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 99
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_lul, 'Lula assina condenação formal da guerra em Gaza no STF à luz do TPI.', 'Apoiamos ordem do TPI. Netanyahu responderá.', 'Declaração em novembro de 2024.', 'verified', false, '2024-11-22', 'https://g1.globo.com/mundo/noticia/2024/11/22/lula-tpi-netanyahu-ordem.ghtml', 'news_article', 2, 'Brasília', 'Declaração', 'lula-tpi-netanyahu-ordem-b158-99') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ame, true FROM ins;

  -- 100
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mau, 'Mauro Vieira encerra 2025 defendendo legado diplomático de Lula III.', 'Multilateralismo voltou. O Brasil recuperou seu protagonismo.', 'Balanço de 2025 em dezembro.', 'verified', false, '2025-12-18', 'https://g1.globo.com/mundo/noticia/2025/12/18/mauro-balanco-2025.ghtml', 'news_article', 1, 'Brasília', 'Balanço diplomático', 'mauro-balanco-2025-b158-100') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ame, true FROM ins;
