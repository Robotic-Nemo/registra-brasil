...
BEGIN
  ...
  -- 7
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mic, 'Michelle Bolsonaro diz que será "candidata do povo" em 2026.', 'Se Deus quiser e o povo pedir, eu serei candidata. Vou ser a voz do meu marido.', 'Culto em igreja em Brasília com apoiadores.', 'verified', true, '2025-10-25', 'https://www1.folha.uol.com.br/poder/2025/10/michelle-bolsonaro-candidata-povo-2026.shtml', 'other', 3, 'Brasília', 'Culto evangélico', 'michelle-candidata-povo-2026-b163-7') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_con, true FROM ins;

  -- 8
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_edu, 'Eduardo Bolsonaro dos EUA diz que 2026 será "a última chance" da direita.', 'Se não vencermos em 2026, não haverá 2030. A ditadura se consolida.', 'Entrevista a canal bolsonarista dos EUA, onde mora em autoexílio.', 'verified', true, '2025-10-28', 'https://g1.globo.com/politica/noticia/2025/10/28/eduardo-bolsonaro-ultima-chance-2026.ghtml', 'social_media_post', 5, 'Flórida, EUA', 'Entrevista em podcast', 'eduardo-ultima-chance-2026-b163-8') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ant, true FROM ins UNION ALL SELECT id, c_des, false FROM ins;

  -- 9
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_zem, 'Zema admite pré-candidatura à Presidência pelo Novo.', 'Sim, sou pré-candidato. Minas Gerais mostra o Brasil que queremos.', 'Entrevista coletiva em Belo Horizonte.', 'verified', false, '2025-10-30', 'https://valor.globo.com/politica/noticia/2025/10/30/zema-pre-candidato-novo-presidencia.ghtml', 'news_article', 2, 'Belo Horizonte', 'Entrevista coletiva', 'zema-pre-candidato-novo-b163-9') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_con, true FROM ins;

  -- 10
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_rat, 'Ratinho Junior diz que disputa presidencial depende do PSD.', 'Vou seguir o que Kassab decidir. Estou pronto para a missão.', 'Entrevista em Curitiba sobre cenário presidencial.', 'verified', false, '2025-11-02', 'https://g1.globo.com/pr/parana/eleicoes/2026/noticia/2025/11/02/ratinho-junior-psd-kassab-presidencia.ghtml', 'news_article', 1, 'Curitiba', 'Entrevista coletiva', 'ratinho-junior-psd-kassab-b163-10') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_con, true FROM ins;

  -- 11
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_cai, 'Caiado diz que é "o único" capaz de unir a direita em 2026.', 'Sem vaidade: sou o único que pode unir a direita sem radicalismo.', 'Entrevista ao Jornal Nacional da TV Globo.', 'verified', false, '2025-11-05', 'https://g1.globo.com/politica/eleicoes/2026/noticia/2025/11/05/caiado-unico-unir-direita.ghtml', 'news_article', 2, 'Goiânia', 'Entrevista ao JN', 'caiado-unico-unir-direita-b163-11') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_con, true FROM ins;

  -- 12
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_lul, 'Lula confirma que disputará reeleição em 2026.', 'Sim, vou disputar. Ainda tenho muito a fazer pelo Brasil e pelo povo pobre.', 'Entrevista coletiva após reunião ministerial em Brasília.', 'verified', true, '2025-11-08', 'https://g1.globo.com/politica/eleicoes/2026/noticia/2025/11/08/lula-confirma-reeleicao-2026.ghtml', 'news_article', 1, 'Brasília', 'Entrevista coletiva', 'lula-confirma-reeleicao-2026-b163-12') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_con, true FROM ins;

  -- 13
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mar, 'Marçal publica vídeo comparando STF a "tribunal comunista".', 'O STF virou tribunal comunista. Ministros com toga e foice.', 'Vídeo em TikTok viralizando ataques ao Supremo.', 'verified', true, '2025-11-10', 'https://www1.folha.uol.com.br/poder/2025/11/marcal-stf-tribunal-comunista.shtml', 'social_media_post', 5, 'TikTok', 'Vídeo viral', 'marcal-stf-tribunal-comunista-b163-13') ON CONFLICT (slug) DO NOTHING RETURNING id)
  ...
  -- 15
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_nik, 'Nikolas chama Zanin de "ministro do gabinete" em sessão.', 'Zanin é ministro do gabinete do Lula. Essa é a verdade.', 'Discurso em plenário da Câmara atacando o STF.', 'verified', true, '2025-11-15', 'https://www1.folha.uol.com.br/poder/2025/11/nikolas-zanin-ministro-gabinete.shtml', 'other', 4, 'Câmara dos Deputados', 'Discurso em plenário', 'nikolas-zanin-gabinete-b163-15') ON CONFLICT (slug) DO NOTHING RETURNING id)
  ...
  -- 36
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_edu, 'Eduardo defende "sanções dos EUA" a Moraes em entrevista a Fox News.', 'O governo Trump deve sancionar Moraes. Ele é um tirano.', 'Entrevista à Fox News nos EUA.', 'verified', true, '2026-01-12', 'https://www1.folha.uol.com.br/poder/2026/01/eduardo-sancoes-eua-moraes-fox-news.shtml', 'news_article', 5, 'Miami, EUA', 'Fox News', 'eduardo-sancoes-moraes-fox-b163-36') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ame, true FROM ins UNION ALL SELECT id, c_ant, false FROM ins;

  -- 37
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_tar, 'Tarcísio filia-se ao PL para disputar Presidência.', 'Entro no PL para honrar a história do partido e disputar 2026.', 'Cerimônia de filiação em Brasília, com Valdemar Costa Neto.', 'verified', true, '2026-01-15', 'https://g1.globo.com/politica/eleicoes/2026/noticia/2026/01/15/tarcisio-filiacao-pl-presidencia.ghtml', 'news_article', 3, 'Brasília', 'Cerimônia de filiação', 'tarcisio-filiacao-pl-b163-37') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_con, true FROM ins;

  -- 38
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_fla, 'Flávio diz que Tarcísio "não é o escolhido" de Bolsonaro.', 'Tarcísio é bom, mas não é o escolhido do Bolsonaro. Ainda.', 'Entrevista após filiação de Tarcísio ao PL.', 'verified', true, '2026-01-16', 'https://www1.folha.uol.com.br/poder/2026/01/flavio-tarcisio-nao-escolhido.shtml', 'news_article', 3, 'Brasília', 'Entrevista', 'flavio-tarcisio-nao-escolhido-b163-38') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_con, true FROM ins;

  -- 39
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mar, 'Marçal promete "fuzilar" corrupção se eleito.', 'Vou fuzilar a corrupção. Bandido vai ter medo.', 'Comício em Curitiba, em pré-campanha.', 'verified', true, '2026-01-18', 'https://g1.globo.com/politica/eleicoes/2026/noticia/2026/01/18/marcal-fuzilar-corrupcao.ghtml', 'other', 5, 'Curitiba', 'Comício', 'marcal-fuzilar-corrupcao-b163-39') ON CONFLICT (slug) DO NOTHING RETURNING id)
  ...
  -- 40
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_nik, 'Nikolas anuncia pré-candidatura ao governo de Minas no Sabatina.', 'Oficialmente: vou disputar o governo de Minas em 2026.', 'Sabatina do UOL em Belo Horizonte.', 'verified', true, '2026-01-20', 'https://www1.folha.uol.com.br/poder/2026/01/nikolas-oficializa-governo-minas.shtml', 'news_article', 2, 'Belo Horizonte', 'Sabatina UOL', 'nikolas-oficializa-governo-minas-b163-40') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_con, true FROM ins;

  -- 41
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_cir, 'Ciro diz que Lula "caiu de joelhos" diante do Centrão.', 'Lula caiu de joelhos para o Centrão. Virou refém.', 'Entrevista à rádio CBN.', 'verified', false, '2026-01-22', 'https://g1.globo.com/politica/noticia/2026/01/22/ciro-lula-joelhos-centrao.ghtml', 'news_article', 2, 'Fortaleza', 'Entrevista CBN', 'ciro-lula-joelhos-centrao-b163-41') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_odi, true FROM ins;
  ...
  -- 79
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_fla, 'Flávio pede "união" da direita contra "o inimigo Lula".', 'Vamos unir contra o inimigo principal: Lula. Depois resolvemos entre nós.', 'Entrevista em Brasília.', 'verified', false, '2026-04-11', 'https://www1.folha.uol.com.br/poder/2026/04/flavio-uniao-direita-inimigo-lula.shtml', 'news_article', 2, 'Brasília', 'Entrevista', 'flavio-uniao-inimigo-lula-b163-79') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_con, true FROM ins;

  -- 80
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_pad, 'Padilha defende reeleição de Lula em entrevista.', 'Lula é o único capaz de continuar o projeto. Vai ganhar.', 'Entrevista ao comentar cenário eleitoral.', 'verified', false, '2026-04-12', 'https://g1.globo.com/politica/eleicoes/2026/noticia/2026/04/12/padilha-reeleicao-lula-defesa.ghtml', 'news_article', 1, 'Brasília', 'Entrevista', 'padilha-reeleicao-lula-b163-80') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_con, true FROM ins;

  -- 81
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_nik, 'Nikolas publica montagem ofensiva com rosto de Janja.', 'Nossa primeira-dama é um vexame. Olha essa foto.', 'Postagem em rede social com imagem editada.', 'verified', true, '2026-04-13', 'https://www1.folha.uol.com.br/poder/2026/04/nikolas-montagem-janja-ofensiva.shtml', 'social_media_post', 3, 'Twitter', 'Postagem', 'nikolas-montagem-janja-b163-81') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_odi, true FROM ins;

  -- 82
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_hmo, 'Hamilton Mourão critica "radicalização" e mira candidatura própria.', 'A direita está radicalizada demais. Tem espaço para alguém equilibrado.', 'Discurso no Senado.', 'verified', false, '2026-04-13', 'https://g1.globo.com/politica/noticia/2026/04/13/mourao-radicalizacao-candidatura-propria.ghtml', 'other', 1, 'Senado Federal', 'Discurso', 'mourao-radicalizacao-candidatura-b163-82') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_con, true FROM ins;

  -- 83
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_van, 'Marcel Van Hattem pede "impeachment coletivo" do STF.', 'Impeachment coletivo no STF. Já passou da hora.', 'Discurso em plenário da Câmara.', 'verified', true, '2026-04-14', 'https://www1.folha.uol.com.br/poder/2026/04/van-hattem-impeachment-coletivo-stf.shtml', 'other', 5, 'Câmara dos Deputados', 'Discurso', 'van-hattem-impeachment-coletivo-stf-b163-83') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ame, true FROM ins UNION ALL SELECT id, c_ant, false FROM ins;

  -- 84
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_adr, 'Adriana Ventura defende rever "papel" do STF via PEC.', 'Precisamos de uma PEC para delimitar o papel do STF.', 'Entrevista na Câmara.', 'verified', false, '2026-04-14', 'https://g1.globo.com/politica/noticia/2026/04/14/adriana-ventura-pec-stf-papel.ghtml', 'news_article', 3, 'Brasília', 'Entrevista', 'adriana-ventura-pec-stf-b163-84') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ame, true FROM ins;

  -- 85
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_kim, 'Kim Kataguiri ataca Marçal e defende "terceira via".', 'Marçal é populismo puro. O Brasil precisa de uma terceira via.', 'Entrevista em São Paulo.', 'verified', false, '2026-04-15', 'https://www1.folha.uol.com.br/poder/2026/04/kim-ataca-marcal-terceira-via.shtml', 'news_article', 2, 'São Paulo', 'Entrevista', 'kim-ataca-marcal-terceira-via-b163-85') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_con, true FROM ins;

  -- 86
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mar, 'Marçal compara ministros do STF a "bandidos de toga".', 'Os ministros do STF são bandidos de toga. É preciso prendê-los.', 'Live bombástica com milhares de espectadores.', 'verified', true, '2026-04-15', 'https://g1.globo.com/politica/noticia/2026/04/15/marcal-ministros-stf-bandidos-toga.ghtml', 'social_media_post', 5, 'YouTube', 'Live', 'marcal-ministros-stf-bandidos-b163-86') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ame, true FROM ins UNION ALL SELECT id, c_int, false FROM ins;

  -- 87
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_zan, 'Zanin nega bloqueio de canais e rebate Marçal em sessão.', 'Não bloqueamos canais. Aplicamos a lei. Quem descumpre arca.', 'Declaração em sessão do STF.', 'verified', false, '2026-04-15', 'https://www1.folha.uol.com.br/poder/2026/04/zanin-rebate-marcal-bloqueio-canais.shtml', 'other', 1, 'STF', 'Sessão plenária', 'zanin-rebate-marcal-canais-b163-87') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_con, true FROM ins;

  -- 88
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_fac, 'Fachin, presidente do TSE, alerta sobre "ameaças" à eleição.', 'Não vamos tolerar ameaças ao processo eleitoral. A Justiça Eleitoral está em guarda.', 'Discurso no TSE sobre preparação para 2026.', 'verified', true, '2026-04-16', 'https://g1.globo.com/politica/eleicoes/2026/noticia/2026/04/16/fachin-tse-ameacas-eleicao.ghtml', 'other', 1, 'TSE', 'Sessão plenária', 'fachin-tse-ameacas-eleicao-b163-88') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_con, true FROM ins;

  -- 89
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_nik, 'Nikolas chama Fachin de "censor-mor" em rede social.', 'Fachin é o censor-mor. Nosso inimigo na eleição.', 'Postagem após discurso de Fachin.', 'verified', true, '2026-04-16', 'https://www1.folha.uol.com.br/poder/2026/04/nikolas-fachin-censor-mor.shtml', 'social_media_post', 4, 'Twitter', 'Postagem', 'nikolas-fachin-censor-mor-b163-89') ON CONFLICT (slug) DO NOTHING RETURNING id)
  ...
  -- 99
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_lul, 'Lula diz que "vai derrotar o fascismo" em 2026.', 'Vamos derrotar o fascismo de novo. O Brasil não quer golpe.', 'Ato em Brasília marcando aniversário de 3 anos do governo.', 'verified', true, '2026-04-17', 'https://www1.folha.uol.com.br/poder/2026/04/lula-derrotar-fascismo-2026.shtml', 'other', 1, 'Brasília', 'Ato de 3 anos', 'lula-derrotar-fascismo-2026-b163-99') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_con, true FROM ins;

  -- 100
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mar, 'Marçal encerra abril prometendo "virar o jogo" e "acabar com o sistema".', 'Vou virar o jogo. Vou acabar com esse sistema podre. 2026 é revolução.', 'Live encerrando série "100 dias de pré-campanha".', 'verified', true, '2026-04-17', 'https://g1.globo.com/politica/noticia/2026/04/17/marcal-virar-jogo-acabar-sistema-100-dias.ghtml', 'social_media_post', 5, 'YouTube', 'Live', 'marcal-virar-jogo-sistema-b163-100') ON CONFLICT (slug) DO NOTHING RETURNING id)
