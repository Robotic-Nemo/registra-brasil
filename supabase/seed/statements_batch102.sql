...
BEGIN
  ...
  -- 1
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jair, 'Bolsonaro minimiza segunda onda da Covid-19 ao comentar mortes em Manaus por falta de oxigênio.', 'Não adianta fugir disso, da realidade. Tem que enfrentar de peito aberto, porra.', 'Declaração em transmissão ao vivo enquanto Manaus colapsava com falta de oxigênio em janeiro de 2021.', 'verified', true, '2021-01-14', 'https://g1.globo.com/politica/noticia/2021/01/14/bolsonaro-manaus-oxigenio.ghtml', 'news_article', 4, 'Palácio da Alvorada', 'Live semanal', 'bolsonaro-manaus-peito-aberto-b102-1') ON CONFLICT (slug) DO NOTHING RETURNING id)
  ...
  -- 14
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jair, 'Bolsonaro demite comandantes das três Forças em crise militar sem precedentes.', 'Vocês sabem que eu sou o comandante supremo das Forças Armadas.', 'Fala após demitir os três comandantes em 30 de março de 2021 por resistência a usar militares politicamente.', 'verified', true, '2021-03-30', 'https://www1.folha.uol.com.br/poder/2021/03/bolsonaro-demite-comandantes.shtml', 'news_article', 5, 'Palácio do Planalto', 'Reforma ministerial', 'bolsonaro-demite-comandantes-b102-14') ON CONFLICT (slug) DO NOTHING RETURNING id)
  ...
  -- 23
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_aziz, 'Omar Aziz rebate Bolsonaro e garante independência da CPI diante de pressões políticas.', 'Não estamos aqui para defender governo nenhum. Estamos aqui para investigar.', 'Resposta às tentativas de Bolsonaro de desqualificar os trabalhos da CPI em maio de 2021.', 'verified', false, '2021-05-11', 'https://www12.senado.leg.br/noticias/materias/2021/05/11/aziz-rebate-bolsonaro', 'other', 1, 'Senado Federal', 'Sessão da CPI da Covid', 'aziz-rebate-bolsonaro-b102-23') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ant, true FROM ins;

  -- 24
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_renan, 'Renan Calheiros classifica Bolsonaro como genocida em discurso na CPI.', 'O presidente Jair Bolsonaro tem responsabilidade direta pela tragédia. É um genocida.', 'Pronunciamento como relator da CPI em maio de 2021 durante depoimento de ex-ministros da Saúde.', 'verified', true, '2021-05-12', 'https://www1.folha.uol.com.br/poder/2021/05/renan-bolsonaro-genocida.shtml', 'other', 2, 'Senado Federal', 'Sessão da CPI da Covid', 'renan-bolsonaro-genocida-b102-24') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ant, true FROM ins;

  -- 25
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jair, 'Bolsonaro ironiza perguntas sobre CPI e repete negação de responsabilidade na pandemia.', 'Tenho mil formas de agir sem precisar escalar. Nunca acreditei nessa história de fechar tudo.', 'Declaração a apoiadores no Palácio da Alvorada em maio de 2021 após 435 mil mortes.', 'verified', false, '2021-05-15', 'https://www.cnnbrasil.com.br/politica/bolsonaro-ironiza-cpi/', 'news_article', 3, 'Palácio da Alvorada', 'Cerimônia com apoiadores', 'bolsonaro-ironia-cpi-b102-25') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_neg, true FROM ins;

  -- 26
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_eduardo, 'Eduardo Bolsonaro tenta desqualificar CPI da Covid em entrevista à Fox News.', 'A CPI é um show político da oposição. Meu pai fez o melhor possível na pandemia.', 'Entrevista à emissora conservadora norte-americana em maio de 2021 defendendo o governo.', 'verified', false, '2021-05-18', 'https://www.metropoles.com/brasil/politica-br/eduardo-fox-cpi', 'news_article', 3, 'Brasília', 'Entrevista à Fox News', 'eduardo-fox-cpi-b102-26') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 27
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_flavio, 'Flávio Bolsonaro diz que CPI da Covid visa tirar seu pai do poder.', 'O objetivo da CPI é tirar o Bolsonaro do poder. Eles querem fazer do meu pai o bode expiatório.', 'Entrevista em maio de 2021 defendendo o governo contra os trabalhos da CPI.', 'verified', false, '2021-05-19', 'https://www.poder360.com.br/congresso/flavio-cpi-bode/', 'news_article', 3, 'Senado Federal', 'Entrevista à imprensa', 'flavio-cpi-bode-b102-27') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 28
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_vieira, 'Alessandro Vieira cobra depoimentos de ministros e aliados do governo na CPI.', 'Vamos chamar todos os que têm responsabilidade. Ninguém está acima da lei.', 'Declaração como membro titular da CPI em maio de 2021 defendendo lista de convocações.', 'verified', false, '2021-05-20', 'https://www12.senado.leg.br/noticias/materias/2021/05/20/vieira-convocacoes', 'other', 2, 'Senado Federal', 'Sessão da CPI da Covid', 'vieira-convocacoes-b102-28') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ant, true FROM ins;

  -- 29
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_eliziane, 'Eliziane Gama destaca negacionismo presidencial como causa central de mortes na pandemia.', 'O negacionismo do presidente é a causa direta de milhares de mortes. Isso é fato.', 'Pronunciamento como titular da CPI em maio de 2021 ao abordar boicote a medidas sanitárias.', 'verified', false, '2021-05-21', 'https://www12.senado.leg.br/noticias/materias/2021/05/21/eliziane-negacionismo', 'other', 2, 'Senado Federal', 'Sessão da CPI da Covid', 'eliziane-negacionismo-b102-29') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ant, true FROM ins;
  ...
  -- 31
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_renan, 'Em depoimento à CPI, ex-ministro Mandetta afirma que governo escolheu tratamento precoce sem base.', 'Não havia como convencer o presidente sobre a ineficácia da cloroquina.', 'Fala de Renan conduzindo o depoimento de Mandetta em 4 de maio de 2021, citando discordâncias internas.', 'verified', true, '2021-05-04', 'https://www12.senado.leg.br/noticias/materias/2021/05/04/mandetta-cpi-cloroquina', 'other', 3, 'Senado Federal', 'Depoimento de Mandetta', 'renan-mandetta-cpi-b102-31') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ant, true FROM ins;

  -- 32
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_aziz, 'Aziz confronta Pazuello sobre omissão em Manaus no colapso do oxigênio.', 'O senhor sabia e não agiu. Ponto. As mortes de Manaus estão em suas mãos.', 'Interpelação de Aziz durante depoimento do ex-ministro da Saúde em 19 de maio de 2021.', 'verified', true, '2021-05-19', 'https://www12.senado.leg.br/noticias/materias/2021/05/19/aziz-pazuello-manaus', 'other', 4, 'Senado Federal', 'Depoimento de Pazuello', 'aziz-pazuello-manaus-b102-32') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ant, true FROM ins;

  -- 33
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_renan, 'Renan pressiona Pazuello sobre distribuição de kit-Covid sem eficácia comprovada.', 'O senhor sabia que não tinha eficácia e mesmo assim distribuiu o kit Covid. Isso é responsabilidade criminal.', 'Interpelação feita por Renan Calheiros durante depoimento de Pazuello à CPI em maio de 2021.', 'verified', true, '2021-05-19', 'https://www1.folha.uol.com.br/poder/2021/05/renan-pazuello-kit-covid.shtml', 'other', 4, 'Senado Federal', 'Depoimento de Pazuello', 'renan-pazuello-kit-b102-33') ON CONFLICT (slug) DO NOTHING RETURNING id)
  ...
  -- 34
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jair, 'Bolsonaro nega falta de oxigênio em Manaus apesar de provas apresentadas à CPI.', 'Não houve falta de oxigênio. O governo federal fez tudo que era possível.', 'Declaração em transmissão ao vivo em maio de 2021 contradizendo depoimentos e documentos oficiais.', 'verified', false, '2021-05-20', 'https://g1.globo.com/politica/noticia/2021/05/20/bolsonaro-nega-falta-oxigenio.ghtml', 'news_article', 4, 'Palácio da Alvorada', 'Live semanal', 'bolsonaro-nega-oxigenio-b102-34') ON CONFLICT (slug) DO NOTHING RETURNING id)
  ...
  -- 42
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jair, 'Bolsonaro retira máscara em motociata e é multado pelo Procon-SP.', 'Multa? Paguem vocês. Eu não vou pagar nada por estar com minha gente.', 'Fala após Procon-SP multá-lo em junho de 2021 por promover aglomeração sem máscara em São Paulo.', 'verified', false, '2021-06-14', 'https://g1.globo.com/sp/sao-paulo/noticia/2021/06/14/bolsonaro-multa-procon.ghtml', 'news_article', 3, 'São Paulo', 'Agenda em SP', 'bolsonaro-multa-procon-b102-42') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 43
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_lira, 'Arthur Lira afirma que impeachment não está na pauta da Câmara apesar de 130 pedidos.', 'Não há clima político para impeachment. Não temos elementos técnicos.', 'Declaração em junho de 2021 mantendo as centenas de pedidos de impeachment engavetados.', 'verified', false, '2021-06-15', 'https://www.cnnbrasil.com.br/politica/lira-impeachment-gaveta/', 'news_article', 3, 'Câmara dos Deputados', 'Entrevista à imprensa', 'lira-impeachment-gaveta-b102-43') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_obs, true FROM ins;

  -- 44
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_freixo, 'Marcelo Freixo cobra Lira pela omissão diante dos pedidos de impeachment.', 'A omissão de Arthur Lira é criminosa. São mais de 500 mil mortos pedindo justiça.', 'Declaração em junho de 2021 cobrando o presidente da Câmara a pautar pedidos de impeachment.', 'verified', false, '2021-06-17', 'https://www.metropoles.com/brasil/politica-br/freixo-lira-impeachment', 'social_media_post', 2, 'Rio de Janeiro', 'Postagem em redes sociais', 'freixo-cobra-lira-b102-44') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ant, true FROM ins;
  ...
  -- 46
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_aziz, 'Aziz chama contrato da Covaxin de "crime grotesco" em plena CPI.', 'O contrato da Covaxin é a ponta do iceberg. Isso é crime escancarado.', 'Declaração em 23 de junho de 2021 durante sessão da CPI após depoimento dos irmãos Miranda.', 'verified', true, '2021-06-23', 'https://g1.globo.com/politica/noticia/2021/06/23/aziz-covaxin-crime.ghtml', 'other', 5, 'Senado Federal', 'Sessão da CPI da Covid', 'aziz-covaxin-crime-b102-46') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_cor, true FROM ins;

  -- 47
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_renan, 'Renan afirma que Bolsonaro sabia da propina na compra da Covaxin.', 'O presidente foi avisado pelo deputado Luis Miranda e não fez nada. Isso é prevaricação.', 'Declaração em 25 de junho de 2021 após depoimento do deputado Luis Miranda, que afirmou ter alertado pessoalmente Bolsonaro.', 'verified', true, '2021-06-25', 'https://www12.senado.leg.br/noticias/materias/2021/06/25/renan-bolsonaro-prevaricacao', 'other', 5, 'Senado Federal', 'Sessão da CPI da Covid', 'renan-prevaricacao-b102-47') ON CONFLICT (slug) DO NOTHING RETURNING id)
  ...
  -- 94
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_vanhattem, 'Marcel van Hattem acusa CPI de perseguição política e defende Bolsonaro.', 'A CPI virou um palanque eleitoral contra o presidente da República.', 'Declaração em outubro de 2021 como deputado do Novo minimizando o relatório final.', 'verified', false, '2021-10-25', 'https://www.metropoles.com/brasil/politica-br/van-hattem-cpi-palanque', 'news_article', 3, 'Câmara dos Deputados', 'Entrevista', 'vanhattem-cpi-palanque-b102-94') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 95
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_feliciano, 'Marco Feliciano defende Bolsonaro e ataca CPI como manobra eleitoral.', 'A CPI é uma farsa. Querem derrubar o presidente de qualquer jeito.', 'Declaração em redes sociais em outubro de 2021 defendendo Bolsonaro após CPI.', 'verified', false, '2021-10-23', 'https://www2.camara.leg.br/camaranoticias/noticias/POLITICA/feliciano-cpi-farsa.html', 'social_media_post', 3, 'Câmara dos Deputados', 'Postagem em redes sociais', 'feliciano-cpi-farsa-b102-95') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 96
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_magno, 'Magno Malta defende Bolsonaro em culto evangélico e chama CPI de conspiração.', 'É tudo conspiração. O presidente foi escolhido por Deus.', 'Declaração em culto evangélico em Vila Velha em outubro de 2021 defendendo Bolsonaro.', 'verified', false, '2021-10-24', 'https://www.poder360.com.br/congresso/magno-malta-culto-bolsonaro/', 'news_article', 2, 'Vila Velha, ES', 'Culto evangélico', 'magno-malta-culto-b102-96') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 97
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_silas, 'Silas Câmara defende Bolsonaro na bancada evangélica e tenta diminuir CPI.', 'Nenhum presidente fez tanto pela família brasileira. CPI é perseguição.', 'Declaração em outubro de 2021 como líder da bancada evangélica na Câmara.', 'verified', false, '2021-10-26', 'https://www2.camara.leg.br/camaranoticias/noticias/POLITICA/silas-camara-bancada.html', 'news_article', 2, 'Câmara dos Deputados', 'Reunião de bancada', 'silas-bancada-b102-97') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 98
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_carlos, 'Carlos Bolsonaro ataca CPI em série de postagens e defende tratamento precoce.', 'A CPI é uma farsa nojenta. Meu pai salvou vidas com hidroxicloroquina.', 'Postagens em redes sociais em outubro de 2021 atacando relatório final da CPI.', 'verified', false, '2021-10-27', 'https://www.metropoles.com/brasil/politica-br/carlos-bolsonaro-cpi-posts', 'social_media_post', 3, 'Rio de Janeiro', 'Postagens em redes sociais', 'carlos-bolsonaro-cpi-posts-b102-98') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins UNION ALL SELECT id, c_neg, false FROM ins;

  -- 99
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_pacheco, 'Pacheco confirma envio do relatório da CPI ao STF, PGR e órgãos internacionais.', 'O relatório será encaminhado aos órgãos competentes para as devidas providências.', 'Anúncio em 27 de outubro de 2021 no encerramento oficial da CPI da Covid.', 'verified', false, '2021-10-27', 'https://www12.senado.leg.br/noticias/materias/2021/10/27/pacheco-envio-relatorio', 'other', 2, 'Senado Federal', 'Ato de encerramento da CPI', 'pacheco-envio-relatorio-b102-99') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ant, true FROM ins;

  -- 100
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_renan, 'Renan Calheiros afirma que relatório da CPI é "memória dos mortos" da pandemia.', 'Este relatório é a memória dos mortos da pandemia. Não será esquecido.', 'Declaração em entrevista em 28 de outubro de 2021 ao jornal Folha de São Paulo.', 'verified', false, '2021-10-28', 'https://www1.folha.uol.com.br/poder/2021/10/renan-memoria-mortos.shtml', 'news_article', 2, 'Maceió, AL', 'Entrevista à imprensa', 'renan-memoria-mortos-b102-100') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ant, true FROM ins;
