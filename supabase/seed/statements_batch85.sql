...
BEGIN
  ...
  -- 29
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_lul, 'Lula condena genocídio em Gaza mas recusa romper com Israel.', 'Não vou romper relações diplomáticas com Israel. Romper não ajuda o povo palestino. Mas vou continuar denunciando o genocídio.', 'Entrevista à Rádio Bandeirantes em junho de 2024 sobre pressão por romper relações.', 'verified', false, '2024-06-20', 'https://g1.globo.com/politica/noticia/2024/06/20/lula-rompimento-israel-gaza.ghtml', 'news_article', 2, 'Brasília', 'Entrevista Rádio Bandeirantes', 'lula-rompimento-israel-b85-29') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, false FROM ins;

  -- 30
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_lul, 'Lula chama Macron de parceiro na Amazônia e na energia limpa.', 'Com Macron construímos uma agenda de cooperação concreta na Amazônia, na energia, na COP30. A França é parceira estratégica do Brasil.', 'Declaração conjunta em Belém em março de 2024 na visita de Emmanuel Macron ao Brasil.', 'verified', false, '2024-03-26', 'https://www.lemonde.fr/international/article/2024/03/26/lula-macron-amazonie-cooperation.html', 'news_article', 1, 'Belém', 'Visita oficial de Emmanuel Macron', 'lula-macron-amazonia-b85-30') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, false FROM ins;

  -- 31
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_lul, 'Lula critica Macron por bloquear acordo Mercosul-UE.', 'A França com o Macron está no caminho errado ao bloquear o acordo Mercosul-UE. Eles querem proteger seus agricultores, mas querem vender para o mundo.', 'Entrevista em Brasília em novembro de 2024 antes da assinatura do acordo.', 'verified', false, '2024-11-15', 'https://www.lemonde.fr/international/article/2024/11/15/lula-critique-macron-mercosur.html', 'news_article', 2, 'Brasília', 'Entrevista coletiva', 'lula-critica-macron-mercosul-b85-31') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, false FROM ins;

  -- 32
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_lul, 'Lula fala em português com Biden em bilateral e confunde tradução.', 'Eu pensei que o Biden falava português. Na minha cabeça a gente tava se entendendo bem. Ele balançou a cabeça várias vezes.', 'Relato em entrevista à CBN em fevereiro de 2023 sobre primeira reunião com Biden em Washington.', 'verified', false, '2023-02-12', 'https://g1.globo.com/politica/noticia/2023/02/12/lula-biden-portugues-traducao.ghtml', 'news_article', 1, 'Brasília', 'Entrevista CBN', 'lula-biden-portugues-b85-32') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, false FROM ins;
  ...
  -- 99
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_lul, 'Lula discursa na ONU em 2025 como anfitrião da COP30.', 'A COP30 em Belém é a última chance para o mundo. Ou agimos, ou o planeta não aguenta. O Brasil está pronto para liderar.', 'Discurso de abertura da 80ª AG da ONU em setembro de 2025.', 'verified', true, '2025-09-23', 'https://agenciabrasil.ebc.com.br/politica/noticia/2025-09/lula-onu-cop30-belem', 'news_article', 1, 'Nova York', 'Assembleia-Geral da ONU 2025', 'lula-onu-2025-cop30-b85-99') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 100
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_lul, 'Lula declara vitória da COP30 após aprovação de fundo amazônico.', 'A COP30 foi um sucesso. Aprovamos o Fundo Florestas para Sempre. 125 bilhões de dólares. A Amazônia foi ouvida em Belém.', 'Discurso no encerramento da COP30 em Belém em novembro de 2025.', 'verified', true, '2025-11-21', 'https://g1.globo.com/meio-ambiente/cop-30/noticia/2025/11/21/lula-cop30-encerramento-fundo.ghtml', 'news_article', 1, 'Belém', 'Encerramento da COP30', 'lula-cop30-encerramento-b85-100') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;
