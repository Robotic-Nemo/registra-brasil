...
BEGIN
  ...
  -- 1
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_nik, 'Nikolas acusa Lula de "entregar o Brasil" para China em acordos.', 'Lula está entregando o Brasil para a China, é um traidor da pátria.', 'Postagem em rede social após viagem de Lula a Pequim.', 'verified', true, '2025-01-15', 'https://www.metropoles.com/brasil/politica-br/nikolas-lula-china-entrega', 'social_media_post', 3, 'Brasília', 'Postagem em rede social', 'nikolas-lula-china-entrega-b133-1') RETURNING id)
