...
BEGIN
  ...
  -- 35
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_fla, 'Flávio Bolsonaro nega vínculos com Queiroz e atribui depósitos a negócios pessoais.', 'Queiroz era um funcionário, nunca houve esquema. Os depósitos eram meus, lícitos.', 'Entrevista à Rede Globo tentando esclarecer movimentações financeiras do ex-assessor.', 'verified', true, '2019-01-22', 'https://g1.globo.com/politica/noticia/flavio-bolsonaro-nega-vinculo-com-queiroz.ghtml', 'news_article', 4, 'Rio de Janeiro', 'Entrevista ao Jornal Nacional', 'flavio-nega-vinculos-queiroz-b123-35') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 36
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mor, 'Moro apresenta pacote anticrime com medidas duras contra crime organizado.', 'O Brasil precisa endurecer contra o crime. Esse é o projeto mais importante da gestão.', 'Apresentação do pacote anticrime do Ministério da Justiça.', 'verified', true, '2019-02-04', 'https://www1.folha.uol.com.br/poder/2019/02/moro-apresenta-pacote-anticrime.shtml', 'news_article', 2, 'Brasília', 'Apresentação do pacote', 'moro-pacote-anticrime-b123-36') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 37
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jair, 'Bolsonaro assina decreto que facilita posse de armas.', 'O povo bom tem que ter o direito de se defender. Vamos desengessar a posse.', 'Assinatura de decreto presidencial no Palácio do Planalto.', 'verified', true, '2019-01-15', 'https://g1.globo.com/politica/noticia/bolsonaro-assina-decreto-que-facilita-posse-de-armas.ghtml', 'news_article', 3, 'Brasília', 'Decreto de armas', 'bolsonaro-decreto-armas-b123-37') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_vio, true FROM ins;

  -- 38
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mou, 'Mourão minimiza regime militar e chama ditadura de ''período de exceção''.', 'Aquilo foi um período de exceção necessário. O Brasil corria risco real.', 'Entrevista ao Jornal da Record em que defende o regime militar.', 'verified', true, '2019-03-29', 'https://veja.abril.com.br/politica/mourao-defende-regime-militar-como-periodo-de-excecao/', 'news_article', 4, 'Brasília', 'Entrevista à Record', 'mourao-ditadura-periodo-excecao-b123-38') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_neg, true FROM ins;

  -- 39
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jair, 'Bolsonaro manda comemorar ''Dia do Golpe'' de 1964 em quartéis.', 'O 31 de março deve ser relembrado como o dia em que o Brasil foi salvo do comunismo.', 'Ordem enviada ao Ministério da Defesa para comemorar 55 anos do golpe.', 'verified', true, '2019-03-25', 'https://www1.folha.uol.com.br/poder/2019/03/bolsonaro-manda-comemorar-golpe-de-1964.shtml', 'news_article', 5, 'Brasília', 'Comemoração do golpe', 'bolsonaro-comemora-golpe-1964-b123-39') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ant, true FROM ins;

  -- 40
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_dam, 'Damares diz em culto que viu Jesus em uma goiabeira.', 'Eu subi na goiabeira e encontrei Jesus. Minha vida mudou para sempre ali.', 'Pregação em culto evangélico antes de assumir como ministra.', 'verified', true, '2019-04-06', 'https://g1.globo.com/politica/noticia/damares-alves-diz-que-viu-jesus-em-uma-goiabeira.ghtml', 'other', 2, 'Brasília', 'Culto evangélico', 'damares-jesus-goiabeira-b123-40') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;
