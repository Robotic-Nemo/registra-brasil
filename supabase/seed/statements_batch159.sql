...
BEGIN
  ...
  -- 1
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_fel, 'Feliciano volta a associar religiões afro-brasileiras a "demônios" em culto.', 'Essas entidades do candomblé são demônios. Jesus liberta.', 'Pregação em culto da Assembleia de Deus Catedral da Fé em 2023.', 'verified', true, '2023-02-18', 'https://g1.globo.com/politica/noticia/2023/02/18/feliciano-candomble-demonios.ghtml', 'other', 5, 'São Paulo', 'Culto evangélico', 'feliciano-candomble-demonios-b159-1') ON CONFLICT (slug) DO NOTHING RETURNING id)
  ...
  -- 3
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mag, 'Magno Malta prega que "o Brasil é dos cristãos" em culto na Catedral Mundial.', 'Esse país é dos cristãos. Não aceitamos agenda satânica no Planalto.', 'Pregação em culto da IURD transmitido pela Record em 2023.', 'verified', true, '2023-04-02', 'https://noticias.uol.com.br/politica/ultimas-noticias/2023/04/02/magno-malta-brasil-cristaos-iurd.htm', 'other', 4, 'Rio de Janeiro', 'Culto IURD', 'magno-malta-brasil-cristaos-b159-3') ON CONFLICT (slug) DO NOTHING RETURNING id)
  ...
  -- 14
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_nik, 'Nikolas Ferreira publica vídeo criticando "ideologia LGBT" em escolas.', 'Estão destruindo nossas crianças com essa ideologia. Chega!', 'Publicação em rede social viral em 2023.', 'verified', true, '2023-06-12', 'https://g1.globo.com/politica/noticia/2023/06/12/nikolas-ideologia-lgbt-escolas.ghtml', 'social_media_post', 4, 'Belo Horizonte', 'Rede social', 'nikolas-ideologia-lgbt-escolas-b159-14') ON CONFLICT (slug) DO NOTHING RETURNING id)
  ...
  -- 15
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jair, 'Bolsonaro participa de culto na Assembleia de Deus Vitória em Cristo.', 'O Brasil precisa voltar a Deus. A esquerda é o mal.', 'Culto com o pastor Silas Malafaia em 2023.', 'verified', true, '2023-05-07', 'https://g1.globo.com/politica/noticia/2023/05/07/bolsonaro-malafaia-culto-vitoria.ghtml', 'other', 3, 'Rio de Janeiro', 'Assembleia de Deus Vitória em Cristo', 'bolsonaro-malafaia-culto-b159-15') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_itr, true FROM ins;

  -- 16
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_hil, 'Erika Hilton denuncia discurso de ódio religioso de Feliciano em plenário.', 'É inadmissível que um deputado chame religiões afro de demônios. É crime.', 'Discurso em plenário em resposta a Feliciano em 2023.', 'verified', true, '2023-02-21', 'https://www.camara.leg.br/noticias/923-erika-hilton-feliciano-odio', 'other', 2, 'Brasília', 'Plenário da Câmara', 'hilton-denuncia-feliciano-odio-b159-16') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_itr, true FROM ins;

  -- 17
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_lul, 'Lula recebe líderes evangélicos no Planalto para diálogo.', 'Respeito todas as religiões. O Estado é laico e é dever do presidente ouvir todos.', 'Reunião com pastores no Palácio do Planalto em 2023.', 'verified', false, '2023-04-18', 'https://www.gov.br/planalto/pt-br/2023/04/lula-lideres-evangelicos-dialogo', 'other', 1, 'Brasília', 'Palácio do Planalto', 'lula-evangelicos-dialogo-b159-17') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_itr, true FROM ins;

  -- 18
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_fel, 'Feliciano apoia PL que equipara aborto a homicídio após estupro.', 'Estuprador e mãe que aborta devem receber a mesma pena. É um crime contra Deus.', 'Defesa do PL 1904 na Câmara em 2024.', 'verified', true, '2024-06-12', 'https://g1.globo.com/politica/noticia/2024/06/12/feliciano-pl-1904-aborto-estupro.ghtml', 'other', 5, 'Brasília', 'Câmara dos Deputados', 'feliciano-pl1904-aborto-b159-18') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_mis, true FROM ins UNION ALL SELECT id, c_itr, false FROM ins;

  -- 19
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_sil, 'Silas Câmara é acusado de receber recursos de igreja para campanha.', 'Doações da igreja sempre foram legais. Não tem nada demais.', 'Reportagem sobre financiamento de campanha.', 'verified', false, '2023-11-08', 'https://www1.folha.uol.com.br/poder/2023/11/silas-camara-igreja-campanha.shtml', 'news_article', 3, 'Brasília', 'Investigação jornalística', 'silas-camara-igreja-campanha-b159-19') ON CONFLICT (slug) DO NOTHING RETURNING id)
  ...
  -- 20
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_orl, 'Orlando Silva defende regulação de plataformas contra discurso religioso de ódio.', 'Pastores que pregam ódio contra outras religiões devem responder por isso.', 'Entrevista sobre PL das Fake News em 2023.', 'verified', false, '2023-04-25', 'https://www.camara.leg.br/noticias/956-orlando-silva-regulacao-odio-religioso', 'other', 2, 'Brasília', 'Câmara dos Deputados', 'orlando-silva-regulacao-odio-b159-20') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_itr, true FROM ins;

  -- 21
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mag, 'Magno Malta grava vídeo em culto dizendo que "Lula é anticristo".', 'Esse governo é comandado pelo anticristo. Vamos orar pela libertação do Brasil.', 'Vídeo em culto em 2024.', 'verified', true, '2024-03-10', 'https://noticias.uol.com.br/politica/ultimas-noticias/2024/03/10/magno-malta-lula-anticristo.htm', 'social_media_post', 5, 'Vitória', 'Culto evangélico', 'magno-malta-lula-anticristo-b159-21') ON CONFLICT (slug) DO NOTHING RETURNING id)
  ...
  -- 22
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_pet, 'Talíria Petrone denuncia ataques a terreiros no Rio em plenário.', 'Terreiros estão sendo queimados e pessoas agredidas. Isso é racismo religioso.', 'Discurso em plenário em 2023.', 'verified', false, '2023-05-30', 'https://www.camara.leg.br/noticias/970-taliria-terreiros-rio', 'other', 2, 'Brasília', 'Plenário da Câmara', 'taliria-terreiros-rio-b159-22') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_itr, true FROM ins;

  -- 23
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_dam, 'Damares nega ter feito declaração sobre "menino veste azul, menina veste rosa" após críticas.', 'Fui mal interpretada. Mas defendo sim a diferença entre meninos e meninas.', 'Entrevista no Senado em 2023.', 'verified', false, '2023-07-05', 'https://g1.globo.com/politica/noticia/2023/07/05/damares-menino-azul-menina-rosa.ghtml', 'news_article', 3, 'Brasília', 'Senado Federal', 'damares-menino-azul-menina-rosa-b159-23') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_hom, true FROM ins UNION ALL SELECT id, c_des, false FROM ins;

  -- 24
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_fel, 'Feliciano critica nomeação de Anielle Franco: "agenda ideológica afrocentrista".', 'Essa ministra quer impor religião afro no governo. Cadê a laicidade?', 'Comentário em programa de TV em 2023.', 'verified', false, '2023-03-22', 'https://www1.folha.uol.com.br/poder/2023/03/feliciano-anielle-afrocentrista.shtml', 'news_article', 4, 'São Paulo', 'Programa de TV', 'feliciano-anielle-afrocentrista-b159-24') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_itr, true FROM ins;

  -- 25
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_nik, 'Nikolas ataca Ministério dos Direitos Humanos por "perseguição a cristãos".', 'O governo Lula persegue cristãos e protege macumbeiros. Isso é inaceitável.', 'Publicação em rede social em 2023.', 'verified', true, '2023-08-10', 'https://g1.globo.com/politica/noticia/2023/08/10/nikolas-mdh-perseguicao-cristaos.ghtml', 'social_media_post', 5, 'Belo Horizonte', 'Rede social', 'nikolas-mdh-perseguicao-cristaos-b159-25') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_itr, true FROM ins UNION ALL SELECT id, c_des, false FROM ins;

  -- 26
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jaq, 'Jaques Wagner defende laicidade do Estado em discurso no Senado.', 'O Estado brasileiro é laico. Isso precisa ser respeitado por todos os poderes.', 'Discurso no plenário do Senado em 2023.', 'verified', false, '2023-06-20', 'https://www12.senado.leg.br/noticias/materias/2023/06/20/wagner-laicidade-estado', 'other', 1, 'Brasília', 'Senado Federal', 'wagner-laicidade-estado-b159-26') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_itr, true FROM ins;

  -- 27
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_kic, 'Bia Kicis prega em culto sobre "exército de Deus" no Congresso.', 'Somos um exército do Senhor no Congresso. Vamos tomar esse país para Jesus.', 'Culto na Câmara em 2023.', 'verified', false, '2023-10-04', 'https://noticias.uol.com.br/politica/ultimas-noticias/2023/10/04/kicis-exercito-deus-congresso.htm', 'other', 4, 'Brasília', 'Culto na Câmara', 'kicis-exercito-deus-congresso-b159-27') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_itr, true FROM ins UNION ALL SELECT id, c_aut, false FROM ins;

  -- 28
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_sil, 'Silas Câmara defende isenção fiscal ampla para igrejas.', 'Igreja não paga imposto porque faz obra social. Tem que ampliar a isenção.', 'Defesa de PL sobre imunidade tributária em 2024.', 'verified', false, '2024-04-15', 'https://www.camara.leg.br/noticias/1020-silas-camara-isencao-fiscal-igrejas', 'other', 3, 'Brasília', 'Câmara dos Deputados', 'silas-camara-isencao-igrejas-b159-28') ON CONFLICT (slug) DO NOTHING RETURNING id)
  ...
  -- 29
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mic, 'Michelle Bolsonaro faz "oração profética" pela volta do marido.', 'Profetizo a volta de Bolsonaro. Deus vai fazer justiça.', 'Culto em Brasília em 2024.', 'verified', true, '2024-01-14', 'https://g1.globo.com/politica/noticia/2024/01/14/michelle-oracao-profetica-bolsonaro.ghtml', 'other', 3, 'Brasília', 'Culto evangélico', 'michelle-oracao-profetica-b159-29') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_itr, true FROM ins;

  -- 30
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_pmc, 'Pablo Marçal se apresenta como "coach cristão" e é criticado por pastores.', 'Jesus foi o maior coach da história. Ele ensinou abundância.', 'Evento de campanha em São Paulo em 2024.', 'verified', true, '2024-08-05', 'https://www1.folha.uol.com.br/poder/2024/08/marcal-coach-cristao-jesus.shtml', 'other', 3, 'São Paulo', 'Evento de campanha', 'marcal-coach-cristao-jesus-b159-30') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_itr, true FROM ins UNION ALL SELECT id, c_des, false FROM ins;

  -- 31
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_fel, 'Feliciano pede urgência para PL que proíbe neutralidade de gênero em documentos.', 'Não existe gênero neutro. Deus criou macho e fêmea. Ponto.', 'Discurso em plenário em 2024.', 'verified', false, '2024-05-07', 'https://www.camara.leg.br/noticias/1028-feliciano-pl-genero-documentos', 'other', 4, 'Brasília', 'Câmara dos Deputados', 'feliciano-pl-genero-documentos-b159-31') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_hom, true FROM ins UNION ALL SELECT id, c_itr, false FROM ins;

  -- 32
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_dam, 'Damares defende "cura gay" em entrevista a rádio cristã.', 'Existe sim possibilidade de mudança. Muitas pessoas saem dessa vida.', 'Entrevista à rádio gospel em 2024.', 'verified', true, '2024-07-15', 'https://g1.globo.com/politica/noticia/2024/07/15/damares-cura-gay-radio.ghtml', 'other', 5, 'Brasília', 'Entrevista em rádio', 'damares-cura-gay-radio-b159-32') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_hom, true FROM ins UNION ALL SELECT id, c_itr, false FROM ins;

  -- 33
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_din, 'Flávio Dino defende laicidade ao criticar cruzes em tribunais.', 'A presença de símbolos religiosos em tribunais fere a laicidade constitucional.', 'Debate sobre laicidade no STF em 2024.', 'verified', false, '2024-03-18', 'https://www.stf.jus.br/noticias/1045-dino-laicidade-tribunais', 'other', 2, 'Brasília', 'STF', 'dino-laicidade-tribunais-b159-33') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_itr, true FROM ins;

  -- 34
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mag, 'Magno Malta apoia pastor investigado por estelionato em culto.', 'Esse pastor é um homem de Deus. Estão perseguindo os cristãos.', 'Culto em apoio a pastor da IURD em 2023.', 'verified', false, '2023-12-03', 'https://noticias.uol.com.br/politica/ultimas-noticias/2023/12/03/malta-pastor-iurd-estelionato.htm', 'other', 3, 'Rio de Janeiro', 'Culto IURD', 'malta-pastor-iurd-estelionato-b159-34') ON CONFLICT (slug) DO NOTHING RETURNING id)
  ...
  -- 42
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_san, 'Sanderson defende porte de armas para pastores.', 'Pastor também tem que se defender. Criminosos atacam igrejas.', 'Debate na Câmara em 2023.', 'verified', false, '2023-06-01', 'https://www.camara.leg.br/noticias/971-sanderson-armas-pastores', 'other', 3, 'Brasília', 'Câmara dos Deputados', 'sanderson-armas-pastores-b159-42') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_itr, true FROM ins;

  -- 43
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_pad, 'Padilha se reúne com líderes evangélicos sobre SUS.', 'Precisamos de toda a sociedade para fortalecer o SUS, incluindo as igrejas.', 'Reunião no Ministério da Saúde em 2024.', 'verified', false, '2024-06-10', 'https://www.gov.br/saude/pt-br/2024/06/padilha-evangelicos-sus', 'other', 1, 'Brasília', 'Ministério da Saúde', 'padilha-evangelicos-sus-b159-43') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_itr, true FROM ins;

  -- 44
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mag, 'Magno Malta afirma que "o diabo trabalha pelo STF" em culto.', 'O STF está possuído. O diabo trabalha naquela Corte.', 'Culto em Brasília em 2024.', 'verified', true, '2024-04-22', 'https://noticias.uol.com.br/politica/ultimas-noticias/2024/04/22/malta-diabo-stf-culto.htm', 'other', 5, 'Brasília', 'Culto evangélico', 'malta-diabo-stf-b159-44') ON CONFLICT (slug) DO NOTHING RETURNING id)
  ...
  -- 48
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_hum, 'Humberto Costa critica interferência de pastores em votações sensíveis.', 'Pastor pode ter sua fé, mas não pode ditar lei para 200 milhões de brasileiros.', 'Discurso no Senado em 2023.', 'verified', false, '2023-08-30', 'https://www12.senado.leg.br/noticias/materias/2023/08/30/humberto-costa-pastores-votacoes', 'other', 1, 'Brasília', 'Senado Federal', 'humberto-costa-pastores-votacoes-b159-48') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_itr, true FROM ins;

  -- 49
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_dam, 'Damares defende presença de capelães evangélicos em escolas públicas.', 'As crianças precisam ter acesso à palavra de Deus.', 'Discurso no Senado em 2024.', 'verified', false, '2024-05-02', 'https://www12.senado.leg.br/noticias/materias/2024/05/02/damares-capelaes-escolas', 'other', 3, 'Brasília', 'Senado Federal', 'damares-capelaes-escolas-b159-49') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_itr, true FROM ins;

  -- 50
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jair, 'Bolsonaro é ovacionado em culto da Assembleia de Deus em Brasília.', 'Deus e pátria. Família e liberdade. Essa é a nossa luta.', 'Culto em Brasília em 2024.', 'verified', true, '2024-06-15', 'https://g1.globo.com/politica/noticia/2024/06/15/bolsonaro-assembleia-deus-brasilia.ghtml', 'other', 3, 'Brasília', 'Assembleia de Deus', 'bolsonaro-ad-brasilia-b159-50') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_itr, true FROM ins;

  -- 51
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_gir, 'General Girão usa versículos bíblicos para justificar intervenção militar.', 'A Bíblia diz que Deus protege a pátria. As Forças Armadas fazem parte disso.', 'Discurso na Câmara em 2023.', 'verified', false, '2023-05-12', 'https://www.camara.leg.br/noticias/965-girao-biblia-intervencao', 'other', 5, 'Brasília', 'Câmara dos Deputados', 'girao-biblia-intervencao-b159-51') ON CONFLICT (slug) DO NOTHING RETURNING id)
  ...
  -- 52
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_sil, 'Silas Câmara preside sessão dominada por bancada evangélica.', 'Vamos pautar os projetos da família brasileira. Esta Casa tem maioria cristã.', 'Sessão na Câmara em 2024.', 'verified', false, '2024-08-12', 'https://www.camara.leg.br/noticias/1040-silas-camara-sessao-evangelica', 'other', 2, 'Brasília', 'Câmara dos Deputados', 'silas-camara-sessao-evangelica-b159-52') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_itr, true FROM ins;

  -- 53
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_zan, 'Júlia Zanatta fala em "espírito de Jezabel" ao criticar ministras.', 'Esse espírito de Jezabel tomou conta do governo. É guerra espiritual.', 'Live em rede social em 2024.', 'verified', false, '2024-03-05', 'https://noticias.uol.com.br/politica/ultimas-noticias/2024/03/05/zanatta-jezabel-ministras.htm', 'social_media_post', 4, 'Florianópolis', 'Live em rede social', 'zanatta-jezabel-ministras-b159-53') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_mis, true FROM ins UNION ALL SELECT id, c_itr, false FROM ins;

  -- 54
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_fel, 'Feliciano é condenado em segunda instância por injúria a umbandistas.', 'Não vou me calar. Continuarei defendendo Jesus.', 'Reação a condenação judicial em 2024.', 'verified', true, '2024-09-18', 'https://g1.globo.com/politica/noticia/2024/09/18/feliciano-condenado-injuria-umbandistas.ghtml', 'news_article', 5, 'São Paulo', 'Justiça de SP', 'feliciano-condenado-umbandistas-b159-54') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_itr, true FROM ins;

  -- 55
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mag, 'Magno Malta defende "reino de Cristo" como modelo político em entrevista.', 'Não acredito em democracia secular. O reino de Cristo é o modelo.', 'Entrevista a canal evangélico em 2024.', 'verified', false, '2024-07-10', 'https://www1.folha.uol.com.br/poder/2024/07/malta-reino-cristo-democracia.shtml', 'other', 5, 'Vitória', 'Entrevista', 'malta-reino-cristo-b159-55') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_aut, true FROM ins UNION ALL SELECT id, c_itr, false FROM ins;

  -- 56
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_amo, 'Alexandre de Moraes defende punição a discurso de ódio religioso.', 'A liberdade de crença não permite ataque a outras religiões. Isso é crime.', 'Julgamento no STF em 2024.', 'verified', false, '2024-04-04', 'https://www.stf.jus.br/noticias/1050-moraes-odio-religioso', 'other', 2, 'Brasília', 'STF', 'moraes-odio-religioso-b159-56') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_itr, true FROM ins;

  -- 57
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_kic, 'Bia Kicis defende "guerra espiritual" contra ministros do STF.', 'Temos que batalhar no espírito contra esses juízes. Eles estão amarrados.', 'Live em rede social em 2024.', 'verified', false, '2024-05-30', 'https://noticias.uol.com.br/politica/ultimas-noticias/2024/05/30/kicis-guerra-espiritual-stf.htm', 'social_media_post', 5, 'Brasília', 'Live em rede social', 'kicis-guerra-espiritual-stf-b159-57') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_int, true FROM ins UNION ALL SELECT id, c_itr, false FROM ins;

  -- 58
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_pmc, 'Pablo Marçal é criticado por Silas Malafaia por "oportunismo religioso".', 'Não sou qualquer político. Tenho chamado e unção.', 'Entrevista de Marçal em resposta a Malafaia em 2024.', 'verified', true, '2024-09-02', 'https://g1.globo.com/sp/sao-paulo/eleicoes/2024/noticia/2024/09/02/marcal-malafaia-uncao.ghtml', 'other', 3, 'São Paulo', 'Entrevista', 'marcal-malafaia-uncao-b159-58') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 59
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jair, 'Bolsonaro lidera oração coletiva em ato na Paulista.', 'Vamos orar por este país. Deus não vai abandonar o Brasil.', 'Ato na Avenida Paulista em 2024.', 'verified', true, '2024-02-25', 'https://g1.globo.com/sp/sao-paulo/noticia/2024/02/25/bolsonaro-oracao-paulista.ghtml', 'other', 3, 'São Paulo', 'Avenida Paulista', 'bolsonaro-oracao-paulista-b159-59') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_itr, true FROM ins;

  -- 60
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_fla, 'Flávio Bolsonaro defende pauta evangélica no Senado.', 'A família, a fé e a pátria são nossas prioridades.', 'Discurso no Senado em 2023.', 'verified', false, '2023-09-15', 'https://www12.senado.leg.br/noticias/materias/2023/09/15/flavio-pauta-evangelica', 'other', 2, 'Brasília', 'Senado Federal', 'flavio-pauta-evangelica-b159-60') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_itr, true FROM ins;

  -- 61
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_edu, 'Eduardo Bolsonaro reúne-se com líderes da IURD em Miami.', 'A IURD é uma aliada estratégica da direita brasileira nos EUA.', 'Reunião com líderes religiosos em Miami em 2024.', 'verified', false, '2024-08-25', 'https://www1.folha.uol.com.br/poder/2024/08/eduardo-iurd-miami.shtml', 'news_article', 3, 'Miami', 'Reunião política', 'eduardo-iurd-miami-b159-61') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_con, true FROM ins;

  -- 62
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_fel, 'Feliciano fala em "tomar o poder com Jesus" em culto.', 'Vamos tomar o poder em nome de Jesus. Essa nação é d Ele.', 'Culto em São Paulo em 2025.', 'verified', true, '2025-03-09', 'https://g1.globo.com/politica/noticia/2025/03/09/feliciano-tomar-poder-jesus.ghtml', 'other', 5, 'São Paulo', 'Culto evangélico', 'feliciano-tomar-poder-jesus-b159-62') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_aut, true FROM ins UNION ALL SELECT id, c_itr, false FROM ins;

  -- 63
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_lew, 'Lewandowski critica uso de igrejas para campanha ilegal.', 'A legislação eleitoral é clara: igreja não é palanque.', 'Entrevista como ministro da Justiça em 2025.', 'verified', false, '2025-01-20', 'https://www.gov.br/justica/pt-br/2025/01/lewandowski-igrejas-campanha', 'other', 2, 'Brasília', 'Ministério da Justiça', 'lewandowski-igrejas-campanha-b159-63') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_cor, true FROM ins;

  -- 64
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_dam, 'Damares alega "guerra santa" contra governo Lula em comício.', 'Isso é guerra santa. Estamos contra os principados do mal.', 'Comício em Goiânia em 2025.', 'verified', true, '2025-05-04', 'https://g1.globo.com/go/goias/noticia/2025/05/04/damares-guerra-santa-comicio.ghtml', 'other', 5, 'Goiânia', 'Comício', 'damares-guerra-santa-comicio-b159-64') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_aut, true FROM ins UNION ALL SELECT id, c_itr, false FROM ins;

  -- 65
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mag, 'Magno Malta é investigado por desvio em ONG cristã.', 'Tudo foi usado na obra. Não tem desvio nenhum.', 'Reportagem sobre ONG em 2024.', 'verified', true, '2024-10-12', 'https://noticias.uol.com.br/politica/ultimas-noticias/2024/10/12/magno-malta-ong-crista-desvio.htm', 'news_article', 4, 'Vitória', 'Investigação do MPF', 'malta-ong-crista-desvio-b159-65') ON CONFLICT (slug) DO NOTHING RETURNING id)
  ...
  -- 86
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_kic, 'Bia Kicis apresenta PL para proibir "ofensa a símbolos cristãos".', 'Quem zombar da cruz vai ser punido. Temos que proteger a fé.', 'Apresentação de PL em 2024.', 'verified', false, '2024-09-28', 'https://www.camara.leg.br/noticias/1048-kicis-pl-ofensa-cristaos', 'news_article', 4, 'Brasília', 'Câmara dos Deputados', 'kicis-pl-ofensa-cristaos-b159-86') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_itr, true FROM ins UNION ALL SELECT id, c_aut, false FROM ins;

  -- 87
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_pmc, 'Pablo Marçal se diz "ungido por Deus" para candidatura presidencial.', 'Tenho unção para ser presidente. Deus me chamou para libertar o Brasil.', 'Declaração em podcast em 2025.', 'verified', true, '2025-01-15', 'https://g1.globo.com/politica/noticia/2025/01/15/marcal-uncao-presidencial.ghtml', 'other', 4, 'São Paulo', 'Podcast', 'marcal-uncao-presidencial-b159-87') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins UNION ALL SELECT id, c_itr, false FROM ins;

  -- 88
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_eln, 'Elmar Nascimento articula bancada evangélica em troca de apoio a Haddad.', 'Estamos dispostos a dialogar com o ministro, desde que pauta da família seja respeitada.', 'Negociação no Congresso em 2024.', 'verified', false, '2024-11-05', 'https://www1.folha.uol.com.br/poder/2024/11/elmar-bancada-evangelica-haddad.shtml', 'news_article', 2, 'Brasília', 'Congresso Nacional', 'elmar-bancada-evangelica-haddad-b159-88') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_con, true FROM ins;

  -- 89
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_had, 'Haddad rejeita chantagem religiosa sobre reforma tributária.', 'Não vamos negociar princípios em nome de votos. O país precisa da reforma.', 'Entrevista em 2024.', 'verified', false, '2024-11-10', 'https://www.gov.br/fazenda/pt-br/2024/11/haddad-chantagem-religiosa', 'other', 1, 'Brasília', 'Ministério da Fazenda', 'haddad-chantagem-religiosa-b159-89') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_itr, true FROM ins;

  -- 90
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_fel, 'Feliciano ataca Ministro Gilmar Mendes chamando-o de "inimigo da fé".', 'Gilmar é inimigo da fé. Deus vai julgar.', 'Discurso em 2025.', 'verified', true, '2025-05-15', 'https://g1.globo.com/politica/noticia/2025/05/15/feliciano-gilmar-inimigo-fe.ghtml', 'other', 5, 'Brasília', 'Câmara dos Deputados', 'feliciano-gilmar-inimigo-fe-b159-90') ON CONFLICT (slug) DO NOTHING RETURNING id)
  ...
  -- 91
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_gme, 'Gilmar Mendes afirma que "liberdade religiosa não abrange ódio".', 'A liberdade religiosa não permite atacar outras religiões. Isso é crime.', 'Sessão do STF em 2024.', 'verified', false, '2024-06-15', 'https://www.stf.jus.br/noticias/1055-gilmar-liberdade-religiosa', 'other', 2, 'Brasília', 'STF', 'gilmar-liberdade-religiosa-b159-91') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_itr, true FROM ins;

  -- 92
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_dam, 'Damares apoia pastor acusado de assédio sexual.', 'Esse pastor é íntegro. Estão montando um complô.', 'Declaração em 2024.', 'verified', false, '2024-10-30', 'https://noticias.uol.com.br/politica/ultimas-noticias/2024/10/30/damares-pastor-assedio.htm', 'other', 4, 'Brasília', 'Entrevista', 'damares-pastor-assedio-b159-92') ON CONFLICT (slug) DO NOTHING RETURNING id)
