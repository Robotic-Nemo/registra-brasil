...
BEGIN
  ...
  -- 8
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_fla, 'Flávio Bolsonaro classifica julgamentos do 8J como perseguição política.', 'O STF está fazendo uma perseguição política, não um julgamento.', 'Entrevista à TV Senado sobre os julgamentos.', 'verified', false, '2023-10-10', 'https://www12.senado.leg.br/noticias/materias/2023/10/10/flavio-bolsonaro-critica-stf', 'news_article', 3, 'Senado Federal', 'Entrevista à TV Senado', 'flavio-critica-julgamentos-8j-b125-8') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ame, true FROM ins;

  -- 9
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_edu, 'Eduardo Bolsonaro defende anistia para réus do 8 de Janeiro.', 'Essa gente não merece estar na cadeia, precisamos de uma anistia ampla.', 'Entrevista a rádio após sessão na Câmara.', 'verified', true, '2023-10-18', 'https://www.cnnbrasil.com.br/politica/eduardo-bolsonaro-anistia-8j/', 'news_article', 3, 'Câmara dos Deputados', 'Entrevista a rádio', 'eduardo-defende-anistia-8j-b125-9') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ant, true FROM ins;

  -- 10
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_lir, 'Arthur Lira adia votação do projeto de anistia do 8J após pressão.', 'Não há consenso para pautar a anistia neste momento.', 'Declaração após reunião de líderes na Câmara.', 'verified', false, '2023-10-25', 'https://www1.folha.uol.com.br/poder/2023/10/lira-adia-anistia-8j.shtml', 'news_article', 2, 'Câmara dos Deputados', 'Declaração a imprensa', 'lira-adia-anistia-b125-10') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_con, true FROM ins;

  -- 11
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_kic, 'Bia Kicis afirma que não houve golpe e minimiza 8J.', 'Não houve golpe, houve apenas cidadãos protestando contra a fraude eleitoral.', 'Entrevista à CNN Brasil sobre julgamentos.', 'verified', true, '2023-10-27', 'https://www.cnnbrasil.com.br/politica/bia-kicis-nega-golpe-8j/', 'news_article', 4, 'Brasília', 'Entrevista CNN', 'kicis-nega-golpe-8j-b125-11') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_neg, true FROM ins;

  -- 12
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_zam, 'Zambelli relaciona julgamentos do 8J a uma perseguição política organizada.', 'Estão criminalizando qualquer um que divergiu do governo Lula.', 'Publicação em redes sociais da deputada.', 'verified', false, '2023-11-02', 'https://www.metropoles.com/brasil/politica-brasil/zambelli-critica-julgamentos-8j', 'news_article', 3, 'Redes sociais', 'Publicação em redes', 'zambelli-critica-julgamentos-b125-12') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 13
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_gle, 'Gleisi Hoffmann defende punição rigorosa aos responsáveis pelo 8J.', 'Quem atentou contra a democracia precisa pagar pelo que fez.', 'Entrevista à imprensa na sede do PT.', 'verified', false, '2023-11-08', 'https://www.pt.org.br/gleisi-punicao-8j/', 'other', 1, 'São Paulo', 'Coletiva de imprensa', 'gleisi-defende-punicao-8j-b125-13') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;

  -- 14
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mor, 'Moraes determina quebra de sigilo de financiadores do 8J.', 'Quem financiou os atos responderá criminalmente por tentativa de golpe.', 'Decisão monocrática em inquérito do STF.', 'verified', true, '2023-11-16', 'https://www.stf.jus.br/portal/cms/verNoticiaDetalhe.asp?idConteudo=517002', 'diario_oficial', 1, 'Brasília', 'Decisão STF', 'moraes-quebra-sigilo-financiadores-b125-14') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;

  -- 15
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jai, 'Bolsonaro nega envolvimento em tentativa de golpe ao ser ouvido pela PF.', 'Nunca incentivei nenhum ato antidemocrático, isso é narrativa da esquerda.', 'Depoimento à Polícia Federal em Brasília.', 'verified', true, '2023-11-29', 'https://g1.globo.com/politica/noticia/2023/11/29/bolsonaro-nega-golpe-pf.ghtml', 'news_article', 3, 'Brasília', 'Depoimento PF', 'bolsonaro-nega-golpe-pf-b125-15') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_neg, true FROM ins;
  ...
  -- 27
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_wag, 'Jaques Wagner defende rito acelerado para julgar tentativa de golpe.', 'O Brasil precisa julgar e punir quem atentou contra a democracia.', 'Entrevista no Senado.', 'verified', false, '2024-04-02', 'https://www12.senado.leg.br/noticias/materias/2024/04/02/wagner-defende-julgamento-golpe', 'diario_oficial', 1, 'Senado Federal', 'Entrevista imprensa', 'wagner-rito-golpe-b125-27') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;

  -- 28
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_ran, 'Randolfe classifica tentativa de golpe como atentado histórico.', 'O que aconteceu no 8J foi um atentado sem precedentes à democracia.', 'Pronunciamento no plenário do Senado.', 'verified', false, '2024-04-10', 'https://www12.senado.leg.br/noticias/materias/2024/04/10/randolfe-tentativa-golpe', 'diario_oficial', 1, 'Senado Federal', 'Pronunciamento', 'randolfe-atentado-historico-b125-28') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;

  -- 29
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_dua, 'Duarte Jr defende punição exemplar para articuladores do 8J.', 'Sem punição exemplar, o risco de repetição permanece.', 'Discurso na Câmara dos Deputados.', 'verified', false, '2024-04-11', 'https://www.camara.leg.br/noticias/2024/04/duarte-jr-punicao-8j', 'diario_oficial', 1, 'Câmara dos Deputados', 'Discurso plenário', 'duarte-punicao-exemplar-b125-29') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;

  -- 30
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mor, 'Moraes manda prender general Braga Netto em investigação do golpe.', 'A prisão é necessária para garantir a ordem pública e a aplicação da lei penal.', 'Decisão de prisão preventiva no inquérito do golpe.', 'verified', true, '2024-12-14', 'https://g1.globo.com/politica/noticia/2024/12/14/moraes-prende-braga-netto.ghtml', 'news_article', 2, 'Brasília', 'Prisão Braga Netto', 'moraes-prende-braga-netto-b125-30') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;

  -- 31
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_edu, 'Eduardo Bolsonaro se muda para os EUA e pede asilo político.', 'O Brasil vive uma ditadura do STF, não posso voltar.', 'Declaração à imprensa americana após deixar o Brasil.', 'verified', true, '2025-03-04', 'https://www.cnnbrasil.com.br/politica/eduardo-bolsonaro-eua-asilo/', 'news_article', 4, 'Estados Unidos', 'Declaração imprensa', 'eduardo-eua-asilo-b125-31') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ant, true FROM ins;

  -- 32
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mor, 'STF aceita denúncia e Bolsonaro se torna réu por tentativa de golpe.', 'A trama golpista precisa ser julgada com todo o rigor da lei.', 'Sessão da Primeira Turma do STF.', 'verified', true, '2025-03-26', 'https://www.stf.jus.br/portal/cms/verNoticiaDetalhe.asp?idConteudo=523421', 'diario_oficial', 1, 'Brasília', 'Aceite denúncia STF', 'stf-aceita-denuncia-bolsonaro-b125-32') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;
  ...
  -- 40
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mic, 'Michelle defende Bolsonaro e ataca STF em ato da Paulista.', 'Estão perseguindo um homem inocente, Deus julgará.', 'Discurso no ato da Paulista.', 'verified', false, '2025-04-06', 'https://g1.globo.com/politica/noticia/2025/04/06/michelle-ato-paulista.ghtml', 'news_article', 3, 'São Paulo', 'Ato Paulista abril', 'michelle-ato-paulista-b125-40') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ame, true FROM ins;
  ...
  -- 72
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_nik, 'Nikolas convoca marcha em defesa de Bolsonaro preso.', 'Não vamos aceitar em silêncio essa prisão política.', 'Publicação em redes sociais convocando protesto.', 'verified', true, '2025-11-23', 'https://g1.globo.com/politica/noticia/2025/11/23/nikolas-marcha-bolsonaro-preso.ghtml', 'news_article', 3, 'Redes sociais', 'Convocação de ato', 'nikolas-marcha-preso-b125-72') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ame, true FROM ins;

  -- 73
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_lew, 'Lewandowski defende condenações e diz que Estado de Direito prevaleceu.', 'O Brasil mostrou que o Estado de Direito não tem vencedores nem perdedores.', 'Entrevista como ministro da Justiça.', 'verified', false, '2025-11-26', 'https://www.gov.br/mj/pt-br/assuntos/noticias/2025/11/lewandowski-estado-direito', 'other', 1, 'Brasília', 'Entrevista imprensa', 'lewandowski-estado-direito-b125-73') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;

  -- 74
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mes, 'Jorge Messias afirma que decisão do STF é marco da maturidade democrática.', 'A decisão do STF consolida a maturidade das instituições.', 'Entrevista como advogado-geral da União.', 'verified', false, '2025-09-16', 'https://www.gov.br/agu/pt-br/comunicacao/noticias/2025/09/messias-maturidade-democratica', 'other', 1, 'Brasília', 'Entrevista imprensa', 'messias-maturidade-democratica-b125-74') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;

  -- 75
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_bar, 'Barroso diz que STF cumpriu seu papel histórico ao julgar golpistas.', 'O STF foi firme na defesa da Constituição, como era seu dever.', 'Entrevista em evento na USP.', 'verified', false, '2025-10-05', 'https://www.usp.br/evento/barroso-stf-papel-historico', 'other', 1, 'São Paulo', 'Evento USP', 'barroso-papel-historico-b125-75') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;

  -- 76
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_fac, 'Fachin assume presidência do STF em meio à execução das penas do golpe.', 'Manteremos o rigor na defesa da democracia e das instituições.', 'Discurso de posse como presidente do STF.', 'verified', true, '2025-09-29', 'https://www.stf.jus.br/portal/cms/verNoticiaDetalhe.asp?idConteudo=526890', 'diario_oficial', 2, 'Brasília', 'Posse STF', 'fachin-assume-stf-b125-76') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;

  -- 77
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mor2, 'Sergio Moro critica condenação e vê desequilíbrio no STF.', 'Preocupa o desequilíbrio institucional nesse julgamento.', 'Entrevista à imprensa no Senado.', 'verified', false, '2025-09-14', 'https://www12.senado.leg.br/noticias/materias/2025/09/14/moro-desequilibrio-stf', 'diario_oficial', 2, 'Senado Federal', 'Entrevista imprensa', 'moro-desequilibrio-stf-b125-77') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 78
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mou, 'Mourão defende anistia ampla como reconciliação nacional.', 'Só uma anistia ampla pode pacificar o país.', 'Discurso em plenário do Senado.', 'verified', false, '2025-09-18', 'https://www12.senado.leg.br/noticias/materias/2025/09/18/mourao-anistia-reconciliacao', 'diario_oficial', 3, 'Senado Federal', 'Discurso plenário', 'mourao-anistia-reconciliacao-b125-78') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ant, true FROM ins;

  -- 79
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_pac, 'Pacheco afirma que Senado arquivará PL da anistia ampla.', 'O Senado jamais concederá anistia aos condenados pelo STF.', 'Entrevista no Senado Federal.', 'verified', false, '2025-09-20', 'https://www12.senado.leg.br/noticias/materias/2025/09/20/pacheco-arquivar-anistia', 'diario_oficial', 1, 'Senado Federal', 'Entrevista imprensa', 'pacheco-arquivar-anistia-b125-79') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;

  -- 80
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mor, 'Moraes nega pedido de Bolsonaro para cumprir pena em regime domiciliar.', 'Não há fundamento legal que permita regime domiciliar ao condenado.', 'Decisão monocrática no STF.', 'verified', false, '2025-12-15', 'https://www.stf.jus.br/portal/cms/verNoticiaDetalhe.asp?idConteudo=528123', 'diario_oficial', 1, 'Brasília', 'Decisão STF', 'moraes-nega-domiciliar-b125-80') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;
  ...
  -- 82
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mor, 'Moraes cita necessidade de julgar militares envolvidos no golpe.', 'Os militares que participaram da trama serão responsabilizados igualmente.', 'Voto em sessão do STF.', 'verified', false, '2026-01-22', 'https://www.stf.jus.br/portal/cms/verNoticiaDetalhe.asp?idConteudo=528901', 'diario_oficial', 1, 'Brasília', 'Sessão STF', 'moraes-julgar-militares-b125-82') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;

  -- 83
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_lul, 'Lula faz balanço de três anos do 8 de Janeiro em cerimônia oficial.', 'Três anos depois, a democracia está mais forte e as instituições, respeitadas.', 'Cerimônia em Brasília marcando os três anos do 8J.', 'verified', true, '2026-01-08', 'https://www.gov.br/planalto/pt-br/acompanhe-o-planalto/discursos/2026/01/lula-tres-anos-8j', 'diario_oficial', 2, 'Brasília', 'Três anos do 8J', 'lula-tres-anos-8j-b125-83') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;

  -- 84
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_din, 'Flávio Dino prefaceia livro sobre julgamento histórico do 8J.', 'A memória desses julgamentos é patrimônio da nossa democracia.', 'Lançamento de livro em evento acadêmico.', 'verified', false, '2026-02-14', 'https://www.stf.jus.br/portal/cms/verNoticiaDetalhe.asp?idConteudo=529201', 'diario_oficial', 1, 'Brasília', 'Lançamento livro', 'dino-livro-julgamento-b125-84') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;

  -- 85
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_zan, 'Zanin rejeita novo habeas corpus de Bolsonaro em 2026.', 'Não há fatos novos que justifiquem a concessão de habeas corpus.', 'Decisão monocrática no STF.', 'verified', false, '2026-03-04', 'https://www.stf.jus.br/portal/cms/verNoticiaDetalhe.asp?idConteudo=529510', 'diario_oficial', 1, 'Brasília', 'Decisão STF', 'zanin-rejeita-hc-bolsonaro-b125-85') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;

  -- 86
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mor, 'Moraes condena Carlos Bolsonaro por ataques ao STF em redes.', 'Ataques sistemáticos às instituições também são crimes contra a democracia.', 'Decisão de condenação no STF.', 'verified', true, '2026-04-01', 'https://www.stf.jus.br/portal/cms/verNoticiaDetalhe.asp?idConteudo=530010', 'diario_oficial', 1, 'Brasília', 'Condenação Carlos', 'moraes-condena-carlos-b125-86') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;

  -- 87
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_car2, 'Carlos Bolsonaro é condenado por ataques sistemáticos ao STF.', 'Essa condenação é mais uma perseguição política da família Bolsonaro.', 'Declaração após decisão do STF.', 'verified', true, '2026-04-01', 'https://g1.globo.com/politica/noticia/2026/04/01/carlos-bolsonaro-condenado.ghtml', 'news_article', 3, 'Rio de Janeiro', 'Reação condenação', 'carlos-condenado-b125-87') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_int, true FROM ins;

  -- 88
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_lul, 'Lula participa de evento em memória ao 8 de Janeiro com democracia consolidada.', 'A democracia brasileira passou pelo seu teste mais duro e venceu.', 'Cerimônia no Palácio do Planalto em 2026.', 'verified', false, '2026-01-08', 'https://www.gov.br/planalto/pt-br/acompanhe-o-planalto/pronunciamentos/2026/01/lula-memoria-8j', 'diario_oficial', 2, 'Brasília', 'Cerimônia 8J 2026', 'lula-memoria-8j-2026-b125-88') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;

  -- 89
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jai, 'Bolsonaro lança biografia da cadeia acusando perseguição.', 'Quando sair, escreverei a verdadeira história do Brasil.', 'Entrevista concedida da prisão.', 'verified', true, '2026-02-20', 'https://www.cnnbrasil.com.br/politica/bolsonaro-biografia-cadeia/', 'news_article', 3, 'Brasília', 'Entrevista prisão', 'bolsonaro-biografia-cadeia-b125-89') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;
