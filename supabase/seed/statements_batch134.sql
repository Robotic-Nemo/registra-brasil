...
BEGIN
  ...
  -- 38
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_agu, 'Aguinaldo Ribeiro tem nome citado em esquema de emendas na PB.', 'Nunca intermediei desvio de recursos públicos. Rejeito a acusação.', 'Reportagem do UOL aponta direcionamento de emendas a prefeituras aliadas.', 'verified', false, '2024-07-19', 'https://noticias.uol.com.br/politica/2024/07/19/aguinaldo-emendas-paraiba.htm', 'news_article', 3, 'Câmara dos Deputados', 'Reportagem investigativa', 'aguinaldo-emendas-pb-b134-38') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_cor, true FROM ins;

  -- 39
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mot, 'Hugo Motta é alvo de reportagem por emendas à família na PB.', 'Minhas indicações seguem critério técnico e atendem à minha base eleitoral.', 'Reportagem do Estadão mostra R$ 200 milhões destinados a cidades de redutos da família.', 'verified', false, '2025-04-02', 'https://www.estadao.com.br/politica/hugo-motta-emendas-familia-pb/', 'news_article', 3, 'Câmara dos Deputados', 'Reportagem investigativa', 'motta-emendas-familia-b134-39') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_con, true FROM ins;

  -- 40
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_alc, 'Davi Alcolumbre concentra R$ 1 bilhão em emendas para o Amapá, aponta TCU.', 'Emendas de comissão são instrumento legal de representação do meu estado.', 'TCU destaca concentração histórica de emendas no AP sob comando de Alcolumbre.', 'verified', true, '2025-07-15', 'https://www.tcu.gov.br/noticias/2025/07/emendas-amapa-concentracao.htm', 'other', 3, 'TCU', 'Relatório sobre emendas AP', 'alcolumbre-concentra-emendas-b134-40') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_con, true FROM ins;

  -- 41
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_pac, 'Rodrigo Pacheco é questionado por nomeação de amigos em cargos do Senado.', 'Todas as nomeações seguiram critério técnico e moral.', 'Denúncia envolvendo indicações para Secretaria Geral da Mesa.', 'verified', false, '2024-05-30', 'https://www.metropoles.com/brasil/politica-br/pacheco-nomeacoes-senado', 'news_article', 2, 'Senado Federal', 'Denúncia interna', 'pacheco-nomeacoes-senado-b134-41') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_nep, true FROM ins;
  ...
  -- 85
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_lir, 'Lira diz que Lindbergh "fala o que os patrões mandam".', 'Esse senhor não tem autoridade moral para falar. Fala o que os patrões mandam.', 'Presidente da Câmara retruca ataques do deputado petista.', 'verified', false, '2023-12-14', 'https://www.metropoles.com/brasil/politica-br/lira-lindbergh-patroes', 'news_article', 2, 'Câmara dos Deputados', 'Declaração à imprensa', 'lira-lindbergh-patroes-b134-85') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_int, true FROM ins;

  -- 86
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jai, 'Bolsonaro afirma que foi obrigado a fugir para embaixada húngara.', 'Fui para a embaixada por segurança. Não foi fuga.', 'PF confirma que Bolsonaro passou 2 noites na embaixada da Hungria em fev/2024.', 'verified', true, '2024-03-26', 'https://www1.folha.uol.com.br/poder/2024/03/bolsonaro-embaixada-hungria-fuga.shtml', 'news_article', 5, 'Brasília', 'Declaração à imprensa', 'bolsonaro-embaixada-hungria-b134-86') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_obs, true FROM ins;

  -- 87
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mor, 'Moraes determina tornozeleira a Bolsonaro por risco de fuga.', 'Elementos concretos apontam risco real de fuga para evadir-se da Justiça.', 'STF aplica medidas cautelares após repetidos episódios suspeitos.', 'verified', true, '2025-07-18', 'https://portal.stf.jus.br/noticias/verNoticiaDetalhe.asp?idConteudo=533890', 'other', 1, 'STF', 'Decisão cautelar', 'moraes-tornozeleira-bolsonaro-b134-87') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;

  -- 88
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_gil, 'Gilmar Mendes defende anulação de provas da Lava Jato.', 'Lava Jato cometeu abusos que não podem ser tolerados em uma democracia.', 'Ministro rebate críticas à anulação de provas contra Lula.', 'verified', false, '2024-02-22', 'https://www.conjur.com.br/2024-fev-22/gilmar-defende-anulacao-lava-jato/', 'news_article', 3, 'STF', 'Entrevista à ConJur', 'gilmar-defende-anulacao-b134-88') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_con, true FROM ins;

  -- 89
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jai, 'Bolsonaro é denunciado pela PF por fraude em cartões de vacina.', 'Nunca falsifiquei nada. Isso é mais um teatro.', 'PF indicia ex-presidente e Mauro Cid por esquema de cartões adulterados.', 'verified', true, '2024-03-19', 'https://g1.globo.com/politica/noticia/2024/03/19/bolsonaro-indiciado-cartao-vacina.ghtml', 'news_article', 4, 'Polícia Federal', 'Indiciamento cartões vacina', 'bolsonaro-cartao-vacina-b134-89') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_obs, true FROM ins;

  -- 90
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_dua, 'Duarte Jr. cobra inclusão de Lulinha na lista de indiciados da CPMI.', 'Não aceito blindagem. Lulinha deve responder como qualquer cidadão.', 'Relator defende inclusão após pressão de oposição.', 'verified', true, '2025-10-20', 'https://www.poder360.com.br/congresso/duarte-jr-lulinha-indiciamento/', 'news_article', 3, 'Congresso Nacional', 'Debate na CPMI', 'duarte-inclui-lulinha-b134-90') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_cor, true FROM ins;

  -- 91
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_ran, 'Randolfe sai do PT e critica governo por caso INSS.', 'Foi a pior gestão de crise que já vi. O governo falhou com os aposentados.', 'Senador anuncia saída da base após crise do INSS.', 'verified', true, '2025-06-02', 'https://www12.senado.leg.br/noticias/materias/2025/06/02/randolfe-saida-pt-inss', 'other', 3, 'Senado Federal', 'Anúncio em plenário', 'randolfe-sai-pt-inss-b134-91') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;

  -- 92
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mes, 'Jorge Messias defende autonomia da AGU em caso Juscelino.', 'A AGU atua com autonomia técnica. Não há blindagem do governo.', 'Advogado-geral responde a acusações de omissão no caso Juscelino.', 'verified', false, '2024-04-25', 'https://www.gov.br/agu/pt-br/comunicacao/noticias/2024/04/messias-autonomia', 'other', 1, 'AGU', 'Entrevista à imprensa', 'messias-autonomia-juscelino-b134-92') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;

  -- 93
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jan, 'Jandira Feghali acusa oposição de usar INSS politicamente.', 'A oposição quer transformar uma crise gerencial em escândalo político.', 'Deputada do PCdoB em debate na Câmara.', 'verified', false, '2025-05-18', 'https://www.camara.leg.br/noticias/1069900-jandira-inss-oposicao', 'other', 2, 'Câmara dos Deputados', 'Pronunciamento em plenário', 'jandira-oposicao-inss-b134-93') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;

  -- 94
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_van, 'Marcel van Hattem denuncia uso indevido da Receita Federal pelo governo.', 'Há indícios de que a Receita vem sendo usada como arma política.', 'Deputado apresenta requerimento de CPI sobre vazamentos do Fisco.', 'verified', false, '2024-10-05', 'https://www.camara.leg.br/noticias/1049900-van-hattem-receita-vazamentos', 'other', 3, 'Câmara dos Deputados', 'Requerimento de CPI', 'van-hattem-receita-vazamentos-b134-94') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;

  -- 95
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_had, 'Haddad defende Receita Federal após acusações de vazamentos.', 'A Receita não é usada politicamente. Isso é fake news.', 'Ministro rebate deputados do Novo e do PL.', 'verified', false, '2024-10-08', 'https://valor.globo.com/politica/noticia/2024/10/08/haddad-defende-receita-vazamentos.ghtml', 'news_article', 2, 'Ministério da Fazenda', 'Coletiva de imprensa', 'haddad-defende-receita-b134-95') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;

  -- 96
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jai, 'Bolsonaro começa cumprimento de pena em regime fechado.', 'Sigo preso por convicção. O Brasil merece melhor do que isso.', 'Ex-presidente é levado a cumprir pena em Brasília após trânsito em julgado.', 'verified', true, '2025-11-22', 'https://g1.globo.com/politica/noticia/2025/11/22/bolsonaro-inicia-pena-regime-fechado.ghtml', 'news_article', 5, 'Brasília', 'Cumprimento de pena', 'bolsonaro-inicia-pena-b134-96') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ame, true FROM ins;

  -- 97
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_ale, 'Alessandro Vieira defende extinção do foro privilegiado após Zambelli.', 'A fuga de Zambelli mostra que o foro privilegiado não funciona.', 'Senador apresenta PEC para extinção do foro especial.', 'verified', false, '2025-06-10', 'https://www12.senado.leg.br/noticias/materias/2025/06/10/alessandro-pec-foro', 'other', 1, 'Senado Federal', 'Apresentação de PEC', 'alessandro-pec-foro-b134-97') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_cor, true FROM ins;

  -- 98
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_din, 'Flávio Dino condena aprovação de anistia como "afronta ao Estado de Direito".', 'Anistia para golpistas é afronta inaceitável ao Estado de Direito.', 'Ministro do STF se manifesta sobre projeto em tramitação.', 'verified', true, '2025-09-20', 'https://portal.stf.jus.br/noticias/verNoticiaDetalhe.asp?idConteudo=536000', 'other', 1, 'STF', 'Declaração pública', 'dino-condena-anistia-b134-98') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_obs, true FROM ins;

  -- 99
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_lul, 'Lula diz que vai vetar qualquer anistia a golpistas.', 'Enquanto eu for presidente, não terá anistia para quem atacou a democracia.', 'Presidente reage a articulação do Centrão no Congresso.', 'verified', true, '2025-09-18', 'https://www1.folha.uol.com.br/poder/2025/09/lula-veta-anistia-golpistas.shtml', 'news_article', 2, 'Palácio do Planalto', 'Entrevista coletiva', 'lula-veta-anistia-b134-99') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_obs, true FROM ins;

  -- 100
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_eli, 'Eliziane Gama conclui CPMI do INSS como "maior esquema da história recente".', 'Identificamos o maior esquema de roubo contra aposentados da nossa história.', 'Declaração em coletiva após aprovação do relatório final.', 'verified', true, '2025-10-28', 'https://www.cnnbrasil.com.br/politica/eliziane-cpmi-inss-maior-esquema/', 'news_article', 1, 'Congresso Nacional', 'Coletiva CPMI INSS', 'eliziane-maior-esquema-b134-100') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_cor, true FROM ins;
