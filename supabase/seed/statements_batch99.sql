...
BEGIN
  ...
  -- 20
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_car, 'Carlos Bolsonaro é investigado por articular ataques coordenados nas redes.', 'Não existe gabinete do ódio. É ficção da imprensa.', 'Declaração após CPMI das Fake News iniciar quebra de sigilos.', 'verified', true, '2019-12-10', 'https://g1.globo.com/politica/noticia/2019/12/10/carlos-bolsonaro-gabinete-odio-negacao.ghtml', 'social_media_post', 3, 'Twitter', 'Postagem em rede social', 'carlos-gabinete-odio-negacao-b99-20') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 21
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jair, 'Bolsonaro ataca governadores do Nordeste após reuniões com Macron.', 'Esses governadores do Nordeste são "paraíbas". Estão querendo se aliar à França.', 'Declaração após encontro de governadores do NE com Macron.', 'verified', true, '2019-08-30', 'https://www1.folha.uol.com.br/poder/2019/08/bolsonaro-governadores-paraibas.shtml', 'news_article', 4, 'Brasília', 'Conversa com apoiadores', 'bolsonaro-governadores-paraibas-b99-21') RETURNING id)
  ...
  -- 39
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_fel, 'Feliciano defende Escola sem Partido em palestra.', 'Precisamos proteger nossas crianças da doutrinação ideológica.', 'Palestra em escola de formação política.', 'verified', false, '2019-08-20', 'https://www1.folha.uol.com.br/educacao/2019/08/feliciano-escola-sem-partido.shtml', 'speech', 2, 'Brasília', 'Palestra', 'feliciano-escola-sem-partido-b99-39') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_aut, true FROM ins;

  -- 40
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mag, 'Magno Malta defende leitura bíblica em escolas públicas.', 'A Bíblia tem que voltar para a escola. Nosso país é cristão.', 'Discurso em evento evangélico.', 'verified', false, '2019-10-05', 'https://g1.globo.com/politica/noticia/2019/10/05/malta-biblia-escolas.ghtml', 'speech', 3, 'Vitória, ES', 'Culto evangélico', 'malta-biblia-escolas-b99-40') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_itr, true FROM ins;

  -- 41
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_sil, 'Silas Câmara defende vínculo entre estado e igrejas.', 'O Brasil não é laico de fato. Deus está na Constituição.', 'Declaração em comissão sobre isenções fiscais de igrejas.', 'verified', false, '2019-09-10', 'https://www1.folha.uol.com.br/poder/2019/09/silas-camara-estado-igreja.shtml', 'news_article', 2, 'Câmara dos Deputados', 'Comissão', 'silas-camara-estado-igreja-b99-41') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_itr, true FROM ins;

  -- 42
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_van, 'Van Hattem critica estatais e propõe privatizações aceleradas.', 'Petrobras, Banco do Brasil, Caixa: tudo tem que ser privatizado.', 'Entrevista sobre o programa liberal do Novo.', 'verified', false, '2019-09-15', 'https://valor.globo.com/politica/noticia/2019/09/15/van-hattem-privatizacoes.ghtml', 'news_article', 1, 'Brasília', 'Entrevista', 'van-hattem-privatizacoes-b99-42') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_con, true FROM ins;

  -- 43
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_kim, 'Kim Kataguiri defende plano de Guedes no Congresso.', 'A Previdência aprovada vai salvar o Brasil. Guedes está certo.', 'Entrevista após aprovação no Senado.', 'verified', false, '2019-10-24', 'https://g1.globo.com/politica/noticia/2019/10/24/kim-guedes-previdencia-aprovada.ghtml', 'news_article', 1, 'Brasília', 'Entrevista', 'kim-guedes-previdencia-b99-43') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_con, true FROM ins;

  -- 44
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_adr, 'Adriana Ventura defende corte de ministérios e enxugamento do Estado.', 'O Brasil tem ministérios demais. Hora de enxugar.', 'Declaração sobre reforma administrativa.', 'verified', false, '2019-07-18', 'https://www1.folha.uol.com.br/mercado/2019/07/ventura-corte-ministerios.shtml', 'news_article', 1, 'São Paulo', 'Entrevista', 'ventura-corte-ministerios-b99-44') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_con, true FROM ins;

  -- 45
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_tab, 'Tabata Amaral critica Future-se e ataca corte de bolsas CAPES.', 'Cortar bolsas da CAPES é destruir a pós-graduação brasileira.', 'Discurso em plenário.', 'verified', false, '2019-08-07', 'https://g1.globo.com/politica/noticia/2019/08/07/tabata-capes-cortes.ghtml', 'speech', 1, 'Câmara dos Deputados', 'Plenário', 'tabata-capes-cortes-b99-45') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 46
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_chi, 'Chico Alencar denuncia ataques contínuos à imprensa.', 'Governo declarou guerra à imprensa, ao jornalismo e à democracia.', 'Entrevista à Carta Capital.', 'verified', false, '2019-09-05', 'https://www.cartacapital.com.br/politica/chico-alencar-ataques-imprensa/', 'news_article', 1, 'Rio de Janeiro', 'Entrevista à Carta Capital', 'chico-alencar-ataques-imprensa-b99-46') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_int, true FROM ins;

  -- 47
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jan, 'Jandira Feghali denuncia ataques de Damares a direitos das mulheres.', 'Damares é a pior ministra que o Brasil já teve para os direitos das mulheres.', 'Coletiva após declaração sobre aborto.', 'verified', false, '2020-02-21', 'https://g1.globo.com/politica/noticia/2020/02/21/jandira-damares-direitos-mulheres.ghtml', 'news_article', 1, 'Brasília', 'Coletiva', 'jandira-damares-direitos-mulheres-b99-47') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_mis, true FROM ins;

  -- 48
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_frx, 'Marcelo Freixo é ameaçado após vídeo de Bolsonaro.', 'As ameaças aumentaram depois que o presidente me citou.', 'Denúncia na mídia sobre segurança pessoal.', 'verified', true, '2019-11-03', 'https://oglobo.globo.com/rio/freixo-ameacado-bolsonaro-23615432', 'news_article', 2, 'Rio de Janeiro', 'Entrevista', 'freixo-ameacado-bolsonaro-b99-48') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_vio, true FROM ins;

  -- 49
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jse, 'Serra critica "espetacularização" do governo Bolsonaro.', 'Governar não é tuitar. Precisamos de ações, não lives.', 'Entrevista sobre primeiro ano do governo.', 'verified', false, '2020-01-05', 'https://www1.folha.uol.com.br/poder/2020/01/serra-tuitar-nao-governar.shtml', 'news_article', 1, 'São Paulo', 'Entrevista', 'serra-tuitar-nao-governar-b99-49') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 50
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_gle, 'Gleisi denuncia perseguição política a Lula.', 'Lula é o maior preso político do Brasil. Isso não pode continuar.', 'Entrevista antes da soltura de Lula.', 'verified', false, '2019-10-30', 'https://www.pt.org.br/gleisi-lula-perseguido/', 'news_article', 1, 'Brasília', 'Entrevista', 'gleisi-lula-perseguido-b99-50') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_obs, true FROM ins;

  -- 51
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_lul, 'Lula diz que "não estou com vontade de ser candidato" em primeira entrevista pós-prisão.', 'Não estou com vontade de ser candidato. Estou com vontade de rever o Brasil.', 'Entrevista coletiva após soltura de Curitiba.', 'verified', true, '2019-11-09', 'https://g1.globo.com/sp/sao-bernardo-do-campo-regiao/noticia/2019/11/09/lula-entrevista-abc.ghtml', 'speech', 1, 'São Bernardo do Campo', 'Discurso no Sindicato dos Metalúrgicos', 'lula-solto-abc-discurso-b99-51') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_obs, true FROM ins;

  -- 52
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_dil, 'Dilma critica Moro e Vaza Jato em palestra internacional.', 'A Lava Jato foi um golpe contra a democracia brasileira.', 'Palestra em universidade europeia.', 'verified', false, '2019-07-15', 'https://www1.folha.uol.com.br/poder/2019/07/dilma-lava-jato-golpe.shtml', 'speech', 1, 'Paris', 'Palestra acadêmica', 'dilma-lava-jato-golpe-b99-52') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_obs, true FROM ins;

  -- 53
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_had, 'Haddad alerta para militarização e falta de diálogo.', 'O governo só sabe gritar e militarizar. Falta diálogo e projeto.', 'Discurso em evento do PT em São Paulo.', 'verified', false, '2019-05-01', 'https://g1.globo.com/sp/sao-paulo/noticia/2019/05/01/haddad-militarizacao-governo.ghtml', 'speech', 1, 'São Paulo', 'Ato do 1º de maio', 'haddad-militarizacao-governo-b99-53') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ant, true FROM ins;

  -- 54
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_tem, 'Temer critica provocações do governo ao STF.', 'Não se governa provocando o Supremo. Isso é imaturidade institucional.', 'Entrevista ao Valor.', 'verified', false, '2020-02-14', 'https://valor.globo.com/politica/noticia/2020/02/14/temer-provocacoes-stf.ghtml', 'news_article', 1, 'São Paulo', 'Entrevista', 'temer-provocacoes-stf-b99-54') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ant, true FROM ins;

  -- 55
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jair, 'Bolsonaro cita "estupros" em presídios para defender pacote anticrime.', 'Eu não quero meu filho estuprado na cadeia. Tem que dar tiro mesmo.', 'Declaração defendendo excludente de ilicitude.', 'verified', true, '2019-07-20', 'https://www1.folha.uol.com.br/poder/2019/07/bolsonaro-estupro-presidio.shtml', 'news_article', 4, 'Brasília', 'Entrevista', 'bolsonaro-estupro-presidio-b99-55') RETURNING id)
  ...
  -- 62
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jair, 'Bolsonaro faz fala ofensiva sobre negros em evento.', 'Eu fui num quilombo. O afrodescendente mais leve pesava sete arrobas.', 'Repetição da fala racista em novo evento.', 'verified', true, '2019-07-14', 'https://g1.globo.com/politica/noticia/2019/07/14/bolsonaro-quilombolas-sete-arrobas-repete.ghtml', 'speech', 5, 'Brasília', 'Evento com apoiadores', 'bolsonaro-quilombolas-repete-b99-62') RETURNING id)
  ...
  -- 64
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mou, 'Mourão diz que miscigenação brasileira pode ter sido "benéfica".', 'A miscigenação melhorou a raça. É uma das virtudes brasileiras.', 'Entrevista em que voltou a falar em estereótipos raciais.', 'verified', true, '2019-05-15', 'https://www1.folha.uol.com.br/poder/2019/05/mourao-miscigenacao-raca.shtml', 'news_article', 4, 'Brasília', 'Entrevista', 'mourao-miscigenacao-raca-b99-64') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_rac, true FROM ins;

  -- 65
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_gue, 'Guedes diz que "quem tem nostalgia vai viver em Cuba".', 'Quem tem saudade do passado que vá viver em Cuba.', 'Fala no lançamento de plano liberal em Brasília.', 'verified', true, '2019-10-20', 'https://valor.globo.com/brasil/noticia/2019/10/20/guedes-cuba-nostalgia.ghtml', 'speech', 3, 'Brasília', 'Lançamento de plano econômico', 'guedes-nostalgia-cuba-b99-65') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_odi, true FROM ins;

  -- 66
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jair, 'Bolsonaro pede ao Congresso CPI da Globo.', 'Vou propor CPI da Globo. Está na hora de eles prestarem contas.', 'Declaração após reportagem que ligou Queiroz ao Alvorada.', 'verified', true, '2019-10-30', 'https://www1.folha.uol.com.br/poder/2019/10/bolsonaro-cpi-globo.shtml', 'news_article', 4, 'Brasília', 'Cerca do Alvorada', 'bolsonaro-cpi-globo-b99-66') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_int, true FROM ins UNION ALL SELECT id, c_abu, false FROM ins;

  -- 67
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jair, 'Bolsonaro diz que não vai renovar concessão da Globo.', 'A Globo não vai ter concessão renovada. É bom eles sentarem e conversarem.', 'Ameaça proferida em live.', 'verified', true, '2019-10-31', 'https://g1.globo.com/politica/noticia/2019/10/31/bolsonaro-globo-renovacao.ghtml', 'social_media_post', 5, 'Brasília', 'Live semanal', 'bolsonaro-globo-renovacao-concessao-b99-67') RETURNING id)
  ...
  -- 68
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_dam, 'Damares elogia Bolsonaro como "presidente mais importante da história".', 'Esse é o melhor presidente que já tivemos. Foi ungido por Deus.', 'Discurso em igreja evangélica.', 'verified', false, '2019-12-15', 'https://www1.folha.uol.com.br/poder/2019/12/damares-bolsonaro-ungido.shtml', 'speech', 2, 'Brasília', 'Culto evangélico', 'damares-bolsonaro-ungido-b99-68') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_itr, true FROM ins;

  -- 69
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_fla, 'Flávio tenta anular investigação no STF.', 'O Senador tem foro. A investigação no Rio é inconstitucional.', 'Argumento apresentado ao STF.', 'verified', false, '2019-08-30', 'https://g1.globo.com/politica/noticia/2019/08/30/flavio-stf-foro.ghtml', 'news_article', 3, 'Brasília', 'Petição no STF', 'flavio-stf-foro-b99-69') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_obs, true FROM ins;

  -- 70
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jair, 'Bolsonaro faz piada com feminicídio em live.', 'Minha mulher é minha melhor amiga. Ela me dá cada cabeçada.', 'Fala em live semanal que foi criticada por banalizar violência.', 'verified', false, '2019-09-19', 'https://www1.folha.uol.com.br/poder/2019/09/bolsonaro-piada-michelle.shtml', 'social_media_post', 3, 'Facebook Live', 'Live semanal', 'bolsonaro-piada-michelle-b99-70') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_mac, true FROM ins;

  -- 71
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jair, 'Bolsonaro celebra revogação de nota sobre Stonewall em órgão governamental.', 'Não vamos promover agenda gay no governo.', 'Fala após cancelamento de nota da Secretaria de Cultura.', 'verified', true, '2019-06-28', 'https://g1.globo.com/politica/noticia/2019/06/28/bolsonaro-stonewall-agenda-gay.ghtml', 'news_article', 4, 'Brasília', 'Entrevista', 'bolsonaro-stonewall-agenda-gay-b99-71') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_hom, true FROM ins;

  -- 72
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_sal, 'Salles é criticado pela ONU por política anti-ambiental.', 'A agenda da ONU não vai parar o agronegócio brasileiro.', 'Resposta a críticas internacionais.', 'verified', false, '2019-11-02', 'https://g1.globo.com/natureza/noticia/2019/11/02/salles-onu-agro.ghtml', 'news_article', 3, 'Brasília', 'Entrevista', 'salles-onu-agro-b99-72') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_xen, true FROM ins;

  -- 73
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jair, 'Bolsonaro diz que jornalistas "podem perder emprego" após CPI da Fake News.', 'Muitos jornalistas vão ter seus empregos ameaçados quando a verdade aparecer.', 'Fala ameaçadora em live.', 'verified', true, '2019-11-14', 'https://www1.folha.uol.com.br/poder/2019/11/bolsonaro-jornalistas-emprego.shtml', 'social_media_post', 4, 'Facebook Live', 'Live semanal', 'bolsonaro-jornalistas-emprego-b99-73') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_int, true FROM ins;
  ...
  -- 82
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jair, 'Bolsonaro critica Doria e governadores que o enfrentam.', 'João Doria é traidor. Não vai ser nada em 2022.', 'Declaração após Doria criticar postura anti-vacina.', 'verified', false, '2019-12-10', 'https://g1.globo.com/politica/noticia/2019/12/10/bolsonaro-doria-traidor.ghtml', 'news_article', 2, 'Brasília', 'Cerca do Alvorada', 'bolsonaro-doria-traidor-b99-82') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_int, true FROM ins;

  -- 83
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_dam, 'Damares viaja para Alagoas e distribui bíblias em programa oficial.', 'Vamos levar a palavra de Deus e o amor da família a todos.', 'Ação oficial do ministério com verba pública.', 'verified', false, '2019-07-09', 'https://www1.folha.uol.com.br/poder/2019/07/damares-biblia-alagoas.shtml', 'news_article', 3, 'Alagoas', 'Visita oficial', 'damares-biblia-alagoas-b99-83') RETURNING id)
  ...
  -- 93
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_col, 'Collor defende reforma da Previdência em plenário.', 'A Previdência é indispensável. Não dá para adiar mais.', 'Pronunciamento na tribuna do Senado.', 'verified', false, '2019-09-03', 'https://www12.senado.leg.br/noticias/2019/09/collor-previdencia-pronunciamento', 'speech', 1, 'Senado Federal', 'Pronunciamento', 'collor-previdencia-pronunciamento-b99-93') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_con, true FROM ins;

  -- 94
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mer, 'Mercadante denuncia corte em ciência e tecnologia.', 'Cortar ciência é matar o futuro. Isso é irresponsável.', 'Artigo na Folha sobre cortes no MCTIC.', 'verified', false, '2019-08-09', 'https://www1.folha.uol.com.br/opiniao/2019/08/mercadante-ciencia-cortes.shtml', 'news_article', 1, 'São Paulo', 'Artigo de opinião', 'mercadante-ciencia-cortes-b99-94') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 95
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mar, 'Marta Suplicy questiona postura do governo sobre feminicídio.', 'O governo age como se mulher morrer fosse problema menor.', 'Entrevista após declaração de Bolsonaro.', 'verified', false, '2019-03-13', 'https://g1.globo.com/politica/noticia/2019/03/13/marta-feminicidio-governo.ghtml', 'news_article', 1, 'São Paulo', 'Entrevista', 'marta-feminicidio-governo-b99-95') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_mis, true FROM ins;

  -- 96
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jair, 'Bolsonaro ironiza Argentina e governo Fernández.', 'Os argentinos elegeram mal. Vão quebrar de novo.', 'Declaração após vitória de Alberto Fernández.', 'verified', true, '2019-10-28', 'https://www1.folha.uol.com.br/mundo/2019/10/bolsonaro-fernandez-argentina.shtml', 'news_article', 3, 'Brasília', 'Cerca do Alvorada', 'bolsonaro-fernandez-argentina-b99-96') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_xen, true FROM ins;

  -- 97
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jair, 'Bolsonaro publica fake news sobre Macron e esposa no Twitter.', 'Agora dá para entender por que Macron persegue o Brasil.', 'Legenda em postagem com imagem pejorativa da primeira-dama francesa.', 'verified', true, '2019-08-25', 'https://g1.globo.com/politica/noticia/2019/08/25/bolsonaro-twitter-macron-brigitte.ghtml', 'social_media_post', 4, 'Twitter', 'Postagem oficial', 'bolsonaro-twitter-macron-brigitte-b99-97') RETURNING id)
  ...
  -- 98
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mou, 'Mourão diz que 13 de maio "não tem nada a comemorar".', 'O 13 de maio não é uma data de celebração. Foi uma libertação incompleta.', 'Declaração em cerimônia oficial.', 'verified', false, '2019-05-13', 'https://g1.globo.com/politica/noticia/2019/05/13/mourao-13-maio-abolicao.ghtml', 'news_article', 2, 'Brasília', 'Cerimônia oficial', 'mourao-13-maio-abolicao-b99-98') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_rac, true FROM ins;

  -- 99
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jair, 'Bolsonaro compara pandemia mundial incipiente a "gripezinha" no início de 2020.', 'Esse coronavírus vai passar. É uma fantasia da imprensa.', 'Declaração em fevereiro de 2020, antes de a OMS decretar pandemia.', 'verified', true, '2020-02-28', 'https://g1.globo.com/politica/noticia/2020/02/28/bolsonaro-coronavirus-fantasia.ghtml', 'news_article', 4, 'Brasília', 'Entrevista', 'bolsonaro-coronavirus-fantasia-b99-99') RETURNING id)
