...
BEGIN
  ...
  -- 3
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_edu, 'Eduardo Bolsonaro compara Globo à TV Cubana.', 'A Globo é a TV Cubana do Brasil. Só falta o Fidel mandar.', 'Postagem no X em maio de 2023 após reportagem do Jornal Nacional.', 'verified', false, '2023-05-18', 'https://twitter.com/BolsonaroSP/status/1659000000', 'social_media_post', 3, 'X/Twitter', 'Postagem no X', 'eduardo-globo-tv-cubana-b157-3') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 4
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_zam, 'Zambelli ameaça jornalistas da Globo após condenação.', 'Os jornalistas da Globo vão pagar caro. Estou anotando os nomes.', 'Live no Instagram após primeira condenação judicial em 2023.', 'verified', true, '2023-05-24', 'https://g1.globo.com/politica/noticia/2023/05/24/zambelli-ameaca-jornalistas-globo.ghtml', 'social_media_post', 5, 'Instagram', 'Live após condenação', 'zambelli-ameaca-globo-b157-4') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_int, true FROM ins UNION ALL SELECT id, c_ame, false FROM ins;

  -- 5
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_lul, 'Lula defende que Globo faz oposição "dissimulada" ao governo.', 'A Globo sempre fez oposição a mim, agora de forma mais dissimulada.', 'Entrevista à RedeTV em junho de 2023.', 'verified', false, '2023-06-10', 'https://noticias.uol.com.br/politica/ultimas-noticias/2023/06/10/lula-globo-oposicao.htm', 'news_article', 2, 'Brasília', 'Entrevista RedeTV', 'lula-globo-oposicao-b157-5') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 6
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_nik, 'Nikolas dá discurso transfóbico na tribuna vestindo peruca.', 'Hoje eu me sinto mulher. Agora sou deputada.', 'Discurso na Câmara em 8 de março no Dia da Mulher em 2023.', 'verified', true, '2023-03-08', 'https://g1.globo.com/politica/noticia/2023/03/08/nikolas-peruca-dia-mulher.ghtml', 'speech', 5, 'Câmara dos Deputados', 'Dia Internacional da Mulher', 'nikolas-peruca-dia-mulher-b157-6') RETURNING id)
  ...
  -- 9
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mic, 'Michelle Bolsonaro critica "ideologia de gênero" em novelas da Globo.', 'As novelas da Globo estão destruindo a família brasileira com essa ideologia.', 'Culto em igreja Atitude em abril de 2023.', 'verified', true, '2023-04-15', 'https://noticias.uol.com.br/politica/ultimas-noticias/2023/04/15/michelle-novelas-globo.htm', 'speech', 3, 'Rio de Janeiro', 'Culto evangélico', 'michelle-novelas-globo-b157-9') RETURNING id)
  ...
  -- 15
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_sil, 'Silvio Almeida reage a ataques e defende ministério.', 'Não vamos nos intimidar. Direitos humanos são para todos.', 'Coletiva em resposta a ataques evangélicos em 2023.', 'verified', true, '2023-08-11', 'https://g1.globo.com/politica/noticia/2023/08/11/silvio-almeida-reage.ghtml', 'news_article', 1, 'Brasília', 'Coletiva', 'silvio-almeida-reage-b157-15') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ame, true FROM ins;

  -- 16
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_nik, 'Nikolas publica vídeo acusando Globo de manipular dados sobre Lula.', 'A Globo maquia pesquisas para ajudar o Lula. É fraude televisiva.', 'Vídeo no YouTube em setembro de 2023.', 'verified', false, '2023-09-20', 'https://www.youtube.com/watch?v=nikolas-globo-pesquisa', 'social_media_post', 3, 'YouTube', 'Canal de Nikolas', 'nikolas-globo-pesquisa-b157-16') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 17
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_gir, 'General Girão pede investigação da Globo por "crime contra democracia".', 'A Globo manipulou eleição. É crime contra a democracia.', 'Pronunciamento na Câmara em outubro de 2023.', 'verified', false, '2023-10-03', 'https://www.camara.leg.br/noticias/girao-globo-crime', 'speech', 4, 'Câmara dos Deputados', 'Pronunciamento em plenário', 'girao-globo-crime-b157-17') RETURNING id)
  ...
  -- 20
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_sam, 'Sâmia Bomfim defende jornalistas após série de ataques bolsonaristas.', 'Atacar imprensa livre é ataque à democracia. Basta de intimidação.', 'Pronunciamento na Câmara em defesa da imprensa.', 'verified', false, '2023-11-20', 'https://www.camara.leg.br/noticias/samia-imprensa', 'speech', 1, 'Câmara dos Deputados', 'Defesa da imprensa', 'samia-defesa-imprensa-b157-20') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ame, true FROM ins;

  -- 21
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jair, 'Bolsonaro diz que Globo "ajuda o crime" em crise do Rio.', 'A Globo ajuda o crime. Edita para prejudicar a polícia.', 'Entrevista à Oeste em dezembro de 2023.', 'verified', false, '2023-12-05', 'https://revistaoeste.com/politica/bolsonaro-globo-crime/', 'news_article', 4, 'São Paulo', 'Entrevista Revista Oeste', 'bolsonaro-globo-crime-b157-21') RETURNING id)
  ...
  -- 22
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_had, 'Haddad critica cobertura econômica da Globo e defende arcabouço fiscal.', 'A Globo não tem compromisso com a verdade sobre a economia.', 'Entrevista à CNN Brasil em 2023.', 'verified', false, '2023-09-12', 'https://www.cnnbrasil.com.br/politica/haddad-globo-economia/', 'news_article', 2, 'Brasília', 'Entrevista CNN', 'haddad-globo-economia-b157-22') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 23
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_edu, 'Eduardo Bolsonaro ameaça Globo com "lei mordaça" caso voltem ao poder.', 'Quando voltarmos, a Globo vai pagar. Teremos nossa lei de imprensa.', 'Entrevista à TV Brasília em fevereiro de 2024.', 'verified', true, '2024-02-20', 'https://www.otempo.com.br/politica/eduardo-globo-mordaca', 'news_article', 5, 'Brasília', 'Entrevista TV', 'eduardo-globo-mordaca-b157-23') RETURNING id)
  ...
  -- 35
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_ani, 'Anielle Franco denuncia racismo em coberturas sobre carnaval.', 'A cobertura do carnaval ainda reproduz estereótipos racistas.', 'Evento em março de 2024 como ministra da Igualdade Racial.', 'verified', false, '2024-03-01', 'https://g1.globo.com/politica/noticia/2024/03/01/anielle-racismo-carnaval.ghtml', 'speech', 1, 'Brasília', 'Evento público', 'anielle-racismo-carnaval-b157-35') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_rac, true FROM ins;

  -- 36
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jair, 'Bolsonaro diz que Record "virou Globo" após críticas ao governo anterior.', 'A Record decepciona. Virou a Globo do Edir Macedo.', 'Live em abril de 2024.', 'verified', false, '2024-04-10', 'https://noticias.uol.com.br/politica/ultimas-noticias/2024/04/10/bolsonaro-record-globo.htm', 'social_media_post', 3, 'YouTube', 'Live', 'bolsonaro-record-virou-globo-b157-36') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 37
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_kic, 'Bia Kicis ataca apresentadora da GloboNews.', 'Essa apresentadora é uma militante petista fantasiada de jornalista.', 'Postagem no X em maio de 2024.', 'verified', false, '2024-05-02', 'https://twitter.com/Bia_Kicis/status/1786000000', 'social_media_post', 3, 'X/Twitter', 'Postagem', 'kicis-apresentadora-globonews-b157-37') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_int, true FROM ins;

  -- 38
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mic, 'Michelle Bolsonaro usa culto para cobrar "censura" às novelas.', 'Não queremos essa pauta LGBT nas novelas. Precisamos agir.', 'Evento em igreja em junho de 2024.', 'verified', false, '2024-06-05', 'https://noticias.uol.com.br/politica/ultimas-noticias/2024/06/05/michelle-culto-novelas.htm', 'speech', 3, 'Rio de Janeiro', 'Culto', 'michelle-culto-novelas-b157-38') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_hom, true FROM ins UNION ALL SELECT id, c_itr, false FROM ins;

  -- 39
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_son, 'Sônia Guajajara critica cobertura da Amazônia por grandes emissoras.', 'A mídia ainda invisibiliza os povos indígenas na cobertura da Amazônia.', 'Evento em julho de 2024.', 'verified', false, '2024-07-14', 'https://g1.globo.com/politica/noticia/2024/07/14/guajajara-midia-amazonia.ghtml', 'speech', 1, 'Brasília', 'Evento ONGs', 'guajajara-midia-amazonia-b157-39') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ame, true FROM ins;

  -- 40
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_edu, 'Eduardo Bolsonaro sugere "desGloboização" do Brasil.', 'Precisamos de uma desGloboização nacional. Emissora tem que quebrar.', 'Evento nos EUA em julho de 2024.', 'verified', true, '2024-07-25', 'https://noticias.uol.com.br/politica/ultimas-noticias/2024/07/25/eduardo-desgloboizacao.htm', 'speech', 5, 'Washington, EUA', 'CPAC', 'eduardo-desgloboizacao-b157-40') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ame, true FROM ins UNION ALL SELECT id, c_int, false FROM ins;
  ...
  -- 47
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mor, 'Moraes determina suspensão do X no Brasil em agosto de 2024.', 'Quem não cumpre a lei brasileira não opera no Brasil.', 'Decisão que suspendeu o X por recusa de nomear representante legal.', 'verified', true, '2024-08-30', 'https://g1.globo.com/politica/noticia/2024/08/30/moraes-suspende-x-brasil.ghtml', 'news_article', 2, 'STF', 'Decisão judicial', 'moraes-suspende-x-b157-47') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ame, true FROM ins;

  -- 48
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jair, 'Bolsonaro diz que suspensão do X é "ditadura".', 'Moraes instaurou uma ditadura. Suspender rede social é tirania.', 'Declaração à imprensa em Alagoas em setembro de 2024.', 'verified', true, '2024-09-01', 'https://g1.globo.com/al/alagoas/noticia/2024/09/01/bolsonaro-x-ditadura.ghtml', 'news_article', 4, 'Maceió', 'Agenda política', 'bolsonaro-x-ditadura-b157-48') RETURNING id)
  ...
  -- 49
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_pab, 'Marçal acusa big techs de boicotar sua campanha.', 'A Meta está me boicotando. É o establishment contra mim.', 'Live no YouTube em agosto de 2024.', 'verified', false, '2024-08-20', 'https://www.youtube.com/watch?v=marcal-meta', 'social_media_post', 3, 'YouTube', 'Live', 'marcal-meta-boicote-b157-49') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 50
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_tal, 'Talíria Petrone denuncia discurso de ódio em redes.', 'Redes sociais viraram máquinas de ódio contra mulheres e negras.', 'Pronunciamento em junho de 2024 sobre violência política.', 'verified', false, '2024-06-20', 'https://www.camara.leg.br/noticias/taliria-odio-redes', 'speech', 1, 'Câmara dos Deputados', 'Pronunciamento', 'taliria-odio-redes-b157-50') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_odi, true FROM ins;

  -- 51
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_fme, 'Fernanda Melchionna denuncia milícia digital bolsonarista.', 'Existe uma milícia digital organizada. Polícia tem que investigar.', 'Pronunciamento em abril de 2024.', 'verified', false, '2024-04-18', 'https://www.camara.leg.br/noticias/fernanda-milicia-digital', 'speech', 2, 'Câmara dos Deputados', 'Pronunciamento', 'fernanda-milicia-digital-b157-51') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ame, true FROM ins;

  -- 52
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_nik, 'Nikolas provoca MST em vídeo satírico.', 'O MST é um bando de invasores. Terra improdutiva é invenção.', 'Vídeo no Instagram em agosto de 2023.', 'verified', false, '2023-08-28', 'https://www.instagram.com/nikolasferreiradm/p/mst', 'social_media_post', 3, 'Instagram', 'Postagem', 'nikolas-mst-invasores-b157-52') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_odi, true FROM ins;

  -- 53
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jan, 'Jandira Feghali defende regulação do streaming e audiovisual.', 'Precisamos de cota para produção nacional no streaming.', 'Audiência sobre PL do streaming em junho de 2024.', 'verified', false, '2024-06-12', 'https://www.camara.leg.br/noticias/jandira-streaming', 'speech', 1, 'Câmara dos Deputados', 'Audiência pública', 'jandira-streaming-cota-b157-53') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ame, true FROM ins;

  -- 54
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_chi, 'Chico Alencar critica monopólio de mídia no Brasil.', 'O Brasil ainda vive sob monopólio midiático. Democratização é urgente.', 'Pronunciamento em setembro de 2023.', 'verified', false, '2023-09-15', 'https://www.camara.leg.br/noticias/chico-alencar-midia', 'speech', 1, 'Câmara dos Deputados', 'Pronunciamento', 'chico-monopolio-midia-b157-54') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ame, true FROM ins;

  -- 55
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_gle, 'Gleisi Hoffmann ataca narrativa da Globo sobre gastos.', 'A Globo vende narrativa de gastança. É mentira.', 'Entrevista à CartaCapital em 2024.', 'verified', false, '2024-05-20', 'https://www.cartacapital.com.br/gleisi-globo-gastos/', 'news_article', 2, 'Brasília', 'Entrevista Carta Capital', 'gleisi-globo-gastos-b157-55') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 56
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jair, 'Bolsonaro chama CNN Brasil de "CNN bolivariana".', 'A CNN Brasil é bolivariana. Pior que a Globo.', 'Live em outubro de 2024.', 'verified', false, '2024-10-15', 'https://noticias.uol.com.br/politica/ultimas-noticias/2024/10/15/bolsonaro-cnn-bolivariana.htm', 'social_media_post', 3, 'YouTube', 'Live', 'bolsonaro-cnn-bolivariana-b157-56') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 57
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_dam, 'Damares vota contra Marco Civil da Internet por "censura".', 'O Marco Civil virou ferramenta de censura. Voto contra.', 'Sessão no Senado em 2023.', 'verified', false, '2023-10-25', 'https://www12.senado.leg.br/noticias/materias/2023/10/25/damares-marco-civil', 'speech', 3, 'Senado Federal', 'Sessão plenária', 'damares-marco-civil-b157-57') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 58
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mag, 'Magno Malta associa imprensa à "esquerda satânica".', 'A imprensa brasileira serve à esquerda satânica. É guerra espiritual.', 'Culto em igreja em janeiro de 2024.', 'verified', false, '2024-01-15', 'https://noticias.uol.com.br/politica/ultimas-noticias/2024/01/15/magno-malta-imprensa-satanica.htm', 'speech', 4, 'Vitória, ES', 'Culto evangélico', 'magno-malta-imprensa-satanica-b157-58') RETURNING id)
  ...
  -- 59
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_had, 'Haddad critica revista Veja por manchete sobre economia.', 'A Veja ainda é a revista da Casa de Bolsonaro.', 'Entrevista em novembro de 2024.', 'verified', false, '2024-11-12', 'https://www.cnnbrasil.com.br/politica/haddad-veja/', 'news_article', 2, 'Brasília', 'Entrevista', 'haddad-veja-bolsonaro-b157-59') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 60
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_kic, 'Kicis defende impeachment de ministros do STF após suspensão do X.', 'Moraes e Dino têm que ser impedidos. Virou tirania judicial.', 'Pronunciamento em setembro de 2024.', 'verified', true, '2024-09-03', 'https://www.camara.leg.br/noticias/kicis-impeachment-moraes', 'speech', 4, 'Câmara dos Deputados', 'Pronunciamento', 'kicis-impeachment-moraes-b157-60') RETURNING id)
  ...
  -- 77
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_lul, 'Lula celebra Oscar de Fernanda Torres e filme sobre ditadura.', 'Fernanda Torres honra o Brasil. O filme expõe feridas necessárias.', 'Discurso no Palácio do Planalto em março de 2025.', 'verified', true, '2025-03-03', 'https://g1.globo.com/politica/noticia/2025/03/03/lula-celebra-oscar.ghtml', 'speech', 1, 'Brasília', 'Discurso', 'lula-oscar-fernanda-b157-77') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ame, true FROM ins;

  -- 78
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jair, 'Bolsonaro diz que anistia do 8 de janeiro virá "por pressão popular".', 'A anistia vai sair. O povo vai pressionar. A imprensa que engula.', 'Entrevista em janeiro de 2025 no aniversário dos atos.', 'verified', true, '2025-01-08', 'https://g1.globo.com/politica/noticia/2025/01/08/bolsonaro-anistia-pressao.ghtml', 'news_article', 4, 'Brasília', 'Entrevista', 'bolsonaro-anistia-pressao-b157-78') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ant, true FROM ins;

  -- 79
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_nik, 'Nikolas defende anistia e acusa mídia de "fabricar golpe".', 'O golpe foi fabricado pela mídia. Anistia já.', 'Pronunciamento em fevereiro de 2025.', 'verified', true, '2025-02-20', 'https://www.camara.leg.br/noticias/nikolas-anistia-golpe', 'speech', 5, 'Câmara dos Deputados', 'Pronunciamento', 'nikolas-anistia-golpe-fabricado-b157-79') RETURNING id)
