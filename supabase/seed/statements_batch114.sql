...
BEGIN
  ...
  -- 1
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_col, 'Collor anuncia confisco da poupança no Plano Collor I.', 'Só me resta um tiro, presidente. E eu vou dar esse tiro.', 'Pronunciamento sobre as medidas econômicas que bloquearam poupanças no Banco Central.', 'verified', true, '1990-03-16', 'https://www1.folha.uol.com.br/folha/treinamento/hotsites/collor/conheca/discursos.shtml', 'news_article', 4, 'Brasília', 'Lançamento do Plano Collor', 'collor-tiro-plano-b114-1') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;

  -- 2
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_col, 'Collor defende confisco da poupança como ato necessário contra inflação.', 'Vou liquidar com a inflação com um só tiro.', 'Primeiro pronunciamento do Plano Collor que bloqueou cruzados dos brasileiros.', 'verified', true, '1990-03-16', 'https://acervo.estadao.com.br/noticias/acervo,plano-collor-marco-1990,8867,0.htm', 'news_article', 4, 'Palácio do Planalto', 'Plano Brasil Novo', 'collor-liquidar-inflacao-b114-2') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;
