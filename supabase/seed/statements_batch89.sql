...
BEGIN
  ...
  -- 12
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_lul, 'Lula diz que quem criou a Bolsa Família foi ele e ninguém mais, apagando FHC.', 'Quem criou o Bolsa Família foi eu. O pessoal quer dizer que foi o FHC, mas foi eu, com meu governo.', 'Entrevista ao JN. FHC rebateu lembrando o Bolsa Escola e programas anteriores.', 'verified', true, '2023-02-09', 'https://www1.folha.uol.com.br/poder/2023/02/lula-criou-bolsa-familia-fhc.shtml', 'news_article', 2, 'Brasília', 'JN', 'lula-bolsa-familia-criador-b89-12') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 13
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_lul, 'Lula confunde quilombo com aldeia indígena em visita, causando incômodo.', 'Quando eu cheguei na aldeia... quer dizer, no quilombo, fui muito bem recebido pelos caciques, digo, líderes.', 'Visita em Alcântara. Fala viralizou como gafe de desconhecimento cultural.', 'verified', false, '2023-11-17', 'https://www.metropoles.com/brasil/politica-brasil/lula-quilombo-aldeia-confunde', 'news_article', 2, 'Alcântara', 'Visita quilombo', 'lula-quilombo-aldeia-b89-13') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 14
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_lul, 'Lula se refere a Kamala Harris como a mulata americana em comentário racial.', 'A mulata americana, a Kamala, é uma mulher de fibra. Ela vai ganhar dessa gente.', 'Entrevista em NY após Assembleia da ONU. Nota do Itamaraty tentou amenizar.', 'verified', true, '2024-09-25', 'https://www.estadao.com.br/internacional/lula-kamala-mulata-americana/', 'news_article', 3, 'Nova York', 'ONU', 'lula-kamala-mulata-b89-14') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;
  ...
  -- 38
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_lul, 'Lula diz que Musk tem que ser preso no Brasil se vier.', 'Se o Musk vier ao Brasil, ele será preso. Ele desrespeitou a Justiça, tem que cumprir a lei.', 'Entrevista em BH. Gerou repercussão internacional.', 'verified', true, '2024-08-29', 'https://g1.globo.com/politica/noticia/2024/08/29/lula-musk-preso-brasil.ghtml', 'news_article', 3, 'Belo Horizonte', 'Entrevista', 'lula-musk-preso-b89-38') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;

  -- 39
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_lul, 'Lula diz que Bolsonaro foi o pior pai, pior presidente, pior tudo.', 'O Bolsonaro foi o pior pai do Brasil, pior presidente, pior marido, pior tudo. Não serviu pra nada.', 'Evento em Alagoas. Michelle Bolsonaro reagiu em redes.', 'verified', false, '2024-02-12', 'https://www.metropoles.com/brasil/politica-brasil/lula-bolsonaro-pior-tudo', 'news_article', 2, 'Maceió', 'Evento', 'lula-bolsonaro-pior-tudo-b89-39') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_odi, true FROM ins;

  -- 40
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_lul, 'Lula diz que pode transmitir o cargo a Janja se ela quiser.', 'Se a Janja quiser ser candidata, eu apoio. Posso passar o cargo pra ela. Ela tem capacidade.', 'Entrevista à TV Bahia. Oposição acusou personalismo e nepotismo discursivo.', 'verified', false, '2024-10-05', 'https://www1.folha.uol.com.br/poder/2024/10/lula-janja-candidata-presidencia.shtml', 'news_article', 3, 'Salvador', 'TV Bahia', 'lula-janja-candidata-b89-40') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_con, true FROM ins;

  -- 41
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_lul, 'Lula faz piada sobre Nikolas Ferreira dizendo que ele é mulher.', 'Esse Nikolas Ferreira parece mulher, tem voz de mulher. Se é homem, assume, se é mulher, assume.', 'Evento em SP. Nikolas respondeu com processo judicial e vídeo crítico.', 'verified', true, '2024-04-12', 'https://www.estadao.com.br/politica/lula-nikolas-voz-mulher/', 'news_article', 3, 'São Paulo', 'Comício', 'lula-nikolas-voz-mulher-b89-41') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_odi, true FROM ins;

  -- 42
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_lul, 'Lula chama Pablo Marçal de charlatão e bandido em fala de rua.', 'O Pablo Marçal é charlatão, bandido de coach. Pega dinheiro do povo e promete riqueza.', 'Campanha em SP. Marçal respondeu com ação cível.', 'verified', false, '2024-09-18', 'https://www.poder360.com.br/eleicoes/lula-pablo-marcal-charlatao-bandido/', 'news_article', 2, 'São Paulo', 'Campanha municipal', 'lula-marcal-charlatao-b89-42') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_odi, true FROM ins;

  -- 43
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_lul, 'Lula diz que Ciro Gomes é doente mental em briga pública.', 'O Ciro Gomes tem problema mental. Não é normal ficar atacando o tempo todo o PT.', 'Entrevista à rádio. Ciro processou por danos morais.', 'verified', false, '2023-10-03', 'https://g1.globo.com/politica/noticia/2023/10/03/lula-ciro-problema-mental.ghtml', 'news_article', 3, 'Brasília', 'Rádio CBN', 'lula-ciro-mental-b89-43') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_odi, true FROM ins;

  -- 44
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_lul, 'Lula diz que Damares Alves é lobo em pele de cordeiro evangélico.', 'A Damares é lobo em pele de cordeiro. Fala de Deus e faz maldade com mulher.', 'Entrevista rádio BH. Damares processou criminalmente.', 'verified', false, '2024-05-20', 'https://www.cnnbrasil.com.br/politica/lula-damares-lobo-cordeiro/', 'news_article', 2, 'Belo Horizonte', 'Rádio', 'lula-damares-lobo-b89-44') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_odi, true FROM ins;
  ...
  -- 46
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_lul, 'Lula insinua que Bolsonaro fingiu o atentado de 2018.', 'Esse negócio da facada do Bolsonaro é muito estranho. Ninguém provou nada, pode ter sido fingimento.', 'Entrevista podcast. Família Bolsonaro acionou Justiça.', 'verified', true, '2023-09-06', 'https://www1.folha.uol.com.br/poder/2023/09/lula-facada-bolsonaro-fingimento.shtml', 'news_article', 4, 'São Paulo', 'Podcast', 'lula-facada-fingimento-b89-46') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;
