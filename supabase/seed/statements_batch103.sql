...
BEGIN
  ...
  -- 3
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jair, 'Bolsonaro compara passaporte da vacina a ditadura em discurso na Avenida Paulista.', 'Passaporte da vacina é coisa de ditadura. Somos livres.', 'Declaração em ato em São Paulo em novembro de 2021 contra medidas sanitárias.', 'verified', false, '2021-11-15', 'https://g1.globo.com/sp/sao-paulo/noticia/2021/11/15/bolsonaro-passaporte-ditadura.ghtml', 'news_article', 3, 'Avenida Paulista, SP', 'Ato com apoiadores', 'bolsonaro-passaporte-ditadura-b103-3') ON CONFLICT (slug) DO NOTHING RETURNING id)
  ...
  -- 49
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_moraes, 'Moraes determina diligências contra financiadores das caravanas de 7 de Setembro.', 'Precisamos identificar os financiadores das manifestações antidemocráticas.', 'Decisão em setembro de 2021 no inquérito das milícias digitais.', 'verified', true, '2021-09-10', 'https://www.stf.jus.br/portal/cms/verNoticiaDetalhe.asp?idConteudo=472000', 'other', 2, 'Supremo Tribunal Federal', 'Decisão monocrática', 'moraes-caravanas-7set-b103-49') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ant, true FROM ins;

  -- 50
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jair, 'Bolsonaro defende Cláudio Castro no RJ mesmo após Chacina do Jacarezinho.', 'O que aconteceu no Jacarezinho é fruto do combate ao crime. A polícia tem que ter autonomia.', 'Declaração em maio de 2021 após a Chacina do Jacarezinho com 28 mortos.', 'verified', true, '2021-05-07', 'https://www1.folha.uol.com.br/cotidiano/2021/05/bolsonaro-jacarezinho.shtml', 'news_article', 4, 'Brasília', 'Entrevista à imprensa', 'bolsonaro-jacarezinho-b103-50') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_vio, true FROM ins;

  -- 51
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_freixo, 'Marcelo Freixo denuncia Chacina do Jacarezinho e cobra responsabilização.', 'Jacarezinho foi uma chacina. O governo Bolsonaro legitima este tipo de violência.', 'Declaração em 6 de maio de 2021 após a operação policial no Jacarezinho.', 'verified', false, '2021-05-06', 'https://www.poder360.com.br/estados/freixo-jacarezinho-chacina/', 'news_article', 2, 'Rio de Janeiro', 'Entrevista à imprensa', 'freixo-jacarezinho-b103-51') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_vio, true FROM ins;

  -- 52
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jair, 'Bolsonaro ataca ativista indígena Sonia Guajajara durante reunião com ruralistas.', 'A Sonia Guajajara é financiada pelo estrangeiro.', 'Declaração em reunião com bancada ruralista em abril de 2021.', 'verified', false, '2021-04-12', 'https://www.cnnbrasil.com.br/politica/bolsonaro-sonia-guajajara/', 'news_article', 3, 'Brasília', 'Reunião com ruralistas', 'bolsonaro-guajajara-b103-52') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_odi, true FROM ins;

  -- 53
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_salles, 'Ricardo Salles incentiva "passar a boiada" e usa pandemia para afrouxar normas ambientais.', 'Temos que aproveitar que a atenção está na pandemia para passar a boiada.', 'Declaração resgatada em 2021 de reunião ministerial de abril de 2020, usada em depoimento na CPI.', 'verified', true, '2021-06-08', 'https://g1.globo.com/politica/noticia/2021/06/08/salles-passar-boiada.ghtml', 'news_article', 5, 'Brasília', 'Reunião ministerial', 'salles-passar-boiada-b103-53') ON CONFLICT (slug) DO NOTHING RETURNING id)
  ...
  -- 54
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jair, 'Bolsonaro promete refinaria nova para não depender de preços internacionais.', 'Vamos construir uma refinaria nova. Não vamos depender do dólar.', 'Declaração em agosto de 2021 após altas consecutivas da gasolina.', 'verified', false, '2021-08-27', 'https://www1.folha.uol.com.br/mercado/2021/08/bolsonaro-refinaria-combustiveis.shtml', 'news_article', 1, 'Brasília', 'Entrevista à imprensa', 'bolsonaro-refinaria-b103-54') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 55
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jair, 'Bolsonaro é hospitalizado com suspeita de obstrução intestinal.', 'Meu problema é soluço há dez dias. Estou bem.', 'Declaração de 14 de julho de 2021 durante hospitalização em São Paulo.', 'verified', false, '2021-07-14', 'https://g1.globo.com/politica/noticia/2021/07/14/bolsonaro-hospital-obstrucao.ghtml', 'news_article', 1, 'São Paulo', 'Internação hospitalar', 'bolsonaro-obstrucao-b103-55') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 56
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jair, 'Bolsonaro declara que pessoas morrem "por doenças ou por Deus" e minimiza vacina.', 'Todo mundo morre. Ou por doença ou por Deus.', 'Declaração em evento com apoiadores em junho de 2021.', 'verified', false, '2021-06-18', 'https://www.cnnbrasil.com.br/politica/bolsonaro-todo-mundo-morre/', 'news_article', 3, 'Brasília', 'Encontro com apoiadores', 'bolsonaro-todo-mundo-morre-b103-56') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_neg, true FROM ins;

  -- 57
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_pacheco, 'Pacheco prorroga CPI da Covid por pressão da oposição.', 'A CPI será prorrogada conforme decidido pelo plenário. Estado democrático de direito.', 'Declaração em agosto de 2021 concordando com prorrogação da CPI.', 'verified', false, '2021-08-04', 'https://www12.senado.leg.br/noticias/materias/2021/08/04/pacheco-prorroga-cpi', 'other', 1, 'Senado Federal', 'Ato administrativo', 'pacheco-prorroga-cpi-b103-57') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ant, true FROM ins;

  -- 58
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_randolfe, 'Randolfe convoca Ricardo Barros, líder do governo, para depor na CPI.', 'Ricardo Barros precisa explicar o envolvimento com a Covaxin e com o governo.', 'Declaração em julho de 2021 após requerimento aprovado pela CPI.', 'verified', false, '2021-07-15', 'https://g1.globo.com/politica/noticia/2021/07/15/randolfe-convoca-ricardo-barros.ghtml', 'other', 3, 'Senado Federal', 'Sessão da CPI da Covid', 'randolfe-convoca-barros-b103-58') ON CONFLICT (slug) DO NOTHING RETURNING id)
  ...
  -- 75
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jair, 'Bolsonaro ataca governadores do Nordeste e diz que não enviou vacina "por ironia".', 'Não enviei vacina para governadores que me atacavam. Por ironia, me atacam mais.', 'Declaração em entrevista em junho de 2021 admitindo uso político da distribuição de vacinas.', 'verified', true, '2021-06-14', 'https://g1.globo.com/politica/noticia/2021/06/14/bolsonaro-governadores-vacina-ironia.ghtml', 'news_article', 5, 'Brasília', 'Entrevista', 'bolsonaro-governadores-vacinas-b103-75') ON CONFLICT (slug) DO NOTHING RETURNING id)
  ...
  -- 76
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jair, 'Bolsonaro diz que Brasil "não é quintal de ninguém" ao atacar Moraes.', 'O Brasil não é quintal de ministro do STF. Somos livres.', 'Declaração em setembro de 2021 em encontro com apoiadores.', 'verified', false, '2021-09-12', 'https://www.cnnbrasil.com.br/politica/bolsonaro-quintal-moraes/', 'news_article', 4, 'Brasília', 'Encontro com apoiadores', 'bolsonaro-quintal-moraes-b103-76') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ant, true FROM ins;

  -- 77
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_soraya, 'Soraya Thronicke relata intimidação do governo durante CPI.', 'Recebi telefonemas de gente do Planalto me pedindo para segurar a pauta. É intimidação.', 'Declaração em setembro de 2021 como senadora titular da CPI.', 'verified', false, '2021-09-20', 'https://www12.senado.leg.br/noticias/materias/2021/09/20/soraya-intimidacao-planalto', 'news_article', 3, 'Senado Federal', 'Entrevista à imprensa', 'soraya-intimidacao-b103-77') ON CONFLICT (slug) DO NOTHING RETURNING id)
  ...
  -- 80
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_eduardo, 'Eduardo Bolsonaro viaja à Hungria e CPAC para aproximar-se da extrema-direita global.', 'Queremos construir uma direita internacional forte, de Orbán a Trump.', 'Declaração em evento em Budapeste em setembro de 2021.', 'verified', false, '2021-09-25', 'https://www.metropoles.com/brasil/politica-br/eduardo-hungria-direita', 'news_article', 2, 'Budapeste, Hungria', 'Evento internacional de direita', 'eduardo-hungria-direita-b103-80') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ant, true FROM ins;

  -- 81
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_carlos, 'Carlos Bolsonaro coordena gabinete do ódio em ataques coordenados a adversários.', 'Quem ataca meu pai, eu vou atrás.', 'Declaração em redes sociais em julho de 2021 após investigações apontarem centro de fake news.', 'verified', false, '2021-07-20', 'https://www1.folha.uol.com.br/poder/2021/07/carlos-bolsonaro-gabinete-odio.shtml', 'social_media_post', 4, 'Rio de Janeiro', 'Postagem em redes sociais', 'carlos-gabinete-odio-b103-81') ON CONFLICT (slug) DO NOTHING RETURNING id)
