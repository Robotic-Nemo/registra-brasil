...
BEGIN
  ...
  -- 82
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_lir, 'Arthur Lira defende "emendas como direito" após CPMI Pix.', 'Emendas são direito do parlamentar, democracia não pode ser tutelada.', 'Entrevista após críticas à CPMI sobre emendas.', 'verified', false, '2024-09-25', 'https://www.cnnbrasil.com.br/politica/lira-emendas-direito-democracia/', 'news_article', 3, 'Brasília', 'Entrevista Câmara', 'lira-emendas-direito-b135-82') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ame, true FROM ins;
