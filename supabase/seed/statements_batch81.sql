...
BEGIN
  ...
  -- 43
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_nik, 'Nikolas lidera "viralização" da Bíblia em horário nobre da Câmara.', 'Hoje li Romanos na Câmara em horário nobre. Viralizamos a palavra de Deus onde antes era só esquerda falando.', 'Discurso-pregação em plenário.', 'verified', true, '2023-08-10', 'https://www.gospelmais.com.br/nikolas-biblia-camara-viralizacao.html', 'news_article', 2, 'Câmara dos Deputados', 'Plenário', 'nikolas-biblia-viralizacao-b81-43') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;

  -- 44
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mic, 'Michelle acusa Janja de "bruxaria" após visita a terreiro.', 'Janja foi num terreiro. Aquilo ali é bruxaria disfarçada. O Brasil não pode ser governado por feitiçaria.', 'Live no Instagram.', 'verified', true, '2023-11-03', 'https://www.revistaoeste.com/politica/michelle-janja-bruxaria-terreiro/', 'social_media_post', 5, 'Redes sociais', 'Live Instagram', 'michelle-janja-bruxaria-b81-44') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_int, true FROM ins;

  -- 45
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jaf, 'Jandira Feghali aciona Justiça contra Michelle por racismo religioso.', 'Michelle Bolsonaro cometeu crime de racismo religioso ao chamar cerimônia afro-brasileira de bruxaria. Estamos protocolando queixa-crime.', 'Coletiva no Congresso.', 'verified', true, '2023-11-06', 'https://www.cartacapital.com.br/politica/jandira-michelle-racismo-religioso/', 'news_article', 2, 'Brasília', 'Coletiva no Congresso', 'jandira-michelle-queixa-b81-45') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_odi, true FROM ins;
  ...
  -- 58
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_gle, 'Gleisi Hoffmann responde Malta: "mulher petista não obedece a machista com Bíblia".', 'Magno Malta disfarça machismo de teologia. Mulher brasileira não obedece a machista, com ou sem Bíblia na mão.', 'Post no X.', 'verified', true, '2024-03-09', 'https://www.cartacapital.com.br/politica/gleisi-magno-malta-machista/', 'social_media_post', 1, 'Redes sociais', 'Post no X', 'gleisi-malta-machista-b81-58') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_con, true FROM ins;

  -- 59
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_dam, 'Damares ataca escolas particulares religiosas que trataram pauta LGBT.', 'Colégio evangélico que adota pauta LGBT parou de ser colégio evangélico. Pais precisam boicotar.', 'Post em redes.', 'verified', false, '2024-05-24', 'https://www.revistaoeste.com/politica/damares-colegios-evangelicos-lgbt-boicote/', 'social_media_post', 4, 'Redes sociais', 'Post em redes', 'damares-colegios-lgbt-b81-59') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_hom, true FROM ins;

  -- 60
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mfe, 'Feliciano promove congresso "Reino Agora" com pastores da Universal e AD juntos.', 'Universal e Assembleia juntas neste congresso. É Reino agora, é Brasil voltando a Deus.', 'Congresso Reino Agora em Brasília.', 'verified', true, '2025-06-18', 'https://www.gospelmais.com.br/feliciano-reino-agora-universal-ad.html', 'news_article', 2, 'Brasília', 'Congresso Reino Agora', 'feliciano-reino-agora-b81-60') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_con, true FROM ins;

  -- 61
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_bia, 'Bia Kicis critica Cármen Lúcia por chamar fé de "privada".', 'Cármen Lúcia errou feio dizendo que fé é privada. Fé é pública, fé é sal da terra, fé é testemunho.', 'Post no X em resposta a discurso da ministra.', 'verified', false, '2024-07-31', 'https://www.revistaoeste.com/politica/bia-kicis-carmen-lucia-fe-privada/', 'social_media_post', 3, 'Redes sociais', 'Post no X', 'bia-kicis-carmen-lucia-b81-61') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 62
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_nik, 'Nikolas diz que "Lula ofendeu Deus" ao visitar terreiro.', 'Lula foi num terreiro e ofendeu Deus diretamente. Presidente do Brasil não pode se curvar a entidade pagã.', 'Vídeo publicado no X após visita de Lula a terreiro em SP.', 'verified', true, '2023-07-22', 'https://www.gospelmais.com.br/nikolas-lula-terreiro-ofender-deus.html', 'social_media_post', 5, 'Redes sociais', 'Post no X', 'nikolas-lula-terreiro-deus-b81-62') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_int, true FROM ins;

  -- 63
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_lul, 'Lula visita terreiro de candomblé e diz que "todos os deuses são respeitáveis".', 'Para mim, todos os deuses são respeitáveis. Eu fui criado católico, mas respeito orixás como respeito Jesus.', 'Visita a terreiro em São Paulo.', 'verified', true, '2023-07-21', 'https://www.oglobo.globo.com/politica/lula-terreiro-candomble-sao-paulo-2023-todos-deuses.ghtml', 'news_article', 1, 'São Paulo', 'Terreiro de candomblé — Itaquera', 'lula-terreiro-todos-deuses-b81-63') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_con, true FROM ins;
  ...
  -- 94
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_dam, 'Damares é criticada por usar orfanato em campanha religiosa.', 'Estamos dando Cristo para as crianças do orfanato. Críticas de imprensa são fruto do inimigo querendo calar a evangelização.', 'Visita a orfanato em Goiânia com transmissão ao vivo.', 'verified', false, '2024-10-12', 'https://www1.folha.uol.com.br/cotidiano/2024/10/damares-orfanato-evangelizacao-transmissao.shtml', 'news_article', 4, 'Goiânia', 'Visita a orfanato', 'damares-orfanato-evangelizacao-b81-94') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;

  -- 95
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_sil, 'Silas Câmara é acusado de contratar familiares como pastores-assessores.', 'Meus filhos são pastores concursados da igreja, não cargos fantasma. Imprensa vermelha inventa escândalo.', 'Entrevista à Folha em reação a reportagem.', 'verified', true, '2025-04-14', 'https://www1.folha.uol.com.br/poder/2025/04/silas-camara-familiares-pastores-assessores.shtml', 'news_article', 4, 'Brasília', 'Folha — entrevista', 'silas-familiares-pastores-b81-95') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_nep, true FROM ins;

  -- 96
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mag, 'Magno Malta ataca Janja em culto: "mulher de presidente tinha que saber rezar".', 'Essa mulher de presidente tinha que saber rezar, não ficar em culto de macumba. Deus vê tudo.', 'Culto com transmissão na TV Gospel Century.', 'verified', true, '2024-02-14', 'https://www.gospelmais.com.br/magno-malta-janja-macumba-culto.html', 'news_article', 5, 'Vitória (ES)', 'Culto Rede Paz', 'magno-malta-janja-macumba-b81-96') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_int, true FROM ins;

  -- 97
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_nik, 'Nikolas Ferreira diz que "homem gay não pode ser pastor".', 'Homem gay não pode ser pastor, ponto. Não é preconceito, é a Bíblia. Quem quer ser pastor tem que ser homem de Deus.', 'Live com pastores.', 'verified', true, '2024-01-14', 'https://www.gospelmais.com.br/nikolas-homem-gay-nao-pode-ser-pastor.html', 'social_media_post', 5, 'Internet', 'Live com pastores', 'nikolas-gay-nao-pastor-b81-97') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_hom, true FROM ins;

  -- 98
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mfe, 'Feliciano promete "CPI das religiões afro" se oposição vencer 2026.', 'Se a oposição vencer em 2026, eu serei o primeiro a propor CPI das religiões afro, que estão por trás da violência no país.', 'Entrevista à Revista Oeste.', 'verified', true, '2025-07-29', 'https://www.revistaoeste.com/politica/feliciano-cpi-religioes-afro-2026/', 'news_article', 5, 'São Paulo', 'Revista Oeste — entrevista', 'feliciano-cpi-religioes-afro-b81-98') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_int, true FROM ins;

  -- 99
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_lul, 'Lula abre centro de apoio a terreiros em SP em resposta a ataques.', 'Inauguramos hoje o Centro Nacional de Apoio às Religiões de Matriz Africana. Terreiro tem o mesmo respeito que qualquer igreja.', 'Inauguração em São Paulo.', 'verified', true, '2025-03-14', 'https://www.oglobo.globo.com/politica/lula-centro-apoio-terreiros-matriz-africana-2025.ghtml', 'news_article', 1, 'São Paulo', 'Inauguração Centro Nacional', 'lula-centro-terreiros-b81-99') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_con, true FROM ins;

  -- 100
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_dam, 'Damares classifica o centro de apoio a terreiros como "templo do paganismo oficial".', 'Lula financia paganismo oficial com dinheiro do contribuinte cristão. Isso é afronta ao Brasil de fé.', 'Post em redes e entrevista à Record News.', 'verified', true, '2025-03-15', 'https://www.gospelmais.com.br/damares-centro-terreiros-paganismo.html', 'news_article', 5, 'Brasília', 'Record News + redes', 'damares-paganismo-oficial-b81-100') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_int, true FROM ins;
