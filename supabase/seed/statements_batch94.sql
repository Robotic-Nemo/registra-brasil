...
BEGIN
  ...
  -- 67
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_maluf, 'Maluf diz que "rouba, mas faz" defendendo seu legado em São Paulo.', 'Eu fiz. Os paulistanos sabem disso. A obra está aí.', 'Defesa do próprio legado em entrevista à Veja SP sobre investigações de lavagem de dinheiro.', 'verified', false, '2012-03-09', 'https://veja.abril.com.br/politica/maluf-rouba-mas-faz/', 'news_article', 3, 'São Paulo', 'Entrevista Veja SP', 'maluf-rouba-mas-faz-b94-67') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_cor, true FROM ins;

  -- 68
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_dilma, 'Dilma sanciona Lei Maria da Penha ampliada contra feminicídio.', 'Não vamos aceitar mais mulher morta por ser mulher.', 'Cerimônia no Planalto sancionando ampliação da lei contra violência doméstica.', 'verified', false, '2013-05-12', 'https://g1.globo.com/politica/noticia/2013/05/dilma-sanciona-lei-feminicidio.html', 'news_article', 1, 'Palácio do Planalto', 'Cerimônia de sanção', 'dilma-sanciona-maria-penha-b94-68') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 69
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_renan, 'Renan defende PEC que reduz poderes do MP após Lava Jato.', 'O MP precisa de limites. Ninguém está acima da lei.', 'Discurso de Renan em defesa da PEC 37 em resposta ao protagonismo do MP nas operações.', 'verified', false, '2013-06-25', 'https://www12.senado.leg.br/noticias/materias/2013/06/25/renan-defende-pec-37', 'news_article', 4, 'Senado Federal', 'Discurso plenário', 'renan-pec-37-mp-b94-69') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_obs, true FROM ins;

  -- 70
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_aecio, 'Aécio promete privatizar estatais se eleito presidente.', 'Vamos desestatizar o que não funciona. Estado precisa ser eficiente.', 'Promessa de campanha em sabatina com empresários no Lide.', 'verified', false, '2014-08-07', 'https://www.estadao.com.br/politica/aecio-privatizacoes-lide-imp-,1235918', 'news_article', 1, 'São Paulo', 'Sabatina Lide', 'aecio-privatizacoes-lide-b94-70') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 71
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_dilma, 'Dilma promete "não haver recessão" em plena crise de 2014.', 'Não vai haver recessão. Fiquem tranquilos.', 'Promessa de Dilma em meio a sinais de desaceleração que depois viraria recessão histórica.', 'verified', true, '2014-08-19', 'https://www1.folha.uol.com.br/mercado/2014/08/1502812-dilma-nao-havera-recessao.shtml', 'news_article', 3, 'Palácio do Planalto', 'Entrevista', 'dilma-nao-recessao-b94-71') ON CONFLICT (slug) DO NOTHING RETURNING id)
  ...
  -- 89
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_dilma, 'Dilma defende Mais Médicos em meio a protestos contra cubanos.', 'Os médicos brasileiros tiveram chance. Não vamos deixar a população sem atendimento.', 'Declaração em cerimônia do programa Mais Médicos após entidades médicas protestarem.', 'verified', false, '2013-08-26', 'https://g1.globo.com/politica/noticia/2013/08/dilma-defende-mais-medicos-cubanos.html', 'news_article', 1, 'Brasília', 'Cerimônia Mais Médicos', 'dilma-mais-medicos-cubanos-b94-89') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 90
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_lula, 'Lula vê EUA espionando Petrobras e clama por soberania.', 'Os americanos espionam nossas empresas. Precisamos defender a soberania.', 'Resposta de Lula a revelações de Snowden sobre espionagem da NSA contra Petrobras.', 'verified', false, '2013-09-10', 'https://www.cartacapital.com.br/politica/lula-nsa-petrobras/', 'news_article', 2, 'São Paulo', 'Entrevista', 'lula-nsa-petrobras-b94-90') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 91
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_sarney, 'Sarney é acusado de nepotismo em caso de filhos e netos no Senado.', 'Minha família sempre serviu ao Brasil. Não há ilegalidade.', 'Resposta de Sarney a reportagens sobre parentes contratados em gabinetes do Senado.', 'verified', false, '2011-06-14', 'https://oglobo.globo.com/politica/sarney-nepotismo-senado-2781223', 'news_article', 4, 'Brasília', 'Coletiva Senado', 'sarney-nepotismo-senado-b94-91') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_nep, true FROM ins;

  -- 92
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jair, 'Bolsonaro defende ditadura como "período glorioso" do Brasil.', 'A ditadura foi um período glorioso. Não houve ditadura, houve democracia.', 'Negação da ditadura em audiência na Câmara que tramitou Comissão da Verdade.', 'verified', true, '2013-09-12', 'https://www1.folha.uol.com.br/poder/2013/09/1342912-bolsonaro-ditadura-periodo-glorioso.shtml', 'news_article', 5, 'Câmara dos Deputados', 'Audiência pública', 'bolsonaro-ditadura-gloriosa-b94-92') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ant, true FROM ins UNION ALL SELECT id, c_des, false FROM ins;

  -- 93
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_alckmin, 'Alckmin defende privatização da Sabesp em meio à crise.', 'A iniciativa privada traria eficiência. O Estado não dá conta sozinho.', 'Declaração do governador à Folha em setembro de 2014 durante crise hídrica crítica.', 'verified', false, '2014-09-29', 'https://www1.folha.uol.com.br/cotidiano/2014/09/1519812-alckmin-sabesp-privatizacao.shtml', 'news_article', 2, 'São Paulo', 'Entrevista', 'alckmin-sabesp-privatizacao-b94-93') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 94
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_renan, 'Renan minimiza CPI da Petrobras pedida pela oposição.', 'Essa CPI é manobra eleitoral. Não vai prosperar no Senado.', 'Renan, como presidente do Senado, barrou tramitação de CPI após Lava Jato começar.', 'verified', false, '2014-09-24', 'https://www12.senado.leg.br/noticias/materias/2014/09/24/renan-cpi-petrobras', 'news_article', 4, 'Senado Federal', 'Coletiva presidente do Senado', 'renan-barra-cpi-petrobras-b94-94') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_obs, true FROM ins;

  -- 95
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_gleisi, 'Gleisi Hoffmann anuncia candidatura ao Senado pelo Paraná.', 'Vou ao Senado defender o projeto do PT e da Dilma.', 'Anúncio da candidatura ao Senado pelo Paraná, deixando a Casa Civil em 2014.', 'verified', false, '2014-02-04', 'https://g1.globo.com/pr/parana/eleicoes/2014/noticia/2014/02/gleisi-hoffmann-anuncia-senado-parana.html', 'news_article', 1, 'Curitiba', 'Anúncio pré-candidatura', 'gleisi-senado-parana-2014-b94-95') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_con, true FROM ins;

  -- 96
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_fhc, 'FHC apoia protestos contra Dilma durante jornadas de junho.', 'As ruas estão dizendo algo que o governo não quer ouvir.', 'Artigo no Estadão de FHC durante protestos de junho lendo o movimento como crítica ao PT.', 'verified', false, '2013-06-25', 'https://www.estadao.com.br/politica/fhc-protestos-junho-imp-,1045612', 'news_article', 2, 'São Paulo', 'Artigo Estadão', 'fhc-protestos-junho-b94-96') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 97
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_dilma, 'Dilma reage à ameaça de CPI do mensalão tucano e defende transparência.', 'Todo dinheiro público deve ser investigado. Não temos nada a esconder.', 'Dilma em entrevista sobre CPI envolvendo denúncias contra tucanos em MG e DF.', 'verified', false, '2012-03-26', 'https://www1.folha.uol.com.br/poder/1063312-dilma-cpi-mensalao-tucano.shtml', 'news_article', 1, 'Palácio do Planalto', 'Entrevista', 'dilma-cpi-mensalao-tucano-b94-97') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 98
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jair, 'Bolsonaro nega racismo em caso "galho mais alto da árvore".', 'Nunca fui racista. Só defendi a meritocracia.', 'Resposta a críticas após declarações sobre quilombolas e negros.', 'verified', false, '2014-04-10', 'https://oglobo.globo.com/politica/bolsonaro-nega-racismo-galho-12189821', 'news_article', 4, 'Rio de Janeiro', 'Entrevista TV', 'bolsonaro-nega-racismo-b94-98') ON CONFLICT (slug) DO NOTHING RETURNING id)
  ...
  -- 99
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_cunha, 'Cunha compra apoio de pequenos partidos para presidência da Câmara.', 'Estamos conversando com todos. Vou construir a maior coalizão da história.', 'Articulação de Cunha comprando apoio de partidos nanicos com cargos antes da eleição em fevereiro.', 'verified', true, '2014-12-20', 'https://www1.folha.uol.com.br/poder/2014/12/1566621-cunha-apoio-nanicos-presidencia-camara.shtml', 'news_article', 4, 'Brasília', 'Bastidores Câmara', 'cunha-apoio-nanicos-camara-b94-99') ON CONFLICT (slug) DO NOTHING RETURNING id)
