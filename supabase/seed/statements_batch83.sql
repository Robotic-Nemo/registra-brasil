...
BEGIN
  ...
  -- 34
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mvh, 'Marcel propõe CPI do PNLD para "checar viés ideológico".', 'PNLD virou propaganda ideológica paga com dinheiro público. Precisa de CPI urgente.', 'Apresentação de requerimento de CPI na Câmara.', 'verified', false, '2024-07-04', 'https://www.poder360.com.br/congresso/van-hattem-cpi-pnld-viés/', 'news_article', 3, 'Câmara dos Deputados', 'Requerimento de CPI', 'van-hattem-cpi-pnld-b83-34') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ame, true FROM ins;

  -- 35
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_kim, 'Kim Kataguiri defende "meritocracia" contra cotas.', 'A revisão das cotas foi covardia do Senado. Deveríamos caminhar para a meritocracia, não para o assistencialismo racial.', 'Coluna no Estadão após aprovação da nova Lei de Cotas.', 'verified', false, '2023-11-16', 'https://www.estadao.com.br/opiniao/kim-meritocracia-cotas-2023/', 'news_article', 3, 'São Paulo', 'Coluna Estadão', 'kim-meritocracia-cotas-b83-35') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_rac, true FROM ins;
  ...
  -- 37
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_tab, 'Tábata apoia Pé-de-Meia mas critica execução do MEC.', 'O conceito do Pé-de-Meia está certo. Mas o MEC está atrasado com pagamentos e dados. Não basta boa intenção.', 'Pronunciamento sobre relatório da CGU sobre o programa.', 'verified', false, '2025-03-04', 'https://novaescola.org.br/conteudo/25800/tabata-pe-de-meia-cgu', 'news_article', 2, 'Câmara dos Deputados', 'Pronunciamento', 'tabata-pe-de-meia-cgu-b83-37') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 38
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_eri, 'Erika Hilton defende cotas para trans em federais.', 'Vagas para travestis e trans nas universidades são reparação. Não estamos pedindo favor, exigindo direito.', 'Pronunciamento em plenário por lei que regulamenta cotas trans.', 'verified', false, '2024-11-27', 'https://g1.globo.com/educacao/noticia/2024/11/27/erika-cotas-trans-universidades.ghtml', 'news_article', 2, 'Câmara dos Deputados', 'Plenário', 'erika-cotas-trans-b83-38') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;
