...
BEGIN
  ...
  -- 18
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jair, 'Bolsonaro acusa ONGs de atearem fogo na Amazônia sem apresentar provas.', 'Pode ser que as ONGs estejam ateando fogo para chamar a atenção do mundo.', 'Declaração em meio às queimadas recordes na Amazônia em agosto de 2019.', 'verified', true, '2019-08-21', 'https://g1.globo.com/politica/noticia/2019/08/21/bolsonaro-acusa-ongs-queimadas.ghtml', 'news_article', 4, 'Brasília', 'Transmissão ao vivo', 'bolsonaro-ongs-queimadas-amazonia-b98-18') ON CONFLICT (slug) DO NOTHING RETURNING id)
  ...
  -- 43
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jair, 'Bolsonaro diz que "não vai se meter" em caso do filho Flávio.', 'Eu não vou me meter. Se o Flávio errou, que ele pague.', 'Declaração ao ser questionado sobre rachadinha.', 'verified', false, '2019-02-10', 'https://www1.folha.uol.com.br/poder/2019/02/bolsonaro-flavio-rachadinha.shtml', 'news_article', 2, 'Brasília', 'Cerca do Alvorada', 'bolsonaro-flavio-rachadinha-b98-43') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_cor, true FROM ins;

  -- 44
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_sar, 'Sarney critica ataques de Bolsonaro à Nova República.', 'Estamos vivendo um retrocesso institucional sem precedentes desde 1988.', 'Declaração em entrevista ao Globo.', 'verified', false, '2019-04-02', 'https://oglobo.globo.com/politica/sarney-retrocesso-institucional-23567890', 'news_article', 1, 'Brasília', 'Entrevista ao Globo', 'sarney-retrocesso-institucional-b98-44') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ant, true FROM ins;

  -- 45
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_col, 'Collor defende Bolsonaro no Senado e ataca mídia.', 'A imprensa não dá trégua a um governo eleito pelo povo.', 'Pronunciamento em plenário do Senado.', 'verified', false, '2019-06-12', 'https://www12.senado.leg.br/noticias/2019/06/collor-defesa-bolsonaro', 'other', 1, 'Senado Federal', 'Pronunciamento em plenário', 'collor-defende-bolsonaro-b98-45') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;

  -- 46
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mer, 'Mercadante critica desmonte de políticas sociais pelo governo.', 'O Brasil está desmontando, peça por peça, a rede de proteção social.', 'Entrevista após cortes em programas sociais.', 'verified', false, '2019-05-15', 'https://www1.folha.uol.com.br/poder/2019/05/mercadante-desmonte-social.shtml', 'news_article', 1, 'São Paulo', 'Entrevista', 'mercadante-desmonte-social-b98-46') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 47
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_mar, 'Marta Suplicy critica pacote anti-aborto de Damares.', 'A ministra transforma crença pessoal em política pública. Isso é inaceitável.', 'Entrevista no contexto do debate sobre aborto.', 'verified', false, '2019-03-15', 'https://g1.globo.com/politica/noticia/2019/03/15/marta-critica-damares-aborto.ghtml', 'news_article', 1, 'São Paulo', 'Entrevista à rádio', 'marta-critica-damares-aborto-b98-47') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 48
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_sil, 'Silas Câmara defende uso de recursos públicos em ação religiosa.', 'A bancada evangélica vai garantir que os valores cristãos prevaleçam no orçamento.', 'Reunião da bancada evangélica na Câmara.', 'verified', false, '2019-02-26', 'https://www1.folha.uol.com.br/poder/2019/02/silas-camara-bancada-evangelica.shtml', 'news_article', 2, 'Câmara dos Deputados', 'Reunião de bancada', 'silas-camara-bancada-evangelica-b98-48') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_itr, true FROM ins;

  -- 49
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_van, 'Marcel Van Hattem defende reforma da Previdência em plenário.', 'Quem não quer reforma é quem vive do Estado. A reforma salvará o Brasil.', 'Pronunciamento em plenário em defesa da PEC.', 'verified', false, '2019-07-10', 'https://g1.globo.com/politica/noticia/2019/07/10/van-hattem-defende-previdencia.ghtml', 'other', 1, 'Câmara dos Deputados', 'Discurso sobre a Previdência', 'van-hattem-previdencia-b98-49') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_con, true FROM ins;

  -- 50
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_kim, 'Kim Kataguiri defende teto de gastos mesmo em crise.', 'Sem teto de gastos, o Brasil volta à inflação dos anos 80.', 'Entrevista sobre política fiscal.', 'verified', false, '2019-08-20', 'https://www1.folha.uol.com.br/mercado/2019/08/kim-kataguiri-teto-gastos.shtml', 'news_article', 1, 'Brasília', 'Entrevista', 'kim-teto-gastos-b98-50') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_con, true FROM ins;

  -- 51
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_adr, 'Adriana Ventura defende revisão da Lei Maria da Penha.', 'A Maria da Penha tem falhas que precisam ser corrigidas.', 'Declaração em audiência pública sobre violência contra mulher.', 'verified', false, '2019-09-10', 'https://g1.globo.com/politica/noticia/2019/09/10/ventura-lei-maria-penha.ghtml', 'news_article', 2, 'Câmara dos Deputados', 'Audiência pública', 'ventura-maria-da-penha-b98-51') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_mis, true FROM ins;

  -- 52
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_tab, 'Tabata Amaral critica cortes na educação.', 'Cortar o MEC é atentar contra o futuro do Brasil.', 'Discurso em plenário contra bloqueio de R$ 6 bilhões na Educação.', 'verified', false, '2019-05-06', 'https://g1.globo.com/politica/noticia/2019/05/06/tabata-critica-cortes-educacao.ghtml', 'other', 1, 'Câmara dos Deputados', 'Pronunciamento em plenário', 'tabata-cortes-educacao-b98-52') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 53
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_chi, 'Chico Alencar critica militarização do governo.', 'Nunca tivemos tantos militares em cargos civis desde a ditadura.', 'Entrevista à Carta Capital.', 'verified', false, '2019-08-25', 'https://www.cartacapital.com.br/politica/chico-alencar-militarizacao/', 'news_article', 1, 'Rio de Janeiro', 'Entrevista à Carta Capital', 'chico-alencar-militarizacao-b98-53') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ant, true FROM ins;

  -- 54
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jan, 'Jandira Feghali critica Damares e ameaças ao SUS.', 'O SUS está sendo desmontado enquanto Damares prega moralismo.', 'Pronunciamento em plenário sobre saúde.', 'verified', false, '2019-06-18', 'https://www.cartacapital.com.br/politica/jandira-sus-damares/', 'other', 1, 'Câmara dos Deputados', 'Discurso em plenário', 'jandira-critica-sus-damares-b98-54') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 55
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_frx, 'Marcelo Freixo denuncia ameaças de milícia após citações de Bolsonaro.', 'Depois de ser citado pelo presidente, recebi ameaças de milicianos.', 'Entrevista ao Globo após Bolsonaro ter feito insinuações.', 'verified', true, '2019-11-01', 'https://oglobo.globo.com/politica/freixo-ameacas-milicia-bolsonaro-23612345', 'news_article', 3, 'Rio de Janeiro', 'Entrevista ao Globo', 'freixo-ameacas-milicia-b98-55') ON CONFLICT (slug) DO NOTHING RETURNING id)
  ...
  -- 72
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jair, 'Bolsonaro afirma que "minoria tem que se curvar à maioria".', 'As minorias têm que se adequar às maiorias. Ou simplesmente desaparecem.', 'Declaração durante palestra no Clube Hebraica nos EUA em março de 2019.', 'verified', true, '2019-03-03', 'https://g1.globo.com/politica/noticia/2019/03/03/bolsonaro-minoria-curvar-maioria.ghtml', 'other', 5, 'Washington, EUA', 'Palestra para empresários', 'bolsonaro-minoria-curvar-maioria-b98-72') ON CONFLICT (slug) DO NOTHING RETURNING id)
