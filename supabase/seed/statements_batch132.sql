...
BEGIN
  ...
  -- 1
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_gle, 'Gleisi chama Eduardo Bolsonaro de traidor da pátria após articulação nos EUA.', 'Eduardo Bolsonaro é um traidor da pátria que pede sanções contra o próprio país.', 'Declaração em entrevista coletiva na sede do PT após reuniões de Eduardo em Washington.', 'verified', true, '2023-03-15', 'https://www1.folha.uol.com.br/poder/2023/03/gleisi-eduardo-bolsonaro-traidor.shtml', 'news_article', 3, 'São Paulo', 'Coletiva do PT', 'gleisi-eduardo-traidor-b132-1') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_odi, true FROM ins;

  -- 2
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_jan, 'Janones publica vídeo viral chamando Bolsonaro de "genocida fujão".', 'Bolsonaro é um genocida fujão que abandonou o Brasil na pandemia e agora foge dos EUA.', 'Vídeo postado no TikTok com mais de 10 milhões de visualizações em 24 horas.', 'verified', true, '2023-02-10', 'https://www.metropoles.com/brasil/politica-br/janones-bolsonaro-genocida-fujao', 'social_media_post', 3, 'Brasília', 'Postagem em rede social', 'janones-bolsonaro-genocida-fujao-b132-2') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_odi, true FROM ins;
  ...
  -- 13
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_nik, 'Nikolas espalha desinformação sobre programa Bolsa Família.', 'Lula vai tirar o Bolsa Família de 3 milhões de pessoas, é um criminoso social.', 'Vídeo no Instagram desmentido pela Agência Lupa no mesmo dia.', 'verified', true, '2023-02-20', 'https://www.metropoles.com/brasil/politica-br/nikolas-bolsa-familia-desinformacao', 'social_media_post', 4, 'Belo Horizonte', 'Postagem em rede social', 'nikolas-bolsa-familia-desinfo-b132-13') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_des, true FROM ins;
  ...
  -- 68
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_fel, 'Feliciano acusa governo Lula de "perseguir cristãos".', 'Esse governo ateu quer perseguir os cristãos, acabar com nossa fé.', 'Sermão em culto em Goiânia transmitido ao vivo.', 'verified', false, '2023-08-30', 'https://www.metropoles.com/brasil/politica-br/feliciano-lula-perseguir-cristaos', 'news_article', 3, 'Goiânia', 'Culto Catedral do Avivamento', 'feliciano-perseguir-cristaos-b132-68') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_itr, true FROM ins;

  -- 69
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_sam, 'Sâmia Bomfim denuncia violência política de gênero contra Gleisi.', 'Gleisi é alvo de violência política de gênero diária da extrema-direita.', 'Entrevista em sessão da Câmara sobre violência política.', 'verified', false, '2024-03-15', 'https://g1.globo.com/politica/noticia/2024/03/15/samia-gleisi-violencia-politica.ghtml', 'news_article', 2, 'Câmara dos Deputados', 'Sessão plenária', 'samia-gleisi-violencia-politica-b132-69') ON CONFLICT (slug) DO NOTHING RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_mis, true FROM ins;
