...
BEGIN
  ...
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_lula, 'Lula critica Temer em caravana e diz que governo ilegítimo desmonta direitos sociais.', 'O Temer é um governo ilegítimo que vem desmontando tudo o que foi construído em 13 anos. O povo vai responder em 2018.', 'Discurso em Caruaru na Caravana Lula pelo Brasil em agosto de 2017.', 'verified', false, '2017-08-18', 'https://g1.globo.com/pe/caruaru-regiao/noticia/lula-critica-temer-em-caruaru.ghtml', 'news_article', 1, 'Caruaru - PE', 'Caravana Lula pelo Brasil', 'lula-caruaru-temer-b97-3') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 4 Dilma discurso Viena
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_dilma, 'Dilma em discurso na Universidade de Viena denuncia golpe parlamentar articulado por Temer e Cunha.', 'Meu impeachment foi um golpe parlamentar disfarçado de legalidade. Uma ruptura democrática.', 'Conferência na Universidade de Viena em 28 de outubro de 2016 após sua destituição.', 'verified', false, '2016-10-28', 'https://www.dw.com/pt-br/dilma-denuncia-golpe-em-palestra-em-viena/a-36196459', 'news_article', 1, 'Universidade de Viena', 'Conferência internacional', 'dilma-viena-golpe-b97-4') RETURNING id)
  ...
  -- 40 Edu futuro eua
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_edu, 'Eduardo Bolsonaro reativa gesto Steve Bannon em aliança internacional em 2018.', 'Vamos trazer Bannon para o Brasil. A direita global precisa unir forças.', 'Publicação em rede social após encontro com Bannon em agosto de 2018.', 'verified', false, '2018-08-13', 'https://www1.folha.uol.com.br/mundo/2018/08/eduardo-bolsonaro-encontra-bannon.shtml', 'news_article', 3, 'Nova York', 'Encontro com Bannon', 'eduardo-bannon-aliança-b97-40') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ant, true FROM ins;

  -- 41 Flavio Queiroz rachadinha
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_fla, 'Flávio Bolsonaro minimiza R$ 1,2 milhão movimentado por Queiroz.', 'Não é rachadinha. Queiroz cuidava dos meus negócios privados. Tudo legal.', 'Entrevista em dezembro de 2018 após relatório do Coaf revelar movimentações.', 'verified', true, '2018-12-09', 'https://g1.globo.com/rj/rio-de-janeiro/noticia/flavio-queiroz-rachadinha-coaf.ghtml', 'news_article', 4, 'Rio de Janeiro', 'Revelação do Coaf', 'flavio-queiroz-minimiza-b97-41') RETURNING id)
  ...
  -- 58 Damares menina
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_damares, 'Damares Alves defende caso polêmico em que teria sido tutora de menina indígena.', 'Sou mãe de coração de uma indígena. Resgatei uma criança das mãos da morte.', 'Entrevista em julho de 2018, caso que depois geraria questionamentos judiciais.', 'verified', false, '2018-07-22', 'https://www1.folha.uol.com.br/cotidiano/2018/07/damares-alves-menina-indigena.shtml', 'news_article', 3, 'Brasília', 'Entrevista', 'damares-tutela-indigena-b97-58') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_con, true FROM ins;

  -- 59 Magno Marielle
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_magno, 'Magno Malta ataca Marielle Franco ao defender miliciano após o assassinato.', 'A esquerda está transformando a morte dela em show. Existem brasileiros morrendo todos os dias.', 'Pronunciamento no Senado em 20 de março de 2018 após o assassinato de Marielle.', 'verified', true, '2018-03-20', 'https://www12.senado.leg.br/noticias/materias/2018/03/20/magno-malta-marielle', 'news_article', 4, 'Senado Federal', 'Pronunciamento sobre Marielle', 'magno-ataca-marielle-b97-59') RETURNING id)
  ...
  -- 72 Flavio Alerj
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_fla, 'Flávio Bolsonaro vota pela aprovação de reforma previdência municipal no Rio em 2017.', 'A previdência quebrou. Precisamos reformar para garantir pagamento a quem trabalha.', 'Votação na Alerj em 2017.', 'verified', false, '2017-11-08', 'https://g1.globo.com/rj/rio-de-janeiro/noticia/flavio-vota-reforma-previdencia-rj.ghtml', 'news_article', 1, 'Alerj', 'Votação reforma RJ', 'flavio-reforma-rj-b97-72') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 73 Gleisi 2018 prisão Lula
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_gle, 'Gleisi lidera vigília em frente à PF em Curitiba durante prisão de Lula.', 'Lula livre é nosso lema. Não vamos sair daqui enquanto ele estiver preso injustamente.', 'Vigília iniciada em 7 de abril de 2018, mantida por 580 dias.', 'verified', true, '2018-04-07', 'https://g1.globo.com/pr/parana/noticia/pt-vigilia-frente-pf-curitiba-lula.ghtml', 'news_article', 1, 'Curitiba', 'Vigília Lula Livre', 'gleisi-vigilia-lula-b97-73') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_ant, true FROM ins;

  -- 74 Moro Globo
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_moro, 'Moro concede entrevista exclusiva à Globo dias após aceitar ministério de Bolsonaro.', 'Aceitei o desafio de combater a corrupção no Executivo. Continuo um juiz servindo ao país.', 'Entrevista ao Jornal Nacional em 5 de novembro de 2018.', 'verified', true, '2018-11-05', 'https://g1.globo.com/jornal-nacional/noticia/2018/11/05/entrevista-com-sergio-moro.ghtml', 'news_article', 4, 'Rede Globo', 'Jornal Nacional', 'moro-entrevista-jn-b97-74') RETURNING id)
  ...
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_had, 'Haddad critica ausência de Bolsonaro em debates no segundo turno.', 'Bolsonaro foge do debate porque tem medo. Não tem proposta, só ódio.', 'Declaração em 18 de outubro de 2018 ao confirmar novo debate sem Bolsonaro.', 'verified', false, '2018-10-18', 'https://g1.globo.com/politica/eleicoes/2018/noticia/haddad-critica-ausencia-bolsonaro-debate.ghtml', 'news_article', 1, 'São Paulo', 'Coletiva debate', 'haddad-bolsonaro-foge-debate-b97-76') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;

  -- 77 Serra TRF
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_serra, 'Serra é denunciado por lavagem de dinheiro no Lava Jato em 2017.', 'Sou vítima de calúnias. Nunca lavei um centavo. Essas acusações são vergonhosas.', 'Declaração em 20 de dezembro de 2017 após denúncia.', 'verified', false, '2017-12-20', 'https://www1.folha.uol.com.br/poder/2017/12/1945823-serra-denunciado-lavagem.shtml', 'news_article', 3, 'São Paulo', 'Denúncia por lavagem', 'serra-denunciado-lavagem-b97-77') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_cor, true FROM ins;

  -- 78 Marta governo Doria
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_marta, 'Marta Suplicy é nomeada secretária na gestão Doria em São Paulo.', 'Aceito o convite para servir a cidade que tanto amo. Vamos trabalhar por uma São Paulo melhor.', 'Posse na Secretaria de Relações Internacionais em janeiro de 2017.', 'verified', false, '2017-01-02', 'https://g1.globo.com/sao-paulo/noticia/2017/01/marta-suplicy-secretaria-doria.html', 'news_article', 1, 'Prefeitura de SP', 'Posse secretaria', 'marta-secretaria-doria-b97-78') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_irr, true FROM ins;
  ...
  -- 99 Aecio filho
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_aecio, 'Aécio tenta blindagem pelo STF e pede para que não seja preso em 2017.', 'Tenho foro privilegiado. Qualquer decisão de juiz de primeiro grau contra mim é nula.', 'Declaração em 17 de maio de 2017 após vazamento dos áudios.', 'verified', false, '2017-05-17', 'https://www12.senado.leg.br/noticias/materias/2017/05/17/aecio-invoca-foro-privilegiado', 'news_article', 3, 'Senado Federal', 'Defesa judicial', 'aecio-foro-privilegiado-b97-99') RETURNING id)
  INSERT INTO statement_categories (statement_id, category_id, is_primary) SELECT id, c_abu, true FROM ins;

  -- 100 Temer decreto Rio GLO
  WITH ins AS (INSERT INTO statements (politician_id, summary, full_quote, context, verification_status, is_featured, statement_date, primary_source_url, primary_source_type, severity_score, venue, event_name, slug) VALUES (v_temer, 'Temer assina decreto de intervenção federal na segurança pública do Rio em 2018.', 'Estamos dando os meios necessários para combater o crime organizado. A intervenção é pela paz.', 'Cerimônia em 16 de fevereiro de 2018 no Palácio do Planalto.', 'verified', true, '2018-02-16', 'https://g1.globo.com/politica/noticia/temer-assina-decreto-intervencao-rio.ghtml', 'news_article', 3, 'Palácio do Planalto', 'Decreto de intervenção federal', 'temer-intervencao-rio-b97-100') RETURNING id)
